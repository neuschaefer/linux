...
int skb_init_intel(struct sk_buff *skb)
{
    ...
    memset((void *)SKB_GET_COOKIE_P(skb), 0, sizeof(SKB_INTEL_COOKIE));
    SKB_GET_PP_INFO_P(skb)->egress_queue = TI_PPM_EGRESS_QUEUE_INVALID;
#ifndef CONFIG_MACH_PUMA5
    SKB_GET_PP_INFO_P(skb)->pp_session.session_handle = AVALANCHE_PP_INVALID_SESSION; /* Set invalid session */
#endif
...
#ifdef CONFIG_TI_PACKET_PROCESSOR
    memcpy((void *)SKB_GET_COOKIE_P(n), (void *)SKB_GET_COOKIE_P(skb), sizeof(*SKB_GET_COOKIE_P(skb)));
#endif  /* CONFIG_TI_PACKET_PROCESSOR */
...
static void copy_skb_header(struct sk_buff *new, const struct sk_buff *old)
{
    ...
    new->ti_ds_traffic_prio = old->ti_ds_traffic_prio;
#endif /* CONFIG_TI_META_DATA */
