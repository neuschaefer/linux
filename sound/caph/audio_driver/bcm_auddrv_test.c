	...
	case 3:		/* Dump audio registers */
        ...
        case 4:/* Enable telephony */
        {
			...
			AUDCTRL_EnableTelephony(AUDIO_SOURCE_ANALOG_MAIN,
						AUDIO_SINK_HANDSET);
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502F050))) = (UInt32) (0x805DC990) );
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502F054))) = (UInt32) (0x8000C900) );
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502C160))) = (UInt32) (0xFFFF7FFF) );
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502C240))) = (UInt32) (0x07000000) );
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502C244))) = (UInt32) (0x0) );
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502C260))) = (UInt32) (0x07000000) );
            ( *((UInt32 *) (HW_IO_PHYS_TO_VIRT(0x3502C264))) = (UInt32) (0x0) );
	...
	case 10:
		{
			...
			aTrace(LOG_AUDIO_DRIVER,
				...
				" for debugging..\n");
			if(!bClk) csl_caph_ControlHWClock(TRUE);
			regVal = (0x00A5A5 <<
...
*/
	...
	case 11:
		...
		case 12:
		{
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020118))) = (UInt32)0x00000000);

            ( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020000))) = (UInt32)0x00000010);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020004))) = (UInt32)0x00002110);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020008))) = (UInt32)0x00000014);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502000C))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020010))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020014))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020018))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502001C))) = (UInt32)0x00000000);

			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020020))) = (UInt32)0x00000240);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020024))) = (UInt32)0x00000240);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020028))) = (UInt32)0x00000204);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502002C))) = (UInt32)0x00000240);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020030))) = (UInt32)0x00000240);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020034))) = (UInt32)0x00004204);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020038))) = (UInt32)0x00004240);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502003C))) = (UInt32)0x00000808);


			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020040))) = (UInt32)0x00000808);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020044))) = (UInt32)0x00000004);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020048))) = (UInt32)0x00000808);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502004C))) = (UInt32)0x00000808);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020050))) = (UInt32)0x00000005);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020054))) = (UInt32)0x00000808);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020058))) = (UInt32)0x00000808);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502005C))) = (UInt32)0x00000808);

			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020060))) = (UInt32)0x00000001);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020064))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020068))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502006C))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020070))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020074))) = (UInt32)0x10001000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020078))) = (UInt32)0x10001000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502007C))) = (UInt32)0x00000101);


			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020080))) = (UInt32)0x00000010);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020084))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020088))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502008C))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020080))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020084))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020088))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x3502008C))) = (UInt32)0x00000000);


			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200A0))) = (UInt32)0xCB8B40C5);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200A4))) = (UInt32)0xCB8B40C5);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200A8))) = (UInt32)0xCB8B40C5);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200AC))) = (UInt32)0xCB8B40C5);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200B0))) = (UInt32)0xCB8B40C5);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200B4))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200B8))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200BC))) = (UInt32)0x00000000);

			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200C0))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200C4))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200C8))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200CC))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200D0))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200D4))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200D8))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200DC))) = (UInt32)0x00000000);

			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200E0))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200E4))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200E8))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200EC))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200F0))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200F4))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200F8))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x350200FC))) = (UInt32)0x00000000);
			( *((UInt32 *)(HW_IO_PHYS_TO_VIRT(0x35020118))) = (UInt32)0x00000000);
