 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_enable(CHAL_HANDLE handle, cUInt16 enable)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
 *
 ...
 * ============================================================================
 */
void chal_audio_earpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable  )
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_val;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_dma_enable(CHAL_HANDLE handle, cUInt16 dma_enable)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_gain(CHAL_HANDLE handle, cUInt32 gain)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_bits_per_sample(CHAL_HANDLE handle, cUInt16 bits)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2)
 *
...
void chal_audio_earpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2)
{
    cUInt32     reg_val;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
cUInt32 chal_audio_earpath_write_fifo(CHAL_HANDLE handle, cUInt32 *src, cUInt32 length, _Bool ign_ovf)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32      n;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_sdm_set_dither_poly(CHAL_HANDLE handle, cUInt32 vout_dither_poly)
 *
...
void chal_audio_earpath_sdm_set_dither_poly(CHAL_HANDLE handle, cUInt32 vout_dither_poly)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
void chal_audio_earpath_sdm_set_dither_seed(CHAL_HANDLE handle, cUInt32 vout_dither_seed)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_int_clear(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
 *
...
void chal_audio_earpath_set_dac_pwr(CHAL_HANDLE handle, cUInt16 enable)
{
    ...
    else
    {
		...
		/* the following note is from Rhea A0:
		 ...
		 Need more study on this --- Enabling EP DAC when enabling ANALOG MIC path seems to
		 have an impact on gain in CAPRI. check with ASIC team*/
		...
		if(!chal_audio_isHSpath_active()) /* if HS path is not active, then power down the HS */
		{
			reg_value = BRCM_READ_REG(base, AUDIOH_HS_PWR);
			reg_value |= AUDIOH_HS_PWR_AUDIOTX_HS_REF_PD_MASK;
			reg_value |= AUDIOH_HS_PWR_AUDIOTX_HS_DACR_PD_MASK;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_drv_pwr(CHAL_HANDLE handle,  cUInt16 enable)
 *
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_slowramp_ctrl(CHAL_HANDLE handle, cUInt16 sr_ctrl)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_clear_slowramp_ctrl(CHAL_HANDLE handle, cUInt16 sr_ctrl)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_isolation_ctrl(CHAL_HANDLE handle, cUInt16 sr_ctrl)
 *
 *  Description:  Set AudioTx Slow Ramp Generator Controls
 *
 *  Parameters:   handle - audio chal handle.
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_clear_isolation_ctrl(CHAL_HANDLE handle, cUInt16 sr_ctrl)
 *
 ...
 * ============================================================================
 */
void chal_audio_earpath_clear_isolation_ctrl(CHAL_HANDLE handle, cUInt16 iso_ctrl)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_value;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_earpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
 *
...
/* According to ASIC team, we need to power on AUDIOH_HS_PWR_AUDIOTX_HS_REF_PD
 and AUDIOH_EP_PWR_AUDIOTX_EP_IHF_REF_PD to get EP working with loud volume.
 HS path will call this function to check the EP path status and based on the status,
 HS_PWR register will be configured accordingly*/
...
EXPORT_SYMBOL(chal_audio_isEPpath_active);
