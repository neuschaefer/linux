 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_enable(CHAL_HANDLE handle, cUInt16 enable)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable)
 * 
...
void chal_audio_ihfpath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
{
        cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_val;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_dma_enable(CHAL_HANDLE handle, cUInt16 dma_enable)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_set_gain(CHAL_HANDLE handle, cUInt32 gain)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_set_bits_per_sample(CHAL_HANDLE handle, cUInt16 bits)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hsath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2)
 * 
...
void chal_audio_ihfpath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2)
{
    cUInt32     reg_val;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
cUInt32 chal_audio_ihfpath_write_fifo(CHAL_HANDLE handle, cUInt32 *src, cUInt32 length, _Bool ign_ovf)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32      n;
...
void chal_audio_ihfpath_sdm_set_coef(CHAL_HANDLE handle, cUInt32 ihf_coef_L, cUInt32 ihf_coef_R)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
void chal_audio_ihfpath_sdm_set_dither_poly(CHAL_HANDLE handle, cUInt32 ihf_dither_poly_L, cUInt32 ihf_dither_poly_R)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_value;
...
void chal_audio_ihfpath_sdm_set_dither_seed(CHAL_HANDLE handle, cUInt32 ihf_dither_seed_L, cUInt32 ihf_dither_seed_R)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_int_clear(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable )
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_ihfpath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
 * 
