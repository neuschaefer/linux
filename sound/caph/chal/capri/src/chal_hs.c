 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_enable(CHAL_HANDLE handle, cUInt16 enable)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_int_enable(CHAL_HANDLE handle, cUInt16  thr_int_enable, cUInt16 err_int_enable)
 *
...
void chal_audio_hspath_int_enable(CHAL_HANDLE handle, cUInt16 thr_int_enable, cUInt16 err_int_enable)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_val;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_dma_enable(CHAL_HANDLE handle, cUInt16 dma_enable)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_set_gain(CHAL_HANDLE handle, cUInt32 gain)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_set_bits_per_sample(CHAL_HANDLE handle, cUInt16 bits)
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2)
 *
...
void chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, cUInt16 thres, cUInt16 thres_2)
{
    cUInt32     reg_val;
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
cUInt32 chal_audio_hspath_write_fifo(CHAL_HANDLE handle, cUInt32 *src, cUInt32 length, _Bool ign_ovf)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32      n;
...
void chal_audio_hspath_sdm_set_coef(CHAL_HANDLE handle, cUInt32 hs_coef_L, cUInt32 hs_coef_R)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
void chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle, cUInt32 hs_dither_poly_L, cUInt32 hs_dither_poly_R)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    cUInt32 reg_value;
...
void chal_audio_hspath_sdm_set_dither_seed(CHAL_HANDLE handle, cUInt32 hs_dither_seed_L, cUInt32 hs_dither_seed_R)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle, cUInt32 vout_supply_ctrl)
 *
...
void chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle, _Bool hs_ds_pol, cUInt8 hs_ds_delay, cUInt8 hs_ds_lag)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_hs_supply_thres(CHAL_HANDLE handle, cUInt32 hs_supply_thres)
 *
...
void chal_audio_hspath_hs_supply_thres(CHAL_HANDLE handle, cUInt32 hs_supply_thres)
{
    cUInt32 base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_hspath_set_filter(CHAL_HANDLE handle, cUInt16 filter)
 *
...
/* According to ASIC team, we need to power on AUDIOH_HS_PWR_AUDIOTX_HS_REF_PD
	 and AUDIOH_EP_PWR_AUDIOTX_EP_IHF_REF_PD to get EP working with loud volume.
	 EP path will call this function to check the HS path status and based on the status,
...
EXPORT_SYMBOL(chal_audio_ihfpath_sdm_enable_dither);
EXPORT_SYMBOL(chal_audio_ihfpath_sdm_enable_dither_gain);
EXPORT_SYMBOL(chal_audio_ihfpath_sdm_set_dither_strength);
EXPORT_SYMBOL(chal_audio_isHSpath_active);
