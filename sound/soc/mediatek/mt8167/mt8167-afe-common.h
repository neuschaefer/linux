...
enum mt8167_afe_irq_mode {
	...
	MT8167_AFE_IRQ_6, /* dedicated for SPDIF OUT */
	MT8167_AFE_IRQ_7,
...
struct mt8167_afe_be_dai_data {
	...
	bool startuped[SNDRV_PCM_STREAM_LAST + 1];
...
struct mtk_afe {
	...
	int hdmi_channel_select;
	int spdifrx2tx_en;/*pad bypass*/
