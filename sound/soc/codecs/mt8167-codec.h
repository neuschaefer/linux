...
#define APLL1_CON0               APMIXED_REG(0x180)
#define APLL1_CON1               APMIXED_REG(0x184)
#define APLL1_CON2               APMIXED_REG(0x188)
#define APLL1_CON3               APMIXED_REG(0x18c)

#define APLL1_CON_TUNER          APMIXED_REG(0x194)
#define APLL2_CON0               APMIXED_REG(0x1A0)
#define APLL2_CON1               APMIXED_REG(0x1A4)
#define APLL2_CON2               APMIXED_REG(0x1A8)
#define APLL2_CON3               APMIXED_REG(0x1Ac)
#define APLL2_CON_TUNER          APMIXED_REG(0x1B4)
