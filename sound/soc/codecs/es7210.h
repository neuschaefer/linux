 ...
 *
 * About how to integrate ES7210 to rootfs,
 * Step 1:
 ...
 *  change the codec_name of TDM Capture to snd-soc-dummy
 *  change the codec_dai_name of TDM Capture to snd-soc-dummy-dai
