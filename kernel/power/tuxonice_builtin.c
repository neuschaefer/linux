...
int (*toi_flag_ramzswap_disks) (void);
EXPORT_SYMBOL_GPL(toi_flag_ramzswap_disks);

int toi_do_flag_ramzswap_disks(void)
{
	return toi_flag_ramzswap_disks ? (*toi_flag_ramzswap_disks)() : 0;
}
EXPORT_SYMBOL_GPL(toi_do_flag_ramzswap_disks);
#endif
