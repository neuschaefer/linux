...
enum {
    ...
    #include <linux/ti_hil.h>
        ...
        #include <asm-arm/arch-avalanche/puma7/ppsgc_defs.h>
    #endif
...
/* ======================================================================== */
            ...
            #define SKB_GET_PP_INFO_P(skb)      (&(skb)->intel_cookie->s.pp_packet_info)
                ...
                #define SKB_GET_COOKIE_NFCT_P(skb)  ((skb)->intel_cookie->s.nfct)
            #endif
...
#if PUMA7_OR_NEWER_SOC_TYPE && defined (CONFIG_TI_PACKET_PROCESSOR)
