...
#include <linux/brotli/port.h>
#include <linux/brotli/types.h>
...
#if 1
BROTLI_DEC_API size_t BrotliDecoderStateSize(void);
BROTLI_DEC_API void BrotliDecoderStateInit(BrotliDecoderState* s);
BROTLI_DEC_API void BrotliDecoderStateInitWithCustomAllocators(
    BrotliDecoderState* s, brotli_alloc_func alloc_func,
    brotli_free_func free_func, void* opaque);
BROTLI_DEC_API void BrotliDecoderStateCleanup(BrotliDecoderState* s);
#endif
