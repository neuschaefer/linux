...
#define AMXR_PORT_INFO_NAME_SIZE 32
...
{
   char           name[AMXR_PORT_INFO_NAME_SIZE];            /* Name string */
...
/**
*  AMXR specific CSX I/O points used for capture and inject.
*  Enumerated as an index.
*/
typedef enum
{
	AMXR_CSX_POINT_SYNCPORT_SRC_PREMIX = 0,
	AMXR_CSX_POINT_SYNCPORT_DST_PREMIX,
	AMXR_CSX_POINT_SYNCPORT_SRC_POSTMIX,
	AMXR_CSX_POINT_SYNCPORT_DST_POSTMIX,
	AMXR_CSX_POINT_UNSYNCPORT_SRC_PREMIX,
	AMXR_CSX_POINT_UNSYNCPORT_DST_POSTMIX,
	AMXR_NUM_CSX_PORT_POINTS
}
AMXR_CSX_PORT_POINT_ID;
/**
*  AMXR specific CSX I/O points used for capture and inject.
*  Enumerated as an index.
*/
typedef enum
{
	AMXR_CSX_POINT_CNXL_SRC_PREMIX = 0,
	AMXR_CSX_POINT_CNXL_DST_PREMIX,
	AMXR_CSX_POINT_CNXL_SRC_POSTMIX,
	AMXR_CSX_POINT_CNXL_DST_POSTMIX,
	AMXR_NUM_CSX_CNXL_POINTS
}
AMXR_CSX_CNXL_POINT_ID;
...
/* A port's information */
typedef struct amxr_port_extinfo
{
   AMXR_PORT_ID      port;             /* Port ID */
...
/* Port list */
typedef struct amxr_ports
{
   int               ports;             /* Number of connected ports */
   AMXR_PORT_EXTINFO list[1];          /* Variable list of connected ports */
}
AMXR_PORTS;
...
int amxrGetPortList(
   AMXR_HDL             hdl,        /**< (i) Mixer client handle */
   AMXR_PORTS          *portlist,   /**< (o) Ptr to store port list */
   int                  maxlen      /**< (i) Max length in bytes */
);
