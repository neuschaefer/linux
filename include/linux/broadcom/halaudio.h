...
#define HALAUDIO_IF_NAME_SIZE    32
#define HALAUDIO_CODEC_NAME_SIZE 32
/**
...
{
   char           name[HALAUDIO_IF_NAME_SIZE];         /* Interface name */
   ...
   unsigned int   sync_err;         /* Number of sync errors found in interface */
}
HALAUDIO_IF_INFO;
...
{
   char           name[HALAUDIO_CODEC_NAME_SIZE];         /* Codec name */
