...
typedef struct amxr_api_funcs
{
   ...
   int (*getPortList)( AMXR_HDL, AMXR_PORTS *, int );
   ...
   int (*setCsxIoPoints)( AMXR_PORT_ID, AMXR_CSX_PORT_POINT_ID, const CSX_IO_POINT_FNCS *, void * );
   int (*setCsxFrameSync)( CSX_FRAME_SYNC_FP, void * );
}
AMXR_API_FUNCS __no_const;
/***************************************************************************/
/**
