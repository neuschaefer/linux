...
{
	__raw_writel(WDOG_COUNT, WPCM450_WTCNT);
}

static void arch_decomp_wdog_start(void)
{
	__raw_writel(WDOG_COUNT, WPCM450_WTDAT);
	__raw_writel(WDOG_COUNT, WPCM450_WTCNT);
	__raw_writel(WPCM450_WTCON_ENABLE | WPCM450_WTCON_DIV128 | WPCM450_WTCON_RSTEN | WPCM450_WTCON_PRESCALE(0x40), WPCM450_WTCON);
}
...
#ifdef CONFIG_WPCM450_BOOT_ERROR_RESET
...
static void arch_decomp_error(const char *x)
{
	...
	__raw_writel(0x4000, WPCM450_WTDAT);
	__raw_writel(0x4000, WPCM450_WTCNT);
	__raw_writel(WPCM450_WTCON_ENABLE | WPCM450_WTCON_DIV128 | WPCM450_WTCON_RSTEN | WPCM450_WTCON_PRESCALE(0x40), WPCM450_WTCON);
