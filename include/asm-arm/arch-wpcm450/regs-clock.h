...
#define WPCM450_CLKREG(x) ((x) + WPCM450_VA_CLK)
...
#define WPCM450_CLKEN1		WPCM450_CLKREG(0x24)
#define WPCM450_CLKDIV1		WPCM450_CLKREG(0x28)
//#define WPCM450_CKSKEW			(WPCM450_VA_EBI + 0x2C)
...
wpcm450_get_pll(unsigned int pllval, unsigned int baseclk)
{
	uint64_t fvco = 0;

//	mdiv = pllval >> WPCM450_CLKPLL0;
