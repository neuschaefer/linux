...
#define IRQ_VIC_START	  	        		0
#define IRQ_HW_ACCEL_MOD_0					(IRQ_VIC_START + INT_HW_ACCEL_MOD_0	)
#define IRQ_INTRCOMM_RAS_ARM				(IRQ_VIC_START + INT_INTRCOMM_RAS_ARM)
#define IRQ_GPT0							(IRQ_VIC_START + INT_GPT0			)
#define IRQ_GPT1							(IRQ_VIC_START + INT_GPT1			)
#define IRQ_BASIC_TIMER_1_1 				(IRQ_VIC_START + INT_BASIC_TIMER_1_1 )
#define IRQ_BASIC_TIMER_1_2 				(IRQ_VIC_START + INT_BASIC_TIMER_1_2 )
#define IRQ_BASIC_TIMER_2_1 				(IRQ_VIC_START + INT_BASIC_TIMER_2_1 )
#define IRQ_BASIC_TIMER_2_2 				(IRQ_VIC_START + INT_BASIC_TIMER_2_2 )
#define IRQ_BASIC_DMA       				(IRQ_VIC_START + INT_BASIC_DMA       )
#define IRQ_BASIC_SMI       				(IRQ_VIC_START + INT_BASIC_SMI       )
#define IRQ_BASIC_RTC       				(IRQ_VIC_START + INT_BASIC_RTC       )
#define IRQ_BASIC_GPIO      				(IRQ_VIC_START + INT_BASIC_GPIO      )
#define IRQ_BASIC_WDT       				(IRQ_VIC_START + INT_BASIC_WDT       )
#define IRQ_DDR_CONTROLLER  				(IRQ_VIC_START + INT_DDR_CONTROLLER  )
#define IRQ_SYS_ERROR						(IRQ_VIC_START + INT_SYS_ERROR		)
#define IRQ_WAKEUP_RCV						(IRQ_VIC_START + INT_WAKEUP_RCV		)
#define IRQ_JPEG							(IRQ_VIC_START + INT_JPEG			)
#define IRQ_IRDA							(IRQ_VIC_START + INT_IRDA			)
#define IRQ_ADC		        				(IRQ_VIC_START + INT_ADC		     )   
#define IRQ_UART_0							(IRQ_VIC_START + INT_UART_0			)
#define IRQ_SSP								(IRQ_VIC_START + INT_SSP			)
#define IRQ_I2C								(IRQ_VIC_START + INT_I2C			)	
#define IRQ_MAC_1      	 					(IRQ_VIC_START + INT_MAC_1      	 )	
#define IRQ_MAC_2      	 					(IRQ_VIC_START + INT_MAC_2      	 )	
#define IRQ_USB_DEV      					(IRQ_VIC_START + INT_USB_DEV      	)
#define IRQ_USB_H_OHCI_0					(IRQ_VIC_START + INT_USB_H_OHCI_0	)
#define IRQ_USB_H_EHCI_0 					(IRQ_VIC_START + INT_USB_H_EHCI_0 	)
#define	IRQ_USB_H_EHCI_1 					(IRQ_VIC_START + INT_USB_H_EHCI_1 	)
#define IRQ_USB_H_OHCI_1 					(IRQ_VIC_START + INT_USB_H_OHCI_1 	)
#define IRQ_GEN_RAS_1						(IRQ_VIC_START + INT_GEN_RAS_1		)
#define IRQ_GEN_RAS_2						(IRQ_VIC_START + INT_GEN_RAS_2		)
#define IRQ_GEN_RAS_3						(IRQ_VIC_START + INT_GEN_RAS_3		)
#define IRQ_HW_ACCEL_MOD_1					(IRQ_VIC_START + INT_HW_ACCEL_MOD_1	)
#define IRQ_VIC_END							(IRQ_VIC_START + 31)

#define IRQ_UART_1	IRQ_UART_0

#define NR_IRQS								 32 		//no of irqs
#define FIQ_START							 IRQ_VIC_START
#define FIQ_HW_ACCEL_MOD_0					(IRQ_VIC_START + INT_HW_ACCEL_MOD_0	)
#define FIQ_INTRCOMM_RAS_ARM				(IRQ_VIC_START + INT_INTRCOMM_RAS_ARM)
#define FIQ_GPT0							(IRQ_VIC_START + INT_GPT0			)
#define FIQ_GPT1							(IRQ_VIC_START + INT_GPT1			)
#define FIQ_BASIC_TIMER_1_1 				(IRQ_VIC_START + INT_BASIC_TIMER_1_1 )
#define FIQ_BASIC_TIMER_1_2 				(IRQ_VIC_START + INT_BASIC_TIMER_1_2 )
#define FIQ_BASIC_TIMER_2_1 				(IRQ_VIC_START + INT_BASIC_TIMER_2_1 )
#define FIQ_BASIC_TIMER_2_2 				(IRQ_VIC_START + INT_BASIC_TIMER_2_2 )
#define FIQ_BASIC_DMA       				(IRQ_VIC_START + INT_BASIC_DMA       )
#define FIQ_BASIC_SMI       				(IRQ_VIC_START + INT_BASIC_SMI       )
#define FIQ_BASIC_RTC       				(IRQ_VIC_START + INT_BASIC_RTC       )
#define FIQ_BASIC_GPIO      				(IRQ_VIC_START + INT_BASIC_GPIO      )
#define FIQ_BASIC_WDT       				(IRQ_VIC_START + INT_BASIC_WDT       )
#define FIQ_DDR_CONTROLLER  				(IRQ_VIC_START + INT_DDR_CONTROLLER  )
#define FIQ_SYS_ERROR						(IRQ_VIC_START + INT_SYS_ERROR		)
#define FIQ_WAKEUP_RCV						(IRQ_VIC_START + INT_WAKEUP_RCV		)
#define FIQ_JPEG							(IRQ_VIC_START + INT_JPEG			)
#define FIQ_IRDA							(IRQ_VIC_START + INT_IRDA			)
#define FIQ_ADC		        				(IRQ_VIC_START + INT_ADC		     )   
#define FIQ_UART_0							(IRQ_VIC_START + INT_UART_0			)
#define FIQ_SSP								(IRQ_VIC_START + INT_SSP			)
#define FIQ_I2C								(IRQ_VIC_START + INT_I2C			)	
#define FIQ_MAC_1      	 					(IRQ_VIC_START + INT_MAC_1      	 )	
#define FIQ_MAC_2      	 					(IRQ_VIC_START + INT_MAC_2      	 )	
#define FIQ_USB_DEV      					(IRQ_VIC_START + INT_USB_DEV      	)
#define FIQ_USB_H_OHCI_0					(IRQ_VIC_START + INT_USB_H_OHCI_0	)
#define FIQ_USB_H_EHCI_0 					(IRQ_VIC_START + INT_USB_H_EHCI_0 	)
#define	FIQ_USB_H_EHCI_1 					(IRQ_VIC_START + INT_USB_H_EHCI_1 	)
#define FIQ_USB_H_OHCI_1 					(IRQ_VIC_START + INT_USB_H_OHCI_1 	)
#define FIQ_GEN_RAS_1						(IRQ_VIC_START + INT_GEN_RAS_1		)
#define FIQ_GEN_RAS_2						(IRQ_VIC_START + INT_GEN_RAS_2		)
#define FIQ_GEN_RAS_3						(IRQ_VIC_START + INT_GEN_RAS_3		)
#define FIQ_HW_ACCEL_MOD_1					(IRQ_VIC_START + INT_HW_ACCEL_MOD_1	)
#define FIQ_END								(FIQ_START + 31)
