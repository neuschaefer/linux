...
#ifndef __ASM_ARCH_SPEARPLUS_TIMEX_H
#define __ASM_ARCH_SPEARPLUS_TIMEX_H
...
extern unsigned long spearplus_timer_read (int nr);
...
get_cycles (void)
{
       return ~spearplus_timer_read (1);	/* calling timer 0 */
}
