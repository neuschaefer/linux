...
// roku specific flag to control GRKERNSEC_PROC_MEMMAP via sysctl on dev units
int roku_grsec_enable_proc_memmap = 0;

// roku specific flag to control GRKERNSEC_ROKU_ENABLE_PROC_PAGE_MONITOR via sysctl on dev units
int roku_grsec_disable_proc_page_monitor = 1;
...
grsecurity_init(void)
{
	...
	*/
	...
	roku_grsec_enable_proc_memmap = 1;
#endif

#ifdef CONFIG_GRKERNSEC_ROKU_ENABLE_PROC_PAGE_MONITOR
	roku_grsec_disable_proc_page_monitor = 1;
#endif
