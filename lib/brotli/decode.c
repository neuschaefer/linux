...
#ifdef __KERNEL__
    state = (BrotliDecoderState*)kmalloc(sizeof(BrotliDecoderState), GFP_KERNEL);
#else
...
#ifdef __KERNEL__
size_t BrotliDecoderStateSize(void)
{
    return sizeof(BrotliDecoderState);
}
#endif
...
#ifdef __KERNEL__
  BrotliDecoderState* s = kmalloc(sizeof(BrotliDecoderState), GFP_KERNEL);
#else
  BrotliDecoderState s;
#endif
