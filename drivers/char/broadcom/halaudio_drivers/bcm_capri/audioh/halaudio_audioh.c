...
#if defined(CONFIG_BCMPMU_AUDIO) && defined(CONFIG_MFD_BCMPMU)
#define AUDIOH_HEADSET_PMU_SUPPORT 1
#else
#define AUDIOH_HEADSET_PMU_SUPPORT 0
#endif
#endif

#define AUDIOH_STEREO_VIN        0
#define AUDIOH_STEREO_NVIN       0
#define AUDIOH_STEREO_IHF        1
...
#if AUDIOH_HEADSET_PMU_SUPPORT
const static struct gain_map audiohAnaPMUGainMap[] =
{
   {-66,  PMU_HSGAIN_66DB_N},
   {-63,  PMU_HSGAIN_63DB_N},
   {-60,  PMU_HSGAIN_60DB_N},
   {-57,  PMU_HSGAIN_57DB_N},
   {-54,  PMU_HSGAIN_54DB_N},
   {-51,  PMU_HSGAIN_51DB_N},
   {-48,  PMU_HSGAIN_48DB_N},
   {-45,  PMU_HSGAIN_45DB_N},
   {-42,  PMU_HSGAIN_42DB_N},
   {-39,  PMU_HSGAIN_39DB_N},
   {-36,  PMU_HSGAIN_36DB_N},
   {-33,  PMU_HSGAIN_33DB_N},
   {-30,  PMU_HSGAIN_30DB_N},
   {-27,  PMU_HSGAIN_27DB_N},
   {-24,  PMU_HSGAIN_24DB_N},
   {-22,  PMU_HSGAIN_22DB_N },
   {-21,  PMU_HSGAIN_21DB_N },
   {-20,  PMU_HSGAIN_20DB_N },
   {-19,  PMU_HSGAIN_19DB_N },
   {-18,  PMU_HSGAIN_18DB_N },
   {-17,  PMU_HSGAIN_17DB_N },
   {-16,  PMU_HSGAIN_16DB_N },
   {-15,  PMU_HSGAIN_15DB_N },
   {-14,  PMU_HSGAIN_14DB_N },
   {-13,  PMU_HSGAIN_13DB_N },
   {-12,  PMU_HSGAIN_12DB_N },
   {-11,  PMU_HSGAIN_11DB_N },
   {-10,  PMU_HSGAIN_10DB_N },
   {-9 ,  PMU_HSGAIN_9DB_N  },
   {-8 ,  PMU_HSGAIN_8DB_N  },
   {-7 ,  PMU_HSGAIN_7DB_N  },
   {-6 ,  PMU_HSGAIN_6DB_N  },
...
/* Default PMU HS PGA gain */
#define PMU_HS_GAIN_DEF    -10
...
{
#if AUDIOH_STEREO_IHF
   AUDIOH_IHFPATH_LEFT_FIFO_CH_HANDSFREE_SPK = 0,
   AUDIOH_IHFPATH_RIGHT_FIFO_CH_HANDSFREE_SPK,
#else
...
#if AUDIOH_STEREO_IHF
enum audioh_ihfpath_left_mux_pos
{
   AUDIOH_IHFPATH_LEFT_MUX_POS_HANDSFREE_SPK = 0,

   AUDIOH_MAX_IHFPATH_LEFT_MUX_POSITIONS
};

enum audioh_ihfpath_right_mux_pos
{
   AUDIOH_IHFPATH_RIGHT_MUX_POS_HANDSFREE_SPK = 0,

   AUDIOH_MAX_IHFPATH_RIGHT_MUX_POSITIONS
};
#else
...
static spinlock_t gEquLock;   /* acquired when accessing DMA buffer */
   ...
   [AUDIOH_CHAN_VIN_RIGHT] =
   {
      .freq_cfg_array =
      {
         ...
         [1] =
         {
            ...
            .num_ch        = 1,
            .frame_period  = AUDIOH_DEFAULT_FRAME_PERIOD,
            .switch_dev    = SSASW_SRC_16000_AUDIOH_VINR,
         },
      }
   },
#endif
   ...
   [AUDIOH_CHAN_VIN_LEFT] =
   {
      .freq_cfg_array =
      {
         ...
         [1] =
         {
            ...
            .num_ch        = 1,
            .frame_period  = AUDIOH_DEFAULT_FRAME_PERIOD,
            .switch_dev    = SSASW_SRC_16000_AUDIOH_VINL,
         },
      }
   },
#endif
   ...
   [AUDIOH_CHAN_NVIN_RIGHT] =
   {
      .freq_cfg_array =
      {
         ...
         [1] =
         {
            ...
            .num_ch        = 1,
            .frame_period  = AUDIOH_DEFAULT_FRAME_PERIOD,
            .switch_dev    = SSASW_SRC_16000_AUDIOH_NVINR,
         },
      }
   },
#endif
   ...
   [AUDIOH_CHAN_NVIN_LEFT] =
   {
      .freq_cfg_array =
      {
         ...
         [1] =
         {
            ...
            .num_ch        = 1,
            .frame_period  = AUDIOH_DEFAULT_FRAME_PERIOD,
            .switch_dev    = SSASW_SRC_16000_AUDIOH_NVINL,
         },
      }
   },
#endif
   ...
   [AUDIOH_CHAN_HANDSFREE] =
   {
      .freq_cfg_array =
      {
         ...
         [1] =
         {
            ...
            .frame_period  = AUDIOH_DEFAULT_FRAME_PERIOD,
#if AUDIOH_STEREO_IHF
            .switch_dev    = SSASW_SRC_44100_AUDIOH_HANDSFREE_STEREO,
#else
...
static struct audioh_info gAudioh =
{
   ...
   /* Primary Speech mic, Headset mic, Handset mic */
      ...
      [AUDIOH_CHAN_HANDSFREE] =
      {
         ...
         .samp_freq        = AUDIOH_DEFAULT_SAMP_FREQ,
         .frame_period     = AUDIOH_DEFAULT_FRAME_PERIOD,
         .frame_size       = (AUDIOH_DEFAULT_FRAME_SIZE * AUDIOH_MAX_IHFPATH_FIFO_CHANNELS),
         .dma_config =
         {
#if AUDIOH_STEREO_IHF
            .device = AADMA_DEVICE_AUDIOH_MEM_TO_CFIFO_TO_HANDSFREE_STEREO,
#else
         ...
         {
#if AUDIOH_STEREO_IHF
            [AUDIOH_IHFPATH_LEFT_FIFO_CH_HANDSFREE_SPK] =
            {
               .num_mux_pos = AUDIOH_MAX_IHFPATH_LEFT_MUX_POSITIONS,
               .ana_gain =
               {
                  [AUDIOH_IHFPATH_LEFT_MUX_POS_HANDSFREE_SPK] =
                  {
                     .ana_gain_sup = 0,
                  },
               },
            ...
            [AUDIOH_IHFPATH_RIGHT_FIFO_CH_HANDSFREE_SPK] =
            {
               .num_mux_pos = AUDIOH_MAX_IHFPATH_RIGHT_MUX_POSITIONS,
               .ana_gain =
               {
                  [AUDIOH_IHFPATH_RIGHT_MUX_POS_HANDSFREE_SPK] =
                  {
                     .ana_gain_sup = 0,
                  },
               },
...
static int caph_dma_alloc_ring_descriptors( CAPH_DMA_Handle_t, dma_addr_t data_addr1, dma_addr_t data_addr2, size_t numBytes );
...
static int audiohIoRemap( void )
{
   ...
   chal_aci_auxmic_init(gChalAudioHandle, (uint32_t)aci_virt_addr, (uint32_t)auxmic_virt_addr );
...
)
{
   ...
   if( ch->ch_dir == AUDIOH_CH_DIR_INGRESS )
   {
      ...
      else if ( ch->audioh_isrcount <= 2 )
      {
         /* Kick along the DMA during prepare stage */
         rc = caph_dma_continue_transfer( ch->dma_config.caph_handle, CAPH_READY_HIGHLOW );
         if( rc )
         {
            ch->errs.dma_err++;
...
#if AUDIOH_STEREO_IHF
            case HALAUDIO_HWSEL_A:
               *fifo_ch = AUDIOH_IHFPATH_LEFT_FIFO_CH_HANDSFREE_SPK;
               *mux_pos = AUDIOH_IHFPATH_LEFT_MUX_POS_HANDSFREE_SPK;
               break;
            case HALAUDIO_HWSEL_B:
               *fifo_ch = AUDIOH_IHFPATH_RIGHT_FIFO_CH_HANDSFREE_SPK;
               *mux_pos = AUDIOH_IHFPATH_RIGHT_MUX_POS_HANDSFREE_SPK;
#else
            case HALAUDIO_HWSEL_A:
...
/***************************************************************************/
/**
 *  Helper routine to power{up/down} PMU HS PGA block
 */
static void audiohPMUPower(bool on)
{
   bcmpmu_hs_set_gain(PMU_AUDIO_HS_BOTH, PMU_HS_GAIN_DEF);
...
/***************************************************************************/
/**
 *  Helper routine to set the gain of the PMU HS PGA block
 */
static int audiohPMUGainSet( unsigned int chno, unsigned int fifo_ch, unsigned int mux_pos, int db) {
   int i;
   int db_map_size;
   int pmu_hs_gain;
   struct audioh_ch_cfg *ch;
   bcmpmu_hs_path_t pmu_hs_path;
   ...
   {
      case AUDIOH_CHAN_HEADSET:
         db_map_size = sizeof(audiohAnaPMUGainMap)/sizeof(audiohAnaPMUGainMap[0]);
         /* Check if DB gain value is supported */
         for( i = 0; i < db_map_size; i++ )
         {
            if ( db == audiohAnaPMUGainMap[i].db_val )
            {
               pmu_hs_gain = audiohAnaPMUGainMap[i].reg_val;
               break;
            }
         }
         ...
         switch( fifo_ch )
         {
            case AUDIOH_HSPATH_LEFT_FIFO_CH_HEADSET_LEFT_SPK:
               pmu_hs_path = PMU_AUDIO_HS_LEFT;
               break;
            case AUDIOH_HSPATH_RIGHT_FIFO_CH_HEADSET_RIGHT_SPK:
               pmu_hs_path = PMU_AUDIO_HS_RIGHT;
               break;
            default:
               pmu_hs_path = PMU_AUDIO_HS_BOTH;
               break;
         }

         ch->audio_gain[fifo_ch].ana_gain[mux_pos].ana_gain_value = db;

         bcmpmu_hs_set_gain(pmu_hs_path, pmu_hs_gain);
         return 0;
      default:
         return -EINVAL;
   }
...
/***************************************************************************/
/**
 *  Helper routine to get PMU HS PGA block gain information
 *
 *  NOTES :
 *    Currently, there is no interface to query the gain from the PMU. For now,
 *    the implementation uses the cache value.
 *
 */
static int audiohPMUGainGet( unsigned int chno, unsigned int fifo_ch,
   unsigned int mux_pos, HALAUDIO_GAIN_INFO *info)
{
   int i;
   int map_size;
   struct audioh_ch_cfg *ch;
   ...
   {
      case AUDIOH_CHAN_HEADSET:
         map_size = sizeof(audiohAnaPMUGainMap)/sizeof(audiohAnaPMUGainMap[0]);
         /* Use cached "currentdb" value for now. Should ideally query hardware */
         info->currentdb = ch->audio_gain[fifo_ch].ana_gain[mux_pos].ana_gain_value;
         if( info->currentdb == HALAUDIO_GAIN_MUTE )
         {
            info->currentdb = PMU_HS_GAIN_DEF;
         }
         info->maxdb = audiohAnaPMUGainMap[map_size - 1].db_val;
         info->mindb = audiohAnaPMUGainMap[0].db_val;
         info->range_type = HALAUDIO_RANGETYPE_LIST;
         info->range.list.num = map_size;

         for( i = 0; i < map_size; i++ )
         {
            info->range.list.db[i] = audiohAnaPMUGainMap[i].db_val;
         }
...
#endif /* AUDIOH_HEADSET_PMU_SUPPORT */
...
#if AUDIOH_STEREO_IHF
   chal_audio_ihfpath_set_mono_stereo( gChalAudioHandle, 0 );        /* Stereo mode */
#else
...
)
{
   ...
   /* Set mic data loopback configuration */
   chal_audio_set_aci_auxmic_datab( gChalAudioHandle, info->mic_data_lpbk_en );
   ...
   for ( i = 0; i < AUDIOH_MAX_NUM_CHANS; i++, ch++ )
   {
      ...
      if( ch->ch_dir == AUDIOH_CH_DIR_EGRESS )
      {
         ...
         if ( ch->frame_size != 0 )
         {
            ...
            rc = caph_dma_alloc_ring_descriptors( ch->dma_config.caph_handle, ch->dma_buf[0].phys, ch->dma_buf[1].phys, ch->frame_size );
...
#if (AUDIOH_VIN_RIGHT_ENABLE && AUDIOH_VIN_LEFT_ENABLE && AUDIOH_NVIN_RIGHT_ENABLE && AUDIOH_NVIN_LEFT_ENABLE )
   /* Enable all mic paths */
   chal_audio_mic_sync( gChalAudioHandle, 1 );
   chal_audio_digi_mic_all( gChalAudioHandle, CHAL_AUDIO_ENABLE );
#else
...
static int audiohDisable( void )
{
   ...
   /* Disable all paths */
   chal_audio_digi_mic_all( gChalAudioHandle, CHAL_AUDIO_DISABLE );
   chal_audio_mic_sync( gChalAudioHandle, 0 );
   chal_audio_vinpath_select_primary_mic( gChalAudioHandle, 0 );     /* Disable analog mic path */
...
#if AUDIOH_HEADSET_PMU_SUPPORT
   if( !audiohPMUGainSet(chno, fifo_ch, mux_pos, db) )
   {
...
#if AUDIOH_HEADSET_PMU_SUPPORT
   if( !audiohPMUGainGet(chno, fifo_ch, mux_pos, info) )
   {
      return 0;
   }
#endif
...
static int audiohReadProc( char *buf, char **start, off_t offset, int count, int *eof, void *data )
{
   ...
   {
      len += sprintf( buf+len, "DMA Irqs:       egress=%u\n", ch->audioh_isrcount );
...
static int caph_dma_alloc_ring_descriptors( CAPH_DMA_Handle_t handle, dma_addr_t data_addr1, dma_addr_t data_addr2, size_t numBytes )
{
   struct caph_dma_device_attr *devAttr;
   int rc;
   ...
   rc = aadma_alloc_ring_descriptors( devAttr->aadma_handle, data_addr1, data_addr2, numBytes );
...
static int audioh_platform_init( HALAUDIO_AUDIOH_PLATFORM_INFO *info )
{
   ...
   if ( info->spk_en_gpio.handsfree_left_en >= 0 )
   {
      ...
      if( err )
      {
         printk( KERN_ERR "%s: failed to request SPKRAMP_L_EN gpio pin %d rc=%d\n", __FUNCTION__, info->spk_en_gpio.handsfree_left_en, err );
         err = -EBUSY;
   ...
   if ( info->spk_en_gpio.handsfree_right_en >= 0 )
   {
      ...
      if( err )
      {
         printk( KERN_ERR "%s: failed to request SPKRAMP_R_EN gpio pin %d rc=%d\n", __FUNCTION__, info->spk_en_gpio.handsfree_right_en, err );
         err = -EBUSY;
         goto cleanup_and_exit;
      }
   ...
   if ( info->spk_en_gpio.headset_en >= 0 )
   {
      ...
      if( err )
      {
         printk( KERN_ERR "%s: failed to request HEADAMP_EN gpio pin %d rc=%d\n", __FUNCTION__, info->spk_en_gpio.headset_en ,err );
         err = -EBUSY;
         goto cleanup_and_exit;
      }
...
static int audioh_probe( struct platform_device *pdev )
{
   ...
   gAudiohClk.audioh_156m = clk_get( &pdev->dev, AUDIOH_156M_PERI_CLK_NAME_STR );
   gAudiohClk.audioh_26m = clk_get( &pdev->dev, AUDIOH_26M_PERI_CLK_NAME_STR );
   gAudiohClk.audioh_2p4m = clk_get( &pdev->dev, AUDIOH_2P4M_PERI_CLK_NAME_STR );
   gAudiohClk.audioh_apb = clk_get( &pdev->dev, AUDIOH_APB_BUS_CLK_NAME_STR );
   gAudiohClk.aci_apb_clk = clk_get( &pdev->dev, ACI_APB_BUS_CLK_NAME_STR );
   ...
   err = clk_enable( gAudiohClk.aci_apb_clk );
   if( err )
   {
      printk( KERN_ERR "%s: failed to enable aci apb clock %d!\n", __FUNCTION__, err );
      return err;
   }
   ...
   err = halAudioAddInterface( &halaudio_audioh_ops, AUDIOH_MAX_NUM_CHANS, "AUDIOH",
         AUDIOH_DEFAULT_FRAME_PERIOD, 0 /* no synchronize */, &gInterfHandle );
