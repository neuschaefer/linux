...
/*                  JPEG.                                                   */
/*      - NumOfBurst: Number of bursts requested at destination side.       */
...
{
		/*Reset JPEG before starting decoding*/
		JPEG_Reset();
		...
		*JPEG_CTRL_STATUS = (NumOfLli << SHIFT_NUM_LLI);
		...
		if(NumOfBurst)
			*JPEG_BURST_COUNT_BEF_INT = BURST_COUNT_ENABLE | NumOfBurst;
...
/* IN  :	none                                                          	*/
/* OUT : 		                                                            */
/*       pHdrInfo: Pointer to the header info struct.                        */
/*                                                                          */
/* RETURN: none                                                             */
/*--------------------------------------------------------------------------*/
/* REENTRANCY: NA                                                           */
