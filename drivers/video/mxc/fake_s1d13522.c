...
void fake_s1d13522_parse_epd_cmdline(void)
{
	...
	//angela 20121011 add power low
	char *szParsePatternA[]={"waveform_sz=","waveform_p=","logo_sz=","logo_p=","logo_powerlow_sz=","logo_powerlow_p="};
	int ((*pfnDispatchA[])(char *str))={ \
		waveform_size_setup,waveform_p_setup,\
		logo_size_setup,logo_p_setup,
		logo_powerlow_size_setup,logo_powerlow_p_setup};
	int i;
	char *pszCmdLineBuf;
