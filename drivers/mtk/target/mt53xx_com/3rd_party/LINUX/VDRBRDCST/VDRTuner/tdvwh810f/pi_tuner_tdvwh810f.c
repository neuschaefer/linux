...
#include "x_os.h"
#include "eq_script_tdvwh810f.h"//include eq script 
//-----------------------------------------------------------------------------
    ...
    )
{
	...
	//Tuner EQ
	pTdvwh810fEqNormal[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]  = EQTdvwh810fBG;
    pTdvwh810fEqNormal[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]  = EQTdvwh810fDK;
    pTdvwh810fEqNormal[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]   = EQTdvwh810fI;
    pTdvwh810fEqNormal[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN] = EQTdvwh810fL;
	pTdvwh810fEqNormal[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQTdvwh810fM;
    pTdvwh810fEqNormal[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN] = EQTdvwh810fL;
    //weak EQ
    pTdvwh810fEqWeak[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]  = EQTdvwh810fBGWeak;
    pTdvwh810fEqWeak[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]  = EQTdvwh810fDKWeak;
    pTdvwh810fEqWeak[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]   = EQTdvwh810fIWeak;
    pTdvwh810fEqWeak[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQTdvwh810fMWeak;
	pTdvwh810fEqWeak[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN] = EQTdvwh810fLWeak;
    pTdvwh810fEqWeak[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN] = EQTdvwh810fLWeak;
