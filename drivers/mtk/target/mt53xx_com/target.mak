...
TARGET_DRV_INC = -I. \
		 -I$(TARGET_ROOT)/5391_driver/inc \
                 -I$(TARGET_ROOT)/5391_driver/drv_inc \
                 -I$(TARGET_ROOT)/5391_driver/private_inc \
                 -I$(TARGET_ROOT)/d_inc
endif
...
# Linker and options.
#
LD_FLAG   = --entry INT_Reset --scatter $(call path_cnvt,$(TARGET_ROOT)/5391_driver/scatter.sc)
LD_OUTPUT = --Output
