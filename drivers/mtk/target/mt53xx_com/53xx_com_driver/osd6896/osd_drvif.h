...
#define OSD_PLA4_REG                   (OSD_BASE_REG + 0x700)  //for cursor
#define OSD_PLA5_REG                   (OSD_BASE_REG + 0x900)  //for scart
#endif
...
typedef struct _OSD_RGN_SC_CLIP_T
{
    unsigned int    ui4_id;
    unsigned int    ui4_enable;
    unsigned int    ui4_full_fg;
    INT32           i4_src_w;
    INT32           i4_src_h;
    INT32           i4_clip_x;
    INT32           i4_clip_y;
...
typedef struct _OSD_PLA_FIELD_T
{
    ...
    /* DWORD - 014 */     
    UINT32          u4RealHeaderAddr  :   25;   //5363 address 25bits
    UINT32                            :   7;
...
{
    /* DWORD - 000 */
#if !(defined(CC_MT5368)||defined(CC_MT5396)|| defined(CC_MT5389)) //20101129
...
EXTERN INT32 OSD_BASE_SetPlaneSwitchOrder(UINT32 u4TopPlane, UINT32 u4MidPlane, UINT32 u4BotPlane);
...
EXTERN INT32 OSD_BASE_SetPlaneLineShift(UINT32 u4Plane, BOOL fgEnable,  INT32 i4Value);
...
EXTERN INT32 OSD_PLA_WaitStable(UINT32 u4Plane);
...
EXTERN INT32 _OSD_PLA_Get_Hw_RealHeaderAddr(UINT32 u4Plane,volatile UINT32 *pu4Value) ;
...
EXTERN BOOL OSD_PLA_OutputValidCnt(UINT32 u4Plane, UINT32 *retu4Value);

EXTERN void OSD_PLA_EnableFlipMirror(UINT32 u4Plane, BOOL flip, BOOL mirror);

EXTERN void OSD_SetFlipMirror(BOOL flip, BOOL mirror);
...
EXTERN INT32 OSD_SC_SetDstSize(UINT32 u4Scaler,UINT32 u4Width, UINT32 u4Height);
...
EXTERN INT32 OSD_SC_GetScaler(UINT32 u4_plane);
...
EXTERN void OSD_DrawColorbar2(UINT8* pu1Canvas, UINT32 u4Width, UINT32 u4Height,
                      UINT32 u4ColorMode);
...
#endif
#endif
EXTERN INT32 OSD_RGN_SC_Clip(UINT32 u4_plane, void* pv_tag);
