...
*/
extern void drv_extmjc_gamma_write(UINT8 *pArray,UINT32 u4ChannelSize,UINT8 u1DesIdx);
...
extern INT32 drv_extmjc_set_blue_stretch(
    UINT8       ui1_onoff,
    UINT8       ui1_rgain,
    UINT8       ui1_ggain,
    UINT8       ui1_bgain,
...
extern INT32 drv_extmjc_set_color_temperature(
    UINT8       ui1_index,
    UINT16      ui2_value
    );
...
extern INT32 drv_extmjc_set_mjc_bypass_window_directly(
...
extern INT32 drv_extmjc_set_PWM(
    UINT8                u1Src,
    UINT8                u1Ratio,
    UINT8                u1DutyStart,
    UINT8                u1DutyHigh,
...
extern INT32 drv_extmjc_set_SrcTiming(
    UINT8                u1SrcTiming,
    UINT8*              pui1_msg_error
    );
...
extern INT32 d_custom_extmjc_get_delay(
...
extern INT32 drv_extmjc_set_osd_fading(
...
extern INT32 drv_extmjc_set_CSHD_mode(
    UINT8                u1CSHD_Mode,
    UINT16               u2OverScanSize,
    UINT8*              pui1_msg_error
    );

extern INT32 drv_extmjc_set_MJC_MirrorFlip(
    UINT8                u1MirrorFlip,
    UINT8*              pui1_msg_error
    );

extern INT32 drv_extmjc_setPanelPowerSequence( BOOL fgPowerOn );
...
extern INT32 d_custom_extmjc_set_mjc_frz(
    UINT8                                   ui1_fgfrz,
    UINT8*                                  pui1_msg_error
    );
...
extern INT32 drv_extmjc_custom_cmd(
    UINT32                u4Para0,
    UINT32                u4Para1,
    UINT8*              pui1_msg_error
    );
