                       ...
                       VOID * pv_get_info, SIZE_T * pz_size)
{
    ...
    case DRV_CUSTOM_DISP_TYPE_AUTO_COLORTEMP_GETS:
        /* 20110901. FIXME !!! this is for testing auto colortemp. 
           The real impleemntation will be done by Benson later.
        */
		((AUTO_COLORTEMP_GETS_INFO_T *)pv_get_info)->ui1AutoColortempOnOff = 
		                            IO32ReadFldAlign(CUST_GAMMA_01, CUST_GAMMA_PBM_ON);
        return 0;
