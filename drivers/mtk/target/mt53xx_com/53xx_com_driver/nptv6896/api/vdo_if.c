...
void bApiVideoGetDVDModeSigStatus(UINT32 * DVDMode, UINT32 * Sig)
{
	#ifdef CC_SRCDETECT_CVBS_SUPPORT
	if (_bSrcMainNew == SV_VS_CVBS3 && (bGetVideoDecType(0) ==SV_VD_TVD3D)) {
		*DVDMode = 1;
		switch(bTvd3dSignalStatus()) {
			case SV_VDO_STABLE:
				*Sig = 1;
				break;
