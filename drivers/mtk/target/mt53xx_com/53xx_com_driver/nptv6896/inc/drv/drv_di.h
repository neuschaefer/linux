...
#define IS_DTV_SD_I(u1Id)         ((VDP_GetPlayMode(u1Id) == FBM_FBG_DTV_MODE) \
                                && ((bDrvVideoGetSourceTypeTiming(u1Id) == SOURCE_TYPE_TIMING_DTV_SD_I_50) \
                                || (bDrvVideoGetSourceTypeTiming(u1Id) == SOURCE_TYPE_TIMING_DTV_SD_I_60)))
#define IS_DTV_HD_I(u1Id)         ((VDP_GetPlayMode(u1Id) == FBM_FBG_DTV_MODE) \
                                    && ((bDrvVideoGetSourceTypeTiming(u1Id) == SOURCE_TYPE_TIMING_DTV_1080I_50) \
                                    || (bDrvVideoGetSourceTypeTiming(u1Id) == SOURCE_TYPE_TIMING_DTV_1080I_60)))
...
void vDrvDISetFilmModeParam(void); // Add for Vestel --- pingan 0606
...
UINT16 u2DrvDIGetDebugDataMode(UINT8 bPath);
