...
#define _SOURCE_SELECT_H_

#include "source_table.h"

/**
 * Get the video decoder of main path.
 */
#if defined(CC_SOURCE_AUTO_DETECT) || defined(CC_SRCDETECT_CVBS_SUPPORT)
typedef struct _SOURCE_DETECT_STATUS_T
{
...
extern UINT8 bGetSignalTypeBySrc(UINT8 bSrc);
#endif
extern void initAVSV(UINT8 vsrc,UINT8 mon_src);
extern void initYPbPrVGA(UINT8 ic);
extern void initSCARTRGB(UINT8 bVSrc, UINT8 ic);
...
#endif
extern UINT32 u4DrvGetAvMuxByCh(UINT8 ch);
