...
static void *_pvRzSwCallBackTag;

static UINT32 _au4RzSwReg[IMGRZ_REG_FILE_SIZE];

static UINT32 _u4RzSwActionCount;

static UINT8 *_pu1SrcDataA = NULL;
static UINT8 *_pu1SrcDataR = NULL;
static UINT8 *_pu1SrcDataG = NULL;
static UINT8 *_pu1SrcDataB = NULL;

static UINT8 *_pu1TgDataA = NULL;
static UINT8 *_pu1TgDataR = NULL;
static UINT8 *_pu1TgDataG = NULL;
static UINT8 *_pu1TgDataB = NULL;
 ...
 */
//-------------------------------------------------------------------------
static void (*_pfnRzSwCallBack)(void *pvTag);
 ...
 */
//-------------------------------------------------------------------------
void IMGRZ_SwGetRegBase(UINT32 **ppu4RegBase)
{
 ...
 */
//-------------------------------------------------------------------------
INT32 IMGRZ_SwSetCallBack(void (*pfnCallBack)(void *pvTag), void *pvTag)
{
    if (pfnCallBack != NULL)
    {
 ...
 */
//-------------------------------------------------------------------------
UINT32 IMGRZ_SwGetOpCount(void)
{
