...
#define VDP_B2R_MODE_1080P_120      27
#define VDP_B2R_MODE_1440p_24       28
#define VDP_B2R_MODE_1440p_60       29
#define VDP_B2R_MODE_1280p_24       30
#define VDP_B2R_MODE_1280p_25       31
#define VDP_B2R_MODE_1280p_50       32
#define VDP_B2R_MODE_1280p_60       33
#define VDP_B2R_MODE_21_9_30        34
#define VDP_B2R_MODE_480I_120       35
#define VDP_B2R_MODE_576I_100       36
#define VDP_B2R_MODE_1080I_120      37
#define VDP_B2R_MODE_1080I_100      38
#define VDP_B2R_MODE_960p_24		39    //33~37 add for CR DTV00351047 when mm video is 1024*768(tab)and 1080*540(sbs) => v_total too large to do MJC 3D in mt5396
#define VDP_B2R_MODE_960p_60		40
#define VDP_B2R_MODE_960p_25		41
#define VDP_B2R_MODE_960p_50		42
#define VDP_B2R_MODE_960p_30		43
...
EXTERN void _VDP_StatusNofify(UCHAR ucVdpId, UINT32 u4Status);
...
EXTERN UCHAR VDP_GetPendingFB(UCHAR ucVdpId);
EXTERN void VDP_CleanPendingFB(UCHAR ucVdpId);
EXTERN void VDP_SetReleaseDispQ(UCHAR ucVdpId);
...
#else
EXTERN UCHAR VDP_GetPendingFB(void);
EXTERN void VDP_CleanPendingFB(void);
EXTERN void VDP_SetReleaseDispQ(void);
...
EXTERN BOOL VDP_FlushB2RChgFrameMsg(void);
