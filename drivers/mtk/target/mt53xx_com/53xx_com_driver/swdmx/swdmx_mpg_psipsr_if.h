...
EXTERN INT32 SWDMX_PsiPsrParsePsi(PSIPSR_TBL_PMT_T* prPMTTbl, UINT32* pu4NumTblEle, UINT32 u4Timeout, UINT32 u4TsIndex);
EXTERN INT32 SWDMX_PsiPsrParseMgt(PSIPSR_TBL_MGT_T* prMgtTbl, UINT32* pu4NumTblEle, UINT32 u4Timeout, UINT32 u4TsIndex);
EXTERN INT32 SWDMX_PsiPsrParseTvct(PSIPSR_TBL_VCT_T* prVctTbl, UINT32* pu4NumTblEle, PSIPSR_TBL_TS2FREQ_T* prTsTbl, UINT32 u4Timeout, UINT32 u4TsIndex);
EXTERN INT32 SWDMX_PsiPsrParseCvct(PSIPSR_TBL_VCT_T* prVctTbl, UINT32* pu4NumTblEle, PSIPSR_TBL_TS2FREQ_T* prTsTbl, UINT32 u4Timeout, UINT32 u4TsIndex);
EXTERN INT32 SWDMX_PsiPsrParseStt(PSIPSR_TBL_STT_T* prSttTbl, UINT32* pu4NumTblEle, UINT32 u4Timeout, UINT32 u4TsIndex);
EXTERN VOID SWDMX_PsiPsrDataNofify(UINT32 u4Tag);
