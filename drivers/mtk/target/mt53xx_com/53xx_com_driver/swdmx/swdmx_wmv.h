...
SWDMX_HDR_PRS_STATE_T _SWDMX_WMVHeaderParse(SWDMX_RANGE_LIST_T* prRangeList,
...
VOID _SWDMX_WMVComsumeFeeder(VOID);
...
BOOL _WMVMoveData(UINT32 u4StartAddress,UINT32 u4CurPosition ,UINT32 u4FileSize,PayloadHeader* prPayLoadHeader,BOOL fgEndFrame);
