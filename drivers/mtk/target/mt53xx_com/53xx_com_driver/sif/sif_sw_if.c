 ...
 */
//-------------------------------------------------------------------------
static INT32 SifSW_WriteEeprom(UINT32 u4SDA, UINT32 u4SCL, UINT8 *pu1Data, UINT32 u4DataCount)
{
    UINT8 u1Ret = 0;
    INT32 fgSet;
    UINT32 u4Index = 0;  
    ...
    while (u4Index < u4DataCount /*SIF_EDID_SIZE*/)
    {
        u4Cnt = (UINT32) (((u4DataCount /*SIF_EDID_SIZE*/ -  u4Index) > 8) ? 8 : (u4DataCount /*SIF_EDID_SIZE*/ -  u4Index)); 
...
UINT8 SIFSW_WriteData(UINT8 bDevAddr, UINT8 bSubAddr, UINT32 u4DataCount, UINT8 *pbData,
                      UINT16 bOption)
{
    UINT8 bBitDelay;
...
UINT8 Sif_WriteEDIDData(UINT8 u1EDID_ID, UINT8 *pBuf, UINT32 u4Size)
{
    INT32 i4Ret=0;
    switch( u1EDID_ID )
    {
        case 1:
            i4Ret = SifSW_WriteEeprom( SIF_EDID1_SDA ,  SIF_EDID1_SCL , pBuf , u4Size);
    		break;
        case 2:
            i4Ret = SifSW_WriteEeprom( SIF_EDID2_SDA ,  SIF_EDID2_SCL , pBuf , u4Size);
            break;
    	case 3:
            i4Ret = SifSW_WriteEeprom( SIF_EDID3_SDA ,  SIF_EDID3_SCL , pBuf , u4Size);
            break;
        default:
            LOG(3,"[SifEEDIDReadBytes] parameter u1EDID_ID wrong!\n");
            i4Ret = 0	;
