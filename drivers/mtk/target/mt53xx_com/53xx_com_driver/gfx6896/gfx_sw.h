...
extern void GFX_SwSetColorCompRecede(UINT8 **ppu1DestFb, UINT32 u4CM, 
...
extern INT32 GFX_SwFlipMirrorBlt(UINT8 *pu1SrcBase, UINT8 *pu1DstBase, 
...
#if defined(CC_MT5368)||defined(CC_MT5396)|| defined(CC_MT5389)||defined(CC_MT5398)||defined(CC_MT5880)
extern void GFX_SwRop_SrcMuti(const GFX_ROP_DATA_T *prsData);
#endif

#if defined(CC_MT5389)||defined(CC_MT5398)||defined(CC_MT5880)
extern void GFX_SwRop_MAX(const GFX_ROP_DATA_T *prsData);
extern void GFX_SwRop_MIN(const GFX_ROP_DATA_T *prsData);
#endif
...
extern INT32 GFX_SwYCbCr709VFullEqu(const GFX_YCBCR_T *prsSrc, INT32 *pi4ColorComponent);

extern INT32 GFX_SwYCbCr601VFullEqu(const GFX_YCBCR_T *prsSrc,INT32 *pi4ColorComponent);
