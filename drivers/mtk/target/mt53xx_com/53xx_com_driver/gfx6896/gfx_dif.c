...
static GFX_DIF_T _rGfxDifData =
{
    (UINT32)(GFX_HAVE_SW_MOD + GFX_HAVE_HW_MOD),
    (UINT32)E_GFX_HW_MOD,
    (UINT32)0,
    (UINT32 *)NULL
};
...
void GFX_DifSetRegBase(UINT32 *pu4Base)
{
    ...
    _rGfxDifData.pu4CrBase = pu4Base;
}
...
void GFX_DifGetRegBase(UINT32 *pu4Base)
{
    ...
    *pu4Base = (UINT32)(_rGfxDifData.pu4CrBase);
}
...
void GFX_DifReset(void)
{
    ...
    else
    {
        ...
        GFX_UNUSED_RET(x_memset(_rGfxDifData.pu4CrBase, 0, 
...
void GFX_DifSetMode(UINT32 u4GfxMode)
{
    ...
    _rGfxDifData.u4GfxMode = u4GfxMode;
