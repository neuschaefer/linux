 ...
 *  
 */
#ifndef __GFX_DRVIF_H__
#define __GFX_DRVIF_H__
...
extern void _VGFX_SetMatrixCoef_Emu(UINT32 u4MatrixA, UINT32 u4MatrixB, UINT32 u4MatrixC, UINT32 u4MatrixD,
                         UINT32 u4MatrixE, UINT32 u4MatrixF, UINT32 u4MatrixG, UINT32 u4MatrixH, UINT32 u4MatrixI);

extern void _VGFX_SetCoef4Tap(VGFX_COEFF_4_TAP* u4Coef4Tap);

extern void _VGFX_Scaler_Emu(VG_PARAM_SET_T *vgParam);
...
extern void _VGFX_SetReflect( UINT32 u4RefEn, UINT32 u4RefOnly, UINT32 u4TextTureHeight, 
...
extern void _VGFX_ResetReflect(void);
extern void _VGFX_ResetCoef4Tap(void);

#endif
#endif // __GFX_DRVIF_H__
