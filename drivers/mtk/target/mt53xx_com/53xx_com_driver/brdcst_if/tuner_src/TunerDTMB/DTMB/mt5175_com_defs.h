...
#ifndef _MT5175_COM_DEFS_H
#define _MT5175_COM_DEFS_H
...
#define ccCMD_ID_DMBTC_SWITCH    0x7F
enum
{
    ccOFST_DMBTC_SWITCH,   // 1: DTMB, 2: DVBC
    ccOFST_DMBTC_SWITCH_SIZE
};

#define ccCMD_ID_DTMB_ACQ_START       0xA0
enum
{
    // return value
    ccOFST_DTMB_ACQ_START_STATUS,   // 1: OK, 0: FAIL
    ccOFST_DTMB_ACQ_START_RSIZE
};

#define ccCMD_ID_DTMB_SET_SB        0xA1
enum
{
	ccOFST_DTMB_SET_TSIF_SP,
	ccOFST_DTMB_SET_CPE_EN,
    ccOFST_DTMB_SET_SB_RSIZE
};

#define ccCMD_ID_DTMB_REACQ_START     0xA2
enum
{
    // return value
    ccOFST_DTMB_REACQ_START_STATUS,   // 1: OK, 0: FAIL
    ccOFST_DTMB_REACQ_START_RSIZE
};

#define ccCMD_ID_DTMB_REACQ_STOP      0xA3
enum
{
    // return value
    ccOFST_DTMB_REACQ_STOP_STATUS,   // 1: OK, 0: FAIL
    ccOFST_DTMB_REACQ_STOP_RSIZE
};

#if 0
#define ccCMD_ID_DTMB_IDLE             0xA4
enum
{
	ccOFST_DTMB_IDLE_STATUS,
	ccOFST_DTMB_IDLE_RSIZE
};
#endif


#define ccCMD_ID_DTMB_SET_TUNER_PARA0  0xA4
enum
{
    ccOFST_DTMB_SET_TUNER_PARA0_SLP,
    ccOFST_DTMB_SET_TUNER_PARA0_INT,
    ccOFST_DTMB_SET_TUNER_PARA0_MAX,
    ccOFST_DTMB_SET_TUNER_PARA0_MIN,
    ccOFST_DTMB_SET_TUNER_PARA0_SIZE,
    ccOFST_DTMB_SET_TUNER_PARA0_STATUS = ccOFST_DTMB_SET_TUNER_PARA0_SLP,
    ccOFST_DTMB_SET_TUNER_PARA0_RSIZE
};

#define ccCMD_ID_DTMB_SET_TUNER_PARA1  0xA5
enum
{
    ccOFST_DTMB_SET_TUNER_PARA1_TARGET_POW,
    ccOFST_DTMB_SET_TUNER_PARA1_IF_FREQ0,
    ccOFST_DTMB_SET_TUNER_PARA1_IF_FREQ1,
    ccOFST_DTMB_SET_TUNER_PARA1_SIZE,
    ccOFST_DTMB_SET_TUNER_PARA1_STATUS = ccOFST_DTMB_SET_TUNER_PARA1_TARGET_POW,
    ccOFST_DTMB_SET_TUNER_PARA1_RSIZE
};

#define ccCMD_ID_DTMB_SET_EARLY_BREAK  0xA6
enum
{
	ccOFST_DTMB_SET_EARLY_BREAK_TIME_H,
	ccOFST_DTMB_SET_EARLY_BREAK_TIME_L,
	ccOFST_DTMB_SET_EARLY_BREAK_SIZE
};


#define ccCMD_ID_DTMB_GET_STATUS0     0xB0
enum
{
	ccOFST_DTMB_STATUS00,   
    ccOFST_DTMB_STATUS01,   // reserved
	ccOFST_DTMB_STATUS02,
    ccOFST_DTMB_STATUS0_RSIZE
};


#define ccCMD_ID_DTMB_GET_INFO0       0xB1	//CA Status
enum
{
	ccOFST_DTMB_CA_STATUS,  
	ccOFST_DTMB_CR_STATUS,
	ccOFST_DTMB_TPS_INFO, 
	ccOFST_DTMB_TPS_CODEWORD,
	ccOFST_DTMB_SPECINV1,
	ccOFST_DTMB_SPECINV2,
    ccOFST_DTMB_INFO0_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO1       0xB2	//DTMB TFO
enum
{
	ccOFST_DTMB_TFO_25,  
	ccOFST_DTMB_TFO_23,
	...
	//ccOFST_DTMB_ECHO2,
	//ccOFST_DTMB_ECHO3,
    ccOFST_DTMB_INFO1_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO2       0xB3	//DTMB CFO
enum
{
	ccOFST_DTMB_CFO_28,  
	ccOFST_DTMB_CFO_23,
	ccOFST_DTMB_CFO_15,
	ccOFST_DTMB_CFO_07,
    ccOFST_DTMB_INFO2_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO3       0xB4	//DTMB Doppler
enum
{
	ccOFST_DTMB_CH_SPEED,  
	ccOFST_DTMB_DOPP_IND,
	//ccOFST_DTMB_ERR_POW_H,
	//ccOFST_DTMB_ERR_POW_L,
	ccOFST_DTMB_LDPC_ITER,
	ccOFST_DTMB_FFF_SP_GRP_NUM,
	ccOFST_DTMB_FBF_SP_GRP_NUM,
    ccOFST_DTMB_INFO3_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO4       0xB5
enum
{
	ccOFST_DTMB_PN_SNR_H,     
	ccOFST_DTMB_PN_SNR_L,     
	ccOFST_DTMB_LONG_PN_SNR_H,
	ccOFST_DTMB_LONG_PN_SNR_L,
	ccOFST_DTMB_DD_SNR_H,     
	ccOFST_DTMB_DD_SNR_L,     
    ccOFST_DTMB_INFO4_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO5       0xB6	//DTMB TSIF ERR
enum
{
	ccOFST_DTMB_TSIF_PKT_H,
	ccOFST_DTMB_TSIF_PKT_L,
	ccOFST_DTMB_TSIF_ERR_H,
	ccOFST_DTMB_TSIF_ERR_L,
    ccOFST_DTMB_TPS_IND,
    ccOFST_DTMB_INFO5_RSIZE
};


#define ccCMD_ID_DTMB_GET_INFO6       0xB7	//DTMB LDPC ERR
enum
{
	ccOFST_DTMB_LDPC_PKT_H,
	ccOFST_DTMB_LDPC_PKT_L,
	ccOFST_DTMB_LDPC_ERR_H,
	ccOFST_DTMB_LDPC_ERR_L,
    ccOFST_DTMB_INFO6_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO7       0xB8	//DTMB Multi PKT
enum
{
	ccOFST_DTMB_MULTI_PKT1_H,
	ccOFST_DTMB_MULTI_PKT1_L,
	ccOFST_DTMB_MULTI_PKT2_H,
	ccOFST_DTMB_MULTI_PKT2_L,
	ccOFST_DTMB_MULTI_PKT3_H,
	ccOFST_DTMB_MULTI_PKT3_L,
    ccOFST_DTMB_INFO7_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO8       0xB9	//DTMB Multi ERR
enum
{
	ccOFST_DTMB_MULTI_ERR1_H,
	ccOFST_DTMB_MULTI_ERR1_L,
	ccOFST_DTMB_MULTI_ERR2_H,
	ccOFST_DTMB_MULTI_ERR2_L,
	ccOFST_DTMB_MULTI_ERR3_H,
	ccOFST_DTMB_MULTI_ERR3_L,
    ccOFST_DTMB_INFO8_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO9       0xBA
enum
{
	ccOFST_DTMB_ECHO1,
	ccOFST_DTMB_ECHO2,
	ccOFST_DTMB_ECHO3,
	ccOFST_DTMB_REACQCNT,
    ccOFST_DTMB_INFO9_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO10       0xBB
enum
{
    ccOFST_DTMB_LDAGC_GAIN_SHIFT,
    ccOFST_DTMB_LDAGC_GAIN_NORM,
    ccOFST_DTMB_INFO10_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO11       0xBC
enum
{
    ccOFST_DTMB_SLD_PRA_STATUS_MONITOR,
    ccOFST_DTMB_SLD_PRA_RFAGC_CTRL_WORD_H,
    ccOFST_DTMB_SLD_PRA_RFAGC_CTRL_WORD_L,
    ccOFST_DTMB_SLD_PRA_IFAGC_CTRL_WORD_H,
    ccOFST_DTMB_SLD_PRA_IFAGC_CTRL_WORD_L,
    ccOFST_DTMB_SLD_PRA_PGA_GAIN_INDEX,
    ccOFST_DTMB_INFO11_RSIZE
};

#define ccCMD_ID_DTMB_GET_INFO12       0xBD
enum
{
    ccOFST_DTMB_SLD_PRA_MAG_REF_OUT_H,
    ccOFST_DTMB_SLD_PRA_MAG_REF_OUT_L,
    ccOFST_DTMB_LEGACY_PRAD_Cur_Level_sf_H,
    ccOFST_DTMB_LEGACY_PRAD_Cur_Level_sf_L,
    ccOFST_DTMB_INFO12_RSIZE
};


#define ccCMD_ID_DTMB_GET_INFO13       0xBE
enum
{
	ccOFST_DTMB_CE_STATUS_9,
	ccOFST_DTMB_CE_STATUS_10,
	ccOFST_DTMB_CE_STATUS_11,
	ccOFST_DTMB_CE_STATUS_12,
	ccOFST_DTMB_CE_STATUS_13,
	ccOFST_DTMB_CE_STATUS_14,
	ccOFST_DTMB_INFO13_RSIZE
};
