...
#define VGAADCPLL_WORKAROUND    0 //disable by BS       //For 8226 VGA ADC unlock when high temperature.
#define YPBPR_480IP_27MHZ  1
#define SUPPORT_PQ_BYPASS   1
#define SCART_SOG_WA	1
#ifdef __MODEL_slt__
