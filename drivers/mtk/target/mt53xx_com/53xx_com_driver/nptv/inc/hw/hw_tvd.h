...
#define SECAM_01 0x2604
  ...
  #define SECAM_01_3 0x2607
    ...
    #define LDEMPH_BYPASS Fld(1, 7, AC_MSKB0) //3//7
    #define CSEL Fld(3, 4, AC_MSKB0) //6:4
    #define HDEMPH_BYPASS Fld(1, 3, AC_MSKB0) //3//3
...
#define SECAM_04 0x2610
  ...
  #define SECAM_04_3 0x2613
    #define CAGC_IP_TARGET_B Fld(8, 24, AC_FULLB3) //31:24
    #define CAGC_IP_TARGET_A Fld(8, 16, AC_FULLB2) //23:16
...
#define VSRC_08 0x2438  // GENLOCK_Register_Map
