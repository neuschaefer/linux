...
#define RVVLD_VECTOR VECTOR_VDEC
...
#define RW_VDEC_MISC_PDN_CON_SPEC 0xC8    
    #define PDN_SPEC_RV 0xEF
#define RW_VDEC_MISC_PDN_CON_MODULE 0xCC    
    #define PDN_MODULE_RV 0x3B749100
#define RW_VDEC_MISC_CLK_SELECT 0x84    
    #define CLK_FOR_RV 0x2
...
#define WO_VLD_WPTR  (VLD_REG_OFST + (0x110 ))
...
#endif
#endif
VOID vInitRVVld(UCHAR ucEsId);
VOID vInitRVPred(UCHAR ucEsId);
VOID vInitRVVdoMem(UCHAR ucEsId);
VOID vInitRVMiscMem(UCHAR ucEsId);
VOID vSetRVVldVFifo(UCHAR ucEsId);
VOID vInitRVVDec(UCHAR ucEsId);
VOID vResetRVVDec(UCHAR ucEsId);
VOID vSetRVMcBufPtr(UCHAR ucEsId);
VOID vWriteREG(UINT32, UINT32);  // !!!
UINT32 u4ReadREG(UINT32);  // !!!
UINT32 dwRVVldRPtr(UINT32*);
VOID _VDEC_UpdateVldRVWPtr(UINT32 u4WPtr);
VOID vSetRVVSyncPrmBufPtr(UCHAR ucEsId, UINT32);
