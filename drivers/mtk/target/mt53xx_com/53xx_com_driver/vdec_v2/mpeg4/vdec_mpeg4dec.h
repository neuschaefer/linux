 ...
 * $Author: dtvbm11 $
 * $Date: 2012/04/27 $
 * $RCSfile: vdec_mpeg4dec.h,v $
 * $Revision: #1 $
 *---------------------------------------------------------------------------*/

/** @file vdec_mpeg4dec.h
 *  This header file declares exported APIs of MPV.
 */

#ifndef VDEC_MPEG4DEC_H
#define VDEC_MPEG4DEC_H
...
//-----------------------------------------------------------------------------
#define MP4_WAIT_DEC_TIME                500    //SW wait decoding time (ms)
...
void _VH263DEC_DecProc(VDEC_HDLR hVdec, INT32* pi4RetValue);
...
UINT32 *VDEC_GetCrcY(void);
UINT32 *VDEC_GetCrcC(void);
UINT32  VDEC_GetCrcYNum(void);
UINT32  VDEC_GetCrcCNum(void);
void VDEC_ResetCrcPam(void);
#endif
//-----------------------------------------------------------------------------
// Public functions
//-----------------------------------------------------------------------------
