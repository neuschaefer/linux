...
#ifndef VDEC_AVSDEC_H
#define VDEC_AVSDEC_H
...
void _VDEC_AvsPrepareFBufInfo(VDEC_AVS_INFO_T *prDecPrm);

void _VDEC_SetAvsBsInfo(UINT8 u1Num, VDEC_AVS_DECPRM_T *prDecParam, UINT32 u4RDPtrAddr, UINT32 WPtrAddr, UINT32 u4BsFifoStart, 
    UINT32 u4BsFifoEnd, UINT8 u1ECCMode, UINT32 u4ECType);

void _VDEC_AvsDecProc(VDEC_AVS_INFO_T* prDecPrm, INT32* pi4RetValue);

UINT8 _VDEC_WaitAvsDecDone(UCHAR ucEsId, VDEC_AVS_INFO_T *prVdec, UINT8 u1PicStruct, UINT32 u4W, UINT32 u4H, BOOL bWaitDecLock);
