...
#endif
#if defined(CC_MT5395) || defined(CC_MT5368) || defined(CC_MT5396) || defined(CC_MT5389)
...
//5389
//#define CC_ENABLE_TRACKING_MODE
...
#define AVAILABLE_SZ(rptr, wptr) ((rptr <= wptr) ? (wptr - rptr) : (0x1000000 - (rptr - wptr)))  //VFIFO 0x1000000 
#elif defined(CC_FIX_AV_BAD_INTER)
#define AVAILABLE_SZ(rptr, wptr) ((rptr <= wptr) ? (wptr - rptr) : (0xB00000 - (rptr - wptr)))  //VFIFO 0xB00000 
#else
...
#define MAX_SUPPORT_H 2160

#define BASE_VIEW   0
#define DEPEND_VIEW 1

#define IS_SEAMLESS_MODE ((prVdecEsInfo->eMMSrcType == SWDMX_SRC_TYPE_NETWORK_NETFLIX) || prVdecEsInfo->fgSeamlessPlay)
//-----------------------------------------------------------------------------
// Type definitions
//-----------------------------------------------------------------------------
...
typedef struct
{
    ...
    UINT32 u4TrackingAcc;
    UINT32 u4TrackingAccMax;
    UCHAR ucTrackingFbId;
    UCHAR ucTrackingFbIdPending;
    #endif
