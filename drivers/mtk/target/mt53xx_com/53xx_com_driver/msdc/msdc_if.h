...
EXTERN INT32 MsdcReadCard (UINT32 u4Addr, UINT32 *pu4Buf, UINT32 u4Length);
EXTERN INT32 MsdcWriteCard(UINT32 *u4SrcAddr, UINT32 u4ByteOffset, UINT32 u4Len);
EXTERN INT32 MsdcEraseCard(UINT32 u4ByteOffset, UINT32 u4Len);
EXTERN VOID MsdcToggleContClock (VOID);
EXTERN INT32 MsdcIdentReadMMC (UINT32 *pu4Buf, UINT32 u4Addr, UINT32 u4Length);
EXTERN INT32 eMMC2DRAM(UINT32 u4Addr, UINT32 *pSrcOrDes, UINT32 u4Length, UINT32 u4Type);
