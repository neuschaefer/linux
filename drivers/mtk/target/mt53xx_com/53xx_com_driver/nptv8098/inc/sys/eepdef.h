...
enum
{
    ...
    EEP_ADC_START = 0x00,
#ifdef CC_MT5365_V2
    EEP_ADC_DIG_GAIN_HDTV0_LOW_BYTE=EEP_ADC_START,
    EEP_ADC_DIG_GAIN_HDTV0_HIGH_BYTE,
    EEP_ADC_DIG_GAIN_HDTV1_LOW_BYTE,
    EEP_ADC_DIG_GAIN_HDTV1_HIGH_BYTE,
    EEP_ADC_DIG_GAIN_HDTV2_LOW_BYTE,
    EEP_ADC_DIG_GAIN_HDTV2_HIGH_BYTE,
    EEP_ADC_DIG_GAIN_VGA0_LOW_BYTE,
    EEP_ADC_DIG_GAIN_VGA0_HIGH_BYTE,
    EEP_ADC_DIG_GAIN_VGA1_LOW_BYTE,
    EEP_ADC_DIG_GAIN_VGA1_HIGH_BYTE,
    EEP_ADC_DIG_GAIN_VGA2_LOW_BYTE,
    EEP_ADC_DIG_GAIN_VGA2_HIGH_BYTE,
