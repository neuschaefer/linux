...
#define TDTV_FW_00              u4SWReg(0x4000)
  ...
  #define TDNAVI_FW_00            u4SWReg(0x4400)
    #define NAVI_EDGE_TH           Fld(8,   0, AC_FULLB0)
    #define NAVI_DIFF_TH           Fld(8,   8, AC_FULLB1) 
    #define NAVI_CMPLX_TH          Fld(16,  16, AC_FULLW32) 

#define TDNAVI_FW_01            u4SWReg(0x4404)
    #define NAVI_RATIO_LO          Fld(8,   0, AC_FULLB0)
    #define NAVI_RATIO_HI          Fld(8,   8, AC_FULLB1) 
...
#define TDNAVI_STATUS_00            u4SWReg(0x4480)
    #define NAVI_DETECTED             Fld(8,   0, AC_FULLB0)
#define TDNAVI_STATUS_01            u4SWReg(0x4484)
    #define NAVI_HVDIFF             Fld(32,   0, AC_FULLDW)
#define TDNAVI_STATUS_02            u4SWReg(0x4488)
    #define NAVI_CBDIFF             Fld(32,   0, AC_FULLDW)  
...
#define SW_TTD_REG_00          u4SWReg(0x4830)  
...
#define MJC_FW_SCH_01        u4SWReg(0x5304)
    ...
    #define MJC_FW_FRM_SCH_TST_DLY Fld(4,16,AC_MSKB2)//[19:16]
    ...
    #define MJC_FW_FRM_SCH_BWRDC_EN Fld(1,3,AC_MSKB0)//[3:3]
    #define MJC_FW_FRM_SCH_CTRL_IDX Fld(1,2,AC_MSKB0)//[2:2]
    #define MJC_FW_FRM_SCH_CTRL_EN Fld(1,1,AC_MSKB0)//[1:1]
...
#define NR_BK_METER u4SWReg(0x81C0)
