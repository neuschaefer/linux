...
EXTERN void vScpipSetForcedPDS(UINT32 vdpID, UINT32 hPds, UINT32 vPds);
EXTERN void vScpipSetForcedFrontBackDramMode(UINT32 u4VdpId,UINT32 u4Mode);
EXTERN void vScpipSetForced444Mode(UINT32 u4VdpId,UINT32 u4Mode);
EXTERN void vScpipSetForcedMFMode(UINT32 u4VdpId,UINT32 u4Mode);
EXTERN void vScpipSetForcedNonLinear( UINT32 iNonLinearEN, UINT32 iInputTotal, UINT32 iInputMiddle, UINT32 iOutputTotal, UINT32 iOutputMiddle );
EXTERN void vScpipSetPanelInfo(UINT32 u4PanelWidth, UINT32 u4PanelHeight);
EXTERN void vScpipSetInputInfo(UINT32 u4VdpId, UINT32 u4InputWidth, UINT32 u4InputHeight);
EXTERN void vScpipSetOverscanInfo(UINT32 u4VdpId, UINT32 u4X, UINT32 u4Y, UINT32 u4W, UINT32 u4H);
EXTERN void vScpipSetOutputInfo(UINT32 u4VdpId,UINT32 u4OutputX,UINT32 u4OutputY,UINT32 u4OutputWidth,UINT32 u4OutputHeight);
EXTERN void vScpipIsTGUnderflow(UINT32 u4VdpId);
EXTERN void vScpipSetDispMode(UINT32 u4VdpId,UINT32 u4Dispmode);
EXTERN void vScpipSetRegen3DMode(UINT32 u4VdpId,UINT32 u4Regen3DType);
#endif
