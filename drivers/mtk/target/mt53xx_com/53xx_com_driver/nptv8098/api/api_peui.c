...
static PE_UI_RANGE_T aUiQtyItemMinMax[PE_ARG_NS] =
{
	...
	{QUALITY_SNR_BEGIN,     QUALITY_SNR_END,     		R_QTYMAP | R_MAIN | R_MAX},   	// PE_ARG_NR
	...
	{QUALITY_TNR_BEGIN,     QUALITY_TNR_END,     		R_QTYMAP | R_MAIN | R_OFF | R_MAX},   	// PE_ARG_3D_NR
...
UINT32 PE_GetUiRange(UINT8 u1VidPath, PE_ARG_TYPE ucArgType, PE_UI_RANGE_T *prUiRange)
{
    ...
    {        
        Printf("PE_GetUiRange error! %d, %d, %ld\n",
            u1VidPath, ucArgType, (UINT32)prUiRange);
...
void vUi_BLACK_STRETCH(UINT8 u1VidPath, UINT8 bTurnOff)
{
	...
	wWriteQualityTable(QUALITY_AL2_BWS_BK_EN, (UINT16)(!bTurnOff));
...
void vUi_WHITE_STRETCH(UINT8 u1VidPath, UINT8 bTurnOff)
{
	...
	wWriteQualityTable(QUALITY_AL2_BWS_WT_EN, (UINT16)(!bTurnOff));
	vHalVideoAdaptiveLumaParam();
}
...
void vUi_SUPERRESOLUTION(UINT8 u1VidPath, UINT8 bTurnOff)
{
	vHalVideoSuperResolutionOnOff(u1VidPath, SV_ON);
}
	...
	if(QtyRange.i4Dft & R_QTYMAP)
	{
        for (u2QtyItem=QtyRange.i4Min; u2QtyItem <= QtyRange.i4Max; u2QtyItem++)
        {
        	UINT16 u2Value = bApiQtyMapping(u1SrcTypTmg, u2QtyItem, i2Min, i2Max, i2Dft,
                ((QtyRange.i4Dft & (R_OFF|R_MAX)) == (R_OFF|R_MAX)) ? MIN(MAX(i2Cur, i2Min), i2Max) : i2Cur);
