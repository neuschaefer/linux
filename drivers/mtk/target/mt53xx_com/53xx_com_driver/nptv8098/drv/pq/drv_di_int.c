...
{        
        ...
        && (DiPQMode.bFilmOnOff_MultiCadence == SV_ON))
    {
        ...
        vRegWriteFldMulti(MCVP_FUSION_20, 
...
static void _vDrvDISetDARQualityISR(void)
{
    ...
    {       
        ...
        {
            vRegWriteFldMulti(MCVP_DARE_00, 
...
void vDrvDISetInterpMode(UINT8 u1VdpId, E_MIB_DMODE bMode)
{
    ...
    {
        vRegWriteFldMulti(MCVP_FUSION_20, 
            P_Fld(u1FixMotionY, IF_FIX_MOTION_Y) | 
            P_Fld(u1FixMotionC, IF_FIX_MOTION_C) | 
            P_Fld(u1ForceMotionY, IF_FORCE_MOTION_Y) | 
            P_Fld(u1ForceMotionC, IF_FORCE_MOTION_C) | 
            P_Fld(u1FixMotionY, IF_FIX_BOB_Y) | 
            P_Fld(u1FixMotionC, IF_FIX_BOB_C));
    }
    else
    {
        vRegWriteFldMulti(MCVP_SB_04, 
            P_Fld(u1FixMotionY, SB_FIX_MOTION_Y) | 
            P_Fld(u1FixMotionC, SB_FIX_MOTION_C) | 
            P_Fld(u1ForceMotionY, SB_FORCE_MOTION_Y) | 
            P_Fld(u1ForceMotionC, SB_FORCE_MOTION_C));
    }
}
