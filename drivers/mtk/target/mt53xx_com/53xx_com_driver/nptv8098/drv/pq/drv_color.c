...
void vDrvSCEParam(void)
{
    ...
    vRegWriteFldMulti(C_BOOST,
              P_Fld(wReadQualityTable(QUALITY_CBOOST_ONOFF), NEW_BOOST_EN) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_ONOFF), C_BOOST_ENABLE) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_GAIN), BOOST_GAIN) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_LMT_U), NEW_BOOST_LMT_U) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_LMT_L), NEW_BOOST_LMT_L));
#else
    vRegWriteFldMulti(C_BOOST,
              P_Fld(SV_OFF, NEW_BOOST_EN) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_ONOFF), C_BOOST_ENABLE) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_MINUS_EN), MINUS_BOOST_EN) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_GAIN), BOOST_GAIN) |
              P_Fld(wReadQualityTable(QUALITY_CBOOST_RNG_SEL), RANGE_SEL));
#endif	
} 
