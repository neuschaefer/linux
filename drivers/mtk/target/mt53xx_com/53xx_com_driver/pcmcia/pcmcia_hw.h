...
#define POD                 ((UINT32)2 << 30)
#define CI                  ((UINT32)3 << 30)
...
EXTERN INT32    PCMCIAHW_DMA_WRITE32(UINT32 u4DRAMAddr, UINT32 u4FlashAddr, UINT32 u4ByteCount);
EXTERN INT32    PCMCIAHW_DMA_READ32(UINT32 u4DRAMAddr,UINT32 u4FlashAddr,UINT32 u4ByteCount);
