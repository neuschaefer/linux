...
// Definitions of PCMCIA Pins (for PinMux) (Refer to MT8295B Ckgen register map for 0xB03c, 0xB040)
#define PCMCIA_MUX_0    0
#define PCMCIA_MUX_1    32
#define PCMCIA_PINMUX_FUNCTION0 0
#define PCMCIA_PINMUX_FUNCTION1 1
#define PCMCIA_PINMUX_FUNCTION2 2
#define PCMCIA_PINMUX_FUNCTION3 3
#define PCMCIA_PINMUX_GPIO0     (4+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_GPIO1     (6+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_GPIO2     (0+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO3     (2+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO7     (30+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO8     (30+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO9     (24+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_GPIO10    (16+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO11    (8+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO12    (8+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO13    (26+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_GPIO14    (10+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T3SYNC    (24+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T3VALID   (2+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_T3DATA    (24+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T1CLK     (22+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T1SYNC    (22+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T1VALID   (20+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T1DATA    (20+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_T2CLK     (12+PCMCIA_MUX_1)
//#define PCMCIA_PINMUX_T2SYNC    (27+PCMCIA_MUX_1) // 3bit, not support yet
//#define PCMCIA_PINMUX_T2VALID   (24+PCMCIA_MUX_1) // 3bit, not support yet
#define PCMCIA_PINMUX_CI_DATA0  (16+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_CI_DATA1  (14+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_CI_DATA3  (14+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_CI_DATA4  (10+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_CI_DATA5  (10+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_CI_ALE    (14+PCMCIA_MUX_1)
#define PCMCIA_PINMUX_CI_CLE    (18+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_CI_RB     (6+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_CI_INT    (12+PCMCIA_MUX_0)
#define PCMCIA_PINMUX_CI_OEB    (16+PCMCIA_MUX_1)
...
{
    MT8295_ISR_NONE,
    MT8295_ISR_SIF,     // used only for external CI
    MT8295_ISR_IREQ     // used for both internal/external CI
}MT8295_ISR;
...
EXTERN UINT8    PCMCIA_RawRead8(UINT32 offset);
...
EXTERN INT32    PCMCIA_GetPodState(UINT32* pu4ModuleState);
EXTERN void     PCMCIA_RefreshPodState(void);
...
EXTERN void     PCMCIA_Dump(CHAR* pszTitle, UINT8* pu1Msg, UINT32 u4MsgLen);
...
EXTERN void     PCMCIA_AllocDmaBuf(void);
...
EXTERN void     PCMCIA_MT8295PinSet(UINT32 i4PinSel, UINT32 i4Func);
EXTERN void     PCMCIA_AutoSetTsRoutingPath(void);
EXTERN void     PCMCIA_SLT(void);
EXTERN void     PCMCIA_Demo(pcmcia_cam_connectivity_nfy pfnCbk);
EXTERN void     PCMCIA_SetTsType(UINT32 u4TypeValue);
EXTERN UINT32   PCMCIA_GetTsType(void);
