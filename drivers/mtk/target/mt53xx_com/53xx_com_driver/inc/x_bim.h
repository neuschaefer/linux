...
#define REG_RW_BTIME            0x0024          // Timeout Control Register
    #define TO_RTO_CNT          (0xffU << 24)   // RISC timeout counter value
    #define TO_RTEN             (1U << 21)      // RISC timeout counter enable
    #define TO_MLAHB            (1U << 20)      // Multi-layer AHB enable bit
    #define TO_DEMUX_IORW_RDY   (3U << 14)      // DEMUX IO read ready wait state count
    #define TO_DEMUX_IORW       (3U << 12)      // DEMUX IO read wait state count
    #define TO_DEMUX_IOWW_RDY   (3U << 10)      // DEMUX IO write ready wait state count
    #define TO_DEMUX_IOWW       (3U << 8)       // DEMUX IO write wait state count
    #define TO_IORW_RDY         (3U << 6)       // IO read ready wait state count
    #define TO_IORW             (3U << 4)       // IO read wait state count
    #define TO_IOWW_RDY         (3U << 2)       // IO write ready wait state count
    #define TO_IOWW             (3U << 0)       // IO write wait state count
...
// Interrupt vectors
    ...
    #define VECTOR_APWM     29          // APWM interrupt
...
#define REG_MISC_IRQST      0x00d0      // MISC Interrupt Status Register
#define REG_MISC_IRQEN      0x00d4      // MISC Interrupt Enable Register
#define REG_MISC_IRQCLR     0x00d8      // MISC Interrupt Clear Register
...
#define REG_RW_PWM2         0x0238      // PWM2 Register
    ...
    #define PWMP_MASK       (0x0000fff0)    // prescaler
...
EXTERN INT32 BIM_IsSecureBoot(void);
// RTC related interfaces moved to rtc_if.h
/*
