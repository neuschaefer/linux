...
// Static variables
//-----------------------------------------------------------------------------
//MT5398 suport 80 play back pid ,64 record pid
#ifdef CC_MT5398
static MEM_BLOCK_T _arSramBlocks[] =
{
    { 0x0c00,   0x140},      // 0xf0017c00, 320byte, PID index table
    { 0x0E00,   0x100},      // 0xf0017e00, 256byte, PID index table
};
#else
//MT5880  MT5860 suport 64 play back pid ,32 record pid
static MEM_BLOCK_T _arSramBlocks[] =
{
    { 0x0c00,   0x100},      // 0xf0017c00, 256byte, Play back PID index table
    { 0x0E00,   0x80},      // 0xf0017e00, 128byte, Recode PID index table
};
#endif //CC_MT5398


//MT5398 suport 80 hw section filter
#ifdef CC_MT5398
...
#else
//MT5880 suport 64 hw section filter
static MEM_BLOCK_T _arSramBlocks2[] =
{
    { 0x4000,   0x200},      // section, pattern
    { 0x4400,   0x200},      // section, mask
    { 0x4800,   0x200},     // section, posneg
    { 0x4C00,   0x100},     // section, ctrl
};
#endif //CC_MT5398
