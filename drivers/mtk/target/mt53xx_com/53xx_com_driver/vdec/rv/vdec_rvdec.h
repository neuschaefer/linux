...
//void vRCVFileHeader(void);
void _RVInitVDecHW(UINT32 u4BsFifoStart, UINT32 u4BsFifoEnd);
void _RVSetBsInfo(UINT32 u4RDPtrAddr, UINT32 u4BsFifoStart,UINT32 u4BsFifoEnd);
void _RVInit(void);
...
#define MV_DIRECT_SZ        0x1FE00                                 // 1920*1088*16/16/16 = 130560
#define VLD_PRED_OFFSET_SZ  0xC000                                  // 3*128*128 = 49152
