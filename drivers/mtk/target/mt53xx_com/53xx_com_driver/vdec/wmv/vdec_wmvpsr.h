...
BOOL fgVldInitBarrelShifter(UINT32);
...
UINT32 iGetIFMvMode(UINT32 iPQuant, BOOL fgRepeat);
void ComputeDQuantDecParam(void);
void UpdateDCStepSize(UINT32 bStepSize);
UINT32 getbits(UINT32 dwBits);
UINT32 get16(UINT32 dwBits);
UINT32 dwGetHi(UINT32 dwN);
//Simple & Main()
