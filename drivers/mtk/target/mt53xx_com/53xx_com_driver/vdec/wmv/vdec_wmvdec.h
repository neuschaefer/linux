...
#ifndef VDEC_WMVDEC_H
#define VDEC_WMVDEC_H
...
void _WMVInitVDecHW(UINT32 u4BsFifoStart, UINT32 u4BsFifoEnd);
void _WMVSetBsInfo(UINT32 u4RDPtrAddr, UINT32 u4BsFifoStart,UINT32 u4BsFifoEnd);
void _WMVInit(void);
