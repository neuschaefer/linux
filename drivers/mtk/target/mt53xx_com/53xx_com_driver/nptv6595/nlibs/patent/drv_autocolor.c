...
void vDrvEnableVGARefVoltageVerify(UINT8 bType)
{
        ...
        switch (bType)
        {
             case 0:
		//Clamp Ch1
		vRegWriteFldAlign(VFE_02, 1, VCLAMP_MONEN);
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0xE,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 1:
		//Clamp Ch2
		vRegWriteFldAlign(VFE_06, 1, VCLAMP_MONEN_CH2);
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0xB,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 2:
		//Clamp Ch3
		vRegWriteFldAlign(VFE_0A, 1, VCLAMP_MONEN_CH3);
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0x8,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 3:
		//BG
		vRegWriteFldAlign(VFE_00, 1, VBG_TEST_EN);
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0x3,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 4:
		//ADC_Ch1
		vRegWriteFldAlign(VFE_03, 2, MONSEL_1);
       	vIO32WriteFldAlign(VGACFG1, 0x06,FLD_RG_VREFMON);
 		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 5:
		//ADC_Ch2
		vRegWriteFldAlign(VFE_07, 2, MONSEL_2);
       	vIO32WriteFldAlign(VGACFG1, 0x05,FLD_RG_VREFMON);
 		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 6:
		//ADC_Ch3
		vRegWriteFldAlign(VFE_0B, 2, MONSEL_3);
       	vIO32WriteFldAlign(VGACFG1, 0x04,FLD_RG_VREFMON);
 		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 7:
		//VCM_Ch1
		vRegWriteFldAlign(VFE_03, 1, MONSEL_1);
       	vIO32WriteFldAlign(VGACFG1, 0x06,FLD_RG_VREFMON);
 		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	...
       	break;
             case 8:
		//VCM_Ch2
		vRegWriteFldAlign(VFE_07, 1, MONSEL_2);
       	vIO32WriteFldAlign(VGACFG1, 0x05,FLD_RG_VREFMON);
 		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	...
       	break;
             case 9:
		//ADC_Ch3
		vRegWriteFldAlign(VFE_0B, 1, MONSEL_3);
       	vIO32WriteFldAlign(VGACFG1, 0x04,FLD_RG_VREFMON);
 		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	...
       	break;
             case 10:
		//Switch to N
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x0,FLD_RG_SYNC_REV_0)|P_Fld(0x1,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
       	break;
             case 11:
              //AG_Ch1
		vRegWriteFldAlign(VFE_00, 1, ACMONEN);
		vRegWriteFldAlign(VFE_02, 1, AGMONEN_1);
		
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0xD,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x0,FLD_RG_SYNC_REV_0)|P_Fld(0x1,FLD_RG_SYNC_REV_1));
       	break;
             case 12:
              //AG_Ch2
		vRegWriteFldAlign(VFE_06, 1, AGMONEN_2);
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0xA,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       	vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x0,FLD_RG_SYNC_REV_0)|P_Fld(0x1,FLD_RG_SYNC_REV_1));
       	break;
             case 13:
              //AG_Ch3
		vRegWriteFldAlign(VFE_00, 1, ACMONEN);
		vRegWriteFldAlign(VFE_0A, 1, AGMONEN_3);
       	vIO32WriteFldMulti(VGACFG1, P_Fld(0xA,FLD_RG_VREFMON)|P_Fld(0x0,FLD_RG_VGA_TESTBUF_PWD)|P_Fld(0x1,FLD_RG_VGA_TESTP_EN)|P_Fld(0x1,FLD_RG_VGA_TESTN_EN));
		vIO32WriteFldAlign(VGACFG2,0x0,FLD_RG_DIG_TST_EN);
		vIO32WriteFldMulti(SYNCFG3,P_Fld(0x1,FLD_RG_SYNC_REV_0)|P_Fld(0x0,FLD_RG_SYNC_REV_1));
		vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
...
void vDrvEnableSyncSlicerRefVoltageVerify(UINT8 bType)
{
	...
	vRegWriteFldAlign(VFE_04, 1, VGA_ABIST_EN);
       vIO32WriteFldMulti(PDWNC_ADCCFG1, P_Fld(0x1,FLD_RG_SRVADC_TESTE)|P_Fld(0x0,FLD_RG_SRV_RES)|P_Fld(0x2,FLD_RG_SRVADC_TESTIN));
	vIO32WriteFldAlign(VGACFG1, 1, FLD_RG_VGA_TESTN_EN);
	vIO32WriteFldAlign(VGACFG1,1,FLD_RG_VGA_TESTP_EN);	
	vIO32WriteFldAlign(VGACFG1,0,FLD_RG_VGA_TESTBUF_PWD);	
	vIO32WriteFldAlign(VGACFG2,0,FLD_RG_DIG_TST_EN);	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_SYNC_TESTO_EN);	
	vIO32WriteFldAlign(VGACFG1,0,FLD_RG_VREFMON11_8);	
        switch (bType)
        {
             case 0:
	//VBG	
	vIO32WriteFldAlign(SYNCFG2,0,FLD_RG_SYNC_TSTSEL);       	
	break;
       case 1:
	//VTH_SOGY	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_TREF_EN);	
	vIO32WriteFldAlign(SYNCFG2,5,FLD_RG_SYNC_TSTSEL);	
	break;
       case 2:
	//VTL_SOGY	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_TREF_EN);	
	vIO32WriteFldAlign(SYNCFG2,4,FLD_RG_SYNC_TSTSEL);	
	break;
       case 3:
	//VTH_SYNC	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_TREF_EN);	
	vIO32WriteFldAlign(SYNCFG2,7,FLD_RG_SYNC_TSTSEL);	
	break;
       case 4:
	//VTL_SYNC	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_TREF_EN);	
	vIO32WriteFldAlign(SYNCFG2,6,FLD_RG_SYNC_TSTSEL);	
	break;
       case 5:
	//FB_VREFP	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_TREF_EN);
	vIO32WriteFldAlign(SYNCFG2,2,FLD_RG_SYNC_TSTSEL);	
	vIO32WriteFldAlign(SYNCFG2,0,FLD_RG_FB_PWD);	
	break;
       case 6:
	//FB_VREFN	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_TREF_EN);	
	vIO32WriteFldAlign(SYNCFG2,1,FLD_RG_SYNC_TSTSEL);	
	vIO32WriteFldAlign(SYNCFG2,0,FLD_RG_FB_PWD);	
	break;
      		default:
      		break;                     	
