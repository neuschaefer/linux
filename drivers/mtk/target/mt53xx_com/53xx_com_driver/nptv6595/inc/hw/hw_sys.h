...
#define INT_COLLECT (IO_VDOIN_BASE+0x0000)
 #define INT_COLLECT_0 (IO_VDOIN_BASE+0x0000)
 #define INT_COLLECT_1 (IO_VDOIN_BASE+0x0001)
 #define INT_COLLECT_2 (IO_VDOIN_BASE+0x0002)
 #define INT_COLLECT_3 (IO_VDOIN_BASE+0x0003)
...
#define SYS_00 (IO_VDOIN_BASE+0x0400)
 #define SYS_00_0 (IO_VDOIN_BASE+0x0400)
 #define SYS_00_1 (IO_VDOIN_BASE+0x0401)
 #define SYS_00_2 (IO_VDOIN_BASE+0x0402)
 #define SYS_00_3 (IO_VDOIN_BASE+0x0403)
    ...
    #define SYS_DDS_CW_GATE Fld(1,25,AC_MSKB3)//[25:25]
