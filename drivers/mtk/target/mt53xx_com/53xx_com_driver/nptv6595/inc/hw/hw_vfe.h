...
#ifdef CC_MT5395
    #define IBG_SEL Fld(3, 26, AC_MSKB3) //28:26
    #define VBG_SEL Fld(4, 22, AC_MSKB2) //25:22
#else
...
#define VFE_06 (IO_HDTV_VFE+0x458)
    ...
    #define VCLAMP_MONEN_CH2 Fld(1, 6, AC_MSKB0) //6
...
#define VFE_0A (IO_HDTV_VFE+0x468)
    ...
    #define VCLAMP_MONEN_CH3 Fld(1, 6, AC_MSKB0) //6
