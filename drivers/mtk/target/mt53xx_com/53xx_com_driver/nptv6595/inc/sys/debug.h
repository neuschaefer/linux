...
//#define ADAPTIVE_SLICER_ENABLE 0  //wu change 1 to 0  to support set slicer for ypbpr
...
#endif
#endif
#define SUPPORT_HDTV_HARDWARE_MUTE 1 /* hw_mute will be enabled later */
...
#ifdef CC_MT5395
//temp work around: Delay 3 frames between set dram address and enable dram write.
#define CC_SCPIP_DRAM_OVERWRITE_WA 0
#else
#define CC_SCPIP_DRAM_OVERWRITE_WA 0
#endif
