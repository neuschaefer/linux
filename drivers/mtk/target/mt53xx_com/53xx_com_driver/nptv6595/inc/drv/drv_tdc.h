...
#define ACTIVE_WIN_NTSC_X_LENGTH	(UINT32)0x2F4
#define ACTIVE_WIN_NTSC_Y_START		(UINT32)0x013
#define ACTIVE_WIN_NTSC_Y_LENGTH	(UINT32)0x103
#define ACTIVE_WIN_DEMO_NTSC_X_START		(UINT32)0x1F4 //For right demo

#define ACTIVE_WIN_PAL_X_START		(UINT32)0x093
...
#define ACTIVE_WIN_PAL_N_X_START	(UINT32)0x09C
#define ACTIVE_WIN_PAL_N_X_LENGTH	(UINT32)0x2EA
#define ACTIVE_WIN_PAL_N_Y_START	(UINT32)0x016
#define ACTIVE_WIN_PAL_N_Y_LENGTH	(UINT32)0x135
