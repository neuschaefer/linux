...
#define vApiNotifyOutVSync(void)
...
extern void vApiNotifyOutVSync(void);
...
/**
 * @brief Register output vsync callback function
 * @param pfnFct: output vsync callback function
 * @retval 0 is fail, 1 is success
 */
EXTERN INT32 NPTV_SetOutVSyncNfyFct(const NPTV_PFN_OUT_SYNC pfnFct);
