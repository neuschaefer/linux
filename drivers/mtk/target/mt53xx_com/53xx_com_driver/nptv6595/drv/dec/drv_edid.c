...
void vVGA_INTERNAL_EDID_Init(void)
{
    ...
    UINT8 i;
    // switch pinmux to gpio to protect internal pdwnc edid sram address
    BSP_PinSet(PIN_VGA_SCL, 0);
    BSP_PinSet(PIN_VGA_SDA, 0);
#endif

    vIO32WriteFldAlign(PDWNC_VGA_DEV, 0, FLD_VGA_EN);
    vIO32WriteFldAlign(PDWNC_VGA_DEV, 0, FLD_WP);
    ...
    {
        vIO32WriteFldAlign(PDWNC_PDMISC, 1, FLD_VGA_DEGLITCH_EN);
        vIO32WriteFldAlign(PDWNC_PDMISC, 3, FLD_VGA_DE_CNT); //should >=2
    }
    ...
    vIO32WriteFldAlign(PDWNC_VGA_DEV, 1, FLD_WP);
    vIO32WriteFldAlign(PDWNC_VGA_DEV, 1, FLD_VGA_EN);

    // switch pinmux back to scl/sda
    BSP_PinSet(PIN_VGA_SCL, 1);
    BSP_PinSet(PIN_VGA_SDA, 1);
#endif
#if 0
	//verify VGA EDID
	UINT8 tmp, value;
...
{
#ifndef CC_HDMI_EDID_DISABLE //this define is in mt5365p1v1.def etc.
    //UINT8 i;
...
#if 1
	/**Set pin mux*/
UINT32 PMUX1,PMUX1_org;
#ifdef CC_MT5365
UINT32 PMUX2,PMUX2_org;
	PMUX1_org=u4IO32Read4B(PDWNC_PINMUX);
	PMUX1=u4IO32Read4B(PDWNC_PINMUX);
	//printf("5365 default pin mux =%x................\n ",PMUX1);
	PMUX1=PMUX1&0xFFF3FF80;	//set SCL/SDA 0~3 to GPIO
	vIO32Write4B(PDWNC_PINMUX, PMUX1);
	//printf("5365 set all SCL/SDA to GPIO and pin mux =%x................\n ",PMUX1);
	
	PMUX2_org=u4IO32Read4B(PDWNC_HDMI_PINMUX);
	PMUX2=u4IO32Read4B(PDWNC_HDMI_PINMUX);
	//printf("5365 default HDMI pin mux =%x................\n ",PMUX2);
	PMUX2=PMUX2&0xFFFF8888;
	vIO32Write4B(PDWNC_HDMI_PINMUX, PMUX2);
	//printf("5365 set all SCL/SDA to GPIO and pin mux =%x................\n ",PMUX2);
#endif
#ifdef CC_MT5395
	PMUX1_org=u4IO32Read4B(PDWNC_PINMUX);
	PMUX1=u4IO32Read4B(PDWNC_PINMUX);
	//printf("5395 default pin mux =%x................\n ",PMUX1);
	PMUX1=PMUX1&0xFC03FF00;	//set SCL/SDA 0~3 to GPIO
	vIO32Write4B(PDWNC_PINMUX, PMUX1);
	//printf("5395 set all SCL/SDA to GPIO and pin mux =%x................\n ",PMUX1);
#endif
#endif
...
#ifdef CC_MT5365
	vIO32Write4B(PDWNC_PINMUX, PMUX1_org);
	//printf("5365 set orginal and pin mux =%x................\n ",u4IO32Read4B(PDWNC_PINMUX));
	vIO32Write4B(PDWNC_HDMI_PINMUX, PMUX2_org);
	//printf("5365 set orginal and pin mux =%x................\n ",u4IO32Read4B(PDWNC_HDMI_PINMUX));
#endif
#ifdef CC_MT5395
	vIO32Write4B(PDWNC_PINMUX, PMUX1_org);
	//printf("5395 set orginal and pin mux =%x................\n ",u4IO32Read4B(PDWNC_PINMUX));
#endif
