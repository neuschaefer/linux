...
static GFX_DBG_ENUM2TEXT_T _rGfxDbgClkEnum2TextTbl[] =
{
    ...
    {(INT32) E_GFX_CLK_SYSPLL_D3,   "216MHz"},
    {(INT32)E_GFX_CLK_DTDPLL_D3,   "200/144 MHz"},
    {(INT32)E_GFX_CLK_SYSPLL_D4,   "162MHz"},
    {(INT32)E_GFX_CLK_SYSPLL_D6,   "108MHz"},
    {(INT32)E_GFX_CLK_MEM_CK,   "UNUSED"},
    {(INT32)E_GFX_CLK_TVDPLL_D2,    "216MHz"},
    {(INT32)E_GFX_CLK_USBPLL_CK,         "240MHz"},
