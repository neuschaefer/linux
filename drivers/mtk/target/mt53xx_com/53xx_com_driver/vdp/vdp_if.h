...
#if 0 // def CC_MT5391
EXTERN void VdpSrmMjcCbCore(UINT32 u4Arg1, UINT32 u4Arg2, UINT32 u4Arg3, UINT32 u4Arg4);
#endif

#if 1 // def CC_MT5360
EXTERN void VDP_SetSramPool(void);
#endif

#ifdef CC_TV_MEMO_MODE
EXTERN UINT32 VDP_SetMemoMode(BOOL fgEnable);
