...
EXTERN void VDP_ScposDispmodeFreeRun(BOOL bEnable);

EXTERN UINT32 VDP_ScposDispModeFIFOOverflow(void);
...
EXTERN UINT32 VDP_NotifyPlaneOrderChanged(UINT32 u4VdpId, UINT32 u4PlaneOrder);
