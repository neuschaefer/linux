 ...
 *---------------------------------------------------------------------------*/
#ifndef MTK_88P1V1_AUD_H
#define MTK_88P1V1_AUD_H
...
static const AUD_INPUT_MUX_SEL_T _arToshibaAudInputMux[] = 
{   // Input ID             DacMuxSel,    SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    {AUD_INPUT_ID_COMP_VID_0,    1,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    ...
    {AUD_INPUT_ID_S_VID_1,       5,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_S_VID_2,       5,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_YPBPR_0,          3,  SW_NO_USED,SW_NO_USED, SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_YPBPR_1,          2,            	SW_NO_USED, SW_NO_USED,SW_NO_USED, SW_NO_USED},            
    ...
    {AUD_INPUT_ID_HDMI_0,           NO_USED,  SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},  
    ...
    {AUD_INPUT_ID_DVI_0,             0,  SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},    
    {AUD_INPUT_ID_DVI_1,      	    0, 	SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    ...
    {AUD_INPUT_ID_SCART_1,         0, 		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rToshibaAudInputMuxTable = 
{
    (sizeof(_arToshibaAudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _arToshibaAudInputMux   
};

static const AUD_INTER_DAC_CFG_T _arToshibaInterDacUsage = 
{
    AUD_CHL_BYPASS,
    AUD_CHL_L_R,
    AUD_CHL_AUX
