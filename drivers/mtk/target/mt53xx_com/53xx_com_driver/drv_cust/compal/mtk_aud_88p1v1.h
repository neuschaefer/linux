...
static const AUD_INPUT_MUX_SEL_T _arMtk88P1V1AudInputMux[] = 
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rMtk88P1V1AudInputMuxTable = 
{
    (sizeof(_arMtk88P1V1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _arMtk88P1V1AudInputMux   
};

static const AUD_INTER_DAC_CFG_T _arMtk88P1V1InterDacUsage = 
{
    AUD_CHL_BYPASS,
    AUD_CHL_L_R,
    AUD_CHL_AUX
