...
#include "compal/toshiba_ir_nec_tbl.h"
// #include "mtk/mtk_ir_rc5_code_tbl.h"
#include "compal/toshiba_ir_rc5_func_tbl.h"

#ifndef KEY_ARRAY
#define KEY_ARRAY
static const KEYARRAY_T _arKeyArray[] =
{
    { 0x9f20, (sizeof(_arToshibaTvKeyMap)/sizeof(KEYUNIT_T)), _arToshibaTvKeyMap },
    { 0xe31c, (sizeof(_arToshibaTvBigKeyMap)/sizeof(KEYUNIT_T)), _arToshibaTvBigKeyMap },
};
#endif /* KEY_ARRAY */
