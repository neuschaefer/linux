...
#define DEFAULT_DDR_CLOCK               (594000000)
...
#define PANELPOWER_GPIO                 (GPIO_LVDS_PWR_ON)
...
#define AUDIO_Mute_Gpio_Num             (9)  //TP_VPLL
#define AUDIO_Amp_Gpio_Num              (GPIO(8)) // GPIO 8
...
// USB Customization
//----------------------------------------------------------------------------
#define USB0_VBUS_GPIO                      (GPIO_USB_PWR_EN0)    // USB_PWR_EN0
#define USB0_VBUS_GPIO_POLARITY		        (1)
#define USB1_VBUS_GPIO                      (2)    // GPIO2
#define USB1_VBUS_GPIO_POLARITY		        (1)

#define USB0_OC_GPIO                        (GPIO_USB_PWR_ERR0)    // USB_PWR_ERR0
