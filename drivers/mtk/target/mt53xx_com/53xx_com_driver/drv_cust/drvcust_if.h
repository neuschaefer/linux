...
// mt5387----------------------------------------------------------------------
#define FBM_MEM_CFG_MT5387_VERF     (0x3D00000) // pip/pop, full-hd, two 16-bit, flip and mirror
#define FBM_MEM_CFG_MT5388_128MB    (0x3D00000 + 0x10000)
#if defined(CC_VIDEO_THUMB_NAIL)
#define FBM_MEM_CFG_MT5387_64MB     (0x2800000)
#elif defined(CC_FLIP_MIRROR_SUPPORT)
#define FBM_MEM_CFG_MT5387_64MB     (0x2500000) // single, full-hd, one 16-bit ddr, flip and mirror
#else
#define FBM_MEM_CFG_MT5387_64MB     (0x2280000 + 0x10000) // single, full-hd, one 16-bit ddr
#endif
#define FBM_MEM_CFG_MT5363_64MB     (0x2d00000 + 0x10000)
#define FBM_MEM_CFG_MT5388_64MB_ATV_WXGA (0x1E00000)
#define FBM_MEM_CFG_MT5365_ATV_64MB (0x1d80000 + 0x10000)
// mt5387----------------------------------------------------------------------
// mt5363----------------------------------------------------------------------
#define FBM_MEM_CFG_MT5363_64MBx2   (0x5600200)
// mt5363----------------------------------------------------------------------
...
#define eFlagDmpllSpectrum      (FLAG_DMPLL_SPECTRUM)
...
typedef enum {
    ...
    eSetSignalUsrNotifyFunc,    //singnal booster add by Hua 0609
...
// Loader Misc
//-----------------------------------------------------------------------------
typedef void (* PFN_LDR_ENVINIT_FUNC)(void);
...
// GPIO alias
#define GPIO_OPWM0              (56)
#define GPIO_OPWM1              (57)
#define GPIO_OPWM2              (58)
#define GPIO(x)                 (x)
...
#define IRRX_MAX_RAW_DATA_SIZE                  ((UINT8) 12) /* byte */
