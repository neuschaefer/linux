...
//#define IS_DRAM_1G_CHIP                     (CKGEN_READ32(0x520) & (1U << 5))  // 0: 800Mhz; 1: 1GMhz
//#define DEFAULT_DDR_CLOCK                   ((IS_DRAM_1G_CHIP ) ? (864000000) : (783000000))
...
#define SPREAD_SPECTRUM_PERMILLAGE          (20)
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "Wistron/Iris_P2_aud.h"
...
#define AUDIO_AOUT_PAD_CFG                  (&_arIrisAoutPadTable) // parson Iris
#define AUDIO_Digital_Data_TABLE 	        (&_afgIrisAudDigitalDataUsage)
#define LOADER_MUSIC_H_FILE                 "Wistron/Iris_DrvLogoMusic.h"
#define AUDIO_OUT_FMT_TABLE                 (&_arIrisAudOutFmtTable)
#define AUDIO_FLASH_AQ_DATA                 (&arIrisAudNvmData)
#define AUDIO_FLASH_AQ_DATA_SIZE            (sizeof(arIrisAudNvmData))
#define AUDIO_FLASH_AQ_DATA_DSCRPT          (&_arIrisAudNvmDscrpt)
#define AUDIO_FLASH_AQ_DATA_DSCRPT_SIZE     (u1IrisAudAQDscrptSize)
...
#ifndef IRIS_PCBA_EVT
#define SYSTEM_EEPROM_SIZE                      (8192)
#else
#define SYSTEM_EEPROM_SIZE                      (16384) /*16KB*/
#endif
...
#define IRIS_PICTURE_DISABLE            /*temporarily disable*/
#else
#define NAND_FLASH_TOTAL_SIZE            (64*1024*1024)
#endif


#define NAND_FLASH_APPIMAGE_SIZE         (0x0900000)                    /* nand_1 - system image                 */
#define NAND_PART_SIZE_1                 NAND_FLASH_APPIMAGE_SIZE       /* nand_1 - system image                 */
#define NAND_PART_SIZE_2                 (0x0000000)                    /* nand_2 - uP bin                       */
...
#define NAND_PART_SIZE_6                 (0x0100000)                    /* nand_6 - Panel                        */
#define NAND_PART_SIZE_7                 (0x1200000)                    /* nand_7 - PQ                           */
#define NAND_PART_SIZE_8                 (0x0080000)                    /* nand_8 - AQ                           */
#ifndef IRIS_PICTURE_DISABLE
#define NAND_PART_SIZE_9                 (0x0500000)                    /* nand_9 - Picture                      */
#else
#define NAND_PART_SIZE_9                 (0x0000000)                    /* nand_9 - Picture                      */
#endif
...
#define LOAD_PANEL_FROM_FLASH_CUSTOM                   Iris_PanelLoadTableFromFlash
#endif
...
#define PAENL_FLASH_TABLE_BASE_PARTITION (6)
...
#define NAND_PART_END                    (9)                           /* total 9 Partitions */
...
//----------------------------------------------------------------------------
#define DRV_LOGO_H_FILE              "Wistron/Iris_DrvLogo.h"
...
#define DRV_CUSTOM_CUST_FILE                      "Wistron/Iris_d_custom.c"
#endif

#ifndef DRV_CUSTOM_CUST_SPEC_SET
#define DRV_CUSTOM_CUST_SPEC_SET                    d_iris_cust_spec_set
#endif

#ifndef DRV_CUSTOM_CUST_SPEC_GET
#define DRV_CUSTOM_CUST_SPEC_GET                    d_iris_cust_spec_get
#endif
...
#define BUTTON_INCLUDE_FILE                 "Wistron/Iris_button.h"
#define GPIO_INCLUDE_FILE                   "Wistron/Iris_gpio.h"

//----------------------------------------------------------------------------
// PDWN external control
//----------------------------------------------------------------------------
#define PDWNC_EXT_IMPL                      "Wistron/Iris_pdwnc_ext.c"

//----------------------------------------------------------------------------
// Customer power on/off sequence
//----------------------------------------------------------------------------
#define POWER_SEQUENCE_EXT_FILE             "Wistron/Iris_PowerSeq.c"
...
#define IR_INCLUDE_FILE                     "Wistron/mtk_ir_sony.h"
#else
#define IR_INCLUDE_FILE                     "mtk/mtk_ir.h"
#endif

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "Wistron/source_table_P2.c"
#endif
...
#define HDMI_GPIO_CONF                      "Wistron/Iris_hdmi_conf_empty.c"
#endif
//----------------------------------------------------------------------------
// default T8032 FW Properties
//----------------------------------------------------------------------------
#ifndef T8032UP_INCLUDE_FILE
#define T8032UP_INCLUDE_FILE                "Wistron/Iris_t8032fw.h"
...
#define VGA_INCLUDE_FILE                    "Wistron/Iris_vga.h"
#endif
...
#define FLASH_PQ_SCE_MAX  (1)
    ...
    #define QTYTBL_INCLUDE_FILE               "Wistron/QTY_DEFAULT/Wistron_QtyTbl.h"
#endif
...
*/
    ...
    #define COLOR_PARAM_INCLUDE_FILE            "Wistron/PANEL_DEFAULT/color_param.h"
#endif

#ifndef CUSTOM_VIDEO_DRV_BODY_FILE
    #define CUSTOM_VIDEO_DRV_BODY_FILE          "Wistron/video_drv/Wistron_video_drv.c"
#endif
