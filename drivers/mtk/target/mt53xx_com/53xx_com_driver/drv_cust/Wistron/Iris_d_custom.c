...
// Global variables
//---------------------------------------------------------------------------
extern UINT32 _u4gIrisModelType;
...
)
{
    ...
    switch (e_cust_spec_type)
    {
        ...
        case DRV_CUSTOM_CUST_SPEC_TYPE_LED_MODE:
        {
            ...
            LOG(7, "[d_iris_cust_spec_set] Set led %d as %d\n", 
                prLEDInfo->eLedType, prLEDInfo->eLedState);
            IrisLEDCtrlFunc(prLEDInfo->eLedType, prLEDInfo->eLedState);
            break;
        }
        ...
        case DRV_CUSTOM_CUST_SPEC_TYPE_STANDBY_LED_DISABLE_MODE:
        {
            ...
            Iris_DisableStandbyLEDCtrl((*(UINT8 *)pv_set_info));
            break;
        }
        ...
        {
            UNUSED(IrisSelfDiagResetCounter());
            break;
        }

        case DRV_CUSTOM_CUST_SPEC_TYPE_BOOT_COUNT_MODE:
        {
            UNUSED(IrisSelfDiagResetBootCount());
            break;
        }
        default:
            i4_ret = -1;
...
)
{
    switch (e_cust_spec_type)
    {
        case DRV_CUSTOM_CUST_SPEC_TYPE_PCB_MODE:
        {
            ...
            *((UINT32 *)(pv_get_info)) = _u4gIrisModelType;
            break;
        }
        case DRV_CUSTOM_CUST_SPEC_TYPE_SELF_DIAG_MODE:
        {
            ...
            UNUSED(IrisSelfDiagGetCounter((D_SELF_DIAG_STATE *)pv_get_info));
            break;
        }
        case DRV_CUSTOM_CUST_SPEC_TYPE_BOOT_COUNT_MODE:
        {
            ...
            if (IrisSelfDiagGetBootCounter((UINT32 *)pv_get_info) != 0)
            {
                return -1;
            }
            break;
