...
#define IRIS_GPIO_FACTORY_WISTRON       1
...
UINT32 _u4gFactoryType = IRIS_GPIO_FACTORY_WISTRON;
...
static void GPIO_IrisReadStrapPin(void)
{
    ...
    _u4gIrisModelType |= (_u4gPCBType == IRIS_GPIO_FACTORY_WISTRON) ?
        DRV_CUSTOM_IRIS_MODEL_FACTORY_WISTRON : DRV_CUSTOM_IRIS_MODEL_FACTORY_SONY;
