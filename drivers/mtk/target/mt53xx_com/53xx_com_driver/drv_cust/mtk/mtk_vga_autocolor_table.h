...
UINT8 code bEFuseCompensation[3] =    //notice if negative, how to express
{
    1, 2, 4    //ch1, ch2, ch3
};
...
UINT8 code bVGADefaultGainTABLE_100[4][3] =
{
    ...
    {0x88, 0x93, 0x96},	 //YPBPR    //2009.7.6 MT5388 ECO
    {0x4F, 0x52, 0x53},  //RGB
...
{ 
   ...
   {0x31, 0x24, 0x35}, //VGA               CH1 : 0x73 > X > 0x36,  CH2: 0x74 > X > 0x36   ,CH3: 0x74 > X > 0x36
