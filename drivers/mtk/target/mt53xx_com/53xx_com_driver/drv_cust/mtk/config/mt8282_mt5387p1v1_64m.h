...
#define FLAG_FORCE_32BIT    1           // 0-DDR2 x2; 1-DDR2x1
...
#define DDR2_PAD_DRIVING_1          0xbb007700

#define DDR2_OUT_CLK_DELAY_CHAIN_0  0x82808080
#define DDR2_OUT_CLK_DELAY_CHAIN_1  0x82808080
#define DDR2_OUT_CLK_DELAY_CHAIN_2  0x82808080
#define DDR2_OUT_CLK_DELAY_CHAIN_3  0x82808080

#define DDR2_DQS_RDSEL				0x00000000	
#define DDR2_DQ_RDSEL				0x00000408 //0x0000080c
...
#define FBM_MEM_CFG_SIZE               FBM_MEM_CFG_MT5387_64MB 
...
#endif
#define BACKLIGHT_GPIO                  (ADIN(3))//(GPIO(49))  // U1TX
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE              "mtk/mtk_aud_87p1v1.h"
#define AUDIO_Mute_Gpio_Num             (GPIO(49)) //(ADIN(3))
#define AUDIO_Amp_Gpio_Num              (GPIO(9))//(OPCTRL(3))
#define AUDIO_MUTE_GPIO_POLARITY        AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_AMP_GPIO_POLARITY         AUD_MUTE_GPIO_HIGH_ENALBE
#define AUDIO_INPUT_MUX_SEL_TABLE      (&_rMtk87P1V1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE           (&_arMtk87P1V1InterDacUsage)
//----------------------------------------------------------------------------
...
#define SYSTEM_EEPROM_WP_GPIO               (GPIO(48))
#define SYSTEM_EEPROM_WP_ENABLE_POLARITY    (0)
#define EDID_EEPROM_WP_GPIO			        (ADIN(2))
...
//----------------------------------------------------------------------------
// MT8280 Customization
//----------------------------------------------------------------------------
#ifdef DRV_SUPPORT_EXTMJC
#define MT8280_RESET_GPIO           (GPIO(81))
#define MT8280_RESET_GPIO_POLARITY  (0) //Low reset
#define CUSTOM_BootupMode           (GPIO_INIT_COMPANION_CHIP)
#endif
...
#define NPTV_SOURCE_TABLE                   "mtk/source_table_5387p1v1.c"
#endif
...
#define HDMI_GPIO_CONF                      "mtk/hdmi_conf_tmds351.c"
#endif
//----------------------------------------------------------------------------
