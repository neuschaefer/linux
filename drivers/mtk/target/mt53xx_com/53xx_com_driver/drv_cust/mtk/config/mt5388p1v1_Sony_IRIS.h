...
#endif
#define BACKLIGHT_GPIO                  (OPCTRL(1))   // GPIO_3
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE              "mtk/mtk_aud_88p1v1.h"
...
#define AUDIO_HP_PLUG_IN_GPIO          (GPIO(7))
#define AUDIO_HP_PLUG_IN_POLARITY       (AUD_GPIO_LOW_ENALBE)
#define AUDIO_INPUT_MUX_SEL_TABLE       (&_rMtk88P1V1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_arMtk88P1V1InterDacUsage)
...
#define NPTV_SOURCE_TABLE                   "mtk/source_table_5388p1v1.c"
#endif
