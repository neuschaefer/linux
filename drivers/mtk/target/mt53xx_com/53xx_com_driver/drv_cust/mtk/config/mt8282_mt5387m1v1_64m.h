...
#endif
#define BACKLIGHT_GPIO                  (GPIO(49))  // U1TX
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE              "mtk/mtk_aud87.h"
#define AUDIO_Mute_Gpio_Num             (ADIN(3))
...
#define AUDIO_INPUT_MUX_SEL_TABLE      (&_rMtk87AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE           (&_arMtk87M1V1InterDacUsage)
//----------------------------------------------------------------------------
...
#define MT8280_RESET_GPIO           (GPIO(56))
...
#define NPTV_SOURCE_TABLE                   "mtk/source_table_5387m1v1.c"
#endif
...
#define HDMI_GPIO_CONF                      "mtk/hdmi_conf_mt5387.c"
#endif
//----------------------------------------------------------------------------
