...
static MULTI_KEY_T _arATVMultiKeyList[] = {
...
static SGL_SERVO_T _arATVSingleServoKey[] = {
	// Servo,		Top,	Btm,	Key
...
/*
static SGL_GPIO_T _arATVSingleGpioKey[] = {
    // GPIO,       Btm,    Key
    {   OPCTRL0,   0,    DKBIT_POWER },
    {   0,         0,    DKBIT_NONE  },
};

#define SINGLE_GPIO_KEY_LIST		(_arATVSingleGpioKey)
*/
#define SINGLE_SERVO_KEY_LIST       (_arATVSingleServoKey)
#define MULTI_KEY_LIST              (_arATVMultiKeyList)
