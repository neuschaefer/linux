...
#
# Description:
#         Creates the various list of source, assembly and object files
#
#############################################################################
...
SRC_OBJ := $(SRC:.c=.o) $(ASM_SRC:.s=.o) $(SRC_CPP:.cpp=.o)
SRC_OBJ := $(SRC_OBJ:.S=.o)
ABS_OBJ := $(addprefix $(OBJ_DIR)/, $(OBJ) $(SRC_OBJ))

REL_ABS_OBJ := $(addprefix $(OBJ_DIR)/, $(foreach i,$(OBJ),$(notdir $(i)) ) $(SRC_OBJ) )
...
#
# Specify the labsolute library path
#
ABS_LIB = $(addprefix $(LIB_LIB_DIR)/,$(LIB))


#
# Specify the dependability files and path
#
DEPEND     := $(SRC:.c=.d) $(SRC_CPP:.cpp=.d)
ABS_DEPEND := $(addprefix $(OBJ_DIR)/, $(DEPEND))

#
# Specify the lint files and path
#
LINT_OBJ     := $(SRC:.c=.lint)
