...
static void _IntrudeHandler(UINT32 u4Region, MID_AGENT_ID_T eAgentId, UINT32 u4Addr)
{
    ...
    // Show intrusion info
    Printf("MEMORY VIOLATION - agent: %s(%d), address: 0x%08x\n",
        MID_AgentIdToString(eAgentId), (UINT32)eAgentId, u4Addr);
...
static void _InitCliInput(void* pvArg)
{
...
#ifndef __KERNEL__
    Printf("5387 Diagnostic Program v0.1\n");
	...
	{
		CLI_Parser("nav.i 124");	
	}
	else
	{
	    CLI_Parser("nav.i 100");
	}
#endif
