...
#ifndef _D_IRIS_CUST_H_
#define _D_IRIS_CUST_H_
...
-----------------------------------------------------------------------------*/
#define DRV_CUSTOM_IRIS_MODEL_60HZ_PANEL        (0)
#define DRV_CUSTOM_IRIS_MODEL_120HZ_PANEL       (1 << 0)
#define DRV_CUSTOM_IRIS_MODEL_AUD_NORMAL        (0 << 1)
#define DRV_CUSTOM_IRIS_MODEL_AUD_5_1_CHANEL    (1 << 1)
#define DRV_CUSTOM_IRIS_MODEL_FACTORY_WISTRON   (0 << 2)
#define DRV_CUSTOM_IRIS_MODEL_FACTORY_SONY      (1 << 2)
#define DRV_CUSTOM_IRIS_MODEL_46_55_INCH_PANEL  (1 << 3)
...
typedef struct _IrisLedDisplay
{
    D_LED_TYPE eLedType;
    UINT32 eLedState;
} D_LED_DISPLAY;
...
extern INT32 d_iris_cust_spec_set (
...
extern INT32 d_iris_cust_spec_get (
    DRV_CUSTOM_CUST_SPEC_TYPE_T    e_cust_spec_type,
    VOID*                          pv_get_info,
    SIZE_T*                        pz_size
);

extern void IrisLEDCtrlFunc(
    D_LED_TYPE eLedType,
    UINT32 u4LedState
);

extern void Iris_DisableStandbyLEDCtrl(
    UINT8 u1Disable
);

extern UINT32 IrisSelfDiagGetBootCounter(
    UINT32 *pu4BootCounter
);

extern UINT32 IrisSelfDiagGetCounter(
    D_SELF_DIAG_STATE   *prErrorInfo
);

extern UINT32 IrisSelfDiagUpdateOnOffCount(void);
extern UINT32 IrisSelfDiagResetCounter(void);
extern UINT32 IrisSelfDiagResetBootCount(void);
extern void IrisSelftDiagUpdateDCC(void);


#endif /* _D_IRIS_CUST_H_ */
