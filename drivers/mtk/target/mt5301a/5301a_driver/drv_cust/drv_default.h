...
#define DEFAULT_DRAM_TYPE           DDR_II_x1
#endif
...
#define DEFAULT_DDR_CLOCK           (729000000)
#endif
...
#if 0
// Audio/0 > Demux/PVR/1 > OSD/3 > B2R/5 > SCALAR/7 > NR/PSCAN/4 > VBI/3D/TVE/2 > VDEC-MC/8 > VLD-JPEG/9 > CPU/6
#define DRAM_PRIORITY_LIST          ((UINT8*)"0162539478")
#endif

// Audio/0 > Demux/PVR/1 > OSD/3 > B2R/5 > SCALAR/7 > VBI/3D/TVE/2 > NR/PSCAN/4 > VLD-JPEG/9 > VDEC-MC/8 > CPU/6
#define DRAM_PRIORITY_LIST          ((UINT8*)"0132546789")
#endif
...
#define SYS_RESET_TIMER             (0xf00000 / 10) // PDWNC at 3Mhz
#endif
...
*/
#ifdef CC_TURNKEY
#undef DEFAULT_TUNER_CTRL1
#endif
#ifndef DEFAULT_TUNER_CTRL1
#define DEFAULT_TUNER_CTRL1		(ADIN(3))
#endif
#ifndef DEFAULT_TUNER_CTRL_LNA
#define DEFAULT_TUNER_CTRL_LNA		(GPIO(2))
#endif
#ifndef DEFAULT_DEMOD_RESET_GPIO
#define DEFAULT_DEMOD_RESET_GPIO    (GPIO(22))
#endif
//----------------------------------------------------------------------------
...
#define AUDIO_HEAAC_MULTICHL_DDCO    (FALSE)     //output RAW data for all level of HE-AAC
//#define AUDIO_HEAAC_MULTICHL_DDCO    (TRUE)     //only output RAW data when HE-AAC level 4
#endif
...
#define AUDIO_AVC_ADJUST_RATE           (0x80)
#endif
...
#ifndef AUDIO_CHL_VOL_EXTRA_GAIN1
#define AUDIO_CHL_VOL_EXTRA_GAIN1       (NULL)
#endif
...
#define AUDIO_LIMITER_FIX_THRESHOLD     (0x60000)//60000 for p1v1, default is 100000.
#endif
...
#ifndef AUDIO_FLASH_COMM_LENGTH
#define AUDIO_FLASH_COMM_LENGTH (0)
#endif

#ifndef AUDIO_FLASH_COMM_DATA
#define AUDIO_FLASH_COMM_DATA (0)
#endif
...
#ifndef AUDIO_VSURR_SETTING
#define AUDIO_VSURR_SETTING_DEFAULT
#define AUDIO_VSURR_SETTING        (&_arVsurrSetting)
#endif

#ifndef AUDIO_BYPASS_CH_VOL
#define AUDIO_BYPASS_CH_VOL_DEFAULT
#define AUDIO_BYPASS_CH_VOL        (0x64)
#endif

#ifndef AUDIO_DMX_CH_VOL
#define AUDIO_DMX_CH_VOL_DEFAULT
#define AUDIO_DMX_CH_VOL        (0x64)
#endif

#ifndef AUDIO_TVSCART_CH_VOL
#define AUDIO_TVSCART_CH_VOL_DEFAULT
#define AUDIO_TVSCART_CH_VOL        (0x64)
#endif

#ifndef FLASH_AQ_BASE_OFFSET
#define FLASH_AQ_BASE_OFFSET_DEFAULT
#define FLASH_AQ_BASE_OFFSET        (0)
#endif

#ifndef FLASH_AQ_PART_ID
#define FLASH_AQ_PART_ID_DEFAULT
#define FLASH_AQ_PART_ID        (0)
#endif
...
//----------------------------------------------------------------------------
    ...
    #define NAND_FLASH_TOTAL_SIZE               (16*1024*1024)
        ...
        #define NAND_FLASH_APPIMAGE_SIZE         (7*1024*1024)//(6*1024*1024)  // temporary solution [DTV00212237]
    #else
        ...
        #define NAND_FLASH_CIPLUS_SIZE           (64*1024)
    #endif
#else
    #ifndef NAND_FLASH_CIPLUS_SIZE
...
#define HDMI_TMDS_EQ_SEL_VALUE (0xE) // for MT5301A, jiewen
#endif
#ifndef HDMI_TMDS_EQ_GAIN_VALUE
#define HDMI_TMDS_EQ_GAIN_VALUE (0x3)  // for MT5301A, jiewen
#endif
#ifndef HDMI_TMDS_HDMI_LBW_VALUE
#define HDMI_TMDS_HDMI_LBW_VALUE (0x3)  // for MT5301A, jiewen
#endif
