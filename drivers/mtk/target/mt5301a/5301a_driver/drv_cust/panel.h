...
#define LSB_OFF (1<<15)
#define LSB_ON (0)
    #define LSBOFF_FUNCTION    (1<<15)
   
#define ROUND_OFF (0)
#define ROUND_ON (1<<14)
    #define ROUND_FUNCTION    (1<<14)

#define RDITHER_OFF (0)
#define RDITHER_ON (1<<13)
    #define RDITHER_FUNCTION    (1<<13)

#define ERROR_DITHER_OFF (0)
#define ERROR_DITHER_ON (1<<12)
        #define ERROR_DITHER_FUNCTION   (1<<12)

#define FPHASE_VALUE ((PANEL_GetDither() & 0x0f00) >> 8)

#define LFSR_OFF (0)
#define LFSR_ON (1)
    #define LFSR_FUNCTION    (1)
