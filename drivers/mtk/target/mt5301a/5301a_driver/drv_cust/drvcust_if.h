...
#define FBM_MEM_CFG_MT5387_64MB     (0x1F00000 + 0x8223)
#else
#define FBM_MEM_CFG_MT5387_64MB     (0x2200000 + 0x10000)
#endif
...
#define FBM_MEM_CFG_MT5363_64MBx2   (0x5300000 + 0x400000) // 4MB for audio, 16MB for video
#elif defined(CC_FLIP_MIRROR_SUPPORT)
#if CC_MIRROR_SW_WA
#define FBM_MEM_CFG_MT5363_64MBx2   (0x5000000 + 0x700000)
#else
#define FBM_MEM_CFG_MT5363_64MBx2   (0x5000000)
#endif
#elif defined(__MODEL_slt__)
#define FBM_MEM_CFG_MT5363_64MBx2   (0x5000000)
#else
#define FBM_MEM_CFG_MT5363_64MBx2   (0x4900000)
#endif
// mt5363----------------------------------------------------------------------
...
typedef enum {
    ...
    eAudioChlVolExtraGain1,
    eAudioChlVolExtraGainNonLineIn,
    eAudioChlVolExtraGainLinkMode,
    eAudioChlVolExtraGainNonLineInLinkMode,
    eAudioChannelDelay,
    eAudioIecCopyright,
    eAudioIecCategory,
    eAudioIecWordLength,
    ...
    eNANDFlashDynamicPartitionUsedSize,
    ...
    eFlagFlashPqGammaX3,            // FlashPQ support gamma DARK, MIDDLE, BRIGHT.
...
#define TOTAL_SERVOADC_NUMBER       (6)
#define TOTAL_GPIO_NUMBER           (192)
#define TOTAL_MT8292_GPIO_NUMBER    (10)
#define TOTAL_MT8295_GPIO_NUMBER    (15)
#define TOTAL_OPCTRL_NUMBER         (20)

// ServoADC
#define MAX_SERVOADC_NUM            TOTAL_SERVOADC_NUMBER

// GPIO alias
#define GPIO_OPWM0              (23)
#define GPIO_OPWM1              (24)
#define GPIO_OPWM2              (25)
#define GPIO(x)                 (x)
...
#define GPIO_HDMI_HPD0			(212)
#define GPIO_HDMI_HPD1			(208)
#define GPIO_HDMI_HPD2			(204)
