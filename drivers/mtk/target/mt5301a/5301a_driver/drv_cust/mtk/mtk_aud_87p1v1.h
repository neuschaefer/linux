 ...
 *---------------------------------------------------------------------------*/
#ifndef MTK_87P1V1_AUD_H
#define MTK_87P1V1_AUD_H
...
static const AUD_INPUT_MUX_SEL_T _arMtk87P1V1AudInputMux[] = 
{   // Input ID             DacMuxSel,    SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    {AUD_INPUT_ID_COMP_VID_0,    6,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    ...
    {AUD_INPUT_ID_S_VID_0,          6,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},  
    ...
    {AUD_INPUT_ID_HDMI_0,           5,  SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},  
    {AUD_INPUT_ID_HDMI_1,     5, 		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_2,     5, 		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_3,     5, 		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_4,     5, 		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_DVI_0,             5,  SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},    
    {AUD_INPUT_ID_DVI_1,      	    5, 	SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rMtk87P1V1AudInputMuxTable = 
{
    (sizeof(_arMtk87P1V1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _arMtk87P1V1AudInputMux   
};

static const AUD_INTER_DAC_CFG_T _arMtk87P1V1InterDacUsage = 
{
    AUD_CHL_L_R,
    AUD_CHL_L_R,
    AUD_CHL_BYPASS
