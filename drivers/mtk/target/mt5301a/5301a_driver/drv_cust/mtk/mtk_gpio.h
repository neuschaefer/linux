...
#if !defined(LINUX_TURNKEY_SOLUTION) && defined(CC_MTK_LOADER)
...
#if !defined(LINUX_TURNKEY_SOLUTION) && defined(CC_MTK_LOADER)//#ifdef CC_MTK_LOADER
...
//for Panel Init
    Printf("Set GPIO44 as output mode for panel initial.\n");
    GPIO_SetOut(95, 0);      
#else /* CC_MTK_LOADER */
