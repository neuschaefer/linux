...
//kal8225
UINT8 code bEFuseCompensation[4][3] =    //notice if negative, how to express
{
    3, 12, 10,    //YPbPr     ch1, ch2, ch3
    3, 5, 5,    //VGA       ch1, ch2, ch3
    2, 3, 4,    //SCART     ch1, ch2, ch3
    0, 0, 0     //VGA_YPBPR ch1, ch2, ch3
};

UINT8 code bVGADefaultGainTABLE_100[4][3] =
{
    //{0x80, 0x8C, 0x8E},	 //YPBPR
    //{0x49, 0x4B, 0x4C},  //RGB
    //{0x21, 0x22, 0x23},  //SCART RGB
    //{0x8C, 0x80, 0x8E}	  //VGA_YPBPR		
    {0x8a, 0x97, 0x97},	 //YPBPR    //2009.11.24 MT8223H/L 
    {0x54, 0x54, 0x54},  //RGB
    {0x2A, 0x2A, 0x2A},  //SCART RGB
    {0x8C, 0x80, 0x8E}	  //VGA_YPBPR		
    
};
UINT8 code bVGADefaultOffsetTABLE_100[4][3] =
{
    {0x3C, 0x80, 0x7E},	 //YPBPR
    {0x71, 0x7A, 0x7D},  //RGB
    {0x3D, 0x42, 0x45},  //SCART RGB
    {0x78, 0x49, 0x7A}  //VGA_YPBPR		
};
...
UINT8 code bVGADefaultGainTABLE_120[4][3] =
{
    ...
    //{0x49, 0x4B, 0x4C},  //RGB
    //{0x21, 0x22, 0x23},  //SCART RGB
    {0x63, 0x7F, 0x80},	 //YPBPR   //2009.7.6 MT5388 ECO
    {0x4F, 0x52, 0x53},  //RGB
    {0x26, 0x28, 0x29},  //SCART RGB
    {0x77, 0x5D, 0x79}	  //VGA_YPBPR		
};
...
UINT8 code bVGADefaultGainTABLE_75_100[4][3] =
{
    ...
    //{0x49, 0x4B, 0x4C},  //RGB
    //{0x21, 0x22, 0x23},  //SCART RGB
    {0x26, 0x30, 0x31},	 //YPBPR   //2009.7.6 MT5388 ECO
    {0x4F, 0x52, 0x53},  //RGB
    {0x26, 0x28, 0x29},  //SCART RGB
...
{ 
  {0xB2, 0xC1, 0xC3},  //YPbPr
  {0x70, 0x73, 0x74},  //VGA
  {0x43, 0x45, 0x46},  //SCART R,G,B
  {0xB7, 0xAB, 0xB7}   // VGA_YPBPR
 };
UINT8 code GAIN_LOW_LIMIT_100[4][3] =    
{ 
   {0x60, 0x6C, 0x6D}, //YPbPr              CH1 : 0x85 > X > 0X48,  CH2: 0xA1 > X > 0X60 , CH3: 0xA1 > X > 0X60
   {0x31, 0x34, 0x35}, //VGA               CH1 : 0x73 > X > 0x36,  CH2: 0x74 > X > 0x36   ,CH3: 0x74 > X > 0x36
   {0x0C, 0x0E, 0x0F}, //SCART R,G,B    CH1: 0x44> X > 0x0F,  CH2: 0x44 > X > 0x0F,  CH3: 0x44 > X > 0x0F   
...
{ 
  {0x8B, 0xAA, 0xAB},  //YPbPr
  {0x70, 0x73, 0x74},  //VGA
  {0x43, 0x45, 0x46},  //SCART R,G,B
  {0xA0, 0x84, 0xA0}   // VGA_YPBPR
};

UINT8 code GAIN_LOW_LIMIT_120[4][3] =    
{ 
   {0x40, 0x59, 0x5A}, //YPbPr              CH1 : 0x85 > X > 0X48,  CH2: 0xA1 > X > 0X60 , CH3: 0xA1 > X > 0X60
   {0x31, 0x34, 0x35}, //VGA               CH1 : 0x73 > X > 0x36,  CH2: 0x74 > X > 0x36   ,CH3: 0x74 > X > 0x36
   {0x0C, 0x0E, 0x0F}, //SCART R,G,B    CH1: 0x44> X > 0x0F,  CH2: 0x44 > X > 0x0F,  CH3: 0x44 > X > 0x0F   
   {0x50, 0x38, 0x51}  // VGA_YPBPR
};

UINT8 code GAIN_HIGH_LIMIT_75_100[4][3]=    
{ 
  {0x3E, 0x49, 0x4A},  //YPbPr
  {0x70, 0x73, 0x74},  //VGA
  {0x43, 0x45, 0x46},  //SCART R,G,B
  {0x49, 0x40, 0x4A}   // VGA_YPBPR
};

UINT8 code GAIN_LOW_LIMIT_75_100[4][3] =    
{ 
   {0x10, 0x19, 0x1A}, //YPbPr             
   {0x31, 0x34, 0x35}, //VGA               
   {0x0C, 0x0E, 0x0F}, //SCART R,G,B   
   {0x0C, 0x06, 0x0C}  // VGA_YPBPR
};
/*
