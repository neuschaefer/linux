...
/// Template for supporting S/W SIF communication to specified slave device(s)
//static UINT8 _au1ArrayOfSlaveAddrUsingSW[1] = {0x14};
//#define SIF_CFG_SW_BUS_ID      (0)
//#define SIF_CFG_SW_SDA      (GPIO(17))
//#define SIF_CFG_SW_SCL      (GPIO(18))
//#define SIF_CFG_NUM_OF_SLAVE_USING_SW      (1)
//#define SIF_CFG_ARRAY_OF_SLAVE_ADDR_USING_SW      (_au1ArrayOfSlaveAddrUsingSW)
