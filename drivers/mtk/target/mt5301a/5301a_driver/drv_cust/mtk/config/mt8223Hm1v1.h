...
#endif
#define BACKLIGHT_GPIO                  (30)
#define BACKLIGHT_ON_VAL                (0)
#define PANELPOWER_GPIO                 (31)
...
#define SYSTEM_EEPROM_WP_GPIO               (11)
#define SYSTEM_EEPROM_WP_ENABLE_POLARITY    (1)
#define EDID_EEPROM_WP_GPIO                 (10)
#define EDID_EEPROM_WP_ENABLE_POLARITY      (0)

//----------------------------------------------------------------------------
// USB Customization
//----------------------------------------------------------------------------
#define USB0_VBUS_GPIO                      (219)
#define USB0_VBUS_GPIO_POLARITY             (1)

//#define USB0_OC_GPIO                        (OPCTRL(1))
...
#define HDMI_GPIO_CONF                      "mtk/mt8223hp1v1_hdmi_conf.c"
#endif

#define SIF_EDID1_SDA  (216)
#define SIF_EDID1_SCL  (215)
#if 1 // for 8223p1v1
#define SIF_EDID2_SDA  SIF_EDID1_SDA  //(212)
#define SIF_EDID2_SCL  SIF_EDID1_SCL  //(211)
#else
#define SIF_EDID2_SDA  (212)
#define SIF_EDID2_SCL  (211)
#endif
/*
 * default VGA table
*/
