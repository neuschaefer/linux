...
//#define PDWNC_INTNO_SIF      10			// SIF interrupt number
#define PDWNC_INTNO_CEC      11          // CEC interrupt number
#define PDWNC_INTNO_RTC      12          // RTC interrupt number
#define PDWNC_INTNO_IRRX     13          // IRRX interrupt number
#define PDWNC_INTNO_ARM_INT     14          // IRRX interrupt number
#define PDWNC_INTNO_AUX_INT     15          // IRRX interrupt number
...
#define PDWNC_INTNO_HDMI_OIRI 31          // OPWR2 interrupt number
...
#define TOTAL_PDWNC_GPIO_NUM    34
#else
#define TOTAL_PDWNC_GPIO_NUM    20//16
#endif
...
#define PDANC_PAD_SERVOADC_EN(x)  (1U << (x))    // SERVO ADC PAD output enable    
...
//#define REG_RO_PDWNC_INTST  0x0040      // PDWNC Interrupt Status Register
    ...
    #define PINTNO_SIF      8			// SIF interrupt number
    ...
    #define PINTNO_ARM	   14          // IRRX interrupt number
    ...
    #define IS_PINTNO_INTABLE_GPIO(x)     (((x <= PDWNC_INTNO_HDMI_SCL2) || (x >= /*PDWNC_INTNO_HDMI_HPD1*/PINTNO_SRVAD0)) ? 1 : 0) //
    #define _PINT(v)        (1U << (v))
...
#define    PDWNC_CMD_ARMT8032_SET_SONY_ERROR_CODE 0x14
#define    PDWNC_CMD_ARMT8032_SET_SONY_ERROR_CODE_BLINKING 0x15
...
#define    PDWNC_T8032_COPY_CEC_DATA_TO_DRAM	  0x5B
