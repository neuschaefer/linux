...
#define SRAM_ITCM_BASE              0x2affe000 //itcm=8k
#define SRAM_OSD_BASE               SRAM_ITCM_BASE + 0x2000 //osd=8k
#define SRAM_DMX_BASE               SRAM_OSD_BASE + 0x2000 //dmx=6k
#define SRAM_DMX_END                SRAM_DMX_BASE + 0x1800
#define SRAM_START                  SRAM_ITCM_BASE
...
#define MJC_BASE                    (IO_VIRT + 0x34000)     
