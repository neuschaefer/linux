...
#define GROUP3_FIRST_AGENT_ID           29
...
typedef enum
{
    ...
    MID_AGENT_PARSER = 17,
    MID_AGENT_GRAPH = 18,
    MID_AGENT_TCMLZHS = 19,
    MID_AGENT_8032RS232 = 20,
    MID_AGENT_TEST1 = 22,
    MID_AGENT_NONE = 30,        // None, for read-only region

    // Group 3
    MID_AGENT_TEST2 = GROUP3_FIRST_AGENT_ID,
...
#define MID_AGENT_MPEG1 MID_AGENT_NONE
#define MID_AGENT_DEMUX MID_AGENT_NONE
#define MID_AGENT_JPEG MID_AGENT_NONE
#define MID_AGENT_DDI MID_AGENT_NONE
