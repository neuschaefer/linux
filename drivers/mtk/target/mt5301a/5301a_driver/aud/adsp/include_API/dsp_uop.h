...
#define UOP_DSP_TTXACC_CONFIG                   (DSP_UOPIDA + (0x07 << 8))
#define UOP_DSP_DEMOD_CONFIG                    (DSP_UOPIDA + (0x08 << 8))
#define UOP_DSP_DETECTOR_CONFIG                 (DSP_UOPIDA + (0x09 << 8))
#define UOP_DSP_DETECTION_CONFIG                (DSP_UOPIDA + (0x0A << 8))
#define UOP_DSP_CANON_PLUS                      (DSP_UOPIDA + (0x0B << 8))
#define UOP_DSP_AM_MUTE_CONFIG                  (DSP_UOPIDA + (0x0C << 8))
#define UOP_DSP_A2_DETECTOR_THRES               (DSP_UOPIDA + (0x0D << 8))
#endif
...
#ifdef DSP_SUPPORT_NPTV
//NPTV Demodulation Related
#define UOP_DSP_TTXACC_CONFIG_DEC2              (DSP_UOPIDA + (0x17 << 8))
#define UOP_DSP_DEMOD_CONFIG_DEC2               (DSP_UOPIDA + (0x18 << 8))
#define UOP_DSP_DETECTOR_CONFIG_DEC2            (DSP_UOPIDA + (0x19 << 8))
#define UOP_DSP_DETECTION_CONFIG_DEC2           (DSP_UOPIDA + (0x1A << 8))
#define UOP_DSP_CANON_PLUS_DEC2                 (DSP_UOPIDA + (0x1B << 8))
#define UOP_DSP_AM_MUTE_CONFIG_DEC2             (DSP_UOPIDA + (0x1C << 8))
#define UOP_DSP_A2_DETECTOR_THRES_DEC2          (DSP_UOPIDA + (0x1D << 8))
#endif
...
#ifdef DSP_SUPPORT_NPTV
#define UOP_DSP_DEMOD_FINE_TUNE_VOLUME          (DSP_UOPIDB + (0x01 << 8))
#define UOP_DSP_DEMOD_FINE_TUNE_VOLUME_DEC2     (DSP_UOPIDB + (0x11 << 8))
#endif
