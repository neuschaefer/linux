...
#ifndef CODEC_AD82581_H
#define CODEC_AD82581_H
...
// I2C Address 
#define AD82581_DEV_ADDR				((UINT8)(0x35<<1))
...
#define REG_AD82581_03			(0x03)
    #define MASTER_VOLUME_8dB   (0x04 << 0)
    #define MASTER_VOLUME_n_25dB   (0x19 << 0)
...
extern void _AD82581_Init(void);
extern void _AD82581_Mute(BOOL fgMute);
extern AMP_T* _AMP_GetDigiAmpFunTbl(void);
