...
#ifndef ADAC_APOGEE_H
#define ADAC_APOGEE_H
...
//APOGEE ddxi 2051
#define APOGEE_DDXI2051_ADDR             0x34 
// APOGEE STA333BW
#ifndef CC_AUD_AMP_STA333BW_SA_1
#define APOGEE_STA333BW_ADDR             0x38 
#else 
#define APOGEE_STA333BW_ADDR             0x3a
#define APOGEE_STA333BW_ADDR_1           0x38  //use 3 amps for 5.1ch
#endif
...
#define REG_APOGEE_MASTER_VOL_CRL   0x07
   #define MASTER_VOL_0DB           (0x0)
   #define MASTER_VOL_NEG_38DB      (0x4c)
   #define MASTER_VOL_MUTE          (0xff)   
#define REG_APOGEE_CHL_1_VOL_CRL    0x08
#define REG_APOGEE_CHL_2_VOL_CRL    0x09
#define REG_APOGEE_CHL_3_VOL_CRL    0x0a
#define REG_APOGEE_AUTOMODE_REG2    0x0c
...
extern AMP_T* _AMP_GetAmpApogeeFunTbl(void);
