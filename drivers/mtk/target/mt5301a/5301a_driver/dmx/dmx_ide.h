...
EXTERN void _DMX_IDE_Enable(BOOL fgEnable);

EXTERN BOOL _DMX_IDE_IsEnabled(void);

EXTERN BOOL _DMX_IDE_Send(UINT32 u4Addr, UINT32 u4Size);

EXTERN BOOL _DMX_IDE_SendPacket(UINT8 u1Idx, UINT32 u4BufStart,
    UINT32 u4BufEnd, UINT32 u4Rp, UINT32 u4Wp);

EXTERN BOOL _DMX_IDE_Read(UINT32 u4Addr, UINT32 u4Size);
