...
#if (DEFAULT_DRAM_TYPE == SDR_x1)
#define CC_SUPPORT_SDR
#include "sdr.h"

// Use fixed DQS input delay or by boot up calibration at ddr_cal3.c
#define DRAM_MANUAL_DQS_MODE
#define MANUAL_DQS              0x00004040  // DQS3~0 : 0, 0, 64, 64.

#elif ((DEFAULT_DRAM_TYPE == DDR_I_x1) || (DEFAULT_DRAM_TYPE == DDR_I_x2))
#define CC_SUPPORT_DDR1
#include "ddr1.h"
...
#elif ((DEFAULT_DRAM_TYPE == DDR_II_x1) || (DEFAULT_DRAM_TYPE == DDR_II_x2))
...
#if defined(CC_NAND_BOOT) || defined(CC_ROM_BOOT) || (defined(CC_MTK_PRELOADER) && defined(NDEBUG))
...
EXTERN void _DDR_SetSdrBeforeAI(void);
EXTERN void _DDR_SetSdrAfterAI(void);
#endif

#ifdef CC_SUPPORT_DDR1
EXTERN void _DDR_SetDdr1BeforeAI(void);
EXTERN void _DDR_SetDdr1AfterAI(void);
#endif
...
EXTERN void _DDR_CheckColumnAddress(void);
