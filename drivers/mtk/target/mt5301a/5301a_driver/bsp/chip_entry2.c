...
{   
    ...
    if (!CHIP_IsRemap())
    {
        ...
        */
        ...
        // Do DQS calibration to get DQS window average value. always no single
        if (DDR_CalibrateDqs())
        {
            CHIP_DisplayString("DRAM Calibration fail !\n");
        ...
        // Only DDR2 need to check column address bits = 9 or 10.
        _DDR_CheckColumnAddress();        
#endif
