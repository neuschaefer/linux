...
// Following are MT5351 UART registers
#define REG_MT5351_SER_INT_EN               (*((volatile UINT16*)(SERIAL_BASE + 0x0c)))
#define REG_MT5351_SER_INT_STATUS           (*((volatile UINT16*)(SERIAL_BASE + 0x10)))
    #define INT_MT5351_SER00_INT            (UINT16)(0x1<<15)
    #define INT_MT5351_SER01_TX_EMPTY       (UINT16)(0x1<<3)
    #define INT_MT5351_SER01_RX_TOUT        (UINT16)(0x1<<2)
    #define INT_MT5351_SER01_RX_FULL        (UINT16)(0x1<<1)
    #define INT_MT5351_SER01_RX_ERR         (UINT16)(0x1<<0)
    #define INT_MT5351_SER01_RX_OVERFLOW    (UINT16)(0x1<<5)
    #define INT_MT5351_SER02_TX_EMPTY       (UINT16)(0x1<<11)
    #define INT_MT5351_SER02_RX_TOUT        (UINT16)(0x1<<10)
    #define INT_MT5351_SER02_RX_FULL        (UINT16)(0x1<<9)
    #define INT_MT5351_SER02_RX_ERR         (UINT16)(0x1<<8)
    #define INT_MT5351_SER02_RX_OVERFLOW    (UINT16)(0x1<<13)
    #define INT_MT5351_SER02_MODEM          (UINT16)(0x1<<12)

#define REG_MT5351_SER_STATUS               (*((volatile UINT8*)(SERIAL_BASE + 4)))

#define REG_MT5351_SER_PORT                 (*((volatile UINT8*)(SERIAL_BASE + 0)))
#define REG_MT5351_SER_MERGE_MODE           (*((volatile UINT32*)(SERIAL_BASE + 0x14)))
#define REG_MT5351_SER_CTR                  (*((volatile UINT32*)(SERIAL_BASE + 0x48)))

#define REG_MT5351_SER01_PORT               (*((volatile UINT8*)(SERIAL_BASE + 0xC0)))
#define REG_MT5351_SER01_STATUS             (*((volatile UINT32*)(SERIAL_BASE + 0xCC)))

#define REG_MT5351_SER01_CTR_REG            (*((volatile UINT32*)(SERIAL_BASE + 0xC8)))

#define REG_MT5351_SER02_PORT               (*((volatile UINT8*)(SERIAL_BASE + 0x100)))
#define REG_MT5351_SER02_STATUS             (*((volatile UINT32*)(SERIAL_BASE + 0x10C)))
#define REG_MT5351_SER02_CTR_REG            (*((volatile UINT32*)(SERIAL_BASE + 0x108)))

#define REG_MT5351_SER_OUT_SEL              (*((volatile UINT8*)(SERIAL_BASE + 0x3C)))
#define REG_MT5351_SER1_BUF_CTL             (*((volatile UINT32*)(SERIAL_BASE + 0xD0)))
...
static UINT8 _BspSerGetRxDataCnt()
{
    ...
    {
        u1RxCnt = (UINT8)(REG_MT5351_SER01_STATUS & SER_READ_ALLOW);
    }
