...
#define NR_MISC (IO_PREPROC_BASE+0xC7C)
    #define dbg_en Fld(1,29,AC_MSKB3)//[29:29]
    #define en_flagw_4f Fld(1,25,AC_MSKB3)//[29:29]
    #define en_flagr Fld(1,24,AC_MSKB3)//[29:29]
...
#define NR_2DNR66 (IO_PREPROC_BASE+0xf30)
    #define c_nearedge_edge_thr1 Fld(8,16,AC_FULLB2)//23:16
...
#define NR_2DNR97 (IO_PREPROC_BASE+0xF94)
    #define DEMOD_ECO_SEL_CONTROL Fld(2,30,AC_MSKB3)//[31:30]
    #define DEMOD_ECO_INI_EN Fld(1,29,AC_MSKB3)//[29]
    #define DEMOD_ECO_RST_B Fld(1,28,AC_MSKB3)//[28]
    #define RESERVED1111111 Fld(6,22,AC_MSKW32)//[27:22]
