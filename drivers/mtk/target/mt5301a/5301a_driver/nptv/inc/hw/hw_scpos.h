...
#define SCPIP_DS1_02 (IO_SCPIP_BASE+0x008)
    #define DS1_02_IMPORT_V_INV_1 Fld(1, 27, AC_MSKB3) //27
...
//    #define DS1_02_HSYNC_DELAY_EN1 Fld(1, 4, AC_MSKB0) //4
    ...
    #define DS1_02_MIRROR_422 Fld(2, 14, AC_MSKB1) //15:14        
    #define DS1_02_PT_RATIO_1 Fld(10, 4, AC_MSKW10) //13:4       
    #define DS1_02_C_FIELD_SEL_1 Fld(1, 3, AC_MSKB0) //3        
    #define DS1_02_C_FIELD_STATE_1 Fld(1, 2, AC_MSKB0) //2
...
#define SCPIP_DS1_05 (IO_SCPIP_BASE+0x014)        
    ...
    #define DS1_05_NONL_H_DS_NEG_1 Fld(1, 12, AC_MSKB1) //12
...
#define SCPIP_DS1_09 (IO_SCPIP_BASE+0x024)    	
    #define DS1_09_DS1_INHACT_DSCALER_H_1 Fld(12, 16, AC_MSKW32) //27:16    	
    #define DS1_09_DS1_INVACT_DSCALER_H_1 Fld(12, 0, AC_MSKW10) //11:0
...
#define SCPIP_PIP_OA_01 (IO_SCPIP_BASE+0x104)
    ...
    #define PIP_OA_01_AUTO_UP_ADJUST Fld(1, 30, AC_MSKB3) //30        
    #define PIP_OA_01_MAIN_DRAMCK_STOP Fld(1, 29, AC_MSKB3) //29
...
#define SCPIP_PIP_OA_08 (IO_SCPIP_BASE+0x120)
    ...
    #define PIP_OA_08_C_DISP_INI_OPT1 Fld(1, 26, AC_MSKB3) //26    
    #define PIP_OA_08_C_TIE_RCS1 Fld(1, 25, AC_MSKB3) //25
...
#define SCPIP_PIP_OA_0F (IO_SCPIP_BASE+0x13c)
    #define PIP_OA_0F_FTRACK_VSYNC_SEL Fld(1, 31, AC_MSKB3) //31
...
#define SCPIP_PIP1_03 (IO_SCPIP_BASE+0x18c)
    #define PIP1_03_IMPORT_DELAY_EN_1 Fld(1, 28, AC_MSKB3) //28        
...
#define SCPIP_PIP1_04 (IO_SCPIP_BASE+0x190)
    #define PIP1_04_REG_VTAP_SEL_DOMAIN_1 Fld(1, 31, AC_MSKB3) //31     
    #define PIP1_04_REG_VUS_BYPASS_SEL_1 Fld(1, 30, AC_MSKB3) //30
...
#define SCPIP_PIP1_05 (IO_SCPIP_BASE+0x194)
     #define PIP1_05_WSTARTP_OF1ST_1 Fld(5, 27, AC_MSKB3) //31:27       
     #define PIP1_05_REG_WEN_SEL_1 Fld(1, 26, AC_MSKB3) //26       
     #define PIP1_05_DRAM_BURST_MODE_1 Fld(1, 25, AC_MSKB3) //25       
     #define PIP1_05_WSTARTP_1 Fld(25, 0, AC_MSKDW) //24:0
#define SCPIP_PIP1_06 (IO_SCPIP_BASE+0x198)
    #define PIP1_06_WSTARTP_OF1ST_1 Fld(7, 25, AC_MSKB3) //31:25       
...
#define SCPIP_PIP1_0F (IO_SCPIP_BASE+0x1bc)
    ...
    #define PIP1_0F_UNINV_DRAM_1 Fld(1, 26, AC_MSKB3) //26    
    #define PIP1_0F_MIRROR_422_PIP Fld(2, 24, AC_MSKB3) //25:24
...
#define SCPIP_PIP1_RO_04 (IO_SCPIP_BASE+0x1d0)        
    #define PIP1_RO_04_FIFO_OVER_W_SEL Fld(1, 5, AC_MSKB0) //5    
    #define PIP1_RO_04_FIFO_OVER_R_SEL Fld(1, 4, AC_MSKB0) //4        
    #define PIP1_RO_04_FIFO_RSTW_1 Fld(1, 3, AC_MSKB0) //3       
    #define PIP1_RO_04_FIFO_RSTR_1 Fld(1, 2, AC_MSKB0) //2        
    #define PIP1_RO_04_FIFO_OVERW_1 Fld(1, 1, AC_MSKB0)//1     
    #define PIP1_RO_04_FIFO_OVERR_1 Fld(1, 0, AC_MSKB0) //0
#define SCPIP_PIP1_RO_05 (IO_SCPIP_BASE+0x1d4)        
    #define PIP1_RO_05_FSEL_DUMP_EN Fld(1, 31, AC_MSKB3) //31    
    #define PIP1_RO_05_FSEL_DUMP Fld(8, 16, AC_FULLB2) //23:16    
    #define PIP1_RO_05_SET_W_POS_EN_1 Fld(1, 15, AC_MSKB1) //15    
    #define PIP1_RO_05_SET_W_POS_1 Fld(8, 0, AC_FULLB0) //7:0
#define SCPIP_PIP1_RO_06 (IO_SCPIP_BASE+0x1d8)    
    #define PIP1_RO_06_W_EN_RD1 Fld(1, 31, AC_MSKB3) //31    
    #define PIP1_RO_06_W_ADDRESS_ST1 Fld(25, 0, AC_MSKDW) //24:0
    #define SCPIP_PIP1_RO_07 (IO_SCPIP_BASE+0x1dc)    
    #define PIP1_RO_07_R_EN_RD1 Fld(1, 31, AC_MSKB3) //31     
    #define PIP1_RO_07_R_ADDRESS_ST1 Fld(25, 0, AC_MSKDW) //24:0   
...
#define SCPIP_US1_01 (IO_SCPIP_BASE+0x284)
    ...
    #define US1_01_NONLINEAR_V_NEG_1 Fld(1, 19, AC_MSKB2) //19    
...
#define SCPIP_SC1_IN_CRC (IO_SCPIP_BASE+0x3d0)        
    #define SC1_IN_CRC_CRC_SEL_IN1 Fld(1, 31, AC_MSKB3) //31    
    #define SC1_IN_CRC_CRC_V_MASK_IN1 Fld(1, 5, AC_MSKB0) //5    
    #define SC1_IN_CRC_CRC_CLEAR_READY_IN1 Fld(1, 4, AC_MSKB0) //4        
    #define SC1_IN_CRC_ODD_LINE_EN_IN1 Fld(1, 3, AC_MSKB0) //3        
    #define SC1_IN_CRC_EVEN_LIEN_EN_IN1 Fld(1, 2, AC_MSKB0) //2        
    #define SC1_IN_CRC_BOT_EN_IN1 Fld(1, 1, AC_MSKB0) //1        
    #define SC1_IN_CRC_TOP_EN_IN1 Fld(1, 0, AC_MSKB0) //0
#define SCPIP_SC1_OUT_CRC (IO_SCPIP_BASE+0x3d4)        
    #define SC1_OUT_CRC_CRC_SEL_OUT1 Fld(1, 31, AC_MSKB3) //31    
    #define SC1_OUT_CRC_CRC_V_MASK_OUT1 Fld(1, 5, AC_MSKB0) //5   
    #define SC1_OUT_CRC_CRC_CLEAR_READY_OUT1 Fld(1, 4, AC_MSKB0) //4        
    #define SC1_OUT_CRC_ODD_LINE_EN_OUT1 Fld(1, 3, AC_MSKB0) //3        
    #define SC1_OUT_CRC_EVEN_LIEN_EN_OUT1 Fld(1, 2, AC_MSKB0) //2        
    #define SC1_OUT_CRC_BOT_EN_OUT1 Fld(1, 1, AC_MSKB0) //1        
    #define SC1_OUT_CRC_TOP_EN_OUT1 Fld(1, 0, AC_MSKB0) //0
#define SCPIP_SC1_CRC_STATUS (IO_SCPIP_BASE+0x3e0)        
    #define SC1_CRC_STATUS_CRC1_OUT_READY Fld(1, 5, AC_MSKB0) //5        
    #define SC1_CRC_STATUS_CRC1_OUT_V_READY Fld(1, 4, AC_MSKB0) //4        
    #define SC1_CRC_STATUS_CRC1_OUT_H_READY Fld(1, 3, AC_MSKB0) //3        
    #define SC1_CRC_STATUS_CRC1_IN_READY Fld(1, 2, AC_MSKB0) //2        
    #define SC1_CRC_STATUS_CRC1_IN_V_READY Fld(1, 1, AC_MSKB0) //1        
    #define SC1_CRC_STATUS_CRC1_IN_H_READY Fld(1, 0, AC_MSKB0) //0
#define SCPIP_SC1_IN_CRC_VALUE (IO_SCPIP_BASE+0x3e4)        
    #define SC1_IN_CRC_VALUE_CRC1_IN_VALUE Fld(32, 0, AC_FULLDW) //31:0    
#define SCPIP_SC1_OUT_CRC_VALUE (IO_SCPIP_BASE+0x3e8)        
    #define SC1_OUT_CRC_VALUE_CRC1_OUT_VALUE Fld(32, 0, AC_FULLDW) //31:0
...
#define OUTSTG_OS_08 (IO_OUTSTG_BASE+0x420)
    #define OS_08_reg_vsync_out_h Fld(12, 20, AC_MSKW32) //31:20
...
#define OUTSTG_OS_76 (IO_OUTSTG_BASE+0x5d8 )
    #define OS_76_OSD_HS_END Fld(2, 30, AC_MSKB3) //31:30
...
#define OUTSTG_OS_E3 (IO_OUTSTG_BASE+0x78c)
    ...
    #define OS_E3_SCPOS_H_SEL Fld(2, 28, AC_MSKB3) //29:28
...
#define OUTSTG_RO_83 (IO_OUTSTG_BASE+0x60c)
    ...
    #define RO_83_FIFO_OVERRUN Fld(1, 19, AC_MSKB2) //19
    #define RO_83_FIFO_UNDERRUN Fld(1, 18, AC_MSKB2) //18
    #define RO_83_FIFO_FULL Fld(1, 17, AC_MSKB2) //17
    #define RO_83_FIFO_EMPTY Fld(1, 16, AC_MSKB2) //16
    #define RO_83_FIFO_LEFT Fld(16, 0, AC_FULLW10) //15:0
