...
#define DVI_00 (IO_VIRT_DVI+(IO_DVI_BASE+0x7c0))
  ...
  #define DVI_00_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7c3))
    ...
    #define DVI_HS_SEL Fld(1, 25, AC_MSKB3) //25
		#define DVI_AV_START12_0 Fld(13, 12, AC_MSKDW) //24:12
...
//		#define DVI_DE_VHS_END Fld(1, 23, AC_MSKB2) //23//what?
		#define DVI_VDE_START11_0 Fld(12, 12, AC_MSKW21) //23:12
		//#define DVI_HDELEN_SEL Fld(1, 11, AC_MSKB1)//11
		#define DVI_VDE_WIDTH Fld(11, 0, AC_MSKW10) //11:0
...
#define DVI_03 (IO_VIRT_DVI+(IO_DVI_BASE+0x7cc))
  ...
  #define DVI_03_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7cf))
    ...
    #define SP1_DE Fld(1, 23, AC_MSKB2) //23
		#define CCH_VDE_WIDTH Fld(11, 12, AC_MSKW21)//22:12
		#define CCH_AV_WIDTH Fld(11, 0, AC_MSKW10)//10:0
...
//#define CCH_VHS_END Fld(1, 23, AC_MSKB2)//23    what?
...
#define DVI_HDS_00 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F4))
	#define DVI_HDS_00_0 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F4))
	#define DVI_HDS_00_1 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F5))
	#define DVI_HDS_00_2 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F6))
	#define DVI_HDS_00_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F7))
		#define HDS_MAIN_SCALER Fld(16, 16, AC_FULLW32)//31:16
		#define HDS_MAIN_OFST Fld(16, 0, AC_FULLW10)//15:0
#define DVI_HDS_01 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F8))
	#define DVI_HDS_01_0 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F8))
	#define DVI_HDS_01_1 (IO_VIRT_DVI+(IO_DVI_BASE+0x7F9))
	#define DVI_HDS_01_2 (IO_VIRT_DVI+(IO_DVI_BASE+0x7FA))
	#define DVI_HDS_01_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7FB))
		#define HDS_PIP_SCALER Fld(16, 16, AC_FULLW32)//31:16
		#define HDS_PIP_OFST Fld(16, 0, AC_FULLW10)//15:0

#define OMUX_00 (IO_VIRT_DVI+(IO_DVI_BASE+0x7fc))
  #define OMUX_00_0 (IO_VIRT_DVI+(IO_DVI_BASE+0x7fc))
  #define OMUX_00_1 (IO_VIRT_DVI+(IO_DVI_BASE+0x7fd))
  #define OMUX_00_2 (IO_VIRT_DVI+(IO_DVI_BASE+0x7fe))
  #define OMUX_00_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7ff))
...
#define DVI_HDTV_01 (IO_VIRT_DVI+(IO_DVI_BASE+0x204))
  ...
  #define DVI_HDTV_01_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x207))
		...
		#define STA_CCH_FLD_DET_VPOS Fld(1, 30, AC_MSKB3) //30
...
#define DVI_HDTV_04 (IO_VIRT_DVI+(IO_DVI_BASE+0x210))
	...
	#define DVI_HDTV_04_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x213))
		#define MAIN_MUTE Fld(1, 29, AC_MSKB3)//29
		#define HDMI_VOUT_MUTE Fld(1, 27, AC_MSKB3)//27
		#define STA_CCH_INT_DE Fld(1, 24, AC_MSKB3) //24
