...
#define PDWNC_CLKPDN (IO_VIRT+0x28000)
		#define FLD_LOCK Fld(1, 7, AC_MSKB0)//7
...
#define PDWNC_T8032_INTEN (IO_VIRT+0x2804C)
		...
		#define FLD_SIFM_INTEN Fld(1, 8, AC_MSKB1)//8
		#define FLD_EXTIO_INTEN Fld(8, 0, AC_FULLB0)//7:0
#define PDWNC_GPIOEN (IO_VIRT+0x28070)
		#define FLD_GPIO_EN Fld(20, 0, AC_MSKDW)//19:0
#define PDWNC_GPIOOUT (IO_VIRT+0x28074)
		#define FLD_GPIO_OUT Fld(20, 0, AC_MSKDW)//19:0
#define PDWNC_GPIOIN (IO_VIRT+0x28078)
...
#define PDWNC_EXTIO3INTCFG (IO_VIRT+0x280F8)
		#define FLD_EXINT3_2ED Fld(8, 16, AC_FULLB2)//23:16
		#define FLD_EXINT3_LEV Fld(8, 8, AC_FULLB1)//15:8
		#define FLD_EXINT3_POL Fld(8, 0, AC_FULLB0)//7:0
#define PDWNC_EXTIO4INTCFG (IO_VIRT+0x280FC)
		#define FLD_EXINT4_2ED Fld(8, 16, AC_FULLB2)//23:16
		#define FLD_EXINT4_LEV Fld(8, 8, AC_FULLB1)//15:8
		#define FLD_EXINT4_POL Fld(8, 0, AC_FULLB0)//7:0
...
#define VGACFG2 (IO_VIRT+0x280D8)
    ...
    #define FLD_RG_INPUT_CAP_6PF Fld(1, 12, AC_MSKB1) //12
    #define FLD_RG_PGA_ADC_LPF Fld(4, 8, AC_MSKB1) //11:8 
...
#define PDWNC_VRAM_CK (IO_VIRT+0x28140)
		#define FLD_SEL_SRAM_CK Fld(1, 2, AC_MSKB0) //2
...
#define PDWNC_ASYNC_RD (IO_VIRT+0x2874C)
		#define FLD_ASYNC_RD Fld(8, 0, AC_FULLB0)//7:0
...
// HDMI built-in EDID
#if 1
#define DDC_HDMI0_CNTL0 (IO_VIRT+0x28600)
	#define DDC_HDMI0_CNTL0_0 (IO_VIRT+0x28600)
	#define DDC_HDMI0_CNTL0_1 (IO_VIRT+0x28601)
	#define DDC_HDMI0_CNTL0_2 (IO_VIRT+0x28602)
	#define DDC_HDMI0_CNTL0_3 (IO_VIRT+0x28603)
		#define HDMI0_I2C_DEGLITCH		Fld(1, 19, AC_MSKB2)
		#define HDMI0_I2C_OUT_OPTION	Fld(1, 18, AC_MSKB2)
		#define HDMI0_DDCCI_OFF	Fld(1, 17, AC_MSKB2)
		#define HDMI0_EDID_OFF			Fld(1, 16, AC_MSKB2)		
		#define HDMI0_DDCCI_DEV_ADDR	Fld(7, 8, AC_MSKB1)
		#define HDMI0_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)

#define DDC_HDMI0_CNTL1 (IO_VIRT+0x28604)
		#define EDID_CHK_SUM			Fld(8, 16, AC_MSKB2)
		#define EDID_DEV_ADDR			Fld(8, 8, AC_MSKB1)
		#define EDID_PADR_OFST			Fld(8, 0, AC_MSKB0)	
		
#define DDC_HDMI1_CNTL0 (IO_VIRT+0x28608)
	#define DDC_HDMI1_CNTL0_0 (IO_VIRT+0x28608)
	#define DDC_HDMI1_CNTL0_1 (IO_VIRT+0x28609)
	#define DDC_HDMI1_CNTL0_2 (IO_VIRT+0x2860a)
	#define DDC_HDMI1_CNTL0_3 (IO_VIRT+0x2860b)
		#define HDMI1_I2C_DEGLITCH		Fld(1, 19, AC_MSKB2)
		#define HDMI1_I2C_OUT_OPTION	Fld(1, 18, AC_MSKB2)
		#define HDMI1_DDCCI_OFF	Fld(1, 17, AC_MSKB2)
		#define HDMI1_EDID_OFF			Fld(1, 16, AC_MSKB2)		
		#define HDMI1_DDCCI_DEV_ADDR	Fld(7, 8, AC_MSKB1)		
		#define HDMI1_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)

#define DDC_HDMI1_CNTL1 (IO_VIRT+0x2860c)
		#define EDID_CHK_SUM			Fld(8, 16, AC_MSKB2)
		#define EDID_DEV_ADDR			Fld(8, 8, AC_MSKB1)
		#define EDID_PADR_OFST			Fld(8, 0, AC_MSKB0)

			
#define DDC_HDMI2_CNTL0 (IO_VIRT+0x28610)
	#define DDC_HDMI2_CNTL0_0 (IO_VIRT+0x28610)
	#define DDC_HDMI2_CNTL0_1 (IO_VIRT+0x28611)
	#define DDC_HDMI2_CNTL0_2 (IO_VIRT+0x28612)
	#define DDC_HDMI2_CNTL0_3 (IO_VIRT+0x28613)
		#define HDMI2_I2C_DEGLITCH		Fld(1, 19, AC_MSKB2)
		#define HDMI2_I2C_OUT_OPTION	Fld(1, 18, AC_MSKB2)
		#define HDMI2_DDCCI_OFF	Fld(1, 17, AC_MSKB2)
		#define HDMI2_EDID_OFF			Fld(1, 16, AC_MSKB2)		
		#define HDMI2_DDCCI_DEV_ADDR	Fld(7, 8, AC_MSKB1)
		#define HDMI2_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)
		
#define DDC_HDMI2_CNTL1 (IO_VIRT+0x28614)
		#define EDID_CHK_SUM			Fld(8, 16, AC_MSKB2)
		#define EDID_DEV_ADDR			Fld(8, 8, AC_MSKB1)
		#define EDID_PADR_OFST			Fld(8, 0, AC_MSKB0)
		
#define DDC_VGA_CNTL0 (IO_VIRT+0x28618)
	#define DDC_VGA_CNTL0_0	(IO_VIRT+0x28618)
	#define DDC_VGA_CNTL0_1 (IO_VIRT+0x28619)
	#define DDC_VGA_CNTL0_2 (IO_VIRT+0x2861a)
	#define DDC_VGA_CNTL0_3 (IO_VIRT+0x2861b)
		#define VGA_I2C_DEGLITCH		Fld(1, 19, AC_MSKB2)
		#define VGA_I2C_OUT_OPTION		Fld(1, 18, AC_MSKB2)
		#define VGA_DDCCI_OFF	Fld(1, 17, AC_MSKB2)
		#define VGA_EDID_OFF			Fld(1, 16, AC_MSKB2)		
		#define VGA_DDCCI_DEV_ADDR		Fld(7, 8, AC_MSKB1)
		#define VGA_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)
		
#define DDC_MISC_CNTL0 (IO_VIRT+0x2861c)
		#define DLADR_AUTO_INC Fld(1, 26, AC_MSKB3)
	    #define CHANNEL_SEL	Fld(2, 24, AC_MSKB3)
		#define EDID_DL_MODE Fld(1, 23, AC_MSKB2)
		#define EDID_DL_ADDR Fld(7, 16, AC_MSKB2)
		
#define EDID_READBACK_DATA (IO_VIRT+0x28620)
#define EDID_DOWNLOAD_PORT (IO_VIRT+0x28650)
		#define EDID_DL_PORT Fld(32, 0, AC_FULLDW)
		
#define DDCCI_INTERRUPT (IO_VIRT+0x28624)


#define DDCCI_INTERRUPT_EN (IO_VIRT+0x28628)
#define DDCCI_INTERRUPT_CLR (IO_VIRT+0x2862c)

#define DDCCI_RDATA0 (IO_VIRT+0x28630)
#define DDCCI_RDATA1 (IO_VIRT+0x28634)
#define DDCCI_RDATA2 (IO_VIRT+0x28638)
#define DDCCI_RDATA3 (IO_VIRT+0x2863c)
#define DDCCI_WDATA0 (IO_VIRT+0x28640)
#define DDCCI_WDATA1 (IO_VIRT+0x28644)
#define DDCCI_WDATA2 (IO_VIRT+0x28648)
#define DDCCI_WDATA3 (IO_VIRT+0x2864c)

#define EDID_DOWNLOAD_PORT (IO_VIRT+0x28650)

#define I2C_PKT_LENGTH (IO_VIRT+0x28654)
#define I2C_PKT_LENGTH_0 (IO_VIRT+0x28654)
#define I2C_PKT_LENGTH_1 (IO_VIRT+0x28655)
#define I2C_PKT_LENGTH_2 (IO_VIRT+0x28656)
#define I2C_PKT_LENGTH_3 (IO_VIRT+0x28657)
...
#define DDC_HDMI0_CNTL0 (IO_VIRT+0x28600)
	...
	#define DDC_HDMI0_CNTL0_3 (IO_VIRT+0x28603)
		...
		#define HDMI0_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)
#define DDC_HDMI0_CNTL1 (IO_VIRT+0x28604)
	#define DDC_HDMI0_CNTL1_0 (IO_VIRT+0x28604)
	#define DDC_HDMI0_CNTL1_1 (IO_VIRT+0x28605)
	#define DDC_HDMI0_CNTL1_2 (IO_VIRT+0x28606)
	#define DDC_HDMI0_CNTL1_3 (IO_VIRT+0x28607)
...
#define DDC_HDMI1_CNTL0 (IO_VIRT+0x28608)
	...
	#define DDC_HDMI1_CNTL0_3 (IO_VIRT+0x2860b)
		...
		#define HDMI1_DDCCI_DEV_ADDR	Fld(7, 8, AC_MSKB1)		
		#define HDMI1_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)
#define DDC_HDMI1_CNTL1 (IO_VIRT+0x2860)
	#define DDC_HDMI1_CNTL1_0 (IO_VIRT+0x2860c)
	#define DDC_HDMI1_CNTL1_1 (IO_VIRT+0x2860d)
	#define DDC_HDMI1_CNTL1_2 (IO_VIRT+0x2860e)
	#define DDC_HDMI1_CNTL1_3 (IO_VIRT+0x2860f)
...
#define DDC_HDMI2_CNTL0 (IO_VIRT+0x28610)
	...
	#define DDC_HDMI2_CNTL0_3 (IO_VIRT+0x28613)
		...
		#define HDMI2_EDID_DEV_ADDR		Fld(7, 0, AC_MSKB0)
#define DDC_HDMI2_CNTL1 (IO_VIRT+0x28614)
	#define DDC_HDMI2_CNTL1_0 (IO_VIRT+0x28614)
	#define DDC_HDMI2_CNTL1_1 (IO_VIRT+0x28615)
	#define DDC_HDMI2_CNTL1_2 (IO_VIRT+0x28616)
	#define DDC_HDMI2_CNTL1_3 (IO_VIRT+0x28617)
...
#define EDID_DL_CTRL (IO_VIRT+0x2861c)
	#define EDID_DL_CTRL_3 (IO_VIRT+0x2861f)
	#define EDID_DL_CTRL_2 (IO_VIRT+0x2861e)
	    #define CHANNEL_SEL	Fld(2, 24, AC_MSKB3)
...
#define DDCCI_INTERRUPT (IO_VIRT+0x28624)
#if 0
	#define DDCCI_READ16_INT		0x8000
	#define DDCCI_READ8_INT		0x4000
	#define DDCCI_WRITE16_INT		0x2000
	#define DDCCI_WRITE8_INT		0x1000
	#define SIF3_R_INT				0x0800
	#define SIF3_W_INT				0x0400
	#define SIF3_FETCH_FAIL_INT	0x0200
	#define SIF2_R_INT				0x0100
	#define SIF2_W_INT				0x0080
	#define SIF2_FETCH_FAIL_INT	0x0040
	#define SIF1_R_INT				0x0020
	#define SIF1_W_INT				0x0010
	#define SIF1_FETCH_FAIL_INT	0x0008
	#define SIF0_R_INT				0x0004
	#define SIF0_W_INT				0x0002
	#define SIF0_FETCH_FAIL_INT	0x0001
#endif
