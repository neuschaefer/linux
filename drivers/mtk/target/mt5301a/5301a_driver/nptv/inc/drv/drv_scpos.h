...
#define SCALER_DRAM_BURST_MODE 0
...
#else
#define fgPIP444Mode() (FALSE)
#define fgPIPWriteOn() (FALSE)
#define vDrvPIPImportOnOff(bOnOff) 
#define vDrvPIPMute(bOnOff)
#define fgPIPMuteOn() (0)
#endif
