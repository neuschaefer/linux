...
#else
#define getPicInfo(bPath)   (&_rMPicInfo)
#define getDispInfo(bPath)   (&_rMDispInfo)
#define getDispPrm(bPath)   (&_rMDispPrm)
#define getChannel(bPath)  (&_rMChannel)
#endif
...
#if !SUPPORT_POP
#define getScalerMode(bPath) _arScalePrm[VDP_1].u4DispMode
#else
...
typedef struct
{
    ...
    VDP_NEW_NONLINEAR_PRM_T rNewNonlinearPrm;
...
typedef enum
{
    SCPIP_CLK_TYPE_PS_ROOT= 0,    
    SCPIP_CLK_TYPE_OCLK  = 0x1,    
    SCPIP_CLK_TYPE_VDOIN = 0x2,
...
EXTERN UINT32 _VDP_SetNewNonLinear(UINT32 u4InputWidth, UINT32 u4OutputWidth,UINT32 u4InputMidWidth,UINT32 u4OutputMidWidth);
//-----------------------------------------------------------------------------
