...
#define HDTV_BST_DET 0
#define internal_path_TPV 0 //just for TPV 5335 SC/R internal path ; need to check if it has to be removed
#define BYPASS_MIXER1_TO_SLICER 1  // 1: When Monitor SCART RGB Sync signal
...
#if 1//CLI_CVBS
extern void vDrvCVBSPGACheck(void);
extern void vDrvTargetBlankCheck(void);
extern void vDrvIOOffsetBlankCheck(void);
extern void vDrvPeakLimitCheck(UINT8 PYC);
extern void vDrvSVFTest(void);
#endif
...
extern void vPGA_RESISTOR_BUFFER_COM(UINT8 bType);
#endif
extern UINT8 _bPGAGainOffsetHistory[4];
extern UINT8 _bEFUSE_AUTOCOLOR_READY;//kal8225
