...
extern void vDrvTDCDemo(UINT8 bOnOff, UINT8 bRegion, UINT16 wXCenter);
...
extern void vScposNormProc(void) ;
...
extern void LboxSourceChange(UINT32 u4SrcWidth, UINT32 u4SrcHeight, UINT8 u1SrcInterlace);
...
extern void vDrvMainContrast(UINT16 u2Value) ;
extern void vDrvPipContrast(UINT16 u2Value) ;

extern void vDrvMainBrightness(UINT16 wValue) ;

extern void vDrvMainSaturation(UINT16 u2Value) ;
extern void vDrvPipSaturation(UINT16 u2Value) ;

extern void vDrvMainHue(UINT16 wValue) ;
...
extern void vDrvColorDemo(UINT8 bOnOff, UINT8 bRegion, UINT16 wXCenter);
//extern void vDrvHSharpDemo(UINT8 bOnOff, UINT8 bRegion, UINT16 wXCenter);//remove Hsharp for 8223 porting
extern void vDrv2DSharpDemo(UINT8 bOnOff, UINT8 bRegion, UINT16 wXCenter);
extern void vDrvECTIDemo(UINT8 bOnOff, UINT8 bRegion,  UINT16 wXCenter);
...
// drv_di.h
extern void vDrvDIChkImpl(UINT8 bPath) ;
extern void vDrvDIDemo(UINT8 bPath, UINT8 bOnOff, UINT8 bRegion, UINT16 wXCenter) ;
...
// drv_contrast.h
extern void vDrvAutoContrastInit(void) ;
extern void vDrvAutoContrastOn(UINT8 bPath) ;
extern void vDrvAutoContrastOff(UINT8 bPath) ;
extern void vDrvAutoContrast(void) ;
extern void vDrvDBLInit(void);
extern void vDrvBacklightCtrlInit(void);
// vdo_misc.h
...
//extern void vUtOptColorOn(UINT8 bOn, UINT8 bR, UINT8 bG, UINT8 bB) ;
//extern void vUtOptColor(UINT8 bColor1, UINT8 bColor2) ;
//mtk01140 20050602
extern void vUtFastSCE(UINT8 * pBuf) ;
...
// drv_nr.h
extern void vDrvNRSet2DNROnOff(UINT8 bOnOff);
extern void vDrvNRSet3DNROnOff(UINT8 bOnOff);
extern void vDrvNRDemo(UINT8 bOnOff, UINT8 bRegion, UINT16 wXCenter);
