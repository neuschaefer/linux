...
EXTERN BOOL ISDBT_Init(DEMOD_CTX_T * pDemod_CTX_T);
...
EXTERN BOOL ISDBT_GetBer(DEMOD_CTX_T * pDemod_CTX_T,BOOL fgBer);
#ifdef ENABLE_DEMOD_PRESET
EXTERN BOOL StoreTMCCData(DEMOD_CTX_T * pDemod_CTX_T);
EXTERN BOOL LoadTMCCData(DEMOD_CTX_T * pDemod_CTX_T);
EXTERN VOID vCleanTMCCData(DEMOD_CTX_T * pDemod_CTX_T);
EXTERN BOOL fgTMCCDataAval(DEMOD_CTX_T * pDemod_CTX_T);
EXTERN VOID vShowTMCCData(DEMOD_CTX_T * pDemod_CTX_T);
#endif
