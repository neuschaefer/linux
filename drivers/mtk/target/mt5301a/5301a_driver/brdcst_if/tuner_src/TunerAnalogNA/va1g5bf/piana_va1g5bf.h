 ...
 * $Author: dtvbm11 $
 * $Date: 2012/04/27 $
 * $RCSfile: piana_va1g5bf.h,v $
 * $Revision: #1 $
 *
 *---------------------------------------------------------------------------*/

/**
 * @file piana_va1g5bf.h
 *
 * Alps VA1G5BF Tuner Driver Declaration.
 *  
 **/

#ifndef _PIANA_VA1G5BF_H_
#define _PIANA_VA1G5BF_H_
...
#define VA1G5BF_ANA_INIT_FREQ   55000       // Khz
#define VA1G5BF_ANA_PIC_IF      45750       // Khz
#define VA1G5BF_ANA_FREQ_STEP   500         // 100hz
...
#define VA1G5BF_ANA_UNLOCK        0
#define VA1G5BF_ANA_LOCK          1

#define VA1G5BF_ANA_TUNER_VER     "ver1.0_VA1G5BF"
