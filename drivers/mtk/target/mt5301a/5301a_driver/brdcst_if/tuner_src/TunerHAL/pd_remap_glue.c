...
// Static variables
//-----------------------------------------------------------------------------
static REMAP_PD_CTX_T pPdCtxREMAP[2];
...
#if defined(PD_REMAP_TER_DIG) || defined(PD_REMAP_CAB_DIG) || defined(PD_REMAP_SAT_DIG)
	return  pPdCtxREMAP[1].e_conn_type;
#else
	return  pPdCtxREMAP[0].e_conn_type;
#endif
}
#else
static INT32   RemapGetTunerID(UINT16 TunerID,DRV_CONN_TYPE_T e_conn_type)
...
static INT32   RemapGetConnType(UINT16 TunerID,DRV_CONN_TYPE_T e_conn_type)
{
	...
	return pPdCtxREMAP[RemapGetTunerID(TunerID,e_conn_type)].e_conn_type;
}
#endif
...
static INT32 REMAP_TunerClose(PTD_SPECIFIC_CTX ptTDSpecificCtx)
{
    ...
    if(RemapGetTunerID(SKIP_ARG,SKIP_ARG)==0)
    {
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_TER_ANA,Close)) " fail\r\n");
			return i4Ret;
		}
	#endif
	...
	#ifdef PD_REMAP_CAB_ANA
		{
			...
			if(i4Ret != DRVAPI_TUNER_OK){
				Printf(MKSTR(PDNAME_CALL(PD_REMAP_CAB_ANA,Close))" fail\r\n");
				return i4Ret;
			}
		}
	#endif
	...
	#ifdef PD_REMAP_SAT_ANA
		{
			...
			if(i4Ret != DRVAPI_TUNER_OK){
				Printf(MKSTR(PDNAME_CALL(PD_REMAP_SAT_ANA,Close))" fail\r\n");
				return i4Ret;
			}
		}
	#endif
    ...
    {	
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_TER_DIG,Close))" fail\r\n");
			return i4Ret;
		}
	#endif
...
//			i4Ret = PDNAME_CALL(PD_REMAP_CAB_DIG,Close)(ptTDSpecificCtx);
			...
			if(i4Ret != DRVAPI_TUNER_OK){
				Printf(MKSTR(PDNAME_CALL(PD_REMAP_CAB_DIG,Close))" fail\r\n");
				return i4Ret;
			}
		}
	#endif
...
//			i4Ret = PDNAME_CALL(PD_REMAP_CAB_DIG,Close)(ptTDSpecificCtx);
			...
			if(i4Ret != DRVAPI_TUNER_OK){
				Printf(MKSTR(PDNAME_CALL(PD_REMAP_SAT_DIG,Close))" fail\r\n");
				return i4Ret;
			}
		}
	#endif
                            ...
                            SIZE_T z_conn_info_len, x_break_fct _BreakFct, void* pvArg)
{
	...
	if(pPdCtxREMAP[id].e_conn_type != e_conn_type)
	{
		...
		switch(RemapFctTbl(pPdCtxREMAP[id].e_conn_type))
		{
			...
			case 2:
					...
					break;
			default:
					Printf("unacceptable TunerClose e_conn_type=%d\r\n",e_conn_type);
					break;
		}
	}
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerAcq e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static INT16 REMAP_TunerGetSync(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetSync e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static VOID  REMAP_TunerDisc(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerDisc e_conn_type=%d\r\n",e_conn_type);
				break;
	}
//	return 0;
...
static void REMAP_TunerGetSignal(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type, SIGNAL *_pSignal)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetSignal e_conn_type=%d\r\n",e_conn_type);
				break;
	}
//	return 0;
}
...
static UINT8 REMAP_TunerGetSignalLevel(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetSignalLevel e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
}
...
static INT16 REMAP_TunerGetSignalLeveldBm(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetSignalLeveldBm e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static UINT16 REMAP_TunerGetSignalPER(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetSignalPER e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static UINT16 REMAP_TunerGetSignalSNR(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CONN_TYPE_T e_conn_type)
{
	...
	switch(RemapFctTbl(e_conn_type))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetSignalSNR e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
}
...
static void REMAP_TunerSetMpgFmt(PTD_SPECIFIC_CTX ptTDSpecificCtx, MPEG_FMT_T  *pt_mpeg_fmt)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerSetMpgFmt e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	//return 0;
}
...
static char *REMAP_TunerGetVer(PTD_SPECIFIC_CTX ptTDSpecificCtx)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetVer e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static INT32 REMAP_TunerNimTest(PTD_SPECIFIC_CTX ptTDSpecificCtx)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerNimTest e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
}
...
static void REMAP_TunerSetRegSetting(PTD_SPECIFIC_CTX ptTDSpecificCtx, UCHAR ucRegSet, UCHAR ucRegAddr, UCHAR ucRegValue)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerSetRegSetting e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	//return 0;
...
static void REMAP_TunerShowRegSetting(PTD_SPECIFIC_CTX ptTDSpecificCtx)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerShowRegSetting e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	//return 0;
...
static void REMAP_TunerTestI2C(PTD_SPECIFIC_CTX ptTDSpecificCtx)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerTestI2C e_conn_type=%d\r\n",e_conn_type);
				break;
	}
//	return 0;
...
static void REMAP_TunerCommand(PTD_SPECIFIC_CTX ptTDSpecificCtx, INT32 i4Argc, const CHAR** aszArgv)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerCommand e_conn_type=%d\r\n",e_conn_type);
				break;
	}
//	return 0;
}
...
static void REMAP_TunerDtdCommand(PTD_SPECIFIC_CTX ptTDSpecificCtx,INT32 i4Argc, const CHAR** aszArgv)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerDtdCommand e_conn_type=%d\r\n",e_conn_type);
				break;
	}
//	return 0;
...
static void REMAP_TunerDetachI2C(PTD_SPECIFIC_CTX ptTDSpecificCtx, BOOL bDetach)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerDetachI2C e_conn_type=%d\r\n",e_conn_type);
				break;
	}
//	return 0;
                                ...
                                VOID *pzAttribute, SIZE_T* pzAttributeLen)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetAttribute e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
}
                                        ...
                                        const VOID *pvAttribute, SIZE_T zAttributeLen)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerSetAttribute e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static INT32 REMAP_TunerSetDiagCmd(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CUSTOM_TUNER_SET_TYPE_T e_tuner_set_type, VOID* pv_set_info, SIZE_T z_size)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerSetDiagCmd e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
...
static INT32 REMAP_TunerGetDiagInfo(PTD_SPECIFIC_CTX ptTDSpecificCtx, DRV_CUSTOM_TUNER_GET_TYPE_T e_tuner_get_type, VOID* pv_get_info, SIZE_T* pz_size)
{
	...
	switch(RemapFctTbl(e_conn_type=RemapGetConnType(SKIP_ARG,SKIP_ARG)))
	{
		...
		case 2:
				...
				break;
		default:
				Printf("unacceptable TunerGetDiagCmd e_conn_type=%d\r\n",e_conn_type);
				break;
	}
	return 0;
}
...
// public functions
//-----------------------------------------------------------------------------
void PD_REMAP_Register_LTDIS_Fct(PTD_CTX ptTDCtx)
{
...
INT32 REMAP_TunerOpen(PTD_CTX ptTDCtx, TUNER_CONFIG_T * ptTunerCfgInfo, PTD_SPECIFIC_CTX* ptTDSpecificCtx)
{
    ...
    if(ptTunerCfgInfo->TunerID ==0)
    {
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_TER_ANA,Open))" fail\r\n");
			return i4Ret;
		}
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_CAB_ANA,Open))" fail\r\n");
			return i4Ret;
		}
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_SAT_ANA,Open))" fail\r\n");
			return i4Ret;
		}
    ...
    {	
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_TER_DIG,Open))" fail\r\n");
			return i4Ret;
		}
		...
		if(i4Ret != DRVAPI_TUNER_OK){
			Printf(MKSTR(PDNAME_CALL(PD_REMAP_CAB_DIG,Open))" fail\r\n");
			return i4Ret;
		}
		...
		pPdCtxREMAP[1].e_conn_type = TUNER_CONN_TYPE_CAB_DIG; //init conn_type to CAB_DIG
			...
			if(i4Ret != DRVAPI_TUNER_OK){
				Printf(MKSTR(PDNAME_CALL(PD_REMAP_SAT_DIG,Open))" fail\r\n");
				return i4Ret;
			}
	...
	if(!initialed)
	{
		Printf("REMAP_TunerOpen fail, please check defines of PD_REMAP_TER_DIG/ANA\n");
