...
#define SAMSUNG_DTVA50CVH_STR             "SAMSUNG_DTVA50CVH"
//-----------------------------------------------------------------------------
    ...
    )
{
    ...
    // init EQ script
  // pDTVA50CVHEqNormal[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQDTVA50CVHMN;
    //pDTVA50CVHEqWeak[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQDTVA50CVHMNWeak;
...
u1Mod=param->Modulation;
   ...
   mcSHOW_DBG_MSG(("SAMSUNG DTVA50CVH_TunerSetFreq %dKHz\n",param->Freq));
