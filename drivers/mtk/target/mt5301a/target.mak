...
ifeq "$(RVCT21)" "y"
CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -DINLINE=__inline --cpu ARM926EJ-S --gnu --signed_chars
else
CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -DINLINE=__inline --cpu ARM926EJ-S --gnu --signed_chars --no_unaligned_access
endif
...
TARGET_DRV_INC = -I. \
		 -I$(TARGET_ROOT)/5301a_driver/inc \
                 -I$(TARGET_ROOT)/5301a_driver/drv_inc \
                 -I$(TARGET_ROOT)/5301a_driver/private_inc \
                 -I$(TARGET_ROOT)/d_inc
endif
...
# Linker and options.
#
LD_FLAG   = --entry INT_Reset --scatter $(call path_cnvt,$(TARGET_ROOT)/5301a_driver/scatter.sc)
LD_OUTPUT = --Output
