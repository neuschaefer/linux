...
void u1LVDSClockSkew_Reset(void)
{
	...
	vIO32WriteFldAlign(REG_LVDS_TX_CFG6,0, RG_LVDSB_INSKEWTST_ODD_EN_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG7,0, RG_LVDSB_INSKEWTST_EVEN_EN_D11);
#ifdef CC_MT5396
	vIO32WriteFldAlign(REG_LVDS_TX_CFG15,0, RG_LVDSA_INSKEWTST_ODD_EN_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG16,0, RG_LVDSA_INSKEWTST_EVEN_EN_D11);
#endif

	vIO32WriteFldAlign(REG_LVDS_TX_CFG6,1, RG_LVDSB_INSKEWTST_ODD_EN_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG7,1, RG_LVDSB_INSKEWTST_EVEN_EN_D11);
#ifdef CC_MT5396
	vIO32WriteFldAlign(REG_LVDS_TX_CFG15,1, RG_LVDSA_INSKEWTST_ODD_EN_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG16,1, RG_LVDSA_INSKEWTST_EVEN_EN_D11);
#endif
...
void u1CheckLVDSClockSkew_Enable(UINT8 u1OnOff)
{
	if (u1OnOff)
	{
	vIO32WriteFldAlign(RGS_LVDS_TX_CFG0, 0,RG_LVDSB_EN);
	#ifdef CC_MT5396
	vIO32WriteFldAlign(REG_LVDS_TX_CFG0, 0xFFF,RG_LVDSB_EXT_EN_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG9, 0xFFF,RG_LVDSA_EXT_EN_D11);
	#else
...
{
	UINT8 u1ChA = 0,u1ChB = 0,u1ChC=0 , u1ChD= 0, u1ChABCD= 0;
	#ifdef CC_MT5396
	u1ChA = IO32ReadFldAlign(RGS_LVDS_TX_CFG0, RGS_LVDSB_ABIST_ODD_21EDG_D11);
	u1ChB = IO32ReadFldAlign(RGS_LVDS_TX_CFG0, RGS_LVDSB_ABIST_EVEN_21EDG_D11);
	
	u1ChC = IO32ReadFldAlign(RGS_LVDS_TX_CFG0, RGS_LVDSA_ABIST_ODD_21EDG_D11);
	u1ChD = IO32ReadFldAlign(RGS_LVDS_TX_CFG0, RGS_LVDSA_ABIST_EVEN_21EDG_D11);
	#else
	u1ChA = IO32ReadFldAlign(RGS_LVDS_TX_CFG0, RGS_ABIST_ODD_21EDG_D11);
	u1ChB = IO32ReadFldAlign(RGS_LVDS_TX_CFG0, RGS_ABIST_EVEN_21EDG_D11);
	#endif
	u1ChABCD = u1ChA | u1ChB | u1ChC | u1ChD;
	return (u1ChABCD);
}
#endif
