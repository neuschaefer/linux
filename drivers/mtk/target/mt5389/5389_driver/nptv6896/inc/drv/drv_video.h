...
extern void vDrvTDC95FrmeWork(UINT8 bOnOff);
extern void vDrvSetTDCGameMode(UINT8 bEnable);
...
//Caihua Add 20120327
extern void vDrvSetTdtvContrast(UINT8 bPath, UINT16 u2Value) ;
extern void vDrvSetTdtvBrightness(UINT8 bPath, UINT16 wValue) ;
extern void vDrvSetTdtvSaturation(UINT8 bPath, UINT16 u2Value) ;
extern void vDrvSetTdtvHue(UINT8 bPath, UINT16 wValue) ;
//end
