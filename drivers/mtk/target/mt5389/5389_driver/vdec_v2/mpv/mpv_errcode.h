...
#ifndef DO_PROF_LEV_CHECK
#define DO_PROF_LEV_CHECK
#endif
...
#ifdef  DO_PROF_LEV_CHECK
#define PROF_ID_RES         0x00000009
#define LEV_ID_RES          0x0000000a
#else
#define PROF_ID_RES         0x00000000
#define LEV_ID_RES          0x00000000
#endif
...
#define POINTER_NOT_AVAILABLE       0x00000401
#define GET_MM_FIRST_SEQ_HEADER     0x00000402

// 9000 is need to extract CC data
...
#define VDEC_ERR_SYSTEM     0x4 // h/w find a system start code in slice level picture
