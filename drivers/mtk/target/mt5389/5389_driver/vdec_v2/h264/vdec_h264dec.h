...
#ifndef VDEC_H264DEC_H
#define VDEC_H264DEC_H
...
void _VDEC_SetBsInfo(UINT8 u1Num, UINT32 u4RDPtrAddr, UINT32 WPtrAddr, UINT32 u4BsFifoStart, 
...
void _VDEC_RefPicListReordering(void);
