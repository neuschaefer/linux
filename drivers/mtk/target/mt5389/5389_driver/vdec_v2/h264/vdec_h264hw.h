...
#ifndef VDEC_H264HW_H
#define VDEC_H264HW_H
...
#define AVC_VLD_READ32(offset)            IO_READ32    (AVC_VLD_BASE,    (offset))
#define AVC_VLD_WRITE32(offset, value)        IO_WRITE32    (AVC_VLD_BASE,    (offset), (value))

#define AVC_MV_READ32(offset)                IO_READ32    (AVC_MV_BASE,    (offset))
#define AVC_MV_WRITE32(offset, value)        IO_WRITE32    (AVC_MV_BASE,    (offset), (value))
#else
#define VLD_READ32(offset)                _VDEC_IO_Read32(VLD_BASE, offset)
#define VLD_WRITE32(offset, value)        _VDEC_IO_Write32(VLD_BASE, offset, value)

#define VLD_TOP_READ32(offset)                _VDEC_IO_Read32(VLD_TOP_BASE, offset)
#define VLD_TOP_WRITE32(offset, value)        _VDEC_IO_Write32(VLD_TOP_BASE, offset, value)

#define MC_READ32(offset)                _VDEC_IO_Read32(MC_BASE, offset)
#define MC_WRITE32(offset, value)            _VDEC_IO_Write32(MC_BASE, offset, value)

#define AVC_VLD_READ32(offset)            _VDEC_IO_Read32(AVC_VLD_BASE, offset)
#define AVC_VLD_WRITE32(offset, value)    _VDEC_IO_Write32(AVC_VLD_BASE, offset, value)

#define AVC_MV_READ32(offset)            _VDEC_IO_Read32(AVC_MV_BASE, offset)
#define AVC_MV_WRITE32(offset, value)    _VDEC_IO_Write32(AVC_MV_BASE, offset, value)

//for mt5363
#define PP_READ32(offset)            _VDEC_IO_Read32(PP_BASE, offset)
#define PP_WRITE32(offset, value)    _VDEC_IO_Write32(PP_BASE, offset, value)

#define VDEC_MISC_READ32(offset)            _VDEC_IO_Read32(VDEC_MISC, offset)
#define VDEC_MISC_WRITE32(offset, value)    _VDEC_IO_Write32(VDEC_MISC, offset, value)
...
// *********************************************************************
#define RW_VLD_TOP_TOTAL_MBS_IN_PIC 0x6C    //[16:0]

#define RW_VLD_TOP_MDEC_TIMEOUT_INT_SWITCH 0x54
    #define MDEC_INT_SWITCH_EN 1
    #define MDEC_INT_SWITCH_OFF (0xFFFFFFFE)

#ifdef CC_ENABLE_TRACKING_MODE
#define RW_VLD_TOP_TRACKING_MODE 0x48
...
// *********************************************************************
// VDEC MISC Registers define
// *********************************************************************

#define RW_VDEC_MISC_INTERRUPT_CLR 0xA4
...
#define RW_VDEC_MISC_CLK_SELECT 0x84    
    #define CLK_FOR_H264 0x2

// *********************************************************************
// H.264 relate Registers define
// *********************************************************************
// KB's scaling list
...
#define RW_AVLD_CTRL    0x84
    ...
    #define AVC_DEC_ERROR_ONLY1MC_START    (0x0<<25)    // 0: if error reconcealment is enable
    #define AVC_DEC_ERROR_SKIP_PIC_END    (0x1<<26)
...
#endif
#define AVC_NOT_CHK_DATA_NSPEC  ((UINT32)(0x1) << 15)
#define RW_AVLD_SPS        0x88
#ifdef IS_POST_MT5368
#define RW_AVLD_PIC_SIZE    0x68
#define RW_AVLD_SHDR_1_2   0x8C
#else
...
#ifdef IS_POST_MT5368
#define RW_AVLD_PRED_ADDR    0x28
#define RW_AVLD_PRED_MODE    0x2C
#else
#define RW_AVLD_PRED_ADDR    0x244
#endif
    #define PRED_SRAM_USED        0
    #ifdef IS_POST_MT5368
    #define PRED_SRAM_BYPASS    1   // vld_top_reg(11, 0x2C)[0]
    #else
...
#define RW_AVLD_ERR_MASK        0x280
    #ifdef NON_SPEC_CTRL1_EN
    #define ERR_MASK    0x3fdfbeff    //disable bit21, ignore cbp error case, disable bit14, cabac_zero_word_err
    #else
    #define ERR_MASK    0x3fdffeff
    #endif
    #define ERR_MASK_MM 0xbfdfb2f7 //0xbfdfb3b7
    #define ERR_MASK_OBSV        0x7fdfffff
    #define FBUF_ERR_MASK        0//0x30000000	disable this mechanism
    #define ERR_REF_MASK          0//0x200//0x4210  //lg bitstream
    #define ERR_DISP_MASK        0x210
#define RO_AVLD_ERR_ACC        0x284
#ifdef IS_POST_MT5368
#define RO_AVLD_DEC_CYCLE        0x80
#else
...
#ifdef IS_POST_MT5368
#define RW_AVLD_MC_BUSY_THD    0x58     //[31:0]
    #define MC_BUSY_THD        0xffffffff
#else
...
#define RW_AVLD_EMU_PREV        0x2C8
    ...
    #define VIEW_REORDER_SWITCH 0x0 //bit 13
    #define MVC_SWITCH 0x4000
    #define PREFIX_NAL_TRAILING_32 0x8000  // 0 for 24 bit
    #define HDR_EXTENTION_SWITCH 0x10000
    #define REORDER_MVC_SWITCH 0x20000
    #define BYPASS_PREFIX_NALU 0x400000
    #endif
...
#define RW_AVLD_ANCHOR_L0 0x2F0   //~36C
#define RW_AVLD_ANCHOR_L1 0x370   //~3EC
#define RW_AVLD_ANCHOR_L0_NUM    0x3F0
#define RW_AVLD_ANCHOR_L1_NUM    0x3F4
#define RW_AVLD_ANCHOR_MISC  0x3F8
    #define MVC_LOAD_ANCHOR     (1<<16)
...
#define RW_AMV_MV_BUF_MODE 0x220
    #define SIZE_REDUCE 0x20
//-----------------------------------------------------------------------------
...
BOOL _VDEC_ResetVLD1(UINT32 u4RDPtrAddr, UINT32 u4WPtrAddr, UINT32 u4BsFifoStart, 
    UINT32 u4BsFifoEnd, UINT32 u4PredSA, UINT8 u1ECCMode, UINT32 u4ECType, BOOL fgIsMM);

BOOL _VDEC_ResetVLD2(UINT32 u4RDPtrAddr, UINT32 u4WPtrAddr, UINT32 u4BsFifoStart, UINT32 u4BsFifoEnd);
...
VOID _VDEC_EnableCRC(BOOL fgEn);
...
void _VDEC_SetSHDRAVLD1(UINT32 u4SHDRInfo, UINT32 u4FirstMBInSlice);
...
void _VDEC_SetVldWPtr(UINT32 u4WPtr, UINT32 u4VStart, UINT32 u4VEnd);

void _VDEC_SetPRefPicListReg(VDEC_REF_PIC_LIST_T rRefPicList, VDEC_FBUF_INFO_T* prFBufInfoPtr, 
