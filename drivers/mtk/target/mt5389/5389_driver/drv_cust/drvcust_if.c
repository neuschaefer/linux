...
INT32 DRVCUST_OptQuery(QUERY_TYPE_T eQryType, UINT32 *pu4Data)
{
    ...
    case eTunerTypeDefault:
        *pu4Data = (UINT32) DEFAULT_TUNER_TYPE_DEFAULT;
        return 0;
#ifdef DEFAULT_TUNER_TYPE_OFST0
    case eTunerTypeOfst0:
        *pu4Data = (UINT32) DEFAULT_TUNER_TYPE_OFST0;
        return 0;
#endif

#ifdef DEFAULT_TUNER_TYPE_OFST1
    case eTu#nerTypeOfst1:
        *pu4Data = (UINT32) DEFAULT_TUNER_TYPE_OFST1;
        return 0;
#endif

#ifdef DEFAULT_TUNER_TYPE_OFST2
	...
	case eWatchdogResetWaitTime:
		*pu4Data = WATCHDOG_RESET_WAITTIME;
        return 0;
    ...
    case eAudioDownmixWithBalance:
        *pu4Data = AUDIO_DOWNMIX_WITH_BALANCE;
        return 0;
        
    case eAudioPanFadeControl:
        *pu4Data = AUDIO_PANFADE_CONTROL;
        return 0;
    ...
    case eNANDFlashAppImageSize:
        *pu4Data = NAND_FLASH_APPIMAGE_SIZE;
        return 0;
    ...
    *pu4Data = (UINT32)SCART_PIN8_HI_THRES;
    ...
    case eNotifyVideoAutoDoneFunc:
       ...
       return 0;
		   ...
		   case eFlashHdcpKeyPartitionID:
			   *pu4Data = 0;//(UINT32)FLASH_HDCPKEY_PARTITION_ID;
			   return 0;
		   case eFlashHdmiEdidyPartitionID:
				*pu4Data = 0;//(UINT32)FLASH_HDMIEDID_PARTITION_ID;
			   return 0;
			case eFlashVgaEdidPartitionID:
			   *pu4Data = 0;//(UINT32)FLASH_VGAEDID_PARTITION_ID;
				return 0;
			case eFlashCIKeySetPartitionID:
			   *pu4Data = 0;//(UINT32)FLASH_CIKEYSET_PARTITION_ID;
				return 0;
#endif         
...
//sunman_lmt   DSP_SUPPORT_SRS_SSHD
    ...
    case eAudioSRSEnalbe:
      *pu4Data = (UINT32)EEP_AUDIO_SRS_ENABLE_OFFSET;
      return 0; 
      
    case eAudioMpeg4Enalbe:
      *pu4Data = (UINT32)EEP_AUDIO_MPEG4_ENABLE_OFFSET;
      return 0; 
