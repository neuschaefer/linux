 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5389P1V1_AUD_H
#define MT5389P1V1_AUD_H

#include "aud_if.h"

static const AUD_INPUT_SW_GPIO_T _armt5389p1v1InputSwGpio = 
{
    GPIO(1),                         
    GPIO(2),                         
    UNUSED_GPIO,
...
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    ...
    {AUD_INPUT_ID_S_VID_0,      1,	        0,          1,          SW_NO_USED, SW_NO_USED},  
    ...
    {AUD_INPUT_ID_YPBPR_0,      1,          0,          0,          SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_YPBPR_1,      1,          1,          0,          SW_NO_USED, SW_NO_USED},            
    {AUD_INPUT_ID_YPBPR_2,    	NO_USED, 	SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_VGA_0,        1,          1,          1,          SW_NO_USED, SW_NO_USED},    
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5389p1v1AudInputMuxTable = 
{
    (sizeof(_armt5389p1v1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5389p1v1AudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5389p1v1InterDacUsage = 
{
...
static const AUD_ADAC_USAGE_T _armt5389p1v1AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
...
static const AUD_DIGITAL_DATA_T _afgmt5389p1v1AudDigitalDataUsage =
{
    TRUE,			//MCLK,BCK,LRCK
    TRUE,			//AOSDATA0
    TRUE,			//AOSDATA1
...
static const AUD_AOUT_PAD_CFG_T _armt5389p1v1AoutPadTable =
{
