...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5389m3v1_aud.h"
#define AUDIO_Mute_Gpio_Num                 (OPCTRL(1)) //(GPIO(55))        
#define AUDIO_Amp_Gpio_Num                  (OPCTRL(2))
#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_AMP_GPIO_POLARITY             AUD_AMP_GPIO_LOW_ENALBE
#define AUDIO_HP_PLUG_IN_GPIO               (GPIO(218)) 
...
#define SIF_INCLUDE_FILE               "mtk/mt5389_sif_cfg.h"
#endif
...
//----------------------------------------------------------------------------
#define CI_8295_RESET_GPIO                  (GPIO(14))  
#define CI_8295_RESET_POLARITY              (1)
#define CI_EXTERNAL_IC_INT_GPIO             (GPIO(4))  // Set:Interrupt Mode, UnSet:Polling Mode
...
#define USB1_VBUS_GPIO                      OPCTRL(0)
...
// MTK IR only setting
//----------------------------------------------------------------------------
#define IR_INCLUDE_FILE                     "mtk/vestel_ir.h"

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE               "mtk/source_table_5389m3v1.c" 
#endif
...
#define PINMUX_INCLUDE_FILE                 "mtk/mt5389m3v1_pin_setup.h"
#endif
...
#define HDMI_GPIO_CONF                      "mtk/hdmi_conf_mt5389_m3v1.c"
#endif
...
#define TCON_CUST_FILE                      "mtk/mt5389m1v2_tcon_cust.c"
#endif
//----------------------------------------------------------------------------
...
#define DMX_INCLUDE_FILE               "mtk/mtk_dmx_eu.h"
#endif
...
#define NOR_FLASH_LOADER_SIZE       (0x30000)                        // loader               
#define NOR_FLASH_KERNEL_SIZE       (20*65536)                      // kernel
#define NOR_FLASH_RFS_SIZE          (16*1024*1024-35*65536)         // rootfs
#define NOR_FLASH_RO_SIZ            (0x40000)                       // ro partition
#define NOR_FLASH_RW_SIZ            (0x80000)	                    //rw partition
