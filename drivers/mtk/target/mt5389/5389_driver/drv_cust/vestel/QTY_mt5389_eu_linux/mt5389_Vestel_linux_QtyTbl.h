...
tagDFT_QTY aDefaultQtyTbl[QUALITY_MAX] =
{
    ...
    {0x00, 0x00, 0xA0,/*0x75,*/ FROM_DFT, QUALITY_BACKLIGHT_VIDEO_PWM_MIN},
    {0x00, 0x00, 0xDA,/*0xB5,*/ FROM_DFT, QUALITY_BACKLIGHT_VIDEO_PWM_MED},
...
{
    {SOURCE_TYPE_TIMING_RFTV_PAL,       SOURCE_TYPE_TIMING_SECAM_RFTV},             // [0] TUNER_PAL
    {SOURCE_TYPE_TIMING_RFTV_NTSC_358,  SOURCE_TYPE_TIMING_RFTV_NTSC_443},          // [1] TUNER_NTSC
    {SOURCE_TYPE_TIMING_CVBS_PAL,       SOURCE_TYPE_TIMING_CVBS_PAL_60_OS},         // [2] CVBS_PAL
    {SOURCE_TYPE_TIMING_CVBS_NTSC_358,  SOURCE_TYPE_TIMING_CVBS_NTSC_443_OS},       // [3] CVBS_NTSC
    {SOURCE_TYPE_TIMING_SCART_AV_PAL,   SOURCE_TYPE_TIMING_SCART_AV_SECAM},         // [4] SCART_CVBS_PAL
    {SOURCE_TYPE_TIMING_SCART_AV_NTSC_358,  SOURCE_TYPE_TIMING_SCART_AV_NTSC_443},  // [5] SCART_CVBS_NTSC
    {SOURCE_TYPE_TIMING_SCART_RGB,      SOURCE_TYPE_TIMING_SCART_RGB},              // [6] SCART_RGB (50/60?)
    {SOURCE_TYPE_TIMING_SV_PAL,         SOURCE_TYPE_TIMING_SCART_SV_SECAM},         // [7] SV&SCART_SV PAL
    {SOURCE_TYPE_TIMING_SV_NTSC_358,    SOURCE_TYPE_TIMING_SCART_SV_NTSC_443},      // [8] SV&SCART_SV NTSC
    {SOURCE_TYPE_TIMING_YPBPR_SD_I_50,  SOURCE_TYPE_TIMING_YPBPR_SD_P_60_OS},       // [9] YPBPR_SD
    {SOURCE_TYPE_TIMING_YPBPR_720P_24,  SOURCE_TYPE_TIMING_YPBPR_1080P_60},         // [10] YPBPR_HD
    {SOURCE_TYPE_TIMING_DIGI_SD_I_50,   SOURCE_TYPE_TIMING_3D_480p_60_FP},          // [11] HDMI_SD
    {SOURCE_TYPE_TIMING_DIGI_720P_24,   SOURCE_TYPE_TIMING_DIGI_1080P_60},          // [12] HDMI_HD
    {SOURCE_TYPE_TIMING_DTV_SD_I_50,    SOURCE_TYPE_TIMING_DTV_SD_P_60},            // [13] DTV_SD
    {SOURCE_TYPE_TIMING_DTV_720P_24,    SOURCE_TYPE_TIMING_DTV_1080P_60},           // [14] DTV_HD
    {SOURCE_TYPE_TIMING_MM_SD_I,        SOURCE_TYPE_TIMING_MM_1080IP_HD},           // [15] MM
    {SOURCE_TYPE_TIMING_PC_RGB,         SOURCE_TYPE_TIMING_PC_YCBCR},               // [16] PC
 ...
 */
UINT8 bCustomQtyTbl[FLASHPQ_NUM][17][CUSTOM_QTY_TBL_DIM] =
{
    {
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_RFTV_PAL,       SOURCE_TYPE_TIMING_SECAM_RFTV},             // [0] TUNER_PAL
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_RFTV_NTSC_358,  SOURCE_TYPE_TIMING_RFTV_NTSC_443},          // [1] TUNER_NTSC
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_CVBS_PAL,       SOURCE_TYPE_TIMING_CVBS_PAL_60_OS},         // [2] CVBS_PAL
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_CVBS_NTSC_358,  SOURCE_TYPE_TIMING_CVBS_NTSC_443_OS},       // [3] CVBS_NTSC
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_SCART_AV_PAL,   SOURCE_TYPE_TIMING_SCART_AV_SECAM},         // [4] SCART_CVBS_PAL
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_SCART_AV_NTSC_358,  SOURCE_TYPE_TIMING_SCART_AV_NTSC_443},  // [5] SCART_CVBS_NTSC
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_SCART_RGB,      SOURCE_TYPE_TIMING_SCART_RGB},              // [6] SCART_RGB (50/60?)
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_SV_PAL,         SOURCE_TYPE_TIMING_SCART_SV_SECAM},         // [7] SV&SCART_SV PAL
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_SV_NTSC_358,    SOURCE_TYPE_TIMING_SCART_SV_NTSC_443},      // [8] SV&SCART_SV NTSC
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_YPBPR_SD_I_50,  SOURCE_TYPE_TIMING_YPBPR_SD_P_60_OS},       // [9] YPBPR_SD
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_YPBPR_720P_24,  SOURCE_TYPE_TIMING_YPBPR_1080P_60},         // [10] YPBPR_HD
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_DIGI_SD_I_50,   SOURCE_TYPE_TIMING_3D_480p_60_FP},          // [11] HDMI_SD
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_DIGI_720P_24,   SOURCE_TYPE_TIMING_DIGI_1080P_60},          // [12] HDMI_HD
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_DTV_SD_I_50,    SOURCE_TYPE_TIMING_DTV_SD_P_60},            // [13] DTV_SD
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_DTV_720P_24,    SOURCE_TYPE_TIMING_DTV_1080P_60},           // [14] DTV_HD
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_MM_SD_I,        SOURCE_TYPE_TIMING_MM_1080IP_HD},           // [15] MM
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_PC_RGB,         SOURCE_TYPE_TIMING_PC_YCBCR},               // [16] PC
    },
    #if (FLASHPQ_NUM>=2)
    {
        #include "QTY_TBL_DEFAULT_PQF.h"    // {SOURCE_TYPE_TIMING_RFTV_PAL,       SOURCE_TYPE_TIMING_SECAM_RFTV},             // [0] TUNER_PAL
