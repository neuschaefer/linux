...
#if defined(CC_MTK_LOADER) && defined(CC_LOADER_SHRINK_PANEL_TABLE) // loader shrink
#ifdef PANEL_SELECT
#undef PANEL_SELECT
#define PANEL_SELECT PANEL_SS_40_FHD
#endif

#ifdef CC_MULTI_PANEL
#undef CC_MULTI_PANEL
#endif
#endif
...
#endif
#if ((PANEL_SELECT == PANEL_MLVDS_CHILINFHD60) || CC_MULTI_PANEL)
    {
    1920,           // u2PanelWidth
    1080,           // u2PanelHeight
...
#endif
#if ((PANEL_SELECT ==  PANEL_EPI_LGDV11GIPFHD60) || CC_MULTI_PANEL)
    {
    1920,           // u2PanelWidth
    1080,           // u2PanelHeight
...
CHAR* GetPanelName(UINT32 u4Index)
{
    ...
    case PANEL_MLVDS_CHILINFHD60: return "PANEL_MLVDS_CHILINFHD60";
    ...
    case PANEL_EPI_LGDV11GIPFHD60: return "PANEL_EPI_LGDV11GIPFHD60";
    case PANEL_AUO_T315HB01_V1: return "PANEL_AUO_T315HB01_V1_FHD60PR";
	...
	switch (u4Index)
	{
		case 0: return "PANEL_DEFAULT";
    	case 1: return "PANEL_LG_42_WU2";  // #25
    	case 2: return "PANEL_AUO_37_HW1"; // #10
    	case 3: return "PANEL_TEST_MODE_WXGA";  // TEST_MODE_WXGA_PNL
		default: return "NO NAME";
	}
#endif
