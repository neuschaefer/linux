...
{
   MAC_ADDRESS_T MAC_ADDR = DEFAULT_MAC_ADDRESS;
...
#ifdef CC_MT5389
    vIO32WriteFldAlign(CKGEN_ETH_MISC_CTRL, 0x0, FLD_ETH_AFE_PWD);
    x_thread_delay(50);
...
//    ClrBitMAC(MAC_MODE_CONFIG, BIG_ENDIAN);  //Little endian 2010/3/2
	...
	if(i4EthDrvGetMacAddr((MAC_ADDRESS_T *)MAC_ADDR) != NET_DRV_OK)
	{
	   	ERR_ETHER("Can not get MAC addr from EEP\n");
	}
