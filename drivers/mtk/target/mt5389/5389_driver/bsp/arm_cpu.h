...
#define REG_RW_REMAP        (BIM_BASE + 0x1C)
#define BIT_REMAP           1

#define SRAM_OSD_BASE	(0xfb000000)
#define SRAM_LZHS_BASE	(SRAM_OSD_BASE + 0x4000)
#define SRAM_DMX_BASE	(SRAM_LZHS_BASE + 0x1000)
#define SRAM_DMX_END    (SRAM_DMX_BASE + 0x7000)
#define SRAM_START      (SRAM_OSD_BASE)
#define SRAM_END        (SRAM_DMX_END)
#define SRAM_ITCM_BASE  (SRAM_LZHS_BASE)
...
#define CR_SUBPAGE_XP                (1 << 23)
#define CR_UNALIGNMENT_SUPPORT       (1 << 22)       //@ unalignment support
#define CR_VECTOR                    (1 << 13)       //@ Vector base
