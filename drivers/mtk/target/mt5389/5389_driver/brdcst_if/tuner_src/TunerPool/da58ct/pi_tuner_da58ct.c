...
#define TCL_DA58CT_STR             " DA58CT 2010-01-01\n 2011-04-06\n v1.0"

//PLL lock check parameters
#define TCL_DA58CT_PLL_POLL_INTERVAL      10 //ms
#define TCL_DA58CT_PLL_POLL_TIMETOUT      100 //ms typically 
#define TCL_DA58CT_PLL_POLL_CNT           TCL_DA58CT_PLL_POLL_TIMETOUT/TCL_DA58CT_PLL_POLL_INTERVAL //counter
//-----------------------------------------------------------------------------
...
/* LO settings */
 ...
 /* Write to tuner device */
	...
	for(ii=0;ii<TCL_DA58CT_PLL_POLL_CNT;ii++)
	{
	 mcDELAY_MS(TCL_DA58CT_PLL_POLL_INTERVAL);
	 if(DA58CT_TunerGetStatus(psTunerCtx))break;
	}
	
	if(ii<TCL_DA58CT_PLL_POLL_CNT)
	{
