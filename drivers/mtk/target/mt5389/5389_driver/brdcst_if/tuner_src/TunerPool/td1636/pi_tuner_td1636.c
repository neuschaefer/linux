...
#define NXP_TD1636_IF_FREQUENCY_ANA    ((UINT16) 45750)   /* KHz */
#define NXP_TD1636_LO_STEP         ((UINT16) 6250)  /* 10Hz */
#define NXP_TD1636_ANA_LO_STEP         ((UINT16) 6250)  /* 10Hz */
#define NXP_TD1636_STR             "NXP_TD1636 2010-01-01\n 2011-04-07\n v1.0"
//PLL lock check parameters
#define NXP_TD1636_PLL_POLL_INTERVAL      10 //ms
#define NXP_TD1636_PLL_POLL_TIMETOUT      50 //ms max time  according to tuner spec
#define NXP_TD1636_PLL_POLL_CNT           NXP_TD1636_PLL_POLL_TIMETOUT/NXP_TD1636_PLL_POLL_INTERVAL //counter
//-----------------------------------------------------------------------------
    ...
    )
{
    ...
    psTunerCtx->u2IF_Freq =NXP_TD1636_IF_FREQUENCY;
	 psTunerCtx->u2IF_Freq_A=NXP_TD1636_IF_FREQUENCY_ANA;
   // psTunerCtx->u2Ana_LO_Step = psTunerCtx->u2LO_Step;
	...
	pTd1636EqNormal[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQTD1636FMN;
...
/* LO settings */
 ...
 /* Write to tuner device */
	...
	for(ii=0;ii<NXP_TD1636_PLL_POLL_CNT;ii++)
	{
	 mcDELAY_MS(NXP_TD1636_PLL_POLL_INTERVAL);
	 if(TD1636_TunerGetStatus(psTunerCtx))break;
	}
	
	if(ii<NXP_TD1636_PLL_POLL_CNT)
	{
