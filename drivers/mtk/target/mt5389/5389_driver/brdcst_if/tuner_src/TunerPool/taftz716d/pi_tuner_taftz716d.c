...
#define C_TAFTZ716D_VERSION				"LG TAFTZ716D 2010-01-01\n 2011-04-07\n v1.0"
    ...
    )
{
    ...
    for (jj=0; jj<2; jj++)
    {
        ...
        if(ii < 20)
        {
            ...
            mcSHOW_DBG_MSG(("LO_%02X: (5) %02X-%02X-%02X-%02X-%02X (%dKHz)\n",pTunerCtx->I2cAddress, TunerS[0], TunerS[1], TunerS[2], TunerS[3],TunerS[4], pTunerCtx->u4RF_Freq));
            break;
        }
        else
        {
