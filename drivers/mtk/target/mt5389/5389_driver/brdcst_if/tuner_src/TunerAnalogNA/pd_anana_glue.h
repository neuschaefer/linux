...
/** @file pd_anana_glue.h
 *  Header file of analog NA pd gule layer.
 */

#ifndef PD_ANANA_GLUE_H
#define PD_ANANA_GLUE_H
...
//--------------
//#define cpANA_LOCK_STS_VIF      0 //move to pi_anana_if.h
//#define cpANA_LOCK_STS_TVD      1
 ...
 #endif
#else 
  #if defined(CC_MT5363)//MT5363 
   #if (fcTUNER_TYPE==cSHARP_VA1G5BF)
     #define AFT_AD_NUM                  4             // MT539x, and cSHARP_VA1G5BF use the Servo AD6 in Philips SPACE
   #else
     #define AFT_AD_NUM                  0             // MT539x, For the Servo AD0
   #endif
  #elif defined(CC_MT5387)//MT5387
   #define AFT_AD_NUM                 4         //MT5387  AFT use ServoAD 4
 #else // MT5360
...
/**
*      Use H-sync counter instead of H/V lock detection to judge TV channel available or not
*/
...
#define CHN_LOCK_VPRES          1
    ...
    //#if CONFIG_MT8202B  //fix zero used for undefined preprocessing identifier
    #ifdef CONFIG_MT8202B
