...
typedef void (*x_cec_drv_nfy_tx_result) (UINT8 result, void* txtag);
//#define CECNFY5VSTATUS 0
#ifdef CECNFY5VSTATUS
typedef void (*x_cec_drv_nfy_5v_status) (UINT8 bSwitch, BOOL fgIs5VOn);
#endif
...
// Export API
// *********************************************************************
EXTERN void CEC_SetRxCallback(x_cec_drv_nfy_data_arrival nfyinfo);
EXTERN void CEC_SetTxCallback(x_cec_drv_nfy_tx_result nfyinfo);

#ifdef CECNFY5VSTATUS
EXTERN void CEC_Set5VCallback(x_cec_drv_nfy_5v_status nfyfp);
#endif
