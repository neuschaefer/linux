...
EXTERN UINT32 VDP_SetMuteOnOff(UINT32 u4VdpId, UINT8 fgEnable); //Caihua 20120227
...
#endif
EXTERN UINT32 VDP_SetBacklightMode(UCHAR ucVdpId, UCHAR ucMode);
EXTERN UINT32 VDP_SetHDMITrueBlack(UINT32 u4VdpId, UINT8 u1OnOff);
