...
/*-------------------------------------------------------
; Bonding options
;	bit 0: support AC3      (if EAC3=1 or DDCO=1, always support EAC3)
;	bit 1: support EAC3     (EAC3)
;	bit 2: support DDCO     (EAC3 + HE-AAC + DDCO)
;	bit 3: support MS10     (EAC3 + HE-AAC + DDCO + DP)
...
#define   W_SRS_STUDIO_FLAG          ((DSP_SRS_DIAG_GRP * 32) + 0x1c)
#define   W_SRS_PURESOUND_FLAG          ((DSP_SRS_DIAG_GRP * 32) + 0x1c)
