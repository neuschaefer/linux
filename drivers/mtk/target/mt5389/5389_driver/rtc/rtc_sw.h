 ...
 *
 * Description:
 *         Header file of hardware independent interface of RTC driver.
 *---------------------------------------------------------------------------*/
...
// UTC bounds
#define UTC_LOWER_BOUND                 (946684800)   // Jan  1 00:00:00, 2000
//#define UTC_UPPER_BOUND                 2147483640  // Jan 19 11:14:00, 2038
#define UTC_INIT_TIME                 946742400
 ...
 */
//----------------------------------------------------------------------------
EXTERN UINT8 _RTC_BcdToBinary(UINT8 u1Bcd);
 ...
 */
//----------------------------------------------------------------------------
EXTERN UINT8 _RTC_BinaryToBcd(UINT8 u1Binary);
 ...
 */
//----------------------------------------------------------------------------
EXTERN BOOL _RTC_RtcToUtc(UINT64* pu8Utc, const RTC_T* prRtc);
 ...
 */
//----------------------------------------------------------------------------
EXTERN BOOL _RTC_UtcToRtc(RTC_T* prRtc, UINT64 u8Utc);
#endif
#endif
