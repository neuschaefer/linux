 ...
 */
//-----------------------------------------------------------------------------
BOOL DMX_RegSourceStateCbForVdec(UINT8 u1Channel, PFN_DMX_SORUCE_STATE_CB_FOR_VDEC pfnStateCb)
{
    return _DMX_RegSourceStateCbForVdec(u1Channel, pfnStateCb);
}
...
BOOL DMX_SetDvbKey(UINT8 u1KeyIndex, BOOL fgEven,const UINT32 au4Key[2])
{
   return _DMX_SetDvbKey(u1KeyIndex, fgEven,au4Key);
}
void DMX_SetDvbIVEx(UINT32 u4IvHi, UINT32 u4IvLo, BOOL fgEven)
{
   _DMX_SetDvbIVEx(u4IvHi,u4IvLo,fgEven);
}
