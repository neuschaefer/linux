...
extern "C" {
	...
	/// The default value in the Availnk device is \a AVL_DVBSx_MPCP_Rising
	...
	enum AVL_DVBSx_MpegPulldown
	{
		...
		AVL_DVBSx_MPPD_Enable = 1		///< = 1 The internal MPEG interface pull-down reistors are enabled.
	};
	...
	/// 
	/// Defines the blind scan spectrum inversion setting. 
	enum AVL_DVBSx_BlindscanSpectrum
	{
		AVL_DVBSx_BS_NORMAL = 0,		///< = 0 The received signal spectrum is not inverted.
		AVL_DVBSx_BS_INVERT = 1			///< = 1 The received signal spectrum is inverted.
	};
	...
	struct AVL_DVBSx_PllConf
	{
		...
		AVL_uint16 m_FecFrequency_10kHz;		///< FEC clock frequency in untis of 10 kHz
