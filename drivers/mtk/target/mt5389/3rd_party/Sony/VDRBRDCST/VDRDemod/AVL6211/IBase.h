...
extern "C" {
	...
	#define AVL_DVBSx_API_VER_BUILD	0x02
	...
	/// @remarks This function is an internal SDK function. Availink recommends that users refrain from directly calling this function. 
	AVL_DVBSx_ErrorCode AVL_DVBSx_DownloadFirmware(AVL_puchar pFirmwareData,  const struct AVL_DVBSx_Chip * pAVLChip);
	...
	/// 
	/// @return ::AVL_DVBSx_ErrorCode, 
	/// Return ::AVL_DVBSx_EC_OK if the firwmare and configuration information has been successfully downloaded to the Availink device.
	/// Return ::AVL_DVBSx_EC_I2CFail if there is an I2C communication problem.
	...
	/// Return ::AVL_DVBSx_EC_I2CFail if there is an I2C communication problem.
	/// @remarks This function is an internal SDK function. Availink recommends that users refraing from directly calling this function.
