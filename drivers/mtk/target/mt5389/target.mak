...
export ASM = ${ARM_BIN}armasm
export CC = ${ARM_BIN}armcc
export LD = ${ARM_BIN}armlink
export AR = ${ARM_BIN}armar
export FROMELF = ${ARM_BIN}fromelf
...
ifeq "$(CA9)" "y"
CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -g -DINLINE=__inline --cpu Cortex-A9.no_neon.no_vfp --gnu --signed_chars --no_unaligned_access
else
ifeq "$(RVCT21)" "y"
CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -DINLINE=__inline --cpu ARM1176JZF-S --gnu --signed_chars
else
CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -DINLINE=__inline --cpu ARM1176JZF-S --gnu --signed_chars --no_unaligned_access
#CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -DINLINE=__inline --cpu ARM1176JZ-S --gnu --signed_chars --no_unaligned_access
endif
endif

#CC_FLAG += --diag_warning 193
...
ifeq "$(CA9)" "y"
ASM_FLAG := -g --cpu=Cortex-A9.no_neon.no_vfp
else
ASM_FLAG := -G --cpu=ARM1176JZF-S --diag_suppress 1786
#ASM_FLAG := -G --diag_suppress 1786
endif
...
# Linker and options.
#
LD_FLAG   = --entry INT_Reset --scatter $(call path_cnvt,$(TARGET_ROOT)/5389_driver/scatter.sc)
LD_OUTPUT = --Output
LD_MAP    =  --symdefs $(BIN_DIR)/$(EXE_NAME).map --xref --map --info unused,sizes,totals --list
