...
#include "cb_low.h"
#define x_dbg_stmt
extern INT32 _CB_PutEvent_Adpt( CB_FCT_ID_T, INT32, void *);
#endif
...
#ifdef LINUX_TURNKEY_SOLUTION
AVC_NFY_PARAM avc_param;

VOID avc_nfy_fct(VOID*              pv_nfy_tag,
                 AVC_COND_T         e_nfy_cond,
                 UINT32             ui4_data_1,
                 UINT32             ui4_data_2)
{
    avc_param.pv_nfy_tag = pv_nfy_tag;
    avc_param.e_nfy_cond = e_nfy_cond;
    avc_param.ui4_data_1 = ui4_data_1;
    avc_param.ui4_data_2 = ui4_data_2;
    _CB_PutEvent_Adpt(CB_DRV_AVC_NFY, sizeof(AVC_NFY_PARAM), &avc_param);
}
#endif
...
#else
            avc_param.pf_nfy = at_combi_nfy_info[ui2_combi_id].pf_avc_nfy;
            avc_nfy_fct(
                at_combi_nfy_info[ui2_combi_id].pv_tag,
                AVC_COND_COMBI_SIGNAL_STATUS,
                ui4_sig_status,
