...
#define NAND_FLASH_TOTAL_SIZE               (64*1024*1024)      /*  64 MB */
...
#define NAND_FLASH_APPIMAGE_SIZE            (12*1024*1024)      /*  12 MB */
...
#define NAND_FLASH_FS_SIZE                  (20*1024*1024)      /*  20 MB */ 
#define NAND_FLASH_CIPLUS_SIZE              (128*1024)          /* 128 KB */
#define NAND_FLASH_NTFS_SIZE                (256*1024)          /* 192 KB */
#define NAND_FLASH_EDID_SIZE                (128*1024)          /* 128 KB */
#define NAND_FLASH_SERVICE_MODE_SIZE        (128*1024)          /* 128 KB */
...
#define NAND_PART_SIZE_15       (NAND_FLASH_SERVICE_MODE_SIZE)          /* Service Mode */
...
#define NAND_PART_NAME_14               "data/edid.bin"
