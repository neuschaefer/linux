...
#ifndef _FRAMETRACK_DRVIF_H_
#define _FRAMETRACK_DRVIF_H_
...
#define SCPIP_FRAME_TRACK_MJC_LOCK_RANGE    60
...
#define FRAME_TRACK_MODE_DDDS_BY_MJC      (1 << 0)
#define FRAME_TRACK_MODE_DDDS_BY_SCALER   (1 << 1)
#define FRAME_TRACK_MODE_VTOTAL_BY_MJC    (1 << 2)
#define FRAME_TRACK_MODE_VTOTAL_BY_SCALER (1 << 3)
#define FRAME_TRACK_MODE_SW_DDDS          (1 << 4)
#define FRAME_TRACK_MODE_CLI_DEBUG        (1 << 16)

#define DDDS_FT_OFF (0)
#define DDDS_FT_FROM_SCALER (1)
#define DDDS_FT_FROM_MJC (2)

//Frame Track functions for input/output V sync alignment
EXTERN void vDrvFrameTrackProc(void);
EXTERN UINT32 u4GetFrameTrackMode(void);
EXTERN void vFrameTrackConfig(UINT32 u4Step);
EXTERN void vScpipSwitchFrameTrackOnOff(UINT32 u4FscOnOff, UINT32 u4PscOnOff);
EXTERN UINT32 u4GetFrameTrackOnOff(void);
BOOL fgFrameTrackIsFlgSet(UINT32 u4Flag);

EXTERN E_FRAME_TRACK_STAUS eScpipGetFrameTrackStatus(void);
EXTERN void vScpipFrameTrackStep(UINT8 bStep);


#endif //#ifndef _FRAMETRACK_DRVIF_H_
