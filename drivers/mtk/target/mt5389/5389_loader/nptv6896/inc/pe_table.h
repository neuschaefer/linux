...
enum
{
    ...
    QUALITY_OSD_MAPPING_3D_CONTRAST,//3D
    QUALITY_OSD_MAPPING_CONTRAST_MSB,
    QUALITY_OSD_MAPPING_3D_CONTRAST_MSB,//3D
    QUALITY_OSD_MAPPING_BRIGHTNESS,
    QUALITY_OSD_MAPPING_3D_BRIGHTNESS,//3D
    QUALITY_OSD_MAPPING_SATURATION,
    QUALITY_OSD_MAPPING_3D_SATURATION,//3D
    QUALITY_OSD_MAPPING_SATURATION_MSB,
    QUALITY_OSD_MAPPING_3D_SATURATION_MSB,//3D
    QUALITY_OSD_MAPPING_HUE,
    QUALITY_OSD_MAPPING_3D_HUE,//3D
    ...
    QUALITY_OSD_MAPPING_SHARPNESS, //(SHARPNESS global gain)OSD_mapping for vestel ---pingan
    QUALITY_OSD_MAPPING_3D_SHARPNESS, //(SHARPNESS global gain)OSD_mapping for vestel ---pingan
    ...
    QUALITY_SHARP_3D_LI_H,
    QUALITY_SHARP_3D_LI_V,
    QUALITY_SHARP_3D_CB_H,
    QUALITY_SHARP_3D_CB_V,
    QUALITY_SHARP_3D_DA_H,
    QUALITY_SHARP_3D_DA_V,
    ...
    //QUALITY_AL2_AL_VERSION,       //todo: remove, pingan
    //QUALITY_AL2_HISTOGRAM_MODE,   //todo: remove, pingan
    QUALITY_AL_AL_VERSION,        //for vestel, pingan
    QUALITY_AL_HISTOGRAM_MODE,    //for vestel, pingan
    ...
    QUALITY_OSD_MAPPING_3D_R_GAIN,//3D
    QUALITY_OSD_MAPPING_G_GAIN,
    QUALITY_OSD_MAPPING_3D_G_GAIN,//3D
    QUALITY_OSD_MAPPING_B_GAIN,
    QUALITY_OSD_MAPPING_3D_B_GAIN,//3D
    QUALITY_OSD_MAPPING_R_GAIN_MSB,
    QUALITY_OSD_MAPPING_3D_R_GAIN_MSB,//3D
    QUALITY_OSD_MAPPING_G_GAIN_MSB,
    QUALITY_OSD_MAPPING_3D_G_GAIN_MSB,//3D
    QUALITY_OSD_MAPPING_B_GAIN_MSB,
    QUALITY_OSD_MAPPING_3D_B_GAIN_MSB,//3D
    ...
    QUALITY_COLOR_3D_SKIN_L,//3D
    QUALITY_COLOR_3D_SKIN_S,//3D
    QUALITY_COLOR_3D_SKIN_H,//3D
    QUALITY_COLOR_SCE_L,
    QUALITY_COLOR_SCE_S,
    QUALITY_COLOR_SCE_H,
...
#define QUALITY_SHARP_BEGIN                 QUALITY_TDSHARP_COR_ZERO_H1 //QUALITY_HSHARP_LOW
#define QUALITY_SHARP_END                   QUALITY_TDSHARPALL_BNR_SHP_LEVEL
...
#define QUALITY_LTI_END                     QUALITY_LTI_CLIP_NEG_LTI_V

#define QUALITY_CTI_BEGIN                   QUALITY_CTIR_ENA //QUALITY_CTIF_ENA
...
#define QUALITY_SNR_END                     QUALITY_2DNR_NX_SNR_DEAD_ZONE_TRANSITION
...
#define QUALITY_AL_END                      QUALITY_AL_BWS_WT_OFST_TH_H //QUALITY_AL_MID_DC_GAIN //QUALITY_AL2_MID_DC_GAIN

#define QUALITY_AL_BS_BEGIN                 QUALITY_AL_BWS_BLACK_ON_1_OFF_0
#define QUALITY_AL_BS_END                   QUALITY_AL_BWS_BK_OFST_TH_H //QUALITY_AL2_BWS_BK_OFST_TH_H

#define QUALITY_AL_WS_BEGIN                 QUALITY_AL_BWS_WHITE_ON_1_OFF_0
#define QUALITY_AL_WS_END                   QUALITY_AL_BWS_WT_OFST_TH_H //QUALITY_AL2_BWS_WT_OFST_TH_H
...
#define QUALITY_SCE_END                     QUALITY_SKIN_HSLOPE

#define QUALITY_SKIN_BEGIN                  QUALITY_COLOR_SKIN_L //QUALITY_SKIN_LUMA_GAIN
#define QUALITY_SKIN_END                    QUALITY_COLOR_SKIN_H //QUALITY_SKIN_HUE_GAIN


//Begin Add for Vestel ---pingan 0606
#define QUALITY_DI_FILM_BEGIN                 QUALITY_DI_FILM_FR_MO_FILTER_L
#define QUALITY_DI_FILM_END                   QUALITY_DI_FILM_SUBTITLE_RATE

#define QUALITY_TVD_COMB_BEGIN                QUALITY_DECODER_AGC2_MODE
#define QUALITY_TVD_COMB_END                  QUALITY_COMB_CB_3D_FW_2D_COST// QUALITY_COMB_D2GAIN_Y
//Caihua Add 20110831
#define QUALITY_ADAP_BKLT_BEGIN             QUALITY_BACKLIGHT_VIDEO_PWM_MIN
#define QUALITY_ADAP_BKLT_END               QUALITY_BACKLIGHT_ECO_SWITCH_LO_LIMIT
//Caihua Add 20110901
#define QUALITY_UI_DEFAULT_BEGIN            QUALITY_OSD_MAPPING_CONTRASTDFT
#define QUALITY_UI_DEFAULT_END              QUALITY_OSD_MAPPING_3D_BLUEGAINDFT//QUALITY_OSD_MAPPING_BLUEGAINDFT //Caihua 20120410
//Caihua Add 20110916
#define QUALITY_SIXCOLOR_BEGIN                 QUALITY_COLOR_COLOR_Y_R
#define QUALITY_SIXCOLOR_END                   QUALITY_COLOR_COLOR_H_M

//Caihua Add 20120325
#define QUALITY_SIXCOLOR_TDTV_BEGIN    QUALITY_COLOR_3D_COLOR_Y_R
#define QUALITY_SIXCOLOR_TDTV_END       QUALITY_COLOR_3D_COLOR_H_M

#define QUALITY_SCE_TDTV_BEGIN                     QUALITY_COLOR_3D_SCE_L
#define QUALITY_SCE_TDTV_END                       QUALITY_COLOR_3D_SCE_H

#define QUALITY_SKIN_TDTV_BEGIN                     QUALITY_COLOR_3D_SKIN_L
#define QUALITY_SKIN_TDTV_END                       QUALITY_COLOR_3D_SKIN_H//QUALITY_COLOR_SKIN_H //Caihua 20120410
...
typedef enum
{
    ...
    // Begin for Vestel --- pingan 0606
    PE_ARG_TVD_COMB,
    PE_ARG_PIC_UI_DFT,
    PE_ARG_SIX_COLOR, 
    PE_ARG_TDTV_SIX_COLOR,
    PE_ARG_TDTV_SCE,
    PE_ARG_TDTV_BRIGHTNESS,
    PE_ARG_TDTV_CONTRAST,
    PE_ARG_TDTV_HUE,
    PE_ARG_TDTV_SATURATION,
    PE_ARG_TDTV_R_GAIN,
    PE_ARG_TDTV_G_GAIN,
    PE_ARG_TDTV_B_GAIN,
    PE_ARG_TDTV_SKIN,
...
typedef struct 
{
    UINT8 bPcfVer[FILE_HEAD_VER_SIZE];
    UINT8 bPcfPanelName[TBL_LONG_PANEL_NAME_SIZE];
    UINT8 bPqfVer[FILE_HEAD_VER_SIZE];
    UINT8 bPqfPanelName[TBL_LONG_PANEL_NAME_SIZE];
} PCF_PQF_INFO;
