...
//#define WO_OSD_MUTE_VTOTAL_CHG // osd without mute during vtotal change
...
#define SUPPORT_SCALERYUV444 1//0
...
//define for 3D overscan support
#if defined(CC_MT5396)
#define SUPPORT_TV3D_OVERSCAN       //option 1, 3D overscan done by MJC and PSC
#ifdef SUPPORT_TV3D_OVERSCAN
#define SUPPORT_MJC_WIDTH_WA
#endif
#ifndef SUPPORT_TV3D_OVERSCAN
#define SUPPORT_3D_OVSN_BY_SCL      //option 2, 3D overscan done by FSC
//#define SUPPORT_3D_H_OVSN_BY_FSC    //choose to do h overscan by front scaler (Should not enable both SUPPORT_3D_H_OVSN_BY_FSC & SUPPORT_3D_H_OVSN_BY_PSC)
#define SUPPORT_3D_H_OVSN_BY_PSC    //choose to do h overscan by post scaler (Should not enable both SUPPORT_3D_H_OVSN_BY_FSC & SUPPORT_3D_H_OVSN_BY_PSC)
#endif
#endif
