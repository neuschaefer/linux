 ...
 *
 *---------------------------------------------------------------------------*/ 
#ifndef _HW_5389_CKGEN_H_
#define _HW_5389_CKGEN_H_
...
#define CKGEN_DMS0 (IO_CKGEN_BASE + 0xD190)
    #define FLD_PCW_NCPO_CHG Fld(1,31,AC_MSKB3)//[31:31]
    #define FLD_PCW_NCPO Fld(31,0,AC_MSKDW)//[30:0]
#define CKGEN_DMS1 (IO_CKGEN_BASE + 0xD194)
    #define FLD_SSC_PRD Fld(16,16,AC_FULLW32)//[31:16]
    #define FLD_SSC_TRI_EN Fld(1,15,AC_MSKB1)//[15:15]
    #define FLD_SSC_EN Fld(1,14,AC_MSKB1)//[14:14]
    #define FLD_FIFO_START_MAN Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_SSC_PHASE_INI Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_DCTS_CTL Fld(2,10,AC_MSKB1)//[11:10]
    #define FLD_CLK_PH_INV Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_NCPO_RSTB Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_NCPO_EN Fld(1,0,AC_MSKB0)//[0:0]
#define CKGEN_DMS2 (IO_CKGEN_BASE + 0xD198)
    #define FLD_SSC_DELTA1 Fld(16,16,AC_FULLW32)//[31:16]
    #define FLD_SSC_DELTA Fld(16,0,AC_FULLW10)//[15:0]
...
#define CKGEN_DDDSVSP_CFG (IO_CKGEN_BASE + 0xD1E8)
    ...
    //#define FLD_FS_OC_CK_SEL Fld(4,0,AC_MSKB0)//[3:0]
    #define FLD_FS_OC_TSTCK_SEL Fld(4,0,AC_MSKB0)//[3:0]  // follow 5368
        #define FS_OC_TSTCK_SEL_DDDS2_NOSS 0            // follow 5368
        #define FS_OC_TSTCK_SEL_DDDS1_SS 1              // follow 5368
        #define FS_OC_TSTCK_SEL_DDDS1_SRC_CK 2          // follow 5368
...
#define CKGEN_VPCLK_CFG (IO_CKGEN_BASE + 0xD2A0)
    ...
    #define FLD_OCLK_DIV_CNT_RST Fld(1,7,AC_MSKB0)//[7:7]
...
#define CKGEN_RGBCLK_CFG (IO_CKGEN_BASE + 0xD2A4)
    ...
    #define FLD_RGB_CLK_TST_SEL Fld(2,8,AC_MSKB1)//[9:8]
...
#define CKGEN_PADDRV (IO_CKGEN_BASE + 0xD360)
    ...
    //#define FLD_PADDRV_AOSDATA4 //removed,5389_AUDIO
    //#define FLD_PADDRV_AOSDATA3 //removed,5389_AUDIO   
    //#define FLD_PADDRV_AOSDATA2 //removed,5389_AUDIO   
    #define FLD_PADDRV_AOSDATA1 Fld(1,9,AC_MSKB1)//[9]    //5389_AUDIO
    #define FLD_PADDRV_AOSDATA0 Fld(1,8,AC_MSKB1)//[8]    //5389_AUDIO
    #define FLD_PADDRV_AOLRCK Fld(1,8,AC_MSKB1)//[8]    //5389_AUDIO
    #define FLD_PADDRV_AOBCK Fld(1,8,AC_MSKB1)//[8]    //5389_AUDIO
    #define FLD_PADDRV_AOMCLK Fld(1,7,AC_MSKB0)//[7]    //5389_AUDIO
    //#define FLD_PADDRV_SPDIF1 //removed,5389_AUDIO
    #define FLD_PADDRV_SPDIF0 Fld(1,6,AC_MSKB0)//[6] //5389_AUDIO
    //#define FLD_PADDRV_ALIN //removed,5389_AUDIO    
...
#define CKGEN_PADTDSEL2 (IO_CKGEN_BASE + 0x3DA8)
...
#define CKGEN_PADE80 (IO_CKGEN_BASE + 0xD3BC)
    #define FLD_PADE8_20 Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_PADE8_19 Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_PADE8_18 Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_PADE8_17 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_PADE8_15 Fld(1,15,AC_MSKB1)//[15:15]
    #define FLD_PADE8_14 Fld(1,14,AC_MSKB1)//[14:14]
    #define FLD_PADE8_13 Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_PADE8_11 Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_PADE8_10 Fld(1,10,AC_MSKB1)//[10:10]
    #define FLD_PADE8_6 Fld(1,6,AC_MSKB0)//[6:6]
    #define FLD_PADE8_5 Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_PADE8_4 Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_PADE8_3 Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_PADE8_2 Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_PADE8_1 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_PADE8_0 Fld(1,0,AC_MSKB0)//[0:0]
#define CKGEN_PMUX0 (IO_CKGEN_BASE + 0xD400)
    #define FLD_PMUX0 Fld(32,0,AC_FULLDW)//[31:0]
    #define FLD_PAD_ASPDIF0 Fld(3,25,AC_MSKB3)//pmx0[27:25]    //5389_AUDIO
    #define FLD_PAD_AOMCLK Fld(3,28,AC_MSKB3)//pmx0[28:30]    //5389_AUDIO
    #define FLD_PAD_AOLRCK_B0 Fld(1,31,AC_MSKB3)//pmx0[31:31]    //5389_AUDIO
    #define FLD_PAD_AOBCK_B0 Fld(1,31,AC_MSKB3)//pmx0[31:31]    //5389_AUDIO
    #define FLD_PAD_AOSDATA0_B0 Fld(1,31,AC_MSKB3)//pmx0[31:31]    //5389_AUDIO
    #define FLD_PAD_GPIO0 Fld(3,0,AC_MSKB0)//pmx0[2:0]    //5389_AUDIO
    #define FLD_PAD_GPIO1 Fld(3,3,AC_MSKB0)//pmx0[5:3]    //5389_AUDIO
    #define FLD_PAD_GPIO2 Fld(3,6,AC_MSKW10)//pmx0[8:6]    //5389_AUDIO    
    #define FLD_PAD_GPIO4 Fld(3,15,AC_MSKW21)//pmx0[17:15] //5389_AUDIO    

#define CKGEN_PMUX1 (IO_CKGEN_BASE + 0xD404)
    #define FLD_PMUX1 Fld(32,0,AC_FULLDW)//[31:0]

    #define FLD_PAD_AOLRCK_B12 Fld(2,0,AC_MSKB0)//pmx1[1:0]    //5389_AUDIO
    #define FLD_PAD_AOBCK_B12 Fld(2,0,AC_MSKB0)//pmx1[1:0]    //5389_AUDIO
    #define FLD_PAD_AOSDATA0_B12 Fld(2,0,AC_MSKB0)//pmx1[1:0]    //5389_AUDIO
    #define FLD_PAD_AOSDATA1 Fld(3,2,AC_MSKB0)//pmx1[4:2]    //5389_AUDIO
    #define FLD_PAD_IF_AGC Fld(3,5,AC_MSKB0)    //pmx1[7:5]
    #define FLD_PAD_RF_AGC Fld(3,8,AC_MSKB1)    //pmx1[10:8]    
    //#define FLD_PAD_AOSDATA2 //removed,5389_AUDIO
    //#define FLD_PAD_AOSDATA3 //removed,5389_AUDIO
    //#define FLD_PAD_AOSDATA4 //removed,5389_AUDIO
...
#define CKGEN_PMUX_MISC (IO_CKGEN_BASE + 0xD410)
    ...
    #define FLD_CLK180M_SEL Fld(1,0,AC_MSKB0)//[0:0] // follow 5368 notation
...
#define CKGEN_GPIOOUT0 (IO_CKGEN_BASE + 0xD500)
    ...
    //#define FLD_PAD_ASPDIF1 //removed,5389_AUDIO
