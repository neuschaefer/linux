...
#define DMPLL_SPECTRUM_PERMILLAGE   (80)//(50) // +- 0.5%.
...
#define DMPLL_SPECTRUM_FREQUENCY   (60)//(30) // Khz.
...
#define DRAM_PRIORITY_LIST          ((UINT8*)"08453192bafcd67e")
#endif
...
#define SYS_RESET_TIMER             0x67AE14 //120ms,    //0xcdfe60 <=> 500ms under 27MHz //0x59019 <=>13.5ms under 27MHz
#endif
...
#define PDWNC_POLARITY              (0)//0 means: normal is low, standby is high
#endif
...
#define DEFAULT_TUNER_CTRL1        (OPCTRL(1)) // do not use hw setting here
#endif
*/

#ifndef CC_CI_USE_MT8295 // added by Chun Zhou, suggested by Lu Zhu
#ifndef DEFAULT_DEMOD_RESET_GPIO
#define DEFAULT_DEMOD_RESET_GPIO    (GPIO(14)) //GPIO(14) is demod_rst to reset mt5135
#endif
#endif
...
#define PANEL_FLASH_TABLE_SIZE         (128)
#endif
//#ifndef PANEL_FLASH_TABLE_ADDRESS
//#define PANEL_FLASH_TABLE_ADDRESS      (0xf720000)
//#endif
...
#ifndef PANEL_FLASH_TABLE_PARTITION_ID
#define PANEL_FLASH_TABLE_PARTITION_ID 18
#endif
...
//PWM port: pwm detail pin list please see drv_pwm.h
#ifndef PWM0_PORT
//#define PWM0_PORT    PAD_PWM0_GPIO3
#define PWM0_PORT    PAD_PWM0_OSDA0
#endif
#ifndef PWM1_PORT
#define PWM1_PORT    PAD_PWM1_IF_AGC
#endif
#ifndef PWM2_PORT
#define PWM2_PORT    PAD_PWM2_PWM0
#endif
...
#define AUDIO_TSHD_INPUTGAIN (0x00400000)//-6dB
#endif
...
//----------------------------------------------------------------------------
        ...
        #ifdef MHEG5_NVM_SUPPORT //SYS_UK_FREEVIEWHD_SUPPORT
            #define NAND_FLASH_MHEG5_NVM_SIZE           (3*1024*1024)
        #else
...
#define WATCHDOG_RESET_WAITTIME    (2)  //max is 9.48s
#endif
...
//----------------------------------------------------------------------------
    ...
    #define FLASH_PQ_SCE_MIN                    (0)
        ...
        #define SUPPORT_FLASH_PQ_ENABLE_QTY_MAX_MIN         (1)//(0)
    #endif
    #ifndef SUPPORT_FLASH_PQ_ENABLE_QTY_SMART_PIC
        #define SUPPORT_FLASH_PQ_ENABLE_QTY_SMART_PIC           (1)//(0)
    #endif
    ...
    //------------------------------------------------------------
#ifdef SUPPORT_2ND_FLASHPQ    //Begin (2ND_FLASHPQ)-----
        ...
        #define SUPPORT_FLASH_PQ_2ND_PART_ENABLE_QTY_MAX_MIN         (1)//(0)
    #endif
    #ifndef SUPPORT_FLASH_PQ_2ND_PART_ENABLE_QTY_SMART_PIC
        #define SUPPORT_FLASH_PQ_2ND_PART_ENABLE_QTY_SMART_PIC           (1)//(0)
    #endif
...
#define EFUSE_AUTOCOLOR 1 //0  // 1 :Use E Fuse Autocolor
#endif
