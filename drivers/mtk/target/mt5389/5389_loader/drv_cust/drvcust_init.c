...
#ifdef CC_MTK_LOADER //only in loader
...
#ifndef CC_MTK_PRELOADER
#ifdef CC_MTK_LOADER
extern INT32 SFLASHHW_GetID(UINT32 u4Index, UINT8 *pu1MenuID, UINT8 *pu1DevID1, UINT8 *pu1DevID2);
extern UINT32 SFLASHHW_GetFlashSize(UINT8 u1MenuID, UINT8 u1DevID1, UINT8 u1DevID2);
#endif

UINT32 u4GetSecondFlashSize(void)
{
    UINT32 u4Index = 1;
    UINT8 u1MenuID = 0, u1DevID1 = 0, u1DevID2 = 0;
    static UINT32 u4FlashSize = 0;
    INT32 i4Ret = 0;
    static UINT8 bAlreadyRead=0;
    if(bAlreadyRead == 0)
    {
        bAlreadyRead = 1;
...
#if 0
#ifdef CC_MTK_LOADER
    Printf("loader:u4FlashSize = 0x%x_______________________\n", u4FlashSize);
#else
    Printf("driver:u4FlashSize = 0x%x_______________________\n", u4FlashSize);
#endif
#endif
    return u4FlashSize;
...
INT32 DRVCUST_InitQuery(QUERY_TYPE_T eQryType, UINT32 *pu4Data)
{
    ...
    switch (eQryType)
    {
        ...
        case eBootLogoSettingOffset:
            *pu4Data = (UINT32)EEP_BOOT_LOGO_EN_OFFSET;
            return 0;
#endif

        case eOADPkgPhyAddressOffset:
            *pu4Data = (UINT32)EEP_OAD_PKG_PHY_ADDR_OFFSET;
            return 0;

        case eRTCWakeupBackltOffset:
			 *pu4Data = (UINT32)EEP_RTC_WAKEUP_BACKLT_EN_OFFSET;
            return 0;
			
#ifndef CC_MTK_PRELOADER

        case eLoaderEnterStandbyInstalled1Offset:
        *pu4Data = (UINT32)EEP_LOADER_ENTER_STANDBY_INSTALLED_1_OFFSET;
        return 0;
        
    case eLoaderEnterStandbyOffset:
        *pu4Data = (UINT32)EEP_LOADER_ENTER_STANDBY_OFFSET;
        return 0;
    case eLoaderStandbyStatus:
        *pu4Data = (UINT32)EEP_LOADER_STANDBY_STATUS;
        return 0;           
    case eTouchPadInstalled1Offset:
        *pu4Data = (UINT32)EEP_TOUCHPAD_INSTALLED_1_OFFSET;
        return 0;
        
    case eTouchPadTop1Offset:
        *pu4Data = (UINT32)EEP_TOUCHPAD_1_TOP_OFFSET;
        return 0;
        
    case eLoaderVersion:
        *pu4Data = (UINT32)EEP_LOADER_VERSION;
        return 0;
        case eTouchPadOrMagicButton:
        *pu4Data = (UINT32)EEP_TOUCHPAD_OR_MAGICBUTTON_OFFSET;
         return 0;
      case eTouchPadInstalledCode:
#ifdef TOUCHPAD_INSTALLED_CODE
        *pu4Data = (UINT32)TOUCHPAD_INSTALLED_CODE;
        return 0;
#else
        return -1;
#endif
        
    case eStandbyInstalledCode:
#ifdef STANDBY_INSTALLED_CODE
        *pu4Data = (UINT32)STANDBY_INSTALLED_CODE;
        return 0;
#else
        return -1;
#endif
    case eScartWakeupEnableOffset:
        *pu4Data = (UINT32)EEP_SCART_WAKEUP_EN_OFFSET;
        return 0;
    case eVgaWakeupEnableOffset:
        *pu4Data = (UINT32)EEP_VGA_WAKEUP_EN_OFFSET;
        return 0;
...
// Loader Misc
        ...
        case eNorFlashPartName0:
            *pu4Data = NOR_PART_NAME_0;
            return 0;
            
        case eNorFlashPartName1:
            *pu4Data = NOR_PART_NAME_1;
           return 0;
            
        case eNorFlashPartName2:
            *pu4Data = NOR_PART_NAME_2;
            return 0;
            
        case eNorFlashPartName3:
            *pu4Data = NOR_PART_NAME_3;
            return 0;
            
        case eNorFlashPartName4:
            *pu4Data = NOR_PART_NAME_4;
            return 0;
            
        case eNorFlashPartEnd:
            *pu4Data = NOR_ARTITION_END;
            return 0;
        case eNorFlashPartEncrypt0:
            *pu4Data = NOR_PART_ENCRYPT_0;
            return 0;
        case eNorFlashPartEncrypt1:
            *pu4Data = NOR_PART_ENCRYPT_1;
            return 0;
        case eNorFlashPartEncrypt2:
            *pu4Data = NOR_PART_ENCRYPT_2;
            return 0;
        case eNorFlashPartEncrypt3:
            *pu4Data = NOR_PART_ENCRYPT_3;
            return 0;
        case eNorFlashPartEncrypt4:
            *pu4Data = NOR_PART_ENCRYPT_4;
            return 0;
...
#ifdef CI_SPI_PINMUX
        case eCISpiPinmux:
            *pu4Data = (UINT32)CI_SPI_PINMUX;
            return 0;
#endif
        case eHDMIHPD0GPIONUM:
#if  defined(CC_MT5389) || defined(CC_MT5396) || defined(CC_MT5368)
...
// Boot
        ...
        case eVGAEDIDNorPartId:
            *pu4Data = VGAEDID_NOR_FLASH_PART_ID;
            return 0;

        case eVGAEDIDNorOffset:
            *pu4Data = VGAEDID_NOR_FLASH_OFFSET;
            return 0;

        case eHDMIEDIDNorPartId:
            *pu4Data = HDMIEDID_NOR_FLASH_PART_ID;
            return 0;

        case eHDMIEDIDNorOffset:
            *pu4Data = HDMIEDID_NOR_FLASH_OFFSET;
            return 0;
    

#if !defined(CC_MTK_LOADER) || !defined(CC_LOADER_SHRINK_QUERY)
...
// Loader logo
        ...
        case eNorFlashPartSize8:
            *pu4Data = NOR_PART_SIZE_8;
            return 0;

        case eNorFlashPartSize9:
            *pu4Data = NOR_PART_SIZE_9;
            return 0;

        case eNorFlashPartSize10:
            *pu4Data = NOR_PART_SIZE_10;
            return 0;

        case eNorFlashPartSize11:
            *pu4Data = NOR_PART_SIZE_11;
            return 0;

        case eNorFlashPartSize12:
            *pu4Data = NOR_PART_SIZE_12;
...
// NAND flash parameter
        ...
        case eVGAEDIDNANDPartId:
            *pu4Data = VGAEDID_NAND_FLASH_PART_ID;
            return 0 ;

        case eVGAEDIDNANDOffset:
            *pu4Data = VGAEDID_NAND_FLASH_OFFSET;
            return 0 ;

        case eHDMIEDIDNANDPartId:
            *pu4Data = HDMIEDID_NAND_FLASH_PART_ID;
            return 0 ;

        case eHDMIEDIDNANDOffset:
            *pu4Data = HDMIEDID_NAND_FLASH_OFFSET;
            return 0 ;
        ...
        case eEepromVgaEdidOffset:
            *pu4Data = DRVCUST_EEPROM_VGA_EDID_OFFSET;
            return 0;
#endif

#ifdef DRVCUST_VGA_EDID_SIZE
        case eEdidVgaSize:
            *pu4Data = DRVCUST_VGA_EDID_SIZE;
            return 0;
#endif

        case eEdidVgaStorageSize:
#ifdef CC_NAND_ENABLE
            *pu4Data = HDMIEDID_NAND_FLASH_PART_SIZE;
#elif defined(DRVCUST_VGA_EDID_STORAGE_SIZE)
            *pu4Data = DRVCUST_VGA_EDID_STORAGE_SIZE;
#else
            return -1 ;
#endif
            return 0;
        ...
        case eEepromHdmiEdidOffset:
            *pu4Data = DRVCUST_EEPROM_HDMI_EDID_OFFSET;
            return 0;
#endif

#ifdef DRVCUST_HDMI_EDID_SIZE
        case eEdidHdmiSize:
            *pu4Data = DRVCUST_HDMI_EDID_SIZE;
            return 0;
#endif
        ...
        case eEdidHdmiStorageSize:
            ...
            *pu4Data = DRVCUST_HDMI_EDID_STORAGE_SIZE;
#else
            return -1;
#endif
            return 0;
        ...
        case eEdidVgaIndexOffset:
            *pu4Data = EEPROM_VGA_EDID_INDEX_OFFSET;
            return 0;
#endif

#ifdef EEPROM_HDMI_EDID_INDEX_OFFSET
        case eEdidHdmiIndexOffset:
            *pu4Data = EEPROM_HDMI_EDID_INDEX_OFFSET;
            return 0;
#endif
...
#error not define GPIO_POWER_OFF_FUNC
        ...
        case eUSBVbus2EnablePolarity:
            *pu4Data = USB2_VBUS_GPIO_POLARITY;
            return 0;
#endif
        ...
        case eUSBVbus3EnablePolarity:
            *pu4Data = USB3_VBUS_GPIO_POLARITY;
            return 0;
#endif
        ...
        case eFlagIrrxSoundSupport:
            ...
            *pu4Data = FLAG_IRRX_SOUND_SUPPORT;
            return 0;
#else
            return -1;
#endif
...
// Led
        ...
        case eMt8283LVDSPowerGpio:
            *pu4Data = (UINT32)MT8283_LVDS_POWER_GPIO;
            return 0;
