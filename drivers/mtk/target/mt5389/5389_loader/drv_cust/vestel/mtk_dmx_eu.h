...
// The input pin set
//  DMX_PINSET_INTERNAL: internal demo
//  DMX_PINSET_EXT1: DEMOD_TSCLK - PVR_TSSYNC
//  DMX_PINSET_EXT1_1: DEMOD_TSCLK - DEMOD_TSDATA0, AOLRCK - AOSDATA4
//  DMX_PINSET_EXT1_2: DEMOD_TSCLK - DEMOD_TSDATA0, TCON0 - TCON6
//  DMX_PINSET_EXT2: CITSCLK - CITSDATA0, PVR_TSVAL - SPI_CLE
...
static const DMX_FRONTEND_CONFIG_T _arMtkFeCfgTable[] =
{
    ...
    { TRUE, DMX_PINSET_EXT1, DMX_FRAMER_TWOBIT, DMX_EDGE_POSITIVE, DMX_SYNC_INTERNAL},
    // Frontend input path 1
    { FALSE, DMX_PINSET_EXT1, DMX_FRAMER_SERIAL, DMX_EDGE_POSITIVE, DMX_SYNC_INTERNAL},
    // PVR path
    { FALSE, DMX_PINSET_INTERNAL, DMX_FRAMER_SERIAL, DMX_EDGE_POSITIVE, DMX_SYNC_INTERNAL},
    // No this path in 5368
    { FALSE, DMX_PINSET_INTERNAL, DMX_FRAMER_TWOBIT, DMX_EDGE_POSITIVE, DMX_SYNC_INTERNAL},
};
...
{
    DMX_SCRAMBLE_PESSTART_ONLY,  
    0,                            // If DMX_SCRAMBLE_BOTH_TSFLAG_PESSTART, then this flag is valid
};
