...
{
#if 0//need check the set later for 5368
    UINT32 u4Reg = 0;
    ...
    if (u1Channel == 0)
    {
        ...
        // [26:25] = 1; [28:27] != 2 
        if((u4Reg & 0x18000000) == 0x10000000)
        {
            u4Reg &= ~(0x18000000);
        }
        u4Reg &= ~(0x06000000);        
        ...
        // [9:8] != 1
        if((u4Reg & 0x00000300) == 0x00000100)
        {
            u4Reg &= ~(0x00000300);
        }
    ...
    else if (u1Channel == 1)
    {
        ...
        if((u4Reg & 0x06000000) == 0x02000000)
        {
            u4Reg &= ~(0x06000000);
        }
        CKGEN_WRITE32(0x408, u4Reg);
    ...
    else if (u1Channel == 2)
    {
        ...
        u4Reg &= 0x18000000;        
        u4Reg |= 0x08000000;
        if((u4Reg & 0x06000000) == 0x04000000)
        {
            u4Reg &= ~(0x06000000);
        }
        CKGEN_WRITE32(0x408, u4Reg);
        u4Reg = CKGEN_READ32(0x404);        
        // [9:8] != 2
        if((u4Reg & 0x00000300) == 0x00000200)
        {
            u4Reg &= ~(0x00000300);
        }
        CKGEN_WRITE32(0x404, u4Reg);        
    }    
    else if (_SIF_ISR_IsPdwncMasterEnable() && u1Channel == 3) // PDWNC SIF
    {
