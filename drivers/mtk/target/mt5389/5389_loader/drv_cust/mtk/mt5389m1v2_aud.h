 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5389LM1V2_AUD_H
#define MT5389LM1V2_AUD_H

#include "aud_if.h"

static const AUD_INPUT_SW_GPIO_T _armt5389m1v2InputSwGpio = 
{
    WT6720_GPIO7,                         
    WT6720_GPIO6,                         
    UNUSED_GPIO,
...
static const AUD_INPUT_MUX_SEL_T _armt5389m1v2AudInputMux[] = 
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    ...
    {AUD_INPUT_ID_S_VID_0,      1,	        1,          0,          SW_NO_USED, SW_NO_USED},  
    ...
    {AUD_INPUT_ID_YPBPR_0,      1,          0,          1,          SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_YPBPR_1,      1,          1,          1,          SW_NO_USED, SW_NO_USED},            
    {AUD_INPUT_ID_YPBPR_2,    	NO_USED, 	SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_VGA_0,        1,          0,          0,          SW_NO_USED, SW_NO_USED},    
    {AUD_INPUT_ID_VGA_1,        NO_USED, 	SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_0,       1,          0,          0,   SW_NO_USED, SW_NO_USED},  
    {AUD_INPUT_ID_HDMI_1,       1,          0,          0,   SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_2,       1,          0,          0,   SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_3,       1,          0,          0,   SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_4,       NO_USED,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_DVI_0,         1,          0,          0,  SW_NO_USED, SW_NO_USED},    
    ...
    {AUD_INPUT_ID_SCART_0,     1,          1,          1,          SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_SCART_1,     1,          1,          0,          SW_NO_USED, SW_NO_USED},
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5389m1v2AudInputMuxTable = 
{
    (sizeof(_armt5389m1v2AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5389m1v2AudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5389m1v2InterDacUsage = 
{
    AUD_CHL_AUX, //AR0, AL0 ==> 1st SCART1
    AUD_CHL_DOWNMIX, //AR1, AL1 ==> 2nd Headphone
    AUD_CHL_L_R, //NA
    AUD_CHL_DOWNMIX, //AR1, AL1 ==> Same with 2nd Headphone setting. (0xf00051d4 = 0x00987610)
};

static const AUD_ADAC_USAGE_T _armt5389m1v2AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
...
static const AUD_DIGITAL_DATA_T _afgmt5389m1v2AudDigitalDataUsage =
{
    TRUE,			//MCLK,BCK,LRCK
    TRUE,			//AOSDATA0
    TRUE,			//AOSDATA1
...
static const AUD_AOUT_PAD_CFG_T _armt5389m1v2AoutPadTable =
{
