...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5389m1v2_aud.h"
...
#define AUDIO_INPUT_SW_GPIO_SEL             (&_armt5389m1v2InputSwGpio)
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5389m1v2AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_armt5389m1v2InterDacUsage)
#define AUDIO_ADAC_USAGE                    (&_armt5389m1v2AdacUsage)
#define AUDIO_Digital_Data_TABLE            (&_afgmt5389m1v2AudDigitalDataUsage)
#define AUDIO_AOUT_PAD_CFG                  (&_armt5389m1v2AoutPadTable)
// driver logo setting
...
#define DEFAULT_IRRX_REPEAT_VALID_TIME      (150)//ir repeat time.
...
#define PINMUX_INCLUDE_FILE                 "mtk/mt5389m1v2_pin_setup.h"
#endif
...
#define HDMI_GPIO_CONF                      "mtk/hdmi_conf_mt5389.c"
#endif
...
#define DMX_INCLUDE_FILE               "mtk/mtk_dmx_cn.h"
#endif
