...
#else
#define NS_BIT          0   // w/o trustzone, NS bit will affect PA operation
#endif
...
static void CreatePageTable(UINT32 u4Addr)
{
    ...
    for (i = 0; i < 0x800; i++)
    {
...
#endif
        {
            ...
            pu4Table[i] = L1Entry(SECTION, i << 20, TEX_WRITE_ALLOCATE, C_BIT | B_BIT | NS_BIT, USER_ACCESS);
            //pu4Table[i] = L1Entry(SECTION, i << 20, 0, C_BIT | B_BIT, USER_ACCESS);
        }
    }
