...
static INT32 _CmdJTagType(INT32 i4Argc, const CHAR ** szArgv)
{
    ...
    {
    case 0: //jtag
        Printf("not support jtag, so disable JTAG\n");
        ...
        i4Ret = BSP_PinSet(PIN_HDMI_0_HPD, 1);
		Printf("change back to hdmi use \n");
        break;
    case 1: //hdmi
		...
		IO_WRITE32MSK(IO_VIRT, 0x280b8, 0x4, 0x4);
    ...
    case 2: //usb
		...
		IO_WRITE32MSK(IO_VIRT, 0x280b8, 0x4, 0x4);
        IO_WRITE32MSK(IO_VIRT, 0x59820, 0x300, 0x300);
        IO_WRITE32MSK(IO_VIRT, 0x59920, 0x300, 0x300);
        IO_WRITE32MSK(IO_VIRT, 0xd1d4, 0xf00000, 0xf00000);
        // switch HDMI to USB
        IO_WRITE32MSK(IO_VIRT, 0xd400, 0xa00000, 0xa00000);
        break;
    default:
        return -1;
    }
