...
ifeq "$(ODB)" "true"
ifneq "$(ODB_CONFIG_COMPLETE)" "true"
CC := odbc comp $(CC)
endif
endif
...
ifeq "$(CA9)" "y"
CC_FLAG := $(OPT_FLAG) $(CC_PIC_FLAG) -g -DINLINE=__inline --cpu Cortex-A9.no_neon --gnu --signed_chars --no_unaligned_access
else
ifeq "$(RVCT21)" "y"
...
ifeq "$(CA9)" "y"
ASM_FLAG := -g --cpu=Cortex-A9.no_neon
else
...
# Linker and options.
#
LD_FLAG   = --entry INT_Reset --scatter $(call path_cnvt,$(TARGET_ROOT)/5396_driver/scatter.sc)
LD_OUTPUT = --Output
