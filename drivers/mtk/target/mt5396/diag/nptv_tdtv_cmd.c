...
CLI_EXEC_T arTDTVCmdTbl[] = {
    ...
    {"3DC enable",    "dcen", _i4TTDSet3DDepthCtrl, NULL, "Set 3D depth control",        CLI_GUEST},
...
static INT32 _TdtvSet3DNaviInFwPara(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    u4Para[0] = (UINT32)g_u1TdNaviDetInFrmNum;
    u4Para[1] = (UINT32)g_u1In3DSimilarityRatio;
    u4Para[2] = (UINT32)g_u1In3DSimilarThr;
    u4Para[3] = (UINT32)g_u1In3DDecisionType;
...
static INT32 _TdtvSet3DNaviOutFwPara(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    u4Para[0] = (UINT32)g_u1TdNaviDetOutFrmNum;
    u4Para[1] = (UINT32)g_u1Out3DSimilarityRatio;
    u4Para[2] = (UINT32)g_u1Out3DSimilarThr;
    u4Para[3] = (UINT32)g_u1Out3DDecisionType;
