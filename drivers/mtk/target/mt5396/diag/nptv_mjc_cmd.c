...
static INT32 _i4MjcSet50To120(INT32 i4Argc, const CHAR **szArgv);
...
static INT32 _i4MjcSetFixDsprtForImageSafety(INT32 i4Argc, const CHAR **szArgv);
static INT32 _i4MjcSetDepthCtrl(INT32 i4Argc, const CHAR **szArgv);
#endif
...
CLI_EXEC_T arMjcCmdTbl[] = {
    ...
    {"Set 50to120",     "fvt120",_i4MjcSet50To120,    NULL, "Set MJC 50To120 Conversion",  CLI_GUEST},
    ...
    {"FixDspart On/Off","ttdfd", _i4MjcSetFixDsprtForImageSafety, NULL, "Set FixDspart On/Off",        CLI_GUEST},
    {"DepthCtrl On/Off","dcen",  _i4MjcSetDepthCtrl,  NULL, "Set Depth Ctrl On/Off",       CLI_GUEST},
#endif
...
static INT32 _i4MjcSetPRMode(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    if (i4Argc != 3)
    {
		...
		else
		{
            ...
            Printf("Usage: %s PRMode\n", szArgv[0]);
            Printf("<PRMode>\n");
            Printf(" 0: E_MJC_NO_HALF_PR 1: E_MJC_HPR 2: E_MJC_PR\n");
...
static INT32 _i4MjcSet50To120(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    if (i4Argc != 2)
    {
        Printf("Current Status: %d\n", u1DrvMJCIsSupport50To120());
        Printf("Usage: %s <SupportMode>\n", szArgv[0]);
        Printf("<SupportMode>\n");
        Printf("0: Normal\n");
        Printf("1: Support 50 to 120Hz conversion for 3D.\n");
        Printf("2: Support 50 to 120Hz conversion for 2D.\n");
        Printf("3: Support 50 to 120Hz conversion for both 3D and 2D.\n");

        return 1;
    }

    u4Support = MIN(StrToInt(szArgv[1]), 3);

    vDrvMJCSet50To120(u4Support);
