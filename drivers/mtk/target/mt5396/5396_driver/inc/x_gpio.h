...
#define GPIO_SUPPORT_INT_NUM	64// GPIO0~GPIO55, SDIO, CI_DEMOD(7)
...
typedef enum {
    ...
    #ifdef CC_EXTERNAL_CI	//must sync with gGPIO_HANDLER_FuncTbl[] in gpio.c
    GPIO_HANDLER_MT8295,
    #endif
    #if 0
    GHIO_HANDLER_MT5135,
