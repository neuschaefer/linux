...
/*
    ...
    BGA Net(A)
    0x58B20    	A7   		A12    	A2   		BA0
    0x58B24    	A10    	A4    	A1    	CAS
    0x58B28    	A6   		CS   	A3   		A8
    0x58B2C    BA1    	RAS   	A5    	A0
    0x58B30    	WE   	RESET   	ODT		BA2
    0x58B34    	CKE    	A14    	A11    	A9
    0x58F38					CSX		A13
    ...
    DDR3    	Byte3 	Byte2 	Byte1 	Byte0 
    BGA Net(B)
    0x58F20    	A11    	A3    	A2   		A0
    0x58F24    	A9   		A4    	A1    	CAS
    0x58F28    	A6		CS   	A7    	A8
    0x58F2C   	BA2    	RAS    	R13   	A0
    0x58F30    	CKE  	RESET   	ODT   	BA1
    0x58F34    	WE   	A12   	A10    	A5
    0x58F38					CSX		A14
...
*/
   ...
   #define DDR2_CHA_CLK_DUTY			0x00030204	  
   #endif
    ...
    */
    ...
    #define DDR2_CMD_DELAY_0        0x0
    #endif
    #ifndef DDR2_CMD_DELAY_1
    #define DDR2_CMD_DELAY_1        0x0
    #endif
    #ifndef DDR2_CMD_DELAY_2
    #define DDR2_CMD_DELAY_2        0x0
    #endif
    #ifndef DDR2_CMD_DELAY_3
    #define DDR2_CMD_DELAY_3        0x0
    #endif
    #ifndef DDR2_CMD_DELAY_4
    #define DDR2_CMD_DELAY_4        0x0
    #endif
    #ifndef DDR2_CMD_DELAY_5
    #define DDR2_CMD_DELAY_5        0x0
    #endif
    #ifndef DDR2_CMD_DELAY_6
    #define DDR2_CMD_DELAY_6        0x0
    #endif	

    #ifndef DDR2_OUT_CLK_DELAY_CHAIN_0
    #define DDR2_OUT_CLK_DELAY_CHAIN_0  0x00000000
    #endif
    #ifndef DDR2_OUT_CLK_DELAY_CHAIN_1
    #define DDR2_OUT_CLK_DELAY_CHAIN_1  0x00000000
    #endif
    #ifndef DDR2_CHA_OUT_CLKDUTY_CLKOPTON
    #define DDR2_CHA_OUT_CLKDUTY_CLKOPTON  0x0009000A
    #endif
    #ifndef DDR2_CHB_OUT_CLKDUTY_CLKOPTON
    #define DDR2_CHB_OUT_CLKDUTY_CLKOPTON  0x0009000B
    #endif
    ...
    #define DDR2_CHA_DQS_RDSEL				0x20202020
    #endif
    #ifndef DDR2_CHA_DQ_RDSEL
    #define DDR2_CHA_DQ_RDSEL				0x04040404
    #endif

    #ifndef DDR2_CHB_DQS_RDSEL
    #define DDR2_CHB_DQS_RDSEL				0x04040404
    #endif
    #ifndef DDR2_CHB_DQ_RDSEL
    #define DDR2_CHB_DQ_RDSEL				0x04040404
    #endif

    #ifndef DDR2_DQSIEN
    // (1) Binary coded gating window of byte 3 ~ 0: 37, 37, 37, 37
    #define DDR2_DQSIEN                   0x25252525
    #endif
    ...
    */
    ...
    #define DDR2_DQM_DELAY           0
    #endif

    #ifndef DDR2_CLK_DELAY
    #define DDR2_CLK_DELAY           0
    #endif
    ...
    */
    ...
    #define DDR2_CHA_CMD_DELAY_0  0x0
    #endif
    #ifndef DDR2_CHA_CMD_DELAY_1
    #define DDR2_CHA_CMD_DELAY_1  0x0
    #endif
    #ifndef DDR2_CHA_CMD_DELAY_2
    #define DDR2_CHA_CMD_DELAY_2  0x00840000    //CS 
    #endif
    #ifndef DDR2_CHA_CHB_CMD_DELAY_3
    #define DDR2_CHA_CMD_DELAY_3  0x0
    #endif
    #ifndef DDR2_CHA_CMD_DELAY_4
    #define DDR2_CHA_CMD_DELAY_4  0x00008000    //ODT
    #endif
    #ifndef DDR2_CHA_CMD_DELAY_5
    #define DDR2_CHA_CMD_DELAY_5  0x80000000    //CKE
    #endif
	#ifndef DDR2_CHA_CMD_DELAY_6
    #define DDR2_CHA_CMD_DELAY_6  0x0
    #endif
    //Channel B cmd delay
    #ifndef DDR2_CHB_CMD_DELAY_0
    #define DDR2_CHB_CMD_DELAY_0  0x0
    #endif
    #ifndef DDR2_CHB_CMD_DELAY_1
    #define DDR2_CHB_CMD_DELAY_1  0x0
    #endif
    #ifndef DDR2_CHB_CMD_DELAY_2
    #define DDR2_CHB_CMD_DELAY_2  0x00840000    //CS 
    #endif
    #ifndef DDR2_CHB_CHB_CMD_DELAY_3
    #define DDR2_CHB_CMD_DELAY_3  0x0
    #endif
    #ifndef DDR2_CHB_CMD_DELAY_4
    #define DDR2_CHB_CMD_DELAY_4  0x80008000    //CKE, ODT
    #endif
    #ifndef DDR2_CHB_CMD_DELAY_5
    #define DDR2_CHB_CMD_DELAY_5  0x0
    #endif
	#ifndef DDR2_CHB_CMD_DELAY_6
    #define DDR2_CHB_CMD_DELAY_6  0x0
    #endif
