...
void _DDR_SetDdr3BeforeAI(void)
{
    ...
    // Set pad driving.
     if(IS_DRAM_CHANNELB_ACTIVE()) //Channel B Dq input delay
    {
         DRAM_DDRPHY_WRITE32(0x300, ((UINT32)DDR3_CHB_CLK_DRIVING<<24));
         DRAM_DDRPHY_WRITE32(0x308, ((UINT32)DDR3_CHB_CMD_DRIVING<<24));
         DRAM_DDRPHY_WRITE32(0x30C, ((UINT32)DDR3_CHB_CS_DRIVING<<24));
         DRAM_WRITE32(0x310, ((UINT32)DDR3_CHB_DQS_DRIVING<<24));
         DRAM_WRITE32(0x318, ((UINT32)DDR3_CHB_DQ_DRIVING<<24));
     }
     else
     {
         DRAM_DDRPHY_WRITE32(0x300, ((UINT32)DDR3_CHA_CLK_DRIVING<<24));
         DRAM_DDRPHY_WRITE32(0x308, ((UINT32)DDR3_CHA_CMD_DRIVING<<24));
         DRAM_DDRPHY_WRITE32(0x30C, ((UINT32)DDR3_CHA_CS_DRIVING<<24));
         DRAM_WRITE32(0x310, ((UINT32)DDR3_CHA_DQS_DRIVING<<24));
         DRAM_WRITE32(0x318, ((UINT32)DDR3_CHA_DQ_DRIVING<<24));
     }
    //Set clk duty-cycle
    ...
    //Set MR2, MR3.
    DRAM_WRITE32(0x14, u4MRS2);

    // Set clock delay.
    if(IS_DRAM_CHANNELB_ACTIVE()) 
    {
        DRAM_DDRPHY_WRITE32(0x304, DDR3_CHB_CLK_DELAY);
    }
    else
    {
        DRAM_DDRPHY_WRITE32(0x304, DDR3_CHA_CLK_DELAY);
    }
    ...
    {
    // Set DQ output delay.
        DRAM_DDRPHY_WRITE32(0x360, DDR3_CHB_DQ_OUTPUT_DELAY_0);
        DRAM_DDRPHY_WRITE32(0x364, DDR3_CHB_DQ_OUTPUT_DELAY_1);
        DRAM_DDRPHY_WRITE32(0x368, DDR3_CHB_DQ_OUTPUT_DELAY_2);
        DRAM_DDRPHY_WRITE32(0x36C, DDR3_CHB_DQ_OUTPUT_DELAY_3);
    //Set DQM output delay
        DRAM_DDRPHY_WRITE32(0x350, DDR3_CHB_DQM_DELAY);
        // Set DQS output delay.    
        DRAM_DDRPHY_WRITE32(0x354, DDR3_CHB_DQS_DELAY);
    }
    else
    {
        // Set DQ output delay.
        DRAM_DDRPHY_WRITE32(0x360, DDR3_CHA_DQ_OUTPUT_DELAY_0);
        DRAM_DDRPHY_WRITE32(0x364, DDR3_CHA_DQ_OUTPUT_DELAY_1);
        DRAM_DDRPHY_WRITE32(0x368, DDR3_CHA_DQ_OUTPUT_DELAY_2);
        DRAM_DDRPHY_WRITE32(0x36C, DDR3_CHA_DQ_OUTPUT_DELAY_3);
        //Set DQM output delay
        DRAM_DDRPHY_WRITE32(0x350, DDR3_CHA_DQM_DELAY);
    // Set DQS output delay.    
        DRAM_DDRPHY_WRITE32(0x354, DDR3_CHA_DQS_DELAY);
    }
    ...
    if (TCMGET_DDR_CL() == 11)
    {
        ...
        if (!IS_DDR_ASYNCON())
        {
            DRAM_WRITE32(0x04, 0x08533316);
        }
        else
        {
            DRAM_WRITE32(0x04, 0x0A533316);
        }
    ...
    else 
    {
        ...
        if (!IS_DDR_ASYNCON())
        {
            DRAM_WRITE32(0x04, 0x0543320F);        
        }
        else
        {
            DRAM_WRITE32(0x04, 0x0743320F);        
        }        
    }
    ...
    */
    ...
    if((TCMGET_DDR_CLK() >= 1500000000))
    {	
        DRAM_WRITE32(0x00, 0x55fC48EA);//for 1.5G AC timing
    }
    else
    {	  
        DRAM_WRITE32(0x00, 0x55fa45d9);
    }
