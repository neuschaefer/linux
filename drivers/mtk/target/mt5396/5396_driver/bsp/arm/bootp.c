...
static void _CLK_DisplayInfo(UINT32 u4Stage)
{
    ...
    else
    {
        ...
        Printf("2 DQSODT: 0x%01X ('G': to change)\n", (DRAM_READ32(0x310) >> 16) & 0x7);
        Printf("2 DQSRTT: 0x%01X ('H': to change)\n", (DRAM_DDRPHY_READ32(0x310) >> 0) & 0x7);
        Printf("2 DQODT: 0x%01X ('J': to change)\n", (DRAM_READ32(0x318) >> 16) & 0x7);
        Printf("2 DQRTT: 0x%01X ('K': to change)\n", (DRAM_DDRPHY_READ32(0x318) >> 0) & 0x7);
    ...
    while (1)
    {
            ...
            (u4Stage == DRAM_CHANGE_DDR_AFTER_AUTOINIT))
        {
            ...
            case 'G': case 'g':
                ...
                u4Val = (u4Val << 16) | (u4Val << 20);
                u4Val = (DRAM_READ32(0x310) & 0xFF88FFFF) | u4Val;
                DRAM_WRITE32(0x310, u4Val);
                break;
            case 'H': case 'h':
                u4Val = (DRAM_DDRPHY_READ32(0x310) >> 0) & 0x7;
                u4Val = (u4Val == 0x7) ? 0 : (u4Val + 1);
                u4Val = u4Val << 0;
                u4Val = (DRAM_DDRPHY_READ32(0x310) & 0xFFFFFFF8) | u4Val;
            ...
            case 'J': case 'j':
                ...
                u4Val = (u4Val == 0x7) ? 0 : (u4Val + 1);
                u4Val = (u4Val << 16) | (u4Val << 20);
                u4Val = (DRAM_READ32(0x318) & 0xFF88FFFF) | u4Val;
                DRAM_WRITE32(0x318, u4Val);
                break;
            case 'K': case 'k':
                u4Val = (DRAM_DDRPHY_READ32(0x318) >> 0) & 0x7;
                u4Val = (u4Val == 0x7) ? 0 : (u4Val + 1);
                u4Val = u4Val << 0;
                u4Val = (DRAM_DDRPHY_READ32(0x318) & 0xFFFFFFF8) | u4Val;
