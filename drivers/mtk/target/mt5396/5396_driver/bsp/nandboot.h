...
#define NAND_DRAM_BASE                              ((UINT32)0x40000000)
#else
...
#if defined(CC_MT5365) || defined(CC_MT5395)
#define NAND_REG_BASE                       (((UINT32)IO_VIRT) + ((UINT32)0x8000))
#else
