...
#if defined(SUPPORT_PANEL_48HZ) || defined(SUPPORT_PANEL_CUSTOMER_SPEC) || defined(SUPPORT_PANEL_SS) || defined(SUPPORT_PANEL_DITHER)  || defined(SUPPORT_PANEL_3D_PIXEL_SIZE) || defined(SUPPORT_PANEL_3D_SG_CTRL)
...
UINT32 PANEL_GetVDelay60Hz(void)
{
    UINT32 u4Value;
    ...
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2VDelay60Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetHDelay60Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2HDelay60Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetHDutyCycle60Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2HDutyCycle60Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetVDelay50Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2VDelay50Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetHDelay50Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2HDelay50Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetHDutyCycle50Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2HDutyCycle50Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetVDelay48Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2VDelay48Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetHDelay48Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2HDelay48Hz;
    }
    else
    #endif
    {
...
UINT32 PANEL_GetHDutyCycle48Hz(void)
{
    UINT32 u4Value;
    #ifdef SUPPORT_PANEL_3D_SG_CTRL
    UINT32 u4ExtIdx = PANEL_GetExtAttributeIndex();
    if (u4ExtIdx < EXT_PANEL_INDEX_INVALID)
    {   
        u4Value = (UINT32)_arPanelAttributeExt[u4ExtIdx].u2HDutyCycle48Hz;
    }
    else
    #endif
    {
...
//  Optional function
// ------------------------------------------------------------------
#if defined(SUPPORT_PANEL_48HZ) || defined(SUPPORT_PANEL_CUSTOMER_SPEC) || defined(SUPPORT_PANEL_SS) || defined(SUPPORT_PANEL_DITHER) || defined(SUPPORT_PANEL_ERRORLIMIT_TABLE) || defined(SUPPORT_PANEL_3D_PIXEL_SIZE) || defined(SUPPORT_PANEL_3D_SG_CTRL)
static UINT32 PANEL_GetExtAttributeIndex(void)
{
    UINT32 u4ExtIdx;
	UINT32 i ;
...
void PANEL_SetVTotal(UINT16 u2VTotal48Hz, UINT16 u2VTotal50Hz, UINT16 u2VTotal60Hz)
{
    ...
    PANEL_SetVTotalMax(u2VTotal48Hz/10*12);
