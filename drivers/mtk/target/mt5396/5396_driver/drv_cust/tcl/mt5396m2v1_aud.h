 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5396M2V1_AUD_H
#define MT5396M2V1_AUD_H

#include "aud_if.h"

static const AUD_INPUT_MUX_SEL_T _armt5396m2v1AudInputMux[] = 
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    {AUD_INPUT_ID_COMP_VID_0,   3,    	    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_COMP_VID_1,   4,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    ...
    {AUD_INPUT_ID_S_VID_0,      5,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},  
    ...
    {AUD_INPUT_ID_YPBPR_1,      4,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},            
    ...
    {AUD_INPUT_ID_SCART_0,      0, 		    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_SCART_1,      1, 		    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5396m2v1AudInputMuxTable = 
{
    (sizeof(_armt5396m2v1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5396m2v1AudInputMux   
};
//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5396m2v1InterDacUsage = 
{
	AUD_CHL_L_R,
    AUD_CHL_BYPASS,
	AUD_CHL_BYPASS,    
...
static const AUD_ADAC_USAGE_T _armt5396m2v1AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
...
static const AUD_DIGITAL_DATA_T _afgmt5396m2v1AudDigitalDataUsage =
{
    TRUE,			//MCLK,BCK,LRCK
    TRUE,			//AOSDATA0
    TRUE,			//AOSDATA1
