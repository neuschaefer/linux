...
#define PANEL_BACKLIGHT_PWM_PORT            (0)//liufeng_110721	(1)
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "tcl/mt5396m2v1_aud.h"
#define AUDIO_Mute_Gpio_Num                 (0xffffff)
#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_AMP_RESET_GPIO_NUM       		(GPIO(49))
#define AUDIO_AMP_RESET_GPIO_POLARITY   AUD_GPIO_HIGH_ENALBE

#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5396m2v1AudInputMuxTable)
#define AUDIO_ADAC_USAGE                	(&_armt5396m2v1AdacUsage)
#define AUDIO_INTER_DAC_USAGE           	(&_armt5396m2v1InterDacUsage)
#define AUDIO_Digital_Data_TABLE            (&_afgmt5396m2v1AudDigitalDataUsage)
...
//----------------------------------------------------------------------------
#define FLAG_BUTTON_SUPPORT                 (1)	//liufeng_110903
#define BUTTON_INCLUDE_FILE 					"tcl/mtk_button.h"	//liufeng_110903

#ifndef T8032UP_INCLUDE_FILE
#define T8032UP_INCLUDE_FILE                "tcl/mtk_t8032fw.h"
...
#define IR_INCLUDE_FILE                     "tcl/mtk_ir.h"
#define DEFAULT_IRRX_TYPE       (IRRX_RCA_TYPE)    
#define IRRX_USR_CONFIG         0x4010         //0x4110
#define IRRX_USR_SAPERIOD		0x00D6		   //0x00EA
#define IRRX_USR_THRESHOLD      0x0001//0x0002
#define DEFAULT_IRRX_REPEAT_VALID_TIME      (100)  
#else
#define IR_INCLUDE_FILE                     "tcl/mtk_ir.h"
#endif

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "tcl/source_table.c"
#endif
...
#define HDMI_GPIO_CONF                      "tcl/hdmi_conf.c"
#endif
...
#define VGA_INCLUDE_FILE                    "tcl/mtk_vga.h"
#endif
...
#define TVE_INCLUDE_FILE                    "tcl/mtk_tve.c"
#endif
...
#define DMX_INCLUDE_FILE               "tcl/mtk_dmx.h"
#endif
