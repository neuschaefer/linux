 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5396P1V1_AUD_H
#define MT5396P1V1_AUD_H

#include "aud_if.h"

static const AUD_INPUT_MUX_SEL_T _armt5396p1v1AudInputMux[] = 
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5396p1v1AudInputMuxTable = 
{
    (sizeof(_armt5396p1v1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5396p1v1AudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5396p1v1InterDacUsage = 
{
    AUD_CHL_DOWNMIX,
    AUD_CHL_L_R,
    AUD_CHL_AUX,
...
static const AUD_ADAC_USAGE_T _armt5396p1v1AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
...
static const AUD_DIGITAL_DATA_T _afgmt5396p1v1AudDigitalDataUsage =
{
    TRUE,			//MCLK,BCK,LRCK
    TRUE,			//AOSDATA0
    FALSE,			//AOSDATA1
