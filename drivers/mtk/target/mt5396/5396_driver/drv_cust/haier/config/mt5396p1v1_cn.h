...
#define DDR3_CMD_DRIVING            		(0xCC)
//#define DDR3_CS_DRIVING 	                            (0xFF)
//#define DDR3_DQ_DRIVING                                (0xAA)
//#define DDR3_DQS_DRIVING                              (0xAA)

#define DDR3_CHA_DQS_DELAY                  (0x3522)
#define DDR3_CHB_DQS_DELAY                  (0x4466)
#if 0
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_0        (0x02010205)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_1        (0x04040007)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_2        (0x00020002)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_3        (0x01070509)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_4        (0x05060207)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_5        (0x00010101)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_6        (0x00050008)
#define DDR3_CHA_IN_DQ_DELAY_CHAIN_7        (0x05030000)

#define DDR3_CHB_IN_DQ_DELAY_CHAIN_0        (0x01040208)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_1        (0x05050008)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_2        (0x04000104)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_3        (0x01090303)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_4        (0x060A0605)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_5        (0x00010205)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_6        (0x05050409)
#define DDR3_CHB_IN_DQ_DELAY_CHAIN_7        (0x00020508)
#endif
...
#define DDR3_CHA_CMD_DELAY_4                0x80808686	// CKE, CS is here.
#define DDR3_CHA_CMD_DELAY_5                0x86808080	// ODT.
...
#endif
#define BACKLIGHT_GPIO                      (OPCTRL(4))
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "haier/mt5396p1v1_aud.h"
#if 1	//chopper haier android
#define AUDIO_Mute_Gpio_Num                 0xffffffff//chopper haier android//(GPIO(51))
#define AUDIO_MUTE_GPIO_POLARITY            AUD_GPIO_HIGH_ENALBE
#define AUDIO_Amp_Gpio_Num									(OPCTRL(10))
#define AUDIO_AMP_GPIO_POLARITY            AUD_GPIO_LOW_ENALBE//AUD_GPIO_LOW_ENALBE
#define AUDIO_DIGITAL_AMP_RESET_GPIO						(OPCTRL(8))
#define AUDIO_DIGITAL_AMP_RESET_GPIO_POLARITY   		AUD_GPIO_LOW_ENALBE//AUD_GPIO_LOW_ENALBE
#define AUDIO_AMP_CUST_FILE_NAME						"haier/adac_sta339.c"
#else
#define AUDIO_Mute_Gpio_Num                 (GPIO(51))
#define AUDIO_Amp_Gpio_Num                  (GPIO(49))
#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#endif
//#define AUDIO_AMP_GPIO_POLARITY             AUD_AMP_GPIO_LOW_ENALBE
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5396p1v1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_armt5396p1v1InterDacUsage)
#define AUDIO_Digital_Data_TABLE            (&_afgmt5396p1v1AudDigitalDataUsage)
#define AUDIO_ADAC_USAGE                    (&_armt5396p1v1AdacUsage)
#define AUDIO_HP_PLUG_IN_GPIO               0xffffffff//chopper haier android//(OPCTRL(6))
#define AUDIO_HP_PLUG_IN_POLARITY           (AUD_GPIO_LOW_ENALBE)

//----------------------------------------------------------------------------
// Other GPIO customization
#if 1	//chopper haier 5326 android
#define DEFAULT_TUNER_RFAGC_SWITCH_GPIO 0xffffffff//MT5396 m2v1 use OPCTRL8
#else
...
#define CI_5V_POWERON_GPIO                  (GPIO(54))
...
#define USB3_VBUS_GPIO                      OPCTRL10
...
#define T8032UP_INCLUDE_FILE                "haier/mtk_t8032fw.h"
...
// MTK IR only setting
//----------------------------------------------------------------------------
#define IR_INCLUDE_FILE                     "haier/mtk_ir.h"

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "haier/source_table.c"
#endif
...
#define HDMI_GPIO_CONF                      "haier/hdmi_conf.c"
#endif
...
#define VGA_INCLUDE_FILE                    "haier/mtk_vga.h"
#endif
...
#define TVE_INCLUDE_FILE                    "haier/mtk_tve.c"
#endif
...
#define DMX_INCLUDE_FILE               "haier/mtk_dmx.h"
#endif
...
//----------------------------------------------------------------------------
#ifdef CC_USE_512MB_NAND
#define MAX_UPGRADE_IMAGE_FILE_SIZE         (512*1024*1024)     /* 128 MB */
#else
...
#define NAND_FLASH_TOTAL_SIZE            (512*1024*1024)
    ...
    #define NAND_PART_SIZE_2                (0x0100000)         /* nand_2 - sig A            */
    #define NAND_PART_SIZE_3                (0x0100000)         /* nand_3 - sig B            */
    #define NAND_PART_SIZE_4                (0x0300000)         /* nand_4 - kernel          */
    #define NAND_PART_SIZE_5                (0x0300000)         /* nand_5 - kernel_Recovery         */
    #define NAND_PART_SIZE_6                (0x1000000)         /* nand_6 - rootfs         */
    #define NAND_PART_SIZE_7                (0x1000000)         /* nand_7 - rootfs_Recovery         */
    #define NAND_PART_SIZE_8                (0x6E00000)         /* nand_8 - system        110    */
    #define NAND_PART_SIZE_9                (0x6400000)         /* nand_9 - cache          100    */
    #define NAND_PART_SIZE_10               (0xEB00000)         /* nand_10 - userdata    235    */
    ...
    #define NAND_PART_SIZE_16               (0x0200000)         /* nand_16 - Capture Logo  2   */
    #define NAND_PART_SIZE_17               (0x0400000)         /* nand_16 - misc  4*/
    #define NAND_PART_SIZE_18               (0x1000000)         /* nand_16 - recovery   16 */
#else
...
#define NAND_FLASH_TOTAL_SIZE            (256*1024*1024)
    ...
    #define NAND_PART_SIZE_6                (0x1000000)         /* nand_6 - rootfs         */
    #define NAND_PART_SIZE_7                (0x1000000)         /* nand_7 - rootfs_Recovery         */
    #define NAND_PART_SIZE_8                (0x5A00000)         /* nand_8 - system            */
    #define NAND_PART_SIZE_9                (0x1E00000)         /* nand_9 - cache              */
    #define NAND_PART_SIZE_10               (0x5A00000)         /* nand_10 - userdata            */
    #define NAND_PART_SIZE_11               (0x0020000)         /* nand_11 - reserved        */
    #define NAND_PART_SIZE_12               (0x0040000)         /* nand_12 - channel list A  */
    #define NAND_PART_SIZE_13               (0x0040000)         /* nand_13 - channel list B  */
    #define NAND_PART_SIZE_14               (0x0020000)         /* nand_14 - Flash PQ        */
    ...
    #define NAND_PART_NAME_11               "reserved"
...
#ifdef CC_USE_512MB_NAND
    #define NAND_PART_NAME_17               "misc"
    #define NAND_PART_NAME_18               "recovery"
#endif
...
//#define QTYTBL_INCLUDE_FILE               "haier/QTY_DEFAULT/mtk_QtyTbl.h"
#endif
...
//#define COLOR_PARAM_INCLUDE_FILE          "haier/PANEL_DEFAULT/color_param.h"
#endif
...
#define DRV_LOGO_H_FILE                 "haier/MediaTek_Mpeg2Logo.h"
#else
#define DRV_LOGO_H_FILE                 "haier/MediaTek_DrvLogo.h"
#endif
#define DRV_POWER_MUSIC_H_FILE          "haier/mtk_PowerMusic.h"
