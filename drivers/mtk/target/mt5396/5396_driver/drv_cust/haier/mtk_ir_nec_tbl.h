...
#if 1//HF_HAIER_IR wangle_debug
static const KEYUNIT_T _arHaierTvKeyMap[] =
{
    { 0x00, BTN_DIGIT_1 },
    { 0x01, BTN_DIGIT_2 },
    { 0x02, BTN_DIGIT_3 },
    ...
    { 0x08, BTN_DIGIT_9 },
    { 0x09, BTN_DIGIT_0 },
    #if 1//defined(HAIER_MENU_SETTINGS)                                //dai   debug  20100831
     { 0x0a, BTN_PREV_PRG },
   #else
     { 0x0a, BTN_REPEAT },  
   #endif   
    ...
    { 0x1c, BTN_MENU },
    { 0x1d, BTN_EXIT },
    //{ 0x1f, BTN_ROOT_MENU },//BTN_MEM_CARD },//dks_debug
    { 0x1f, BTN_MEM_CARD },
    { 0x20, BTN_PRG_INFO },
	{ 0x28, BTN_PREV },         // james xiong modify  20100908
	{ 0x29, BTN_NEXT},           // james xiong modify 20100908
    //{ 0x30, BTN_HAIER_SCAN},
    { 0x3d, BTN_FAV_CH },
    { 0x40, BTN_HDMI},
	//{ 0x41, BTN_CHLD_LCK},
    ...
    { 0x5f, BTN_GREEN },
    { 0x61, BTN_YELLOW },
    { 0x62, BTN_BLUE },     //dai   20100929
    { 0x64, BTN_CURSOR_UP },
    { 0x65, BTN_CURSOR_LEFT },
    { 0x66, BTN_CURSOR_DOWN },
    { 0x67, BTN_CURSOR_RIGHT },
    { 0x68, BTN_SELECT }, 
    { 0x69, BTN_RETURN },//{ 0x69, BTN_PREV },   // james xiong modify 20100908
    { 0x6a, BTN_FR },
    { 0x6b, BTN_FF }, 
    { 0x6c, BTN_PAUSE },        //dai   add  20100914
   	//{ 0x8a, BTN_3D_CTRL},
