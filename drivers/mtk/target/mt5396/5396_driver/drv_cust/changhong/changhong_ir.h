...
#include "changhong/changhong_ir_nec_tbl.h"
// #include "mtk/mtk_ir_rc5_code_tbl.h"
#include "changhong/mtk_ir_rc5_func_tbl.h"
...
static const KEYARRAY_T _arKeyArray[] =
{
    ...
    { 0xbf40, (sizeof(_arUserKeyMap)/sizeof(KEYUNIT_T)), _arUserKeyMap },
    { 0x6180, (sizeof(_arFactoryKeyMap)/sizeof(KEYUNIT_T)), _arFactoryKeyMap },
};
#endif /* KEY_ARRAY */

static const WAKEUPKEYUNIT_T _arUserWakeupKeyMap[] =
{
...
{
    { 0xbf40, (sizeof(_arUserWakeupKeyMap)/sizeof(WAKEUPKEYUNIT_T)), _arUserWakeupKeyMap }  /* Only command with system code 0 is allowed to wakeup */  	
};
