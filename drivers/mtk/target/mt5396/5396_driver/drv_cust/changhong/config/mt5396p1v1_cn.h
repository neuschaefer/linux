...
#define DEFAULT_DDR_CLOCK                   ((IO_READ32(0xF0008000, 0x1f0) >= 0x53960001) ? (1512000000) : (1404000000))
#define DEFAULT_DDR_BUS_X8                  (1)
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "changhong/mt5396p1v1_aud.h"
...
//----------------------------------------------------------------------------
#define CI_8295_RESET_GPIO                  (GPIO(50))  // It's GPIO_3 on schematic, but we should use 54. (reference to x_pinmux.h)
//#define CI_8295_RESET_POLARITY            (0)
#define CI_EXTERNAL_IC_INT_GPIO             (GPIO(62))  // Set:Interrupt Mode, UnSet:Polling Mode
//#define CI_5V_OC_GPIO                      (MT5135_GPIO(16)) // PAD_IF_AGC of mt5135
#ifdef CC_EXTERNAL_CI
#define CI_5V_POWERON_GPIO                  (MT8295_GPIO(9))
#else
#define CI_5V_POWERON_GPIO                  (GPIO(48))
#endif

#define CI_5V_POWERON_POLARITY              (1)
//#define CI_5V_OC_POLARITY                 (0)
#define CI_EXTERNAL_IC_DRIVING_CURRENT      (4)         // 2mA
...
#define T8032UP_INCLUDE_FILE                "changhong/mtk_t8032fw.h"
#define T8032UP_OFFSET                      au1T8032FW
#define T8032UP_SIZE                        24576//16384
#endif

//----------------------------------------------------------------------------
// changhong IR only setting
//----------------------------------------------------------------------------
#define IR_INCLUDE_FILE                     "changhong/changhong_ir.h"

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "changhong/source_table.c"
#endif
...
#define HDMI_GPIO_CONF                      "changhong/hdmi_conf.c"
#endif
...
#define VGA_INCLUDE_FILE                    "changhong/mtk_vga.h"
#endif
...
#define TVE_INCLUDE_FILE                    "changhong/mtk_tve.c"
#endif
...
#define DMX_INCLUDE_FILE               "changhong/mtk_dmx.h"
#endif

//----------------------------------------------------------------------------
// PCIE configuration
//----------------------------------------------------------------------------
#define PCIE_RESET_GPIO         GPIO(47)
...
//#define QTYTBL_INCLUDE_FILE               "changhong/QTY_DEFAULT/mtk_QtyTbl.h"
#endif
...
//#define COLOR_PARAM_INCLUDE_FILE          "changhong/PANEL_DEFAULT/color_param.h"
#endif
