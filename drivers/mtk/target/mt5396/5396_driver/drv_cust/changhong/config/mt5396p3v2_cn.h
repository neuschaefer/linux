...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "changhong/changhong_mt5396p3v1_aud.h"
...
#define AUDIO_AMP_RESET_GPIO_NUM            (GPIO(50))
#define AUDIO_AMP_RESET_GPIO_POLARITY		(AUD_GPIO_HIGH_ENALBE)

//#define AUDIO_AMP_GPIO_POLARITY             AUD_AMP_GPIO_LOW_ENALBE
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5396p3v1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_armt5396p3v1InterDacUsage)
#define AUDIO_Digital_Data_TABLE            (&_afgmt5396p3v1AudDigitalDataUsage)
#define AUDIO_ADAC_USAGE                    (&_armt5396p3v1AdacUsage)
