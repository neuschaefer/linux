...
static const AUD_INPUT_MUX_SEL_T _arLgeAudInputMux[] = 
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    ...
    {AUD_INPUT_ID_YPBPR_1,      0,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},            
    ...
    {AUD_INPUT_ID_DVI_2,        2,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_DVI_3,        2,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_DVI_4,        2,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rLgeAudInputMuxTable = 
{
    (sizeof(_arLgeAudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _arLgeAudInputMux   
};
...
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _arLgeInterDacUsage = 
{
    AUD_CHL_DOWNMIX,
    AUD_CHL_AUX,
    AUD_CHL_L_R,
...
static const AUD_ADAC_USAGE_T _arLgeAdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
...
static const AUD_DIGITAL_DATA_T _afgLgeAudDigitalDataUsage =
{
    TRUE,			//MCLK,BCK,LRCK
    TRUE,			//AOSDATA0
    FALSE,			//AOSDATA1
...
static const BOOL _aafgLgeAudInputSrcAgcFlag[AUD_DEC_NUM][AUD_STREAM_FROM_NUM] =
{
