...
source_detect_t src_det_tbl[] =
{
   ...
   {SV_VS_CVBS3,   TRUE  }, //SRC_DET_CVBS3,
   {SV_VS_CVBS4,   TRUE  }, //SRC_DET_CVBS4,
   {SV_VS_S1,      TRUE }, //SRC_DET_S1,
   {SV_VS_S2,      TRUE }, //SRC_DET_S2,
   {SV_VS_S3,      TRUE }, //SRC_DET_S3,
   {SV_VS_YPbPr1,  TRUE  }, //SRC_DET_YPbPr1,
   {SV_VS_YPbPr2,  FALSE }, //SRC_DET_YPbPr2,
   {SV_VS_VGACOMP1,TRUE }, //SRC_DET_VGACOMP1,
   {SV_VS_VGA,     TRUE }, //SRC_DET_VGA,
   {SV_VS_HDMI1,   FALSE }, //SRC_DET_HDMI1,
   {SV_VS_HDMI2,   FALSE }, //SRC_DET_HDMI2,
   {SV_VS_HDMI3,   FALSE }, //SRC_DET_HDMI3,
   {SV_VS_HDMI4,   FALSE }, //SRC_DET_HDMI4,
...
const rPortmap_t portmap_table[] =
{
	...
	{SV_VS_CVBS1	,P_C1	,AVMUX(CVBS0,0), 0},
	{SV_VS_CVBS2	,P_C2	,AVMUX(CVBS1,0), 0},
	{SV_VS_CVBS3	,P_C3	,AVMUX(CVBS2,0), 0},
	{SV_VS_CVBS4	,P_C4	,AVMUX(CVBS3,0), 0},

	{SV_VS_ATD1 ,	P_C0	,AVMUX(CVBS0,0), 0},

	{SV_VS_S1	,	P_SV0	,AVMUX(SY1,SC1), 0},
	...
	{SV_VS_SCART1 	,P_FB0	,AVMUX(CVBS2,SC2), P_YP0},	//PT board
	{SV_VS_SCART2	,P_FB1	,AVMUX(CVBS3,SC2), P_YP1},	//DV board

	{SV_VS_SCART3 	,P_FB0	,AVMUX(CVBS0,SC2), P_YP0},	//reserved
	{SV_VS_SCART4	,P_FB1	,AVMUX(CVBS4,SC2), P_YP1},	//reserved
	...
	for(i=0;i<2;i++)
	{
		...
		switch(VSS_MAJOR(bSrc))
		{
			...
			case VSS_DVI:
				...
				vHDMISetSwitch(HDMI_SWITCH_1+VSS_MINOR(bSrc));
				break;
			/*
			case VSS_SCART:
