...
{
    // GENERAL
    {0x60, 0x90, 0x88, FROM_DFT, QUALITY_CONTRAST},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_CONTRAST_MSB},
    {0x4E, 0xB2, 0x80, FROM_DFT, QUALITY_BRIGHTNESS},
    {0x00, 0xFF, 0x80, FROM_DFT, QUALITY_SATURATION},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_SATURATION_MSB},
    {0x60, 0xA0, 0x80, FROM_DFT, QUALITY_HUE}, 
    {0x80, 0x80, 0x80, FROM_DFT, QUALITY_BACKLIGHT},
    // HSHARP
    {0x20, 0x40, 0x40, FROM_DFT, QUALITY_HSHARP_LOW},
    {0x20, 0x40, 0x40, FROM_DFT, QUALITY_HSHARP_LOW_NEG},
    {0x20, 0x40, 0x40, FROM_DFT, QUALITY_HSHARP_MID},
    {0x20, 0x40, 0x40, FROM_DFT, QUALITY_HSHARP_MID_NEG},
    {0x20, 0x40, 0x40, FROM_DFT, QUALITY_HSHARP_HIGH},
    {0x20, 0x40, 0x40, FROM_DFT, QUALITY_HSHARP_HIGH_NEG},
    ...
    {0x00, 0x10, 0x00, FROM_DFT, QUALITY_TDSHARP_GAIN_H1},
    {0x00, 0x30, 0x00, FROM_DFT, QUALITY_TDSHARP_GAIN_H2},
    {0x00, 0x30, 0x00, FROM_DFT, QUALITY_TDSHARP_GAIN_H3},
    ...
    {0x00, 0x40, 0x00, FROM_DFT, QUALITY_TDSHARP_GAIN_V1},
    {0x00, 0x40, 0x00, FROM_DFT, QUALITY_TDSHARP_GAIN_V2},
    ...
    {0x00, 0x28, 0x00, FROM_DFT, QUALITY_LTI_GAIN_LTI_H1},
    ...
    {0x00, 0x30, 0x00, FROM_DFT, QUALITY_LTI_GAIN_LTI_H2},
    ...
    {0x00, 0x20, 0x00, FROM_DFT, QUALITY_LTI_GAIN_LTI_V},
    ...
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_CTIF_U_WND_SZ},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_CTIF_V_WND_SZ},
    ...
    // BLUE STRETCH
    {0x01, 0x01, 0x01, FROM_DFT, QUALITY_BLUE_STRETCH_ENABLE},
    {0x80, 0x74, 0x7A, FROM_DFT, QUALITY_BLUE_STRETCH_GAIN_R},
    {0x80, 0x74, 0x7A, FROM_DFT, QUALITY_BLUE_STRETCH_GAIN_G},
    {0x80, 0x80, 0x80, FROM_DFT, QUALITY_BLUE_STRETCH_GAIN_B},
    {0x00, 0x00, 0x40, FROM_DFT, QUALITY_BLUE_STRETCH_LUMA_THD},
    ...
    {0x00, 0x80, 0x80, FROM_DFT, QUALITY_SCE_SAT_GAIN},
    ...
    {0x00, 0x00, 0x80, FROM_DFT, QUALITY_SKIN_SAT_GAIN},
    {0x60, 0xA0, 0x80, FROM_DFT, QUALITY_SKIN_HUE_GAIN}
};
...
{
    #include "QTY_TBL_HDMI_SD.h"           // {SOURCE_TYPE_TIMING_RFTV_NTSC_358,      SOURCE_TYPE_TIMING_RFTV_PAL_60},        // [0]
    #include "QTY_TBL_HDMI_SD.h"           // {SOURCE_TYPE_TIMING_CVBS_NTSC_358,      SOURCE_TYPE_TIMING_SV_PAL_60},          // [1]
    #include "QTY_TBL_HDMI_SD.h"        // {SOURCE_TYPE_TIMING_CVBS_NTSC_358_OS,   SOURCE_TYPE_TIMING_SV_PAL_60_OS},       // [2]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_SECAM_RFTV,         SOURCE_TYPE_TIMING_SECAM_RFTV},         // [3]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_SECAM_CVBS,         SOURCE_TYPE_TIMING_SECAM_SV},           // [4]
    #include "QTY_TBL_HDMI_SD.h"      // {SOURCE_TYPE_TIMING_SCART_RGB,          SOURCE_TYPE_TIMING_SCART_RGB},          // [5]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_SCART_AV_NTSC_358,  SOURCE_TYPE_TIMING_SCART_SV_SECAM},     // [6]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_YPBPR_SD_I_50,      SOURCE_TYPE_TIMING_YPBPR_SD_I_60_OS},   // [7]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_YPBPR_SD_P_50,      SOURCE_TYPE_TIMING_YPBPR_SD_P_60_OS},   // [8]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_YPBPR_720P_50,      SOURCE_TYPE_TIMING_YPBPR_720P_60},      // [9]
    #include "QTY_TBL_HDMI_SD.h"     // {SOURCE_TYPE_TIMING_YPBPR_1080I_50,     SOURCE_TYPE_TIMING_YPBPR_1080P_60},     // [10]
    #include "QTY_TBL_HDMI_SD.h"      // {SOURCE_TYPE_TIMING_DIGI_SD_I_50,       SOURCE_TYPE_TIMING_DIGI_SD_I_60},       // [11]
    #include "QTY_TBL_HDMI_SD.h"      // {SOURCE_TYPE_TIMING_DIGI_SD_P_50,       SOURCE_TYPE_TIMING_DIGI_SD_P_60},       // [12]
    #include "QTY_TBL_HDMI_SD.h"      // {SOURCE_TYPE_TIMING_DIGI_720P_50,       SOURCE_TYPE_TIMING_DIGI_720P_60},       // [13]
    #include "QTY_TBL_HDMI_SD.h"      // {SOURCE_TYPE_TIMING_DIGI_1080I_50,      SOURCE_TYPE_TIMING_DIGI_1080P_60},      // [14]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_DTV_SD_I_50,        SOURCE_TYPE_TIMING_DTV_SD_I_60},        // [15]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_DTV_SD_P_50,        SOURCE_TYPE_TIMING_DTV_SD_P_60},        // [16]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_DTV_720P_50,        SOURCE_TYPE_TIMING_DTV_720P_60},        // [17]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_DTV_1080I_50,       SOURCE_TYPE_TIMING_DTV_1080P_60},       // [18]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_MM_SD_I,       SOURCE_TYPE_TIMING_MM_SD_P},       // [19]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_MM_720P_SD,       SOURCE_TYPE_TIMING_MM_720P_SD},       // [20]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_MM_720P_HD,       SOURCE_TYPE_TIMING_MM_720P_HD},       // [21]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_MM_1080IP_SD,       SOURCE_TYPE_TIMING_MM_1080IP_SD},       // [22]
    #include "QTY_TBL_HDMI_SD.h"       // {SOURCE_TYPE_TIMING_MM_1080IP_HD,       SOURCE_TYPE_TIMING_MM_1080IP_HD},       // [23]
