...
#define FBM_DMX2_SSIF_EXTEND_SIZE 0x500000
#else
#define FBM_DMX2_SSIF_EXTEND_SIZE 0x0
#endif
#if defined(CC_FBM_INT_VOMX)
#define FBM_TWO_FBP_SIZE (0x800000 + 0x02900000 + 0x10c0000 + 0x530000 + FBM_DMX2_SSIF_EXTEND_SIZE + FBM_H264_LEVEL50_SIZE)
#elif defined(CC_VOMX_TV_COEXIST)
#define FBM_TWO_FBP_SIZE (0x800000 + 0x2F00000 + 0x300000+ FBM_DMX2_SSIF_EXTEND_SIZE + FBM_H264_LEVEL50_SIZE)
#elif defined(CC_FBM_TWO_FBP)
#define FBM_TWO_FBP_SIZE (0x800000 + 0x1B00000 + 0x530000 + FBM_DMX2_SSIF_EXTEND_SIZE + FBM_H264_LEVEL50_SIZE)
#else
...
#define FBM_MEM_CFG_MT5396_DDR3x4           (0xd005000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_H264_LEVEL50_SIZE + FBM_DRM_BUF_SIZE)

#ifndef FBM_DMX_PID_BUF
#define FBM_DMX_PID_BUF 0x0
#endif

#if defined(CC_SUPPORT_5_SEC_PTS_PCR_OFFSET)
#define FBM_MEM_CFG_MT5396_3DTV           (0xA00000 + 0x5770000 + 0xA20000 + 0x400000 + FBM_DMX_PID_BUF + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE+ FBM_VSS_SIZE + FBM_H264_LEVEL50_SIZE + FBM_DRM_BUF_SIZE)
#elif defined(CC_SUPPORT_2_SEC_PTS_PCR_OFFSET)
#define FBM_MEM_CFG_MT5396_3DTV           (0xA00000 + 0x5770000 + 0x1A0000 + FBM_DMX_PID_BUF + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE+ FBM_VSS_SIZE + FBM_H264_LEVEL50_SIZE + FBM_DRM_BUF_SIZE)
#else
#define FBM_MEM_CFG_MT5396_3DTV           (0xA00000 + 0x5770000 + FBM_DMX_PID_BUF + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE+ FBM_VSS_SIZE + FBM_H264_LEVEL50_SIZE + FBM_DRM_BUF_SIZE)
#endif
#define FBM_MEM_CFG_MT5396_3DTV_CHA_NOMJC           (0x6c70000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_VSS_SIZE + FBM_H264_LEVEL50_SIZE + FBM_DRM_BUF_SIZE)

#define FBM_MEM_CFG_MT5501_3DNET               (0x3200000 + FBM_OD_SIZE + FBM_VENC_SIZE  + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_H264_LEVEL50_SIZE + FBM_DRM_BUF_SIZE)
...
#define TOTAL_GPIO_NUMBER           (183)
#define TOTAL_MT8292_GPIO_NUMBER    (10)
#define TOTAL_MT8295_GPIO_NUMBER    (15)
#define TOTAL_OPCTRL_NUMBER         (41)

// ServoADC
#define MAX_SERVOADC_NUM            TOTAL_SERVOADC_NUMBER

// GPIO alias
#define GPIO_OPWM0              (109)
#define GPIO_OPWM1              (110)
#define GPIO_OPWM2              (111)
#define GPIO(x)                 (x)
...
#define SERVO_GPIO2             (231)
#define SERVO_GPIO3             (232)
