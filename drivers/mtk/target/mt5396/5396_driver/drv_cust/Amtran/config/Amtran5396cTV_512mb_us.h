...
// Audio/0 > B2R/5 > NR/PSCAN/4 > Scpip/7 > OSD/OD/3 > MJC_IN/13 > Mjc_out/14 > VLD/9 > VDEC_MC/8 > CPU/6 > Gfx/11 > Demux/PVR/1 > VBI/3D/TVE/2 > VENC/12 > TEST0/15 > 3DGfx/10
...
#ifdef ANDROID
    #define DIRECT_FB_MEM_SIZE                  (16 * 1024 * 1024)
...
#endif
#define BACKLIGHT_GPIO                      (GPIO(5))//(OPCTRL(4))
#define BACKLIGHT_ON_VAL                    (1)
#define PANELPOWER_GPIO                     (GPIO(46))//(OPCTRL(9))
...
#define PANEL_BACKLIGHT_PWM_PORT            (0)//(1)

#define PDWNC_POLARITY                      (0)

#define LVDS_A_CTRL_EVEN (2)
#define LVDS_A_CTRL_ODD  (3) 
#define LVDS_B_CTRL_EVEN (0)
#define LVDS_B_CTRL_ODD  (1)
//----------------------------------------------------------------------------
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5396m2v1_aud.h"
//#define AUDIO_Mute_Gpio_Num             (GPIO(51))
#define AUDIO_Amp_Gpio_Num                (GPIO(35))//(OPCTRL(3))
...
//----------------------------------------------------------------------------
#define SYSTEM_EEPROM_SIZE                  (8192)
#define SYSTEM_EEPROM_WP_GPIO               (GPIO(52))   // GPIO11.
#define SYSTEM_EEPROM_WP_ENABLE_POLARITY    (1)
//#define EDID_EEPROM_WP_GPIO			        (GPIO(4))   // GPIO14.
//#define EDID_EEPROM_WP_ENABLE_POLARITY      (1)

#define DRVCUST_EEPROM_VGA_EDID_OFFSET	((UINT32)0x1A00)
#define DRVCUST_VGA_EDID_SIZE           ((UINT32)128)
#define DRVCUST_HDMI_EDID_STORAGE_SIZE  ((UINT32)(DRVCUST_HDMI_EDID_SIZE))

//----------------------------------------------------------------------------
// USB Customization
//----------------------------------------------------------------------------
#define USB0_VBUS_GPIO                      GPIO(36)//GPIO(43)        // GPIO43.
...
#define USB0_OC_GPIO                        GPIO(28)//ADIN(4)         // ADIN 4.
...
#define BUTTON_INCLUDE_FILE                 "Amtran/Amtran_button.h"
...
// MTK IR only setting
//----------------------------------------------------------------------------
#define IR_INCLUDE_FILE                     "Amtran/Amtran_ir.h"
...
#define PANEL_DISPLAY_TYPE_ALLOWED_MASK ((1<<PANEL_DISPLAY_TYPE_LVDS) | (1 << PANEL_DISPLAY_TYPE_MLVDS) | (1 << PANEL_DISPLAY_TYPE_EPI))

#ifndef TCON_CUST_FILE
#define TCON_CUST_FILE                      "Amtran/Amtran_tcon_cust.c"
#endif
...
// NAND customization
//----------------------------------------------------------------------------
#define NAND_FLASH_TOTAL_SIZE               (2000*1024*1024ULL)

#define NAND_PART_END                       (18)                /* total 16 Partitions */

#ifndef LINUX_NAND_USE_SDM
    #define NAND_PART_SIZE_0                (20 * 1024 * 1024)         /* loader image              */
    #define NAND_PART_SIZE_1                (20 * 1024 * 1024)         /* nand_1 - uboot env        */
    #define NAND_PART_SIZE_2                (20 * 1024 * 1024)         /* nand_2 - sig A            */
    #define NAND_PART_SIZE_3                (20 * 1024 * 1024)         /* nand_3 - sig B            */
    #define NAND_PART_SIZE_4                (20 * 1024 * 1024)         /* nand_4 - kernel A         */
    #define NAND_PART_SIZE_5                (20 * 1024 * 1024)         /* nand_5 - kernel B         */
    #define NAND_PART_SIZE_6                (20 * 1024 * 1024)         /* nand_6 - rootfs A         */
    #define NAND_PART_SIZE_7                (20 * 1024 * 1024)         /* nand_7 - rootfs B         */
    #define NAND_PART_SIZE_8                (400 * 1024 * 1024)         /* nand_8 - basic            */
    #define NAND_PART_SIZE_9                (900 * 1024 * 1024)         /* nand_9 - 3rd              */
    #define NAND_PART_SIZE_10               (80 * 1024 * 1024)         /* nand_10 - perm            */
    #define NAND_PART_SIZE_11               (4 * 1024 * 1024)         /* nand_11 - reserved        */
    #define NAND_PART_SIZE_12               (4 * 1024 * 1024)         /* nand_12 - channel list A  */
    #define NAND_PART_SIZE_13               (4 * 1024 * 1024)         /* nand_13 - channel list B  */
    #define NAND_PART_SIZE_14               (4 * 1024 * 1024)         /* nand_14 - Flash PQ        */
    #define NAND_PART_SIZE_15               (4 * 1024 * 1024)         /* nand_15 - Flash AQ        */
    #define NAND_PART_SIZE_16               (4 * 1024 * 1024)         /* nand_16 - Capture Logo    */
    ...
    #define NAND_FLASH_STATIC_PART_SIZE \
        ...
        #ifndef CC_NANDBOOT_SUPPORT_8K        
        #define NAND_PART_SIZE_17               (0x80000)                     /* nand_17 - EEPROM A (must be one block size) */
        #define NAND_PART_SIZE_18               (0x80000)                     /* nand_18 - EEPROM B (must be one block size) */
        #else
        #define NAND_PART_SIZE_17               (0x0200000)                     /* nand_17 - EEPROM A (must be one block size) */
        #define NAND_PART_SIZE_18               (0x0200000)                     /* nand_18 - EEPROM B (must be one block size) */
        #endif        
    #endif
