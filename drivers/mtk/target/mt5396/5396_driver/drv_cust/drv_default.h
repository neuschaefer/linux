...
#define DRAM_PRIORITY_LIST          ((UINT8*)"08253194bafcd67e")
#endif
...
#endif
#ifndef LOADER_RECOVERY_GPIO_1
#define LOADER_RECOVERY_GPIO_1    (GPIO(52))
#endif
#ifndef LOADER_RECOVERY_GPIO_2
#define LOADER_RECOVERY_GPIO_2    (GPIO(53))
#endif
//----------------------------------------------------------------------------
// Loader logo
//----------------------------------------------------------------------------
...
#define LOADER_LED_TWINKLE          (0)  // in ms
#endif
...
#ifndef DEFAULT_DEMOD_RESET_GPIO
#define DEFAULT_DEMOD_RESET_GPIO    (GPIO(201))
#endif
...
#define AUDIO_POWERSTAGE_USE_AL1AR1          (TRUE)
#endif
...
//FLASH_AQ for 5387 customer model
        		...
        		#ifdef CC_PARTITION_SHIFT_SUPPORT
...
//----------------------------------------------------------------------------
    ...
    #define NAND_PART_OFFSET_31             (NAND_PART_OFFSET_30+NAND_PART_SIZE_30)
        ...
        #ifdef LINUX_TURNKEY_SOLUTION
	#ifdef CC_3RD_RO 	
		#define NAND_PART_NAME_12		"3rd_ro"
	#else
        ...
        #define NAND_PART_NAME_31               "part_31"
            ...
            #define NAND_PART_ENCRYPT_11            (0)
        		...
        		#ifdef CC_PARTITION_SHIFT_SUPPORT
            #define NAND_PART_ENCRYPT_12            (1) /*3rd_ro*/
            #else
            #define NAND_PART_ENCRYPT_12            (0) /*3rd_ro*/
            #endif
        #endif
