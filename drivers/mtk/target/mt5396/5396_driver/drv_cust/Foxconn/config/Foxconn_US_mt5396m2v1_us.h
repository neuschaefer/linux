...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "Foxconn/Lara_US_aud.h"
...
#define T8032UP_INCLUDE_FILE                "Foxconn/Lara_US_t8032fw.h"
...
// MTK IR only setting
//----------------------------------------------------------------------------
#define IR_INCLUDE_FILE                     "Foxconn/Lara_US_ir.h"

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "Foxconn/Lara_US_source_table.c"
#endif
...
#define HDMI_GPIO_CONF                      "Foxconn/Lara_US_hdmi_conf.c"
#endif
...
#define VGA_INCLUDE_FILE                    "Foxconn/Lara_US_vga.h"
#endif
...
#define TCON_CUST_FILE                      "Foxconn/Lara_US_tcon_cust.c"
#endif
...
#define TVE_INCLUDE_FILE                    "Foxconn/Lara_US_tve.c"
#endif
...
#define DMX_INCLUDE_FILE               "Foxconn/Lara_US_dmx.h"
#endif
