...
#include                                    "Foxconn/Figaro_eeprom_layout.h"
...
//----------------------------------------------------------------------------
#define MAX_UPGRADE_IMAGE_FILE_SIZE         NAND_FLASH_TOTAL_SIZE
...
#define SIZE_OF_3RD                         (0x16000000)
#define SIZE_OF_CHANNEL_LIST                (0x0200000)
#define SIZE_OF_PQ                          (0x1400000)
#else
/* DEMO_BOARD */
#define NAND_FLASH_TOTAL_SIZE               (256*1024*1024)
#define SIZE_OF_3RD                         (0x8600000)
#define SIZE_OF_CHANNEL_LIST                (0x0040000)
#define SIZE_OF_PQ                          (0x0200000)
#endif

#define NAND_PART_END                       (20)                /* total 20 Partitions */
...
#define NAND_PART_SIZE_8                    (0x2800000)         /* nand_8 - basic A          */
#define NAND_PART_SIZE_9                    (0x2800000)         /* nand_9 - basic B          */
#define NAND_PART_SIZE_10                   SIZE_OF_3RD         /* nand_10 - 3rd             */
#define NAND_PART_SIZE_11                   (0x0500000)         /* nand_11 - perm            */
#define NAND_PART_SIZE_12                   (0x0020000)         /* nand_12 - reserved        */
#define NAND_PART_SIZE_13                   SIZE_OF_CHANNEL_LIST/* nand_13 - channel list A  */
#define NAND_PART_SIZE_14                   SIZE_OF_CHANNEL_LIST/* nand_14 - channel list B  */
#define NAND_PART_SIZE_15                   SIZE_OF_PQ          /* nand_15 - Flash PQ        */
#define NAND_PART_SIZE_16                   (0x0080000)         /* nand_16 - Flash AQ        */
#define NAND_PART_SIZE_17                   (0x0020000)         /* nand_17 - Flash Panel     */
#define NAND_PART_SIZE_18                   (0x0020000)         /* nand_18 - ci              */
#define NAND_PART_SIZE_19                   (0x0020000)         /* nand_19 - edid            */
#define NAND_PART_SIZE_20                   (0x0020000)         /* nand_20 - Service mode    */


/* The NAND_PART_NAME_0-7 use default names. */
#define NAND_PART_NAME_8                    "basicA"
#define NAND_PART_NAME_9                    "basicB"
#define NAND_PART_NAME_10                   "rw_area"
#define NAND_PART_NAME_11                   "perm"
...
#define NAND_PART_NAME_17                   "panel"
#define NAND_PART_NAME_18                   "ci"
#define NAND_PART_NAME_19                   "edid"
#define NAND_PART_NAME_20                   "svc"
...
#define PINMUX_INCLUDE_FILE                 "Figaro/Figaro_pin_setup.h"
#endif
...
//#define AUDIO_AMP_CUST_FILE_NAME        "mtk/amp_cust.c"
    ...
    */
    ...
    #define DDR3_CHA_CMD_DELAY_0  0x84848484   
  
    
    #define DDR3_CHA_CMD_DELAY_1  0x84848484
    
   
    #define DDR3_CHA_CMD_DELAY_2  0x84848484
   
   
    #define DDR3_CHA_CMD_DELAY_3  0x84848484
    
    
    #define DDR3_CHA_CMD_DELAY_4  0x84848484	// CKE, CS is here.
    
    
    #define DDR3_CHA_CMD_DELAY_5  0x84848484	// ODT.
    
    
    #define DDR3_CHA_CMD_DELAY_6  0x84848484
    
    
    #define DDR3_CHB_CMD_DELAY_0  0x84848484
    
    
    #define DDR3_CHB_CMD_DELAY_1  0x84848484
    
   
    #define DDR3_CHB_CMD_DELAY_2  0x84848484
    
    #define DDR3_CHB_CMD_DELAY_3  0x84848484
    
    #define DDR3_CHB_CMD_DELAY_4  0x84848484	// CKE, CS is here.
    
    #define DDR3_CHB_CMD_DELAY_5  0x84848484	// ODT is here.
   
    #define DDR3_CHB_CMD_DELAY_6  0x84848484
