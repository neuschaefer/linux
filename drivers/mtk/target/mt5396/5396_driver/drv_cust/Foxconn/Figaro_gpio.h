...
// LED GPIO 
#define CUSTOM_GPIO_LED_STANDBY                 OPCTRL(7)   // VGA_SDA

#define CUSTOM_GPIO_LED_POWER                   GPIO(54)     // ADIN2
#define CUSTOM_GPIO_LED_TIMER_AMBER             GPIO(52)     // ADIN5
#define CUSTOM_GPIO_LED_TIMER_GREEN             GPIO(53)    // GPIO 26
...
// Power Key
#define BUTTON_POWER_KEY                        OPCTRL(9)
