...
static SGL_SERVO_T _arWistronSingleServoKey[] = {
    // Servo,       Top,    Btm,    Key
    {   SERVO(4),   56,    48,    DKBIT_MENU      },
    {   SERVO(4),   46,    37,    DKBIT_INPUT_SRC },
    {   SERVO(4),   35,    26,    DKBIT_VOL_UP    },
    {   SERVO(4),   24,    16,    DKBIT_VOL_DOWN  },
    {   SERVO(4),   14,     6,    DKBIT_PRG_UP    },
    {   SERVO(4),    4,     0,    DKBIT_PRG_DOWN  },
    {   SERVO(1),   24,    16,    DKBIT_EJECT     },
    {   SERVO(1),   14,     6,    DKBIT_STOP      },
    {   SERVO(1),    4,     0,    DKBIT_PLAY_PAUSE},
    {   0,          0,      0,    BTN_NONE        }
};

static SGL_GPIO_T _arWistronSingleGpioKey[] = {
    // GPIO,       Btm,    Key
    {   OPCTRL(2), 0,    DKBIT_POWER },
    {   0,         0,    DKBIT_NONE  },
};
