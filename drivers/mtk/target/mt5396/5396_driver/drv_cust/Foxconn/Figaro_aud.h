 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5396M21V1_AUD_H
#define MT5396M21V1_AUD_H

#include "aud_if.h"

static const AUD_INPUT_MUX_SEL_T _arFigaroAudInputMux[] = 
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    ...
    {AUD_INPUT_ID_COMP_VID_2,   3,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    ...
    {AUD_INPUT_ID_YPBPR_0,      6,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    ...
    {AUD_INPUT_ID_SCART_1,      4, 		    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rFigaroAudInputMuxTable = 
{
    (sizeof(_arFigaroAudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _arFigaroAudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _arFigaroInterDacUsage = 
{
    AUD_CHL_DOWNMIX,
    AUD_CHL_LS_RS,
    AUD_CHL_AUX,
...
static const AUD_ADAC_USAGE_T _arFigaroAdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
