...
#if defined(SUPPORT_PANEL_48HZ) || defined(SUPPORT_PANEL_CUSTOMER_SPEC) || defined(SUPPORT_PANEL_SS) || defined(SUPPORT_PANEL_DITHER) || defined(SUPPORT_PANEL_DRIVING)|| defined(SUPPORT_PANEL_ERRORLIMIT_TABLE)|| defined(SUPPORT_PANEL_3D_PIXEL_SIZE)
...
static PANEL_ATTRIBUTE_T _arPanelAttribute[] =
{
#if ((PANEL_SELECT == PANEL_XGA) || CC_MULTI_PANEL) // refer to CLAA150XP03
    {
        ...
        LVDS_A_FROM_AO | LVDS_B_FROM_AO | LVDS_C_FROM_AE | LVDS_D_FROM_AE | 
...
*/
		...
		LVDS_A_FROM_BE | LVDS_B_FROM_BO | LVDS_C_FROM_AE | LVDS_D_FROM_AO | 
		WFB_PANEL_RESET_ON | PWM_LOW_PANEL_BRIGHT | LVDS_DISP_3D_SHUTTER,
#else
		FOUR_PORT | DISP_30BIT | LVDS_NS | LVDS_ODD_SW_OFF |
		LVDS_A_FROM_BE | LVDS_B_FROM_BO | LVDS_C_FROM_AE | LVDS_D_FROM_AO |
...
#endif
#if ((PANEL_SELECT == PANEL_MLVDS_PANASONIC32WXGA8BIT) || CC_MULTI_PANEL)
    {
    1366,           // u2PanelWidth
    768,            // u2PanelHeight
...
//    821,            // u2VTotalMax
...
#if ((PANEL_SELECT == PANEL_LG_42_WU5_SLB1_AS3693) || CC_MULTI_PANEL)
   {
    ...
    0x810,          // u1HPosition
    0x400,          // u1VPosition
    FOUR_PORT | DISP_30BIT | LVDS_MSB_SW_OFF | LVDS_ODD_SW_OFF | LVDS_SPECIAL_NS | PANEL_REODER_SEQ_TO_HALF |
    LVDS_A_FROM_AE | LVDS_B_FROM_BE | LVDS_C_FROM_AO | LVDS_D_FROM_BO |
    ...
    FOUR_PORT | DISP_30BIT | LVDS_NS| LVDS_ODD_SW_OFF |
    WFB_PANEL_RESET_ON | PWM_LOW_PANEL_BRIGHT | LVDS_DISP_3D_SHUTTER |
    LVDS_A_FROM_BE | LVDS_B_FROM_AO | LVDS_C_FROM_BO | LVDS_D_FROM_AE,
#else
    FOUR_PORT | DISP_30BIT | LVDS_NS | LVDS_ODD_SW_OFF |
    WFB_PANEL_RESET_ON | PWM_LOW_PANEL_BRIGHT |
    LVDS_A_FROM_BE | LVDS_B_FROM_AO | LVDS_C_FROM_BO | LVDS_D_FROM_AE,
...
//    1165,           // u2VTotalMax
...
#if ((PANEL_SELECT == PANEL_SS_42_PDP) || CC_MULTI_PANEL)
   {
	 ...
	 0x810, 		 // u1HPosition   
	 0x400, 		 // u1VPosition   
	 DUAL_PORT | DISP_24BIT | LVDS_MSB_SW_ON | LVDS_ODD_SW_OFF |PWM_LOW_PANEL_BRIGHT | PANEL_PDP 
	 | LVDS_A_FROM_AO | LVDS_B_FROM_AE | LVDS_C_FROM_BE | LVDS_D_FROM_BO, 
	 0x00,			 // u1BacklightHigh 
	 0x80,			 // u1BacklightMiddle  
	 0xFF,			 // u1BacklightLow	 
...
#ifdef CC_SCPOS_3DTV_SUPPORT
    FOUR_PORT | DISP_24BIT | LVDS_MSB_SW_ON | LVDS_ODD_SW_OFF | PANEL_PDP|
    PWM_HIGH_PANEL_BRIGHT | LVDS_DISP_3D_POLARIZED_LRLR,
#else
    FOUR_PORT | DISP_24BIT | LVDS_MSB_SW_ON | LVDS_ODD_SW_OFF | PANEL_PDP|
    PWM_HIGH_PANEL_BRIGHT | LVDS_DISP_3D_POLARIZED_LRLR,
...
#if ((PANEL_SELECT ==  PANEL_EPI_LGDV11GIPFHD120) || CC_MULTI_PANEL)
    {
    1920,           // u2PanelWidth
    1080,           // u2PanelHeight
...
static PANEL_LOCAL_DIMMING_ATTRIBUTE_T _arPanelLDAttribute[]=
{
	  ...
	  {
        PANEL_AUO_42_HW1_V3,
        E_SPI_AMS_PROTOCOL,                 // UINT8  u1ProtocolIndex;     
        SV_ON,                             // UINT8 u1SWModeEn;        
        SV_ON,                             // UINT8  u1ScanningOnoff;
        0, 
...
#if ((PANEL_SELECT == PANEL_MLVDS_PANASONIC32WXGA8BIT) || CC_MULTI_PANEL) 
		 {
		   PANEL_MLVDS_PANASONIC32WXGA8BIT,
		   SINGLE_PORT,
		   TCLK_PCLK_RATION_2,
		 },		 
#endif
...
UINT8 au1FlashPanelTableVersion[PANEL_VERSION_LENGTH + 1];
PANEL_HEADER_CUSTOM_ATTRIBUTE_T rFlashPanelHeader;
PANEL_Ext2_CUSTOM_ATTRIBUTE_T rFlashPanelExt2;

static BOOL CustomLoadPanelData(UINT32 u4PartId, UINT32 u4Offset, void *pInfo, UINT32 u4Size)
{
...
CHAR * FlashPanel_GetVersion(void)
{
    ...
    #ifdef PANEL_FLASH_TABLE_BASE_PARTITION
    u4PartId = PANEL_FLASH_TABLE_BASE_PARTITION;
    #endif
    #ifdef PANEL_FLASH_HEADER_ADDRESS
    u4Offset = PANEL_FLASH_HEADER_ADDRESS;
    #endif
    x_memset(au1FlashPanelTableVersion, 0, sizeof(au1FlashPanelTableVersion));
    CustomLoadPanelData(u4PartId, u4Offset, (void *)au1FlashPanelTableVersion, PANEL_VERSION_LENGTH);  // get version info
    #endif
...
UINT32 FlashPanel_GetAQIndex(UINT32 u4Idx)
{
    UNUSED(u4Idx);
#if 1
    UINT32 u4ModelIndex = CustomModelOptionQueryFunc();
    UINT32 u4ShippingRegionIndex = CustomShippingRegionOptionQueryFunc();
    ...
    case DRV_CUSTOM_MODEL_OPTION_P:
        u4Index = ((UINT32)rFlashPanelExt2.au1AQIndex[1] & 0x0F) + 15;
        break;
    case DRV_CUSTOM_MODEL_OPTION_L:
        u4Index = (u4CountryIndex == DRV_CUSTOM_COUNTRY_EU) ? 
                  ((((UINT32)rFlashPanelExt2.au1AQIndex[2] & 0xF0) >> 4) + 15) :
                  (((UINT32)rFlashPanelExt2.au1AQIndex[2] & 0x0F) + 15);
        break;
    case DRV_CUSTOM_MODEL_OPTION_C:
        u4Index = (((UINT32)rFlashPanelExt2.au1AQIndex[1] & 0xF0) >> 4) + 15;
        break;
    /* The F1 and F1S are the Sony 2H EU/PAA/China specific models. */
    case DRV_CUSTOM_MODEL_OPTION_F1:		
    case DRV_CUSTOM_MODEL_OPTION_F1S:
        if(u4CountryIndex == DRV_CUSTOM_COUNTRY_PAA)
        { 
            u4Index = (u4ShippingRegionIndex == DRV_CUSTOM_SHIPPING_REGION_OPTION_GA) ? 
                            (((UINT32)rFlashPanelExt2.au1AQIndex[1] & 0x0F) + 15) :
                            (((UINT32)rFlashPanelExt2.au1AQIndex[0] & 0x0F) );			  
            break;			  
        }
    /* go through */		
    case DRV_CUSTOM_MODEL_OPTION_E:
    case DRV_CUSTOM_MODEL_OPTION_E_PLUS:
    default:
        u4Index = (u4CountryIndex == DRV_CUSTOM_COUNTRY_COL) ? 
                  ((UINT32)rFlashPanelExt2.au1AQIndex[0] & 0x0F) :
                  (((UINT32)rFlashPanelExt2.au1AQIndex[0] & 0xF0) >> 4);
        break;
    }

    return u4Index;
#else    
    return (UINT32)rFlashPanelExt2.au1AQIndex[0];
#endif
}
...
UINT32 FlashPanel_GetPQIndex(UINT32 u4Idx)
{
    ...
    if(u4CountryIndex == DRV_CUSTOM_COUNTRY_PAA)
    {
        u4PQIndex = (u4ShippingRegionIndex == DRV_CUSTOM_SHIPPING_REGION_OPTION_GA) ? 
                            (DRV_CUSTOM_PQ_MAPPING_INDEX_GA) : (DRV_CUSTOM_PQ_MAPPING_INDEX_CHINA);
    }
    else
    {
        u4PQIndex = u4CountryIndex;
    }
    return (UINT32)rFlashPanelExt2.au1PQIndex[u4PQIndex]; 	
#else
#if 1
    UINT32 u4CountryIndex = CustomPCBAQueryCountry();
    return (UINT32)rFlashPanelExt2.au1PQIndex[u4CountryIndex];
#else    
    return (UINT32)rFlashPanelExt2.au1PQIndex[0];
#endif
#endif
}
...
BOOL CustomPanelLoadTableFromFlash(UINT32 u4Type, void *pData)
{
    UINT32 u4Offset = 0;
    UINT32 u4TableSize;
    UINT32 u4Addr;
	...
	// init data structure
	rPanelData.rHeader.u1PanelId = 0;

    // load panel table info
    CustomLoadPanelData(u4PartId, u4Offset, (void *)au1FlashPanelTableVersion, 16);  // get version info
    CustomLoadPanelData(u4PartId, u4Offset+16, (void *)&u4PanelNum, 4);      // get panel number

    u4Addr = DRVCUST_PanelGet(ePanelFlashTableAddress);
    u4TableSize = DRVCUST_PanelGet(ePanelFlashTableSize);

    u4PanelNum = (u4PanelNum > 60)? 60: u4PanelNum; // add for no Flash Panel in flash

    for (i = 0; i < u4PanelNum; i++)
    {
        if (!CustomLoadPanelData(u4PartId, u4Addr+(u4TableSize*i), (void *)&rPanelData, sizeof(PANEL_CUSTOM_FLASH_ATTRIBUTE_T)))
        {
            continue;
        }
    ...
    _arPanelAttributeExt[0].u2DimmingFrequency48Hz = rPanelData.u2DimmingFrequency48Hz;
    #endif

    #ifdef SUPPORT_PANEL_DITHER
     _arPanelAttributeExt[0].u4Dither = rPanelData.rExt2Info.u4Dither;
    #endif
    ...
    #ifdef SUPPORT_PANEL_DRIVING
    _arPanelAttributeExt[0].u1DrivingCurrent = rPanelData.u1DrivingCurrent;
    #endif
...
CHAR* GetPanelName(UINT32 u4Index)
{
    ...
    case PANEL_MLVDS_PANASONIC32WXGA8BIT: return "PANEL_MLVDS_PANASONIC32WXGA8BIT";
	...
	case PANEL_EPI_LGDV11GIPFHD120: return "PANEL_EPI_LGDV11GIPFHD120";	
