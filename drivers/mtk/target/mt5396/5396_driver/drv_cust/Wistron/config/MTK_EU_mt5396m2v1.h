...
#endif
#define BACKLIGHT_GPIO                      (GPIO(43))//david
#define BACKLIGHT_ON_VAL                    (0)//david
#define PANELPOWER_GPIO                     (OPCTRL(9))//david
...
#define PANEL_BACKLIGHT_PWM_PORT            (1)//david
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "Wistron/waffle_aud.h"
#define AUDIO_Mute_Gpio_Num                 (GPIO(49))
#define AUDIO_Amp_Gpio_Num                (OPCTRL(7))
//#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_AMP_GPIO_POLARITY           AUD_AMP_GPIO_HIGH_ENALBE//david
...
#define AUDIO_HP_PLUG_IN_GPIO               (GPIO(45))
#define AUDIO_HP_PLUG_IN_POLARITY        AUD_GPIO_LOW_ENALBE
#define AUDIO_DIGITAL_AMP_RESET_GPIO        (GPIO(55))
...
//----------------------------------------------------------------------------
#define FLAG_EXT_STATUS                     (0)//david
...
//----------------------------------------------------------------------------
#define SYSTEM_EEPROM_SIZE                  (4096)//david
#define SYSTEM_EEPROM_WP_GPIO               (GPIO(46)) //david// OPCTRL9.
...
//----------------------------------------------------------------------------
// European CI (Common Interface) customization (Lu Zhu suggest to reserve these define)
//----------------------------------------------------------------------------
...
*/
#define USB0_OC_GPIO                        GPIO(121)    // ADIN 4.
#define USB0_OC_GPIO_POLARITY		            (0)
#define USB1_OC_GPIO                        GPIO(121)    // ADIN 4.
...
#define BUTTON_INCLUDE_FILE                     "Wistron/Waffle_LED_button.h"
#ifndef T8032UP_INCLUDE_FILE
#define T8032UP_INCLUDE_FILE                "mtk/mtk_t8032fw.h"//"Wistron/waffle_t8032fw.h"
...
// MTK IR only setting
//----------------------------------------------------------------------------
//#define IR_INCLUDE_FILE                     "Wistron/waffle_ir.h"
#define IR_INCLUDE_FILE "Wistron/sirc_ir.h"
//#define IR_INCLUDE_FILE                     "mtk/mtk_ir.h"
#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "Wistron/waffle_source_table.c"
#endif
#define PDWNC_EXT_IMPL                          "Wistron/Waffle_pdwnc.h"//#define PDWNC_EXT_IMPL                          "Wistron/waffle_pdwnc_ext.c"
//----------------------------------------------------------------------------
// default HDMI GPIO control
//----------------------------------------------------------------------------
#ifndef HDMI_GPIO_CONF
#define HDMI_GPIO_CONF                      "Wistron/waffle_hdmi_conf.c"
#endif
...
#define VGA_INCLUDE_FILE                    "Wistron/waffle_vga.h"
#endif
...
#define TVE_INCLUDE_FILE                    "Wistron/waffle_tve.c"
#endif
...
#define DMX_INCLUDE_FILE               "Wistron/waffle_dmx.h"
#endif
...
//david for driver build #endif //#if 0
...
#define DRV_CUSTOM_CUST_FILE                    "Wistron/Waffle_d_custom.c"
#endif

#ifndef DRV_CUSTOM_CUST_SPEC_SET
#define DRV_CUSTOM_CUST_SPEC_SET                d_Waffle_cust_spec_set
#endif

#ifndef DRV_CUSTOM_CUST_SPEC_GET
#define DRV_CUSTOM_CUST_SPEC_GET                d_Waffle_cust_spec_get
#endif

#ifndef CUSTOM_VIDEO_DRV_BODY_FILE
#define CUSTOM_VIDEO_DRV_BODY_FILE              "Wistron/video_drv/Wistron_video_drv.c"
#endif
#define GPIO_INCLUDE_FILE                       "Wistron/Waffle_gpio.h"
