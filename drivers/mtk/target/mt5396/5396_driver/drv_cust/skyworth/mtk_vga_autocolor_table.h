...
INT8 code bEFuseCompensation[4][3] =    //notice if negative, how to express
{
...
{
    {0x13D, 0x17E, 0x182},	 //YPBPR
    {0x164, 0x16D, 0x171},  //RGB
    {0x136, 0x13B, 0x13E},  //SCART RGB
    {0x178, 0x149, 0x17A}  //VGA_YPBPR		
};
...
{
    {1463, 1503, 1503}, //YPBPR(5381) (236-16)/2*74.5/56, (241-128)*74.5/56, (241-128)*74.5/56, all elementa*10
...
UINT8 code bOnChipCheckTolerance[5][2]=
{
    ...
    {0x00, 0x00},   //mode=3,    gain calibration for external signal
...
{ 
  {0xB2, 0xBC, 0xC1},  //YPbPr
  {0x70, 0x6F, 0x73},  //VGA         //{0x70, 0x73, 0x74},  //VGA
  {0x43, 0x42, 0x45},  //SCART R,G,B //{0x43, 0x45, 0x46},  //SCART R,G,B
  {0x45, 0x3E, 0x49}   // VGA_YPBPR
 };
UINT8 code GAIN_LOW_LIMIT_100[4][3] =    
{ 
   {0x60, 0x68, 0x6C}, //YPbPr              CH1 : 0x85 > X > 0X48,  CH2: 0xA1 > X > 0X60 , CH3: 0xA1 > X > 0X60
   {0x31, 0x30, 0x33}, //VGA //{0x31, 0x24, 0x35}, //VGA              CH1 : 0x73 > X > 0x36,  CH2: 0x74 > X > 0x36   ,CH3: 0x74 > X > 0x36
   {0x0C, 0x0B, 0x0D}, //SCART R,G,B//{0x0C, 0x0E, 0x0F},    CH1: 0x44> X > 0x0F,  CH2: 0x44 > X > 0x0F,  CH3: 0x44 > X > 0x0F   
...
{ 
  ...
  {0xB837, 0xB9B9, 0xBA39},  //VGA
  {0xA1A1, 0xA2A2, 0xA322},  //SCART R,G,B
...
{ 
  {0x8B, 0xA5, 0xA9},  //YPbPr
  {0x70, 0x6F, 0x73},  //VGA
  {0x43, 0x42, 0x45},  //SCART R,G,B
  {0x45, 0x3E, 0x49}   // VGA_YPBPR
};

UINT8 code GAIN_LOW_LIMIT_120[4][3] =    
{ 
   {0x40, 0x55, 0x58}, //YPbPr              CH1 : 0x85 > X > 0X48,  CH2: 0xA1 > X > 0X60 , CH3: 0xA1 > X > 0X60
   {0x31, 0x30, 0x33}, //VGA               CH1 : 0x73 > X > 0x36,  CH2: 0x74 > X > 0x36   ,CH3: 0x74 > X > 0x36
   {0x0C, 0x0B, 0x0D}, //SCART R,G,B    CH1: 0x44> X > 0x0F,  CH2: 0x44 > X > 0x0F,  CH3: 0x44 > X > 0x0F   
   {0x16, 0x10, 0x19}  // VGA_YPBPR
};

UINT8 code GAIN_HIGH_LIMIT_75_100[4][3]=    
{ 
  {0x40, 0x50, 0x50},  //YPbPr
  {0x70, 0x6F, 0x73},  //VGA
  {0x43, 0x42, 0x45},  //SCART R,G,B
  {0x45, 0x3E, 0x49}   // VGA_YPBPR
};
