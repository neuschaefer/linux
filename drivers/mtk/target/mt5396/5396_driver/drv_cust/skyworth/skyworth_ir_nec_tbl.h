...
#ifndef MTK_IR_NEC_H
#define MTK_IR_NEC_H
#define PIONEER_IR  //LX_suning_110314 added from kk 110311 add 
...
#ifdef PIONEER_IR //LX_suning_110314 added from kk 110311 add 
static const KEYUNIT_T _arPioneerKeyMap[] =
{
  ...
  //  { 0x0d, BTN_CUSTOM_11 },
    ...
    { 0x10, BTN_PRG_UP },     
    { 0x11, BTN_PRG_DOWN},
    //{ 0x12, BTN_FREEZE},//LX_suning_110401
    { 0x13, BTN_INPUT_SRC },
    { 0x14, BTN_ZOOM },     // is 3D
    { 0x15, BTN_SLEEP},
    { 0x1C, BTN_POWER },
    { 0x1e, BTN_ASPECT},// child lock
    { 0x24, BTN_CURSOR_RIGHT},
    { 0x25, BTN_CURSOR_LEFT},
    { 0x26, BTN_CURSOR_UP},
    { 0x27, BTN_CURSOR_DOWN},
    { 0x28, BTN_SELECT},
	{ 0x30, BTN_FAV_CH},	/*BTN_STOP*///stop  LX_suning_110414	
	{ 0x32, BTN_FAVORITE},	/*BTN_PLAY*/	//play  LX_suning_110414	
	{ 0x33, BTN_PAUSE},	//pause  LX_suning_110414  
	{ 0x34, BTN_FF},		//forward  LX_suning_110414  
	{ 0x35, BTN_FR},		//backward  LX_suning_110414	
	{ 0x36, BTN_NEXT},		//next  LX_suning_110414	
	{ 0x37, BTN_PREV},		//previous  LX_suning_110414	
    { 0x45, BTN_VGA},// HDMI / PC
    { 0x46, BTN_TV},
    { 0x47, BTN_MEM_CARD }, // USB
    { 0x49, BTN_MUTE },
    { 0x4A, BTN_PRG_INFO },
    { 0x53, BTN_P_EFFECT },
    { 0x55, BTN_S_EFFECT },
...
static const KEYUNIT_T _arPioneerKeyMap1[] =
{
    { 0x20, BTN_MENU },
    { 0x22, BTN_EXIT },
    { 0x24, BTN_FREEZE},         /*LX_suning_110401*/
    { 0x2c, BTN_RED },              /* 0x14, Red Key */
    { 0x2d, BTN_GREEN },            /* 0x00, Green Key */
    { 0x2e, BTN_YELLOW },           /* 0x01, Yellow Key */
    { 0x2f, BTN_BLUE },             /* 0x42, Blue Key */
    { 0x3a, BTN_3D },     /* is 3D  //LX_suning_110402 for shortcut of 3D mode */
    { 0x61, BTN_P_EFFECT },
    { 0x62, BTN_PREV_PRG },    // #ifdef SUPPORT_SKY_MENU_1366_OSD // 20110418
    { 0x63, BTN_S_EFFECT },
    { 0x70, BTN_SLEEP},
 //   { 0x64, BTN_PREV_PRG},// is 0x62
};
#endif
...
static const KEYUNIT_T _arSkyworthKeyMap[] =
{
   ...
   // { 0x1a, BTN_FREEZE},          	/* 0x1a, Freeze */
    ...
    { 0x53, BTN_MEM_CARD},        //BTN_CUSTOM_10 /*Uplayer\TV */   
    ...
    { 0x59, BTN_3D},          	/* 0x59, Pingfen */
    { 0x5a, BTN_PREV_DLIST},          	/* 0x5a, yidian gequ*/ 
    ...
    { 0x61, BTN_EXIT},              /* 0x4b, Clock */
    { 0x62, BTN_RED },              /* 0x4b, Clock */
    { 0x63, BTN_GREEN},              /* 0x4b, Clock */
    { 0x64, BTN_YELLOW },              /* 0x4b, Clock */
    { 0x65, BTN_BLUE},              /* 0x4b, Clock */
