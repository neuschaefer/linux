...
tagDFT_QTY aDefaultQtyTbl[QUALITY_MAX] =
{
    ...
    // 3DNR
    {0x00, 0x07, 0x07, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_0},
    {0x00, 0x08, 0x08, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_1},
    {0x00, 0x09, 0x09, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_2},
    {0x00, 0x0A, 0x0A, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_3},
    {0x00, 0x08, 0x08, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_4},
    {0x00, 0x06, 0x06, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_5},
    {0x00, 0x04, 0x04, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_6},
    {0x00, 0x01, 0x01, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_7},
    {0x00, 0x0A, 0x0A, FROM_DFT, QUALITY_3DNR_NR_TBL_C_0},
    {0x00, 0x0A, 0x0A, FROM_DFT, QUALITY_3DNR_NR_TBL_C_1},
    {0x00, 0x0A, 0x0A, FROM_DFT, QUALITY_3DNR_NR_TBL_C_2},
    {0x00, 0x09, 0x09, FROM_DFT, QUALITY_3DNR_NR_TBL_C_3},
    {0x00, 0x07, 0x07, FROM_DFT, QUALITY_3DNR_NR_TBL_C_4},
    {0x00, 0x06, 0x06, FROM_DFT, QUALITY_3DNR_NR_TBL_C_5},
    {0x00, 0x02, 0x02, FROM_DFT, QUALITY_3DNR_NR_TBL_C_6},
    {0x00, 0x01, 0x01, FROM_DFT, QUALITY_3DNR_NR_TBL_C_7},
