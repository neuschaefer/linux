...
static const KEYUNIT_T _arHisense_Use_TvKeyMap[] =
{
    { 0x00, BTN_DIGIT_0 },          /* 0x03, Num0 */
    { 0x01, BTN_DIGIT_1 },          /* 0x13, Num1 */
    { 0x02, BTN_DIGIT_2 },          /* 0x10, Num2 */
    { 0x03, BTN_DIGIT_3 },          /* 0x11, Num3 */
    { 0x04, BTN_DIGIT_4 },          /* 0x0f, Num4 */
    { 0x05, BTN_DIGIT_5 },          /* 0x0c, Num5 */
    { 0x06, BTN_DIGIT_6 },          /* 0x0d, Num6 */
    { 0x07, BTN_DIGIT_7 },          /* 0x0b, Num7 */
    { 0x08, BTN_DIGIT_8 },          /* 0x08, Num8 */
    { 0x09, BTN_DIGIT_9 },          /* 0x09, Num9 */
    { 0x0B, BTN_PREV_PRG },         /* 0x18, Alternate Channel */
    { 0x0C, BTN_PRG_INFO },         /* 0x1f, OSD */
    { 0x0D, BTN_POWER },            /* 0x0e, Power */
    { 0x0E, BTN_MUTE },             /* 0x07, Mute */
    { 0x0F, BTN_FREEZE },           /* 0x54, Freeze */
    { 0x10, BTN_P_EFFECT },         /* 0x59, Sound Effect */
    { 0x11, BTN_S_EFFECT },         /* 0x59, Sound Effect */
    { 0x12, BTN_INPUT_SRC },        /* 0x1e, Input */
    { 0x13, BTN_ASPECT },           /* 0x0a, Active Control */
    { 0x14, BTN_MENU },             /* 0x06, Menu */
    { 0x15, BTN_SELECT },           /* 0x5c, Enter Key */
    { 0x16, BTN_CURSOR_UP },        /* 0x44, Up Key */
    { 0x17, BTN_CURSOR_DOWN },      /* 0x1d, Down Key */
    { 0x18, BTN_CURSOR_RIGHT },     /* 0x48, Right Key */
    { 0x19, BTN_CURSOR_LEFT },      /* 0x1c, Left Key */
    { 0x1A, BTN_SLEEP },            /* 0x40, Sleep */
    { 0x1B, BTN_TV },               /* 0x17, Color System */
    { 0x1C, BTN_PIP_POS },            /* 0x47, Index */ //used for enery saving adjust backlight
    //{ 0x1C, BTN_JIENENG },            /* 0x47, Index */
    //{ 0x1D, BTN_INDEX },            /* 0x47, Index */
    { 0x1D, BTN_EPG},            /* 0x47, Index */ //wangzhikui2010-12-23
    { 0x1E, BTN_FAVORITE },         /* 0x1a, Favorite */

    { 0x1F, BTN_CC },

    { 0x43, BTN_VOL_DOWN },         /* 0x45, Volume Down */
    { 0x44, BTN_VOL_UP },           /* 0x49, Volume Up */
#if 1// def APP_HIS_LOOKBACK_WITH_TIMER	
	//{0x48,BTN_BL_TIME},
#endif
#if 1//huimiao_0927
	{ 0x49, BTN_MTS},
    ...
    { 0x4A, BTN_PRG_UP },           /* 0x51, Channel Up */
    { 0x4B, BTN_PRG_DOWN },         /* 0x4d, Channel Down */
#if 1//huimiao_0927
	{ 0x4C, BTN_AUDIO},
#endif
    { 0x4D, BTN_MEM_CARD},
    { 0x4E, BTN_PLAY },     		// DVD PLAY_PAUSE, Favorite

   //{ 0x4F, BTN_INTERNET },         /* 0x4d, Channel Down */
    { 0x4F, BTN_ROOT_MENU },         /* 0x4d, Channel Down */

    { 0x52, BTN_RED },              /* 0x14, Red Key */
    { 0x53, BTN_GREEN },            /* 0x00, Green Key */
    { 0x54, BTN_YELLOW },           /* 0x01, Yellow Key */
    { 0x55, BTN_BLUE },             /* 0x42, Blue Key */

    { 0x56, BTN_FF },           // DVD forward, SUBPAGE
    { 0x57, BTN_FR },           // DVD backward, TTX
    { 0x58, BTN_PREV },         // DVD previous, REVEAL
    { 0x59, BTN_NEXT },         // DVD next, SIZE
   	{ 0x5A, BTN_FAV_CH },       // STOP, FAV_CH
    { 0x5C, BTN_EXIT },             /* 0x43, CE */
    //{ 0x5D, BTN_RADIO },             //wangzhikui2011-03-08
};
