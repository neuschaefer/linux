...
// Audio Customization
//----------------------------------------------------------------------------
#ifndef HIS_5326_PRODUCT_BOARD_SETTING
...
#else  
#define AUDIO_INCLUDE_FILE                  "hisense/mt5396m2v1_aud.h"
#define AUDIO_Mute_Gpio_Num                 (0xffffffff)
#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_Amp_Gpio_Num                  (OPCTRL(2))
#define AUDIO_AMP_GPIO_POLARITY             AUD_AMP_GPIO_HIGH_ENALBE
#define AUDIO_AMP_RESET_GPIO_NUM       		  (GPIO(45))
...
//#define DRV_LOGO_H_FILE                "hisense/Hisense_Mpeg2Logo.h" // define this will use default boot image
#define DRV_POWER_MUSIC_H_FILE                 "hisense/Hisense_PowerMusic.h"
//----------------------------------------------------------------------------
...
#define T8032UP_INCLUDE_FILE                "hisense/mtk_t8032fw.h"
...
// MTK IR only setting
//----------------------------------------------------------------------------
#define IR_INCLUDE_FILE                     "hisense/mtk_ir.h"

#ifndef NPTV_SOURCE_TABLE
#define NPTV_SOURCE_TABLE                   "hisense/source_table.c"
#endif
...
#define HDMI_GPIO_CONF                      "hisense/hdmi_conf.c"
#endif
...
#define VGA_INCLUDE_FILE                    "hisense/mtk_vga.h"
#endif
...
#define TVE_INCLUDE_FILE                    "hisense/mtk_tve.c"
#endif
...
#define DMX_INCLUDE_FILE               "hisense/mtk_dmx.h"
#endif
