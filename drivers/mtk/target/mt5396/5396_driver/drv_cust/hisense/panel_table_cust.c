...
#endif
#if ((PANEL_SELECT == PANEL_SS_43_LTA430HN01) || CC_MULTI_PANEL) 
{
	1920,           // u2PanelWidth
    1080,           // u2PanelHeight

	  150000000,	 // u4PixelClkMax
	  148500000,		// u4PixelClk60Hz
	  140800000,//123583800,		// u4PixelClk50Hz
 	  120000000,	 // u4PixelClkMin
...
//	  1165, 		  // u2VTotalMax
	  1349,			// u2VTotalMax (display mode)
	  1124,			// u2VTotal60Hz
	  1279,//1124,			// u2VTotal50Hz
	  1099,			// u2VTotalMin
	  120,			// u1VClkMax
	  60, 			// u1VClkMin...spec not defined
    ...
    0x810,       // u1HPosition
    0x400,        // u1VPosition
    DUAL_PORT | DISP_24BIT | LVDS_JEIDA | LVDS_ODD_SW_ON|
    PWM_HIGH_PANEL_BRIGHT, // PWM_HIGH_PANEL_BRIGHT not verified
    0xFF, // (100%) u1BacklightHigh     // u1BacklightHigh
    0x7D, // (67%) u1BacklightMiddle    // u1BacklightMiddle
    0x23, // (50%) u1BacklightLow       // u1BacklightLow
    0,              // u1Reserved
    0,              // u2DimmingFrequency60Hz
    0,              // u2DimmingFrequency50Hz
    3,              // u1LvdsOnDalay
    100,//30,             // u1BacklightOnDelay
    30,             // u1BacklightOffDelay
    1,              // u1LvdsOffDalay
...
#endif
#if ((PANEL_SELECT == PANEL_SS_48_LTA480HN01) || CC_MULTI_PANEL)
    {
    1920,           // u2PanelWidth
    1080,           // u2PanelHeight

    305000000,   // u4PixelClkMax
    296703297,      // u4PixelClk60Hz
    281600000,//280000000,      // u4PixelClk50Hz
    260000000,   // u4PixelClkMin

    2348,      //2347,           // u2HTotalMax
    2200,      //       // u2HTotal60Hz
    2200,      //         // u2HTotal50Hz
    2092,      //     // u2HTotalMin

//    1165,           // u2VTotalMax
    1350,           // u2VTotalMax (display mode)
    1125,           // u2VTotal60Hz
    1280,//1124,           // u2VTotal50Hz
    1110,           // u2VTotalMin
    125,            // u1VClkMax
    95,             // u1VClkMin...spec not defined
    ...
    0x400,          // u1VPosition
#ifdef CC_SCPOS_3DTV_SUPPORT
	  FOUR_PORT | DISP_24BIT | LVDS_JEIDA | LVDS_ODD_SW_OFF |LVDS_A_FROM_AE | LVDS_B_FROM_BE | LVDS_C_FROM_AO | LVDS_D_FROM_BO|
    WFB_PANEL_RESET_ON | PWM_LOW_PANEL_BRIGHT| LVDS_DISP_3D_SHUTTER,
#else
    FOUR_PORT | DISP_30BIT | LVDS_JEIDA | LVDS_ODD_SW_ON |
    WFB_PANEL_RESET_ON | PWM_LOW_PANEL_BRIGHT,
#endif

    0xFF,           // u1BacklightHigh
    0xa0,           // u1BacklightMiddle
    0x80,           // u1BacklightLow
    0,              // u1Reserved
    0,              // u2DimmingFrequency60Hz
    0,              // u2DimmingFrequency50Hz
...
CHAR* GetPanelName(UINT32 u4Index)
{
  ...
  case PANEL_SS_43_LTA430HN01: return "PANEL_SS_43_LTA430HN01";
	case PANEL_SS_48_LTA480HN01: return "PANEL_SS_48_LTA480HN01";
