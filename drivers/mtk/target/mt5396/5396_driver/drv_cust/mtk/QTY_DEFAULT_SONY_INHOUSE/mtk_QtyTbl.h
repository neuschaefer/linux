...
{
    // GENERAL
    {0x30, 0xB0, 0x80, FROM_DFT, QUALITY_CONTRAST},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_CONTRAST_MSB},
    {0x30, 0xB0, 0x80, FROM_DFT, QUALITY_BRIGHTNESS},
    {0x40, 0xC0, 0x80, FROM_DFT, QUALITY_SATURATION},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_SATURATION_MSB},
    {0x30, 0xB0, 0x80, FROM_DFT, QUALITY_HUE}, 
    {0x80, 0x80, 0xFF, FROM_DFT, QUALITY_BACKLIGHT},
    // HSHARP
    ...
    // 2DNR
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_BNR},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_MNR},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_SNR_Y},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_SNR_C},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_BNR_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_MNR_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_2DNR_NX_SNR_GAIN_Y},
    ...
    // 3DNR
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_0},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_1},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_2},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_3},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_4},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_5},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_6},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_MA_7},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_0},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_1},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_2},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_3},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_4},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_5},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_6},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_NR_TBL_C_7},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MOVINGTXR_SUB_WEI_BASE},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MOVINGTXR_SUB_WEI_NL_NAG_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MA_NOISE_ADD_WEI_BASE},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MA_NOISE_ADD_WEI_NL_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MA_PRTRBTN_ADD_WEI_BASE},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MA_PRTRBTN_ADD_WEI_STILL_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_STILL_GMV_ASSIST_DE_PRTRBTN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MC_NOISE_ADD_WEI_BASE},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_MC_NOISE_ADD_WEI_NL_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_CHROMA_MOVINGTXR_SUB_WEI_MAX},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_CHROMA_DC_ADD_WEI_MAX},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_3DNR_MCNR_CHROMA_DC_DIFF_BND},
    // ANR
	...
	{0x00, 0x00, 0x01, FROM_DFT, QUALITY_AL_HISTOGRAM_MODE},
	{0x00, 0x00, 0x0F, FROM_DFT, QUALITY_AL_WEIGHT1},
	{0x00, 0x00, 0x1C, FROM_DFT, QUALITY_AL_WEIGHT2},	
	{0x00, 0x00, 0xE1, FROM_DFT, QUALITY_AL_MID_AC_GAIN},
	...
	{0x00, 0x00, 0x40, FROM_DFT, QUALITY_AL_BWS_BK_AC_GAIN_RATIO},
	...
	{0x00, 0x00, 0x0E, FROM_DFT, QUALITY_AL_BWS_BK_OFST_L},
	{0x00, 0x00, 0x60, FROM_DFT, QUALITY_AL_BWS_BK_OFST_H},
	...
	{0x00, 0x00, 0x4E, FROM_DFT, QUALITY_AL_BWS_WT_AC_GAIN_RATIO},
	...
	{0x00, 0x00, 0x12, FROM_DFT, QUALITY_AL_BWS_WT_OFST_L},
	{0x00, 0x00, 0x2F, FROM_DFT, QUALITY_AL_BWS_WT_OFST_H},
    ...
    {0x00, 0x00, 0x01, FROM_DFT, QUALITY_AL_SKIN_LUMA_ON_1_OFF_0},
	{0x00, 0x00, 0x98, FROM_DFT, QUALITY_AL_SKIN_LUMA_WEIGHT},
	{0x00, 0x00, 0x00, FROM_DFT, QUALITY_AL_SKIN_BLEND_WEIGHT},	

    // RGB GAIN/OFFSET
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_R_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_G_GAIN},
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_B_GAIN},
    {0x02, 0x02, 0x02, FROM_DFT, QUALITY_R_GAIN_MSB},
    {0x02, 0x02, 0x02, FROM_DFT, QUALITY_G_GAIN_MSB},
    {0x02, 0x02, 0x02, FROM_DFT, QUALITY_B_GAIN_MSB},
    ...
    {0x00, 0x00, 0x7A, FROM_DFT, QUALITY_BLUE_STRETCH_GAIN_R},
    {0x00, 0x00, 0x7A, FROM_DFT, QUALITY_BLUE_STRETCH_GAIN_G},
    {0x00, 0x00, 0x83, FROM_DFT, QUALITY_BLUE_STRETCH_GAIN_B},
    ...
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_CBOOST_MINUS_EN}, 
    {0x00, 0x00, 0x80, FROM_DFT, QUALITY_CBOOST_GAIN},     
    {0x00, 0x00, 0x01, FROM_DFT, QUALITY_CBOOST_RNG_SEL},    
    {0x00, 0x00, 0x9C, FROM_DFT, QUALITY_CBOOST_LMT_U},     
    ...
    {0x00, 0x00, 0x10, FROM_DFT, QUALITY_LCN_LIRE_YTH},    
    {0x00, 0x00, 0x04, FROM_DFT, QUALITY_LCN_LIRE_YSLOPE}, 
    {0x00, 0x00, 0x05, FROM_DFT, QUALITY_LCN_LIRE_STH},     
    {0x00, 0x00, 0x04, FROM_DFT, QUALITY_LCN_LIRE_SSLOPE},     
    {0x00, 0x00, 0x60, FROM_DFT, QUALITY_LCN_LSAT_GAIN},    
    {0x00, 0x00, 0x00, FROM_DFT, QUALITY_LCN_LSAT_STH},     
    {0x00, 0x00, 0x10, FROM_DFT, QUALITY_LCN_LSAT_SSLOPE},    
