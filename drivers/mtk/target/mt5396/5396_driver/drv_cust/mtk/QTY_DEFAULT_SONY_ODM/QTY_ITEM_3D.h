// Quality index is built at 2011/6/24 ¤U¤È 04:13:08
    ...
    QUALITY_3DNR_MCNR_MA_NOISE_ADD_WEI_BASE,
    QUALITY_3DNR_MCNR_MA_NOISE_ADD_WEI_NL_GAIN,
    QUALITY_3DNR_MCNR_MA_PRTRBTN_ADD_WEI_BASE,
    QUALITY_3DNR_MCNR_MA_PRTRBTN_ADD_WEI_STILL_GAIN,
    QUALITY_3DNR_MCNR_STILL_GMV_ASSIST_DE_PRTRBTN,
    QUALITY_3DNR_MCNR_MC_NOISE_ADD_WEI_BASE,
    QUALITY_3DNR_MCNR_MC_NOISE_ADD_WEI_NL_GAIN,
    QUALITY_3DNR_MCNR_CHROMA_MOVINGTXR_SUB_WEI_MAX,
    QUALITY_3DNR_MCNR_CHROMA_DC_ADD_WEI_MAX,
    QUALITY_3DNR_MCNR_CHROMA_DC_DIFF_BND,
    // Quality Table of AL
    QUALITY_AL_GAIN,
    QUALITY_AL_OFFSET,
    QUALITY_AL_LIMIT,
