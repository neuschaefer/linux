...
//miniLVDS CMO 2011 Flip-Pixel-2
  struct sTCONREGTABLE sRegMini_PANEL_MLVDS_CMO2011FHD60[] = {
	...
	// clk source
	//Interface Selection, Blue Shift, bit Selection, Pair Selection, Port Selection
	{0xf0035000, 0x20001159, 0xffffffff},
  
	// minilvds input source
	{0xf0035280, 0x80000000, 0xffffffff}, //Input Source, WXGA Dummy Pixel

	// Disable dummy gray insertion
	{0xf003501c, 0x00f0000c, 0xffffffff},
  };

//miniLVDS   CMO 2Port 3Pair WXGA 60
  struct sTCONREGTABLE sRegMini_PANEL_MLVDS_CMO_2P3P_WXGA60[] = {
	...
	{0xf0035120, 0x00000000, 0xffffffff},
	//{0xf0035100, 0x0000003f, 0xffffffff},
	{0xf0035100, 0xFFFF7FE0, 0xffffffff},
  
	//minilvds PN Swap Setting
	//{0xf0035130, 0x00000025, 0xffffffff},
	{0xf0035130, 0xFFFFFFDA, 0xffffffff},
	...
	// clk source
	//Interface Selection, Blue Shift, bit Selection, Pair Selection, Port Selection
	//{0xf0035000, 0x2000114D, 0xffffffff},
    {0xf0035000, 0x2000104D, 0xffffffff},
...
//LGDV4FHD60
  ...
  //CMO 2Port 3Pair WXGA 60
	struct sTCONREGTABLE sRegTg_PANEL_MLVDS_CMO_2P3P_WXGA60[] = {
	
	  // TP, TG0
	  {0xf0034840, 0x00350B90, 0xffffffff},
	  {0xf0034844, 0x00000000, 0xffffffff},
	  {0xf0034848, 0x00350B90, 0xffffffff},
	  ...
	  // POL, TG1						
	  {0xf0034860, 0x06200620, 0xffffffff},
	  {0xf0034864, 0x00000000, 0xffffffff},
	  {0xf0034868, 0x06200620, 0xffffffff},
	  {0xf003486c, 0x00060007, 0xffffffff},
	  {0xf0034870, 0x80000404, 0xffffffff},
	  {0xf0034874, 0x80020004, 0xffffffff},
	  {0xf0034878, 0x00000007, 0xffffffff},
	  {0xf003487c, 0x10000000, 0xffffffff},
	  ...
	  // STV, TG11						
	  {0xf00349A0, 0x06200620, 0xffffffff},
	  {0xf00349A4, 0x00000000, 0xffffffff},
	  {0xf00349A8, 0x00000000, 0xffffffff},
	  {0xf00349Ac, 0x00080007, 0xffffffff},
	  {0xf00349B0, 0x00000000, 0xffffffff},
	  ...
	  // OE, TG2						
	  {0xf0034880, 0x0C0008D0, 0xffffffff}, 			  
	  {0xf0034884, 0x00000000, 0xffffffff}, 			  
	  {0xf0034888, 0x0C0008D0, 0xffffffff}, 			  
	  {0xf003488c, 0x00060007, 0xffffffff}, 			  
	  {0xf0034890, 0x20000000, 0xffffffff}, 			  
	  {0xf0034894, 0x80000000, 0xffffffff}, 			  
	  {0xf0034898, 0x00000007, 0xffffffff}, 			  
	  {0xf003489c, 0x00000000, 0xffffffff}, 			  
	  ...
	  // GSC, TG12						
	  {0xf00349C0, 0x06200B60, 0xffffffff}, 			  
	  {0xf00349C4, 0x00000000, 0xffffffff}, 			  
	  {0xf00349C8, 0x06200B60, 0xffffffff}, 			  
	  {0xf00349Cc, 0x00070007, 0xffffffff}, 			  
	  {0xf00349D0, 0x20000000, 0xffffffff}, 			  
	  {0xf00349D4, 0x80000000, 0xffffffff}, 			  
	  {0xf00349D8, 0x00000007, 0xffffffff}, 			  
	  {0xf00349Dc, 0x0f000000, 0xffffffff},    
...
//    {0xf003497c, 0x80008001, 0xffffffff}, 
    ...
    struct sTCONREGTABLE sRegCustTg_MLVDS_SAMSUNGMB7[] = {
	  ...
	  {0xf003486c, 0x0D200D20, 0xffffffff},
	  {0xf0034870, 0x00000000, 0xffffffff},
	  {0xf0034874, 0x0D200D20, 0xffffffff},
	  {0xf0034878, 0x00000007, 0xffffffff},
	  ...
	  {0xf00348ec, 0x00100011, 0xffffffff},
	  {0xf00348f0, 0x80000303, 0xffffffff},
	  {0xf00348f4, 0x80020002, 0xffffffff},
	  {0xf00348f8, 0x00000007, 0xffffffff},
	  {0xf00348fc, 0x00000000, 0xffffffff},
	  ...
	  {0xf00349Cc, 0x00100012, 0xffffffff},
	  {0xf00349D0, 0x80000303, 0xffffffff},
	  {0xf00349D4, 0x80010001, 0xffffffff},
	  {0xf00349D8, 0x00000007, 0xffffffff},
	  {0xf00349Dc, 0x0f000000, 0xffffffff},	  
	  ...
	  {0xf003494c, 0x00100013, 0xffffffff},
	  {0xf0034950, 0x80000303, 0xffffffff},
	  {0xf0034954, 0x80030003, 0xffffffff},
	  {0xf0034958, 0x00000007, 0xffffffff},
	  {0xf003495c, 0x00000000, 0xffffffff},
...
{
  vIO32WriteFldAlign(GR8, val, GR8_TCGPOEN_A);
	...
	switch (GetCurrentPanelIndex())
	 {
	   ...
	   case PANEL_MLVDS_CMO2011FHD60: 
		 ...
		 case PANEL_MLVDS_CMO_2P3P_WXGA60: 
		  
		   LOG(1,"cust tg init\n");
		 
		   u1count = (sizeof(sRegTg_PANEL_MLVDS_CMO_2P3P_WXGA60) / sizeof(struct sTCONREGTABLE));
		 
		   for ( i = 0 ; i < u1count ; i++)
		   {
			 u4tmp = sRegTg_PANEL_MLVDS_CMO_2P3P_WXGA60[i].u4Addr;
			 u4tmp1 = (u4IO32Read4B(u4tmp) & ~(sRegTg_PANEL_MLVDS_CMO_2P3P_WXGA60[i].u4Msk)) | (sRegTg_PANEL_MLVDS_CMO_2P3P_WXGA60[i].u4Val);
		 
			 vIO32Write4B(u4tmp,u4tmp1);
		   }
		 
		   LOG(1,"Tcon reg flashing %d counts, %d / %d\n", i, sizeof(sRegTg_PANEL_MLVDS_CMO_2P3P_WXGA60), sizeof(struct sTCONREGTABLE));
	...
	switch (GetCurrentPanelIndex())
	 ...
	 case PANEL_MLVDS_CMO2011FHD60:
	   ...
	   case PANEL_MLVDS_CMO_2P3P_WXGA60:
		   ...
		   u1count = (sizeof(sRegMini_PANEL_MLVDS_CMO_2P3P_WXGA60) / sizeof(struct sTCONREGTABLE));
	   
		   for ( i = 0 ; i < u1count ; i++)
		   {
			u4tmp = sRegMini_PANEL_MLVDS_CMO_2P3P_WXGA60[i].u4Addr;
			u4tmp1 = (u4IO32Read4B(u4tmp) & ~(sRegMini_PANEL_MLVDS_CMO_2P3P_WXGA60[i].u4Msk)) | (sRegMini_PANEL_MLVDS_CMO_2P3P_WXGA60[i].u4Val);
	   
			vIO32Write4B(u4tmp,u4tmp1);
		   }
	   
		 LOG(1,"Tcon reg flashing %d counts, %d / %d\n", i, sizeof(sRegMini_PANEL_MLVDS_CMO_2P3P_WXGA60), sizeof(struct sTCONREGTABLE));
