...
#define NAND_PART_END                       (16)                /* total 16 Partitions */
...
#endif
    #ifdef CC_USE_256MB_NAND
    #define NAND_PART_SIZE_9                (0xAB00000)         /* nand_9 - 3rd              */
    #else
    #define NAND_PART_SIZE_9                (0x2B00000)         /* nand_9 - 3rd              */
    #endif
    ...
    #define NAND_PART_SIZE_8				(0x0020000) 		/* nand_8 - basic			 */
      ...
      #else
       #define NAND_PART_SIZE_9                (0xB600000)         /* nand_9 - 3rd              */
      #endif
    #else
      #define NAND_PART_SIZE_9                (0x3600000)         /* nand_9 - 3rd              */
    #endif
    #define NAND_PART_SIZE_10               (0x0500000)         /* nand_10 - perm            */
    #define NAND_PART_SIZE_11               (0x0020000)         /* nand_11 - reserved        */
    #ifdef CC_3RD_RO
