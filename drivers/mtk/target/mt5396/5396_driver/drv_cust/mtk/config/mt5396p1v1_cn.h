...
#define AUDIO_MUTE_GPIO_POLARITY            AUD_AMP_GPIO_LOW_ENALBE
...
#define NAND_FLASH_TOTAL_SIZE            (512*1024*1024)
    ...
    #define NAND_PART_SIZE_4                (0x1000000)         /* nand_16 - boot           16 */
    #define NAND_PART_SIZE_5                (0x7800000)         /* nand_8 - system        120    */
    #define NAND_PART_SIZE_6               (0x0F700000)         /* nand_10 - userdata    247    */
