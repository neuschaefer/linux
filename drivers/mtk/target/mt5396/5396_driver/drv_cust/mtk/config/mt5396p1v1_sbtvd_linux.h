...
#ifdef GINGA_SUPPORT
/* Because the Ginga Application is more and more bigger. */
#define DIRECT_FB_MEM_SIZE                  (70 * 1024 * 1024)
#else
...
#define NAND_PART_END                       (16)                /* total 16 Partitions */
    ...
    #define NAND_PART_SIZE_17               (0x0020000)         /* nand_17 - Virtual EepromA */
    #define NAND_PART_SIZE_18               (0x0020000)         /* nand_18 - Virtual EepromB */            
...
// Demod reset gpio
//----------------------------------------------------------------------------
#define DEFAULT_DEMOD_RESET_GPIO    (GPIO(50))
