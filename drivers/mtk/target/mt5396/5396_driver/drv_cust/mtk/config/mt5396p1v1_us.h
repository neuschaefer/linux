...
#else
    #define DIRECT_FB_MEM_SIZE                  (96 * 1024 * 1024)
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5396p1v1_aud.h"
...
#define FAST_INIT_SUSP_SIZE     (0)
    ...
    #define NAND_PART_SIZE_4                (0x0200000)         /* nand_4 - kernel          */
    #define NAND_PART_SIZE_5                (0x0200000)         /* nand_5 - kernel_Recovery         */
    ...
    #define NAND_PART_SIZE_8                (0x1E00000)         /* nand_8 - basic            */
#else
    #define NAND_PART_SIZE_6				(0x1900000) 		/* nand_6 - rootfs A		 */
    #define NAND_PART_SIZE_7				(0x1900000) 		/* nand_7 - rootfs B		 */
    #define NAND_PART_SIZE_8				(0x0020000) 		/* nand_8 - basic			 */
#endif
    #ifdef CC_USE_256MB_NAND
    #define NAND_PART_SIZE_9                (0xAB00000 - FAST_INIT_SUSP_SIZE)         /* nand_9 - 3rd              */
    #else
    #define NAND_PART_SIZE_9                (0x2B00000 - FAST_INIT_SUSP_SIZE)         /* nand_9 - 3rd              */
    #endif
    #define NAND_PART_SIZE_10               (0x0500000)         /* nand_10 - perm            */
    #ifdef CC_FAST_INIT
    #define NAND_PART_SIZE_11               (FAST_INIT_SUSP_SIZE)         /* nand_11 - reserved        */
    #else
    #define NAND_PART_SIZE_11               (0x0020000)                   /* nand_11 - reserved        */
    #endif
    ...
    #ifdef CC_USE_256MB_NAND
      #ifdef CC_3RD_RO
       #define NAND_PART_SIZE_9				  (0x0500000 ) 		/* nand_9 - 3rd_rw 			 */
      #else
    #define NAND_PART_SIZE_9                (0xB600000 - FAST_INIT_SUSP_SIZE)         /* nand_9 - 3rd              */
      #endif
    #else
    #define NAND_PART_SIZE_9                (0x3600000 - FAST_INIT_SUSP_SIZE)         /* nand_9 - 3rd              */
    #endif
    #define NAND_PART_SIZE_10               (0x0500000)         /* nand_10 - perm            */
    #ifdef CC_FAST_INIT
    #define NAND_PART_SIZE_11               (FAST_INIT_SUSP_SIZE)         /* nand_11 - reserved        */
    ...
    #endif
    #ifdef CC_3RD_RO
    #define NAND_PART_SIZE_12				(0xB600000) 		/* nand_12 - 3rd ro   */
	#else
    #define NAND_PART_SIZE_12				(0x0020000) 		/* nand_12 - reserved   */
	#endif
    #define NAND_PART_SIZE_13				(0x0040000) 		/* nand_13 - channel list A  */
    #define NAND_PART_SIZE_14				(0x0040000) 		/* nand_14 - channel list B  */
    #define NAND_PART_SIZE_15				(0x0020000) 		/* nand_15 - Flash PQ		 */
    #define NAND_PART_SIZE_16				(0x0020000) 		/* nand_16 - Flash AQ		 */
    #define NAND_PART_SIZE_17				(0x0100000) 		/* nand_17- Capture Logo	 */
