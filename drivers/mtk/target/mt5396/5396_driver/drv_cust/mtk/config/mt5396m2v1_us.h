...
#define TRUSTZONE_MEM_SIZE          (1 * 1024 * 1024)

#define LINUX_KERNEL_MEM_SIZE       (((TOTAL_MEM_SIZE - FBM_MEM_CFG_SIZE - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE - TRUSTZONE_MEM_SIZE) / 0x100000) * 0x100000)
...
#define NAND_PART_SIZE_7                (0x0A00000)         /* nand_7 - rootfs B         */
    ...
    #define NAND_PART_SIZE_9            (0xAC00000)         /* nand_9 - 3rd              */
#else
