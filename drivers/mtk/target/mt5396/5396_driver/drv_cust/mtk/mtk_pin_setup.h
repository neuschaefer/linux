...
//    {PIN_OSDA2, 0},
  ...
  //  {PIN_GPIO15,    PINMUX_FUNCTION1 },//GPIO 15
    ...
    {PIN_LDM_CS,    PINMUX_FUNCTION3 },//GPIO 112
    {PIN_LDM_DO,    PINMUX_FUNCTION3 },//GPIO 113
    {PIN_LDM_DI,    PINMUX_FUNCTION3 },//GPIO 114
    {PIN_LDM_CLK,   PINMUX_FUNCTION3 },//GPIO 115
    {PIN_LDM_VSYNC, PINMUX_FUNCTION3 },//GPIO 116   
    #else
    ...
    {PIN_LDM_VSYNC_ECO, PINMUX_FUNCTION1 },//GPIO 116               
	#endif
