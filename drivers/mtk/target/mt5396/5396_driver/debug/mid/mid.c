...
static AGENT_MAPPING_T _arAgentList[] =
{
    ...
    { MID_AGENT_VLD,              "vld" },                      // 9
    { MID_AGENT_3DGFX,            "3dgfx" },                    // 10
    { MID_AGENT_JPEG,             "jpeg" },                     // 11
    { MID_AGENT_VENC,             "video_enc" },                // 12    
    { MID_AGENT_MJCIN,            "mjc_in" },                   // 13    
    { MID_AGENT_MJCOUT,           "mjc_out" },                  // 14
    ...
    { MID_AGENT_PCIE,             "pcie" },                     // 19
    { MID_AGENT_DSP0,             "audio_dsp0" },               // 20
    { MID_AGENT_FCI,              "fci" },                      // 21
    { MID_AGENT_TEST1,            "test1" },                    // 22
    { MID_AGENT_GDMA,             "gdma" },                     // 30

    // Group 3
    { MID_AGENT_GFXLO,            "gfx" },                      // 24
    { MID_AGENT_TCM,              "tcm" },                      // 25
    { MID_AGENT_ETHERNET_CHECKSUM,"eth_chksum" },               // 26
    { MID_AGENT_RS232,            "rs232" },                    // 27
