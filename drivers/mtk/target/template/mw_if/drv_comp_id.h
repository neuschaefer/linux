...
#define DMX_PES_COMP_ID_START               (DMX_PCR_COMP_ID_END + 1)  /* 4 */
#define DMX_PES_COMP_ID_END                 ((DMX_PES_COMP_ID_START + DMX_PES_COMP_NUM) - 1) /**/

// PES memory: 10 - 11
#define DMX_PES_MEM_COMP_NUM                (2)
#define DMX_PES_MEM_COMP_ID_START           (DMX_PES_COMP_ID_END + 1)
#define DMX_PES_MEM_COMP_ID_END             ((DMX_PES_MEM_COMP_ID_START + DMX_PES_MEM_COMP_NUM) - 1)

// PSI: 12 - 31
#define DMX_SECTION_MEM_COMP_NUM            ((32 - DMX_PES_MEM_COMP_ID_END) - 1)
#define DMX_SECTION_MEM_COMP_ID_START       (DMX_PES_MEM_COMP_ID_END + 1)
#define DMX_SECTION_MEM_COMP_ID_END \
        ((DMX_SECTION_MEM_COMP_ID_START + DMX_SECTION_MEM_COMP_NUM) - 1)

#define DMX_SECTION_FILTER_COMP_NUM         32
