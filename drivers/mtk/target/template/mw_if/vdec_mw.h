...
#define YPBPR_CAPABILITY    (TV_DEC_CAP_PHASE|TV_DEC_CAP_H_POSITION|TV_DEC_CAP_V_POSITION|TV_DEC_CAP_AUTO_CLK_PHS_POS|TV_DEC_CAP_CC|TV_DEC_CAP_AUTO_COLOR|TV_DEC_CAP_EU_WSS )
...
VOID _TvdNotifyVPSCNIData(UINT16 u2Data);
