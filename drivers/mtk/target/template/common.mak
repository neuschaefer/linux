...
.PHONY : all target lib depend mw x_inc c_inc custom sys sub_comp lint clean clean_target clean_a clean_o clean_d clean_lib clean_lint clean_mw clean_x clean_c clean_custom clean_sys clean_force $(SUB_COMP) $(ENT_SUB_COMP) $(ENT_OPT_SUB_COMP) $(PREDRV)
