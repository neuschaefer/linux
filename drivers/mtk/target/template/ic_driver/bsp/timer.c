...
#define _u4TimerInterval                                                    \
        (((CKGEN_READ32(REG_GPIO_IN1) & 2) ?                                \
            ((CKGEN_READ32(REG_GPIO_IN1) & 4) ? 54000000 : 48000000) :      \
            ((CKGEN_READ32(REG_GPIO_IN1) & 4) ? 60000000 : 27000000)) / TICKS_PER_SECOND )
...
BOOL HAL_InitTimer(void)
{
    ...
    _u4SysClock = CKGEN_GetXtalClock();
