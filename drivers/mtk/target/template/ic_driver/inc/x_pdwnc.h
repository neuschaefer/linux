...
#define PDWNC_OK                0
#define PDWNC_FAIL              1
#define TOTAL_PDWNC_GPIO_NUM    12
...
#define REG_RW_RGUT         0x00a8      // XTAL & Regulator Control Register
...
#define REG_RW_PDENTRY_CODE 0x0124      // Power Down Entry Code Register, 0x5381->0x1835 to power down
    #define PWRDWN_CODE1    0x5381
    #define PWRDWN_CODE2    0x1835
