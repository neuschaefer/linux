...
// Public functions
//---------------------------------------------------------------------------
void _Uart_DataTest(UINT8 u1Port, RS_232_SETUP_INFO_T *prUartSetupInfo) 
{
    INT32 i;
...
INT32 UART_Test(UINT8 u1Port)
{
    ...
    for (eBaudRate = RS_232_SPEED_110; eBaudRate >= RS_232_SPEED_115200;
         eBaudRate--)
    {
        for (eDataLen = RS_232_DATA_LEN_8; eDataLen <= RS_232_DATA_LEN_8;
             eDataLen++)        
        {
            ...
            {             
                ...
                _Uart_DataTest(TEST_PORT, &rUartSetupInfo);
            }
        }
    }
