...
{
    UART_HwClearFifo(UART_PORT_0);
    UART_HwClearFifo(UART_PORT_1);
#ifdef CC_UART_PD_SUPPORT    
    UART_HwClearFifo(UART_PORT_PD);
#endif

    UART_WRITE32(REG_SER_CTR, CTR_NORMAL);      // BaudRate = 115200
    UART_WRITE32(REG_SER01_CTR, CTR_NORMAL);    // BaudRate = 115200
#ifdef CC_UART_PD_SUPPORT    
    UART_WRITE32(REG_SERPD_CTR, CTR_NORMAL);    // BaudRate = 115200
#endif
    ...
    {
        VERIFY(BSP_PinSet(U2RX_I, 0) == OSR_OK);
        VERIFY(BSP_PinSet(GPIO_12, 4) == OSR_OK);
    }
    else
    {
...
void UART_HwSetBaudRate(UINT32 u4Port, UINT32 u4BaudRate)
{
    ...
    case RS_232_SPEED_110:
        u4Ctr |= (UINT32)BUAD_RATE_110;
        break;

    case RS_232_SPEED_300:
        u4Ctr |= (UINT32)BUAD_RATE_300;
        break;

    case RS_232_SPEED_1200:
        u4Ctr |= (UINT32)BUAD_RATE_1200;
        break;

    case RS_232_SPEED_2400:
        u4Ctr |= (UINT32)BUAD_RATE_2400;
        break;

    case RS_232_SPEED_4800:
        u4Ctr |= (UINT32)BUAD_RATE_4800;
        break;

    case RS_232_SPEED_9600:
        u4Ctr |= (UINT32)BUAD_RATE_9600;
        break;

    case RS_232_SPEED_19200:
        u4Ctr |= (UINT32)BUAD_RATE_19200;
        break;

    case RS_232_SPEED_38400:
        u4Ctr |= (UINT32)BUAD_RATE_38400;
        break;

    case RS_232_SPEED_57600:
        u4Ctr |= (UINT32)BUAD_RATE_57600;

        break;

    case RS_232_SPEED_115200:
        u4Ctr |= (UINT32)BUAD_RATE_115200;
        break;

    case RS_232_SPEED_230400:
        u4Ctr |= (UINT32)BUAD_RATE_115200x2;
        break;

    case RS_232_SPEED_460800:
        u4Ctr |= (UINT32)BUAD_RATE_115200x4;
        break;

    case RS_232_SPEED_921600:
        u4Ctr |= (UINT32)BUAD_RATE_115200x8;
        break;
...
void UART_HwClearFifo(UINT32 u4Port)
{
    UINT32 u4Ctr;
    UINT32 u4Addr;
    ...
    u4Ctr |= (CLEAR_TX_BUFFER | CLEAR_RX_BUFFER);
...
void UART_HwClearIntStatus(UINT32 u4Port)
{    
    switch (u4Port)
    {
    case UART_PORT_0:
