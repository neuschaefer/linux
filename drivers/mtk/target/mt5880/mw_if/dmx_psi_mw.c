                    ...
                    SIZE_T                  z_set_info_len)
{
    ...
    case DEMUX_SET_TYPE_CTRL:
		...
		LOG(6,"[PSI PARSER]The PSI mw set enable to Pid Filter Pidx is %d,fgEnable is %d\n",u1Pidx,rPid.fgEnable);
        break;
                    ...
                    SIZE_T                  z_set_info_len)
{
    ...
    case DEMUX_SET_TYPE_CTRL:
		...
		LOG(6,"[PSI PARSER]The PSI mw set enable to Section FilterIndex is %d,fgEnable is %d\n",u1FilterIndex,rFilter.fgEnable);
        break;
