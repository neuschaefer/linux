...
MFD_REGTBL_T CODE MJCFD_PARAM[6][12] =
{
    // 480p
    {
        ...
        {MJCFD_06, 0x0BAD3039, 0xFFFFFFFF},
    ...
    // 480p_oversample
    {
        ...
        {MJCFD_06, 0x0BAD6439, 0xFFFFFFFF},
        {MJCFD_07, 0x02201000, 0xFFFFFFFF},
        {MJCFD_0D, 0x00000018, 0x00FFFFFF},
        {MJCFD_BD_0, 0x00100010, 0x00FFFFFF},
        {MJCFD_BD_1, 0x00100010, 0x00FFFFFF},
    ...
    // 1080p60, 1080p50
    {
        ...
        {MJCFD_06, 0x0BADC039, 0xFFFFFFFF},
        {MJCFD_07, 0x02201000, 0xFFFFFFFF},
        {MJCFD_0D, 0x00000018, 0x00FFFFFF},
        {MJCFD_BD_0, 0x00100010, 0x00FFFFFF},
        {MJCFD_BD_1, 0x00100010, 0x00FFFFFF},
...
void vDrvMFDInit(void)
{
	...
	vRegWriteFldAlign(MFD_00, 0 , MFD_FILM_SEL_FOR_MJC);
}
...
void vDrvMFDSetQuality(UINT8 u1Timing)
{
    ...
    switch (u1Timing)
    {
        ...
        default: // interlace timing
            vRegWriteFldAlign(MJCFD_00, 0x1 , MJCFD_C_FD_INFO_SEL);
			vRegWriteFldAlign(MJCFD_00, 0x0 , MJCFD_C_FD_SRC_SEL);
            break;
    }
}
