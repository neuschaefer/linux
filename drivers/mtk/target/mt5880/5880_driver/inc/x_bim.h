...
// Interrupt vectors
    ...
    #define VECTOR_PMU1         (VECTOR_MISC_BASE+3)
    #define VECTOR_PMU0         (VECTOR_MISC_BASE+4)
    ...
    #define MAX_IRQ_VECTOR      VECTOR_MMU_PNG1
...
//----------------------------------------------------------------------------
// LZMA
#define LZMA_REG0           0xf00
    #define LZMA_SRC_SEL    (1U << 31)
    #define LZMA_CLK_EN     (1U << 30)
    #define LZMA_WO_OUTSIZE (1U << 29)
    #define LZMA_SRC_ADR    (0x7ffffff)
#define LZMA_INSIZE         0xf04
#define LZMA_REG2           0xf08
    #define LZMADEC_TRIG    (1U << 31)
    #define LZMA_RDY        (1U << 30)
    #define LZMASWRST       (1U << 29)
    #define LZMA_RDY_CLR    (1U << 28)
    #define LZMA_DEST_ADR   (0x7ffffff)
#define LZMA_CHECKSUM       0xf0c
#define LZMA_OUTSIZE        0xf10
#define LZMA_CHECKSUM_LS    0xf14
#define LZMA_SCRAMBLE       0xf18
