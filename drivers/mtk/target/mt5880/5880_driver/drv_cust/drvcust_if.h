...
#define FBM_MEM_CFG_MT5396_DDR3x4           (0xd005000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE)

#if defined(CC_SUPPORT_5_SEC_PTS_PCR_OFFSET)
#define FBM_MEM_CFG_MT5396_3DTV           (0x5770000 + 0xA20000 + 0x400000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE)
#elif defined(CC_SUPPORT_2_SEC_PTS_PCR_OFFSET)
#define FBM_MEM_CFG_MT5396_3DTV           (0x5770000 + 0x1A0000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE)
#else
#define FBM_MEM_CFG_MT5396_3DTV           (0x5770000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE)
#endif
#define FBM_MEM_CFG_MT5396_3DTV_CHA_NOMJC           (0x5780000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE)
