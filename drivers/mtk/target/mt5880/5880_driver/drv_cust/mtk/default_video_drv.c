...
void vApiFlashPqSetSmartPicId(UINT8 bIndex)
{
	...
	static UINT8 bPreNoDropMode=0xFF;  
	UINT8 bCurNoDropMode;
	UINT8 i4UiIndex, j;
...
/* @ Motion Sharpness Quailty Table
 *      
 *      
 */
void DRVCUST_MoSharpSetQtyTbl(void)
{
...
// Get Mo Level                
	...
	vRegWriteFldAlign(TDSHP_29, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARPALL_AC_LPF_COE), 0x00, XLEVEL), TDS_AC_LPF_COE);  	

    // Detail Reveal : HSAHRP Coring
	vRegWriteFldAlign(HSHARP_MAIN_02, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_HSHARP_HIGH_CORING), 0x00, XLEVEL), HSP_SHARP_HIGH_CORING);      
	vRegWriteFldAlign(HSHARP_MAIN_02, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_HSHARP_HIGH_CORING), 0x00, XLEVEL), HSP_SHARP_MID_CORING);      
	vRegWriteFldAlign(HSHARP_MAIN_02, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_HSHARP_HIGH_CORING), 0x00, XLEVEL), HSP_SHARP_LOW_CORING);      
	vRegWriteFldAlign(HSHARP_MAIN_09, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_HSHARP_HIGH_CORING), 0x00, XLEVEL), HSP_LC_SHARP_HIGH_CORING);      
	vRegWriteFldAlign(HSHARP_MAIN_09, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_HSHARP_HIGH_CORING), 0x00, XLEVEL), HSP_LC_SHARP_MID_CORING);      
	vRegWriteFldAlign(HSHARP_MAIN_09, 
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_HSHARP_HIGH_CORING), 0x00, XLEVEL), HSP_LC_SHARP_LOW_CORING);     
    // Clarity Keeping : TDSAHRP Clip Soft Gain
	vRegWriteFldAlign(TDSHP_10,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARP_GAIN_H1), 0x80, XLEVEL), TDS_GAIN_H1);
	vRegWriteFldAlign(TDSHP_10,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARP_GAIN_H2), 0x80, XLEVEL), TDS_GAIN_H2);
	vRegWriteFldAlign(TDSHP_12,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_LTI_GAIN_LTI_H1), 0x80, XLEVEL), TDS_GAIN_LTI_H1);
	vRegWriteFldAlign(TDSHP_12,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_LTI_GAIN_LTI_H2), 0x80, XLEVEL), TDS_GAIN_LTI_H2);


	vRegWriteFldAlign(TDSHP_10,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARP_GAIN_D1), 0xFF, DLEVEL), TDS_GAIN_D1);
	vRegWriteFldAlign(TDSHP_11,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARP_GAIN_D2), 0xFF, DLEVEL), TDS_GAIN_D2);

	vRegWriteFldAlign(TDSHP_11,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARP_GAIN_V1), 0x80, YLEVEL), TDS_GAIN_V1);
	vRegWriteFldAlign(TDSHP_11,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_TDSHARP_GAIN_V2), 0x80, YLEVEL), TDS_GAIN_V2);
	vRegWriteFldAlign(TDSHP_12,                                                                                                    
	    vDrvGetMoSharpValue(wReadQualityTable(QUALITY_LTI_GAIN_LTI_V), 0x80, YLEVEL), TDS_GAIN_LTI_V);
