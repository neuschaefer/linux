...
#if defined(CC_MT5395) || defined(CC_MT5365) || defined(CC_MT5396) || defined (CC_MT5368)
...
static INT32 _SifEDIDWriteCmd(INT32 i4Argc, const CHAR * *szArgv)
{   
#if ((defined (CC_MT5395) || defined(CC_MT5365) || defined(CC_MT5396) || defined(CC_MT5368)) && !defined(CC_HDMI_EDID_DISABLE))
    _InternalEdidWriteSram();
