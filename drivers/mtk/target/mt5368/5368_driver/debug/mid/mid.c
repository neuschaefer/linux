...
static AGENT_MAPPING_T _arAgentList[] =
{
    ...
    { MID_AGENT_GFXHI,            "3dgfx" },             // 11
    { MID_AGENT_VENC,             "video_enc" },         // 12    
    { MID_AGENT_ADSP,             "adsp" },              // 13    
    ...
    { MID_AGENT_GDMA,             "gdma" },              // 19
    { MID_AGENT_FCI,              "fci" },               // 21
    { MID_AGENT_TEST1,            "test1" },             // 22

    // Group 3
    { MID_AGENT_checksum,         "checksum" },          // 30
    ...
    UINT32 u4LowAddr, UINT32 u4HighAddr, UINT32 u4Flags, UINT32 u4AgentListMask)
{
    ...
    u4MidMaxVal = IS_DRAM_CHANNELB_ACTIVE() ? 
        ((TCMGET_CHANNELB_SIZE() * 0x100000)-4) : ((TCMGET_CHANNELA_SIZE() * 0x100000)-4);
