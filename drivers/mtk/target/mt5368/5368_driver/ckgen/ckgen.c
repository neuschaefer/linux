    ...
    switch(eSource)
    {
        ...
        case SRC_BUS_CLK:
            switch (IO32ReadFldAlign(CKGEN_CPU_CKCFG, FLD_BUS_CK_SEL)) {
                ...
                case 3: u4Clock = BSP_GetDomainClock(CAL_SRC_SAWLESSPLL)/3; break;
        ...
        case CAL_SRC_ADCPLL:
            vIO32WriteFldAlign(CKGEN_DBGCFG, 0x20, FLD_CKMON_SEL);
            u4Clock = _CalGetPLLCounter((UINT32)CAL_SRC_MON_CLK);
            u4Clock = u4Clock * 1000; 
            break;
        ...
        case CAL_SRC_USBPLL:
            u4Clock = BSP_GetDomainClock(CAL_SRC_AD_USBPLL_480M_2P);
            break;

        case CAL_SRC_VOPLL:
            u4Clock = BSP_GetDomainClock(CAL_SRC_AD_VOPLL_DPIX_CK);
            break;
