 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5368M1V1_AUD_H
#define MT5368M1V1_AUD_H

#include "aud_if.h"

//AdcMuxSel = 6 is for microphone in BGA 
static const AUD_INPUT_MUX_SEL_T _armt5368m1v1AudInputMux[] = 
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    {AUD_INPUT_ID_COMP_VID_0,   3,    	    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
    {AUD_INPUT_ID_COMP_VID_1,   5,          SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5368m1v1AudInputMuxTable = 
{
    (sizeof(_armt5368m1v1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5368m1v1AudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5368m1v1InterDacUsage = 
{
...
static const AUD_ADAC_USAGE_T _armt5368m1v1AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
