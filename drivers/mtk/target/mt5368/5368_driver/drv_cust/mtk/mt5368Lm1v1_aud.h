 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5368LM1V1_AUD_H
#define MT5368LM1V1_AUD_H

#include "aud_if.h"

static const AUD_INPUT_SW_GPIO_T _armt5368lm1v1InputSwGpio = 
{
    WT6720_GPIO7,                         
    WT6720_GPIO6,                         
    UNUSED_GPIO,
...
static const AUD_INPUT_MUX_SEL_T _armt5368lm1v1AudInputMux[] = 
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5368lm1v1AudInputMuxTable = 
{
    (sizeof(_armt5368lm1v1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5368lm1v1AudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5368lm1v1InterDacUsage = 
{
    AUD_CHL_AUX, //AR0, AL0 ==> SCART1
    AUD_CHL_L_R, //AR1, AL1 ==> Headphone
    AUD_CHL_L_R, //NA
    AUD_CHL_L_R, //NA
};

static const AUD_ADAC_USAGE_T _armt5368lm1v1AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
...
static const AUD_DIGITAL_DATA_T _afgmt5368lm1v1AudDigitalDataUsage =
{
    TRUE,			//MCLK,BCK,LRCK
    TRUE,			//AOSDATA0
    TRUE,			//AOSDATA1
...
static const AUD_AOUT_PAD_CFG_T _armt5368lm1v1AoutPadTable =
{
