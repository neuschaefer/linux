...
#define DRV_LOGO_VDEC_FLASH_ADDR        NOR_PART_OFFSET_9
#define DRV_LOGO_VDEC_FLASH_SIZE        NOR_PART_SIZE_9
#define DRV_LOGO_VDEC_FLASH_SLOT_NUM    (1)
#define DRV_LOGO_VDEC_DEVICE_ID         (9)
#else
...
#define NAND_FLASH_APPIMAGE_SIZE            (8*1024*1024)
