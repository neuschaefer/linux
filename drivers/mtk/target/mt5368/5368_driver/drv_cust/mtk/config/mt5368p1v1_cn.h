...
#else
#define FBM_MEM_CFG_SIZE                    (FBM_MEM_CFG_MT5395_DDR2x2)
#endif
*/
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5368p1v1_aud.h"
...
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5368p1v1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_armt5368p1v1InterDacUsage)
#define AUDIO_ADAC_USAGE                    (&_armt5368p1v1AdacUsage)
#define AUDIO_Digital_Data_TABLE            (&_afgmt5368p1v1AudDigitalDataUsage)
...
//----------------------------------------------------------------------------
#define CI_8295_RESET_GPIO                  (GPIO(15))  
