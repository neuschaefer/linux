...
#define DEFAULT_DDR_CLOCK                   (800000000)
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5368Lp1v1_aud.h"
...
#define AUDIO_INPUT_SW_GPIO_SEL_DEFAULT    (&_armt5368lp1v1InputSwGpio)
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5368lp1v1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE_DEFAULT       (&_armt5368lp1v1InterDacUsage)
#define AUDIO_ADAC_USAGE_DEFAULT            (&_armt5368lp1v1AdacUsage)
