...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5368m1v1_aud.h"
...
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5368m1v1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_armt5368m1v1InterDacUsage)
#define AUDIO_ADAC_USAGE                    (&_armt5368m1v1AdacUsage)
...
#define NAND_FLASH_TOTAL_SIZE               (256*1024*1024)
    ...
    #define NAND_PART_SIZE_19               (0x0020000)         /* nand_19 - Flash TCON              */
#endif
#endif
...
#ifdef CC_SUPPORT_FLASH_TCON
#ifdef LINUX_TURNKEY_SOLUTION
#define FLASH_TCON_BASE_PARTITION             (19)
#else
#define FLASH_TCON_BASE_PARTITION             (10)
#endif
#endif
/*
