...
#define FBM_MEM_CFG_SIZE                    (FBM_MEM_CFG_MT5368_DDR3x2)
/*
#ifdef CC_3D_SUPPORT
...
#endif
#define BACKLIGHT_GPIO                      (GPIO(1))
#define BACKLIGHT_ON_VAL                    (0)
#define PANELPOWER_GPIO                     (GPIO(2))
...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/mt5368p2v1_aud.h"
#define AUDIO_Mute_Gpio_Num                 GPIO_OPWM1
#define AUDIO_Amp_Gpio_Num                  (GPIO(41))
#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_AMP_GPIO_POLARITY             AUD_AMP_GPIO_LOW_ENALBE
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rmt5368p2v1AudInputMuxTable)
#define AUDIO_INTER_DAC_USAGE               (&_armt5368p2v1InterDacUsage)
#define AUDIO_ADAC_USAGE                    (&_armt5368p2v1AdacUsage)
#define AUDIO_Digital_Data_TABLE            (&_afgmt5368p2v1AudDigitalDataUsage)
...
//RF AGC swtich GPIO
#define DEFAULT_TUNER_RFAGC_SWITCH_GPIO (GPIO(54))//MT5368
...
//----------------------------------------------------------------------------
#define CI_8295_RESET_GPIO                (GPIO(15))  // It's GPIO_3 on schematic, but we should use 54. (reference to x_pinmux.h)
#define CI_8295_RESET_POLARITY            (1)
#define CI_EXTERNAL_IC_INT_GPIO             (GPIO(34))  // Set:Interrupt Mode, UnSet:Polling Mode
...
#define NPTV_SOURCE_TABLE                   "mtk/mt5368m1v1_source_table.c"
#endif
...
#define PINMUX_INCLUDE_FILE                 "mtk/mt5368m1v1_pin_setup.h"
#endif
