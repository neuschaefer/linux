...
// NAND Customization
//----------------------------------------------------------------------------
// enlarge NAND app image partition to fulfill SYM_SUPPORT image
    ...
    #define NAND_FLASH_TOTAL_SIZE           (32*1024*1024)
    #define NAND_FLASH_APPIMAGE_SIZE        (0x740000)
    #else
        #if defined(SYS_UK_FREEVIEWHD_SUPPORT)
            #define NAND_FLASH_TOTAL_SIZE           (32*1024*1024)
            #define NAND_FLASH_APPIMAGE_SIZE        (0x740000)
        #else
            #ifdef DEBUG
        ...
        #define LOADER_DUAL_BOOT_OFFSET         (NAND_FLASH_APPIMAGE_SIZE + LOADER_MAX_SIZE)
    #else /* LOADER_MAX_SIZE */
        #define LOADER_DUAL_BOOT_OFFSET         (NAND_FLASH_APPIMAGE_SIZE + 128*1024)
