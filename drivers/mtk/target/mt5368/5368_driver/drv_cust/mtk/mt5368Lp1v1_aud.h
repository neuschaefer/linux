 ...
 *---------------------------------------------------------------------------*/
#ifndef MT5368LP1V1_AUD_H
#define MT5368LP1V1_AUD_H

#include "aud_if.h"

static const AUD_INPUT_SW_GPIO_T _armt5368lp1v1InputSwGpio = 
{
    GPIO(1),
    GPIO(2),
    UNUSED_GPIO,
...
static const AUD_INPUT_MUX_SEL_T _armt5368lp1v1AudInputMux[] = 
{   // Input ID                 AdcMuxSel,  SwGpio1,    SwGpio2,    SwGpio3,    SwGpio4
    ...
    {AUD_INPUT_ID_HDMI_0,       1,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},  
    {AUD_INPUT_ID_HDMI_1,       1,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_2,       1,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_3,       1,    		SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_HDMI_4,       NO_USED,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},   
    {AUD_INPUT_ID_DVI_0,        NO_USED,    SW_NO_USED, SW_NO_USED, SW_NO_USED, SW_NO_USED},    
...
static const AUD_INPUT_MUX_SEL_TABLE_T _rmt5368lp1v1AudInputMuxTable = 
{
    (sizeof(_armt5368lp1v1AudInputMux)/sizeof(AUD_INPUT_MUX_SEL_T)),
    _armt5368lp1v1AudInputMux   
};

//-----------------------------------------------------------------------------
// Internal DAC channel config
//-----------------------------------------------------------------------------
static const AUD_INTER_DAC_CFG_T _armt5368lp1v1InterDacUsage = 
{
    AUD_CHL_BYPASS, //AR0, AL0 ==> Line-Out
    AUD_CHL_L_R,    //AR1, AL1 ==> Headphone
    AUD_CHL_L_R,    //NA
    AUD_CHL_L_R,    //NA
};

static const AUD_ADAC_USAGE_T _armt5368lp1v1AdacUsage = 
{
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
    AUD_ADAC_NULL,
