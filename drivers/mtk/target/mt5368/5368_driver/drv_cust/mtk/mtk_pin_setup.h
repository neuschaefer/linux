...
//	{PIN_HDMI_HPD, 1},
    ...
    {PIN_JTMS, PINMUX_FUNCTION1 },
    {PIN_JTDO, PINMUX_FUNCTION1 },
    {PIN_JTRST_, PINMUX_FUNCTION1 },
    {PIN_HDMI_1_SCL, PINMUX_FUNCTION0 },
    {PIN_HDMI_1_SDA, PINMUX_FUNCTION0 },
    {PIN_HDMI_2_SCL, PINMUX_FUNCTION0 },
    {PIN_HDMI_2_SDA, PINMUX_FUNCTION0 },
    {PIN_HDMI_2_HPD, PINMUX_FUNCTION1 },
#else // deticated JTAG
    {PIN_JTCK, PINMUX_FUNCTION0 },
    {PIN_JTMS, PINMUX_FUNCTION0 },
    {PIN_JTDO, PINMUX_FUNCTION0 },
    {PIN_JTRST_, PINMUX_FUNCTION0 },
    /*
