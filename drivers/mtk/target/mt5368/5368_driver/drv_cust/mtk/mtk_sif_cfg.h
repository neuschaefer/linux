...
static SIF_CONFIG_T _rSifConfig =
{
    5, // Total 7 buses
    {
        ...
        1, // SecondI2C uses V1 engine 
        2, // PdwncI2C uses V2 engine (use OPCTRL0/1)
...
static void SIF_MtkCfgPinSetFunc(UINT8 u1Channel)
{
	...
	{
		u4Reg = CKGEN_READ32(0x408);
		//	[27:26]  != 1; [16:14] = !2; [13:11] = 1
		if((u4Reg & 0x0c000000) == 0x04000000)
		{
			u4Reg &= ~(0x0c000000);
		}
		if((u4Reg & 0x0001c000) == 0x00008000)
		{
			u4Reg &= ~(0x0001c000);
		}
		u4Reg &= ~(0x00003800); 	   
		u4Reg |= 0x00000800;
		CKGEN_WRITE32(0x408, u4Reg);
	}
	else if (u1Channel == 1)	//osda1/oscl1 for tuner,use V2 engine
	{
		u4Reg = CKGEN_READ32(0x408);
		//	[27:26]  != 1; [16:14] = 2; [13:11] = !1
		if((u4Reg & 0x0c000000) == 0x04000000)
		...
		u4Reg &= ~(0x0001c000); 	   
		u4Reg |= 0x00008000;
		if((u4Reg & 0x00003800) == 0x00000800)
		{
			u4Reg &= ~(0x00003800);
		}				
		CKGEN_WRITE32(0x408, u4Reg);
	}	
	else if (u1Channel == 2)	//osda2/oscl2, use V1 engine
	{
		u4Reg = CKGEN_READ32(0x408);
		//	  [27:26]  = 2; [16:14] = !1; [13:11] = !2;
		u4Reg &= ~(0x0c000000); 	   
		u4Reg |= 0x08000000;
		if((u4Reg & 0x0001c000) == 0x00004000)
		{
			u4Reg &= ~(0x0001c000);
		}
		if((u4Reg & 0x00003800) == 0x00001000)
		{
			u4Reg &= ~(0x00003800);
		}		
		CKGEN_WRITE32(0x408, u4Reg);
	...
	#if 1
	else if (_SIF_ISR_IsPdwncMasterEnable() && u1Channel == 3) // PDWNC SIF0 use OPCTRL0/1
	{
		u4Reg = IO_READ32(PDWNC_BASE, 0xB4);
		// [3:2] = 1, [1:0] = 1; [14:12] != 4
		u4Reg &= ~(0x0000000F);
		u4Reg |= 0x00000005;
		if((u4Reg & 0x00007000) == 0x00004000)
		{
			u4Reg &= ~(0x00007000);
		}
	...
	#else
	else if(_SIF_ISR_IsPdwncMasterEnable() && u1Channel == 3)// PDWNC SIF0 use VGA_SDA/SCL
	{
		u4Reg = IO_READ32(PDWNC_BASE, 0xB4);
		// [3:2] != 1, [1:0] != 1; [14:12] = 4		
		if((u4Reg & 0x0000000C) == 0x00000004)
		{
			u4Reg &= ~(0x0000000C);
		}
