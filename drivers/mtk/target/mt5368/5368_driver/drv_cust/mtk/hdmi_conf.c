...
#define HDMI_GPIO_HPD1 (217)
#define HDMI_GPIO_HPD2 (221)
#define HDMI_GPIO_HPD3 (225)
#define HDMI_GPIO_HPD4 (229)

#define HDMI_PWR5V_1 (218)
#define HDMI_PWR5V_2 (222)
#define HDMI_PWR5V_3 (226)
#define HDMI_PWR5V_4 (230)
...
void vHDMIHPDHigh(E_HDMI_SWITCH_NUM eSwitch)
{
	...
	switch(eSwitch)
	{
		...
		case HDMI_SWITCH_3:
			...
			break;
#endif
#ifdef HDMI_GPIO_HPD4
		case HDMI_SWITCH_4:
			GPIO_Output(HDMI_GPIO_HPD4, &i4Val);
			break;
#endif			
		default: /* disable all */
			break;
...
#ifdef HDMI_GPIO_HPD1
		case HDMI_SWITCH_1:
		        GPIO_Output(HDMI_GPIO_HPD1, &dHpdLow);
			break;
#endif
#ifdef HDMI_GPIO_HPD2
		case HDMI_SWITCH_2:
		        GPIO_Output(HDMI_GPIO_HPD2, &dHpdLow);
			break;
#endif
#ifdef HDMI_GPIO_HPD3
		case HDMI_SWITCH_3:
		        GPIO_Output(HDMI_GPIO_HPD3, &dHpdLow);
			break;
#endif
#ifdef HDMI_GPIO_HPD4
		case HDMI_SWITCH_4:
		        GPIO_Output(HDMI_GPIO_HPD4, &dHpdLow);
			break;
#endif			
		default: /* disable all */
			break;
...
#ifdef HDMI_PWR5V_1
	   case HDMI_SWITCH_1:
	      	return GPIO_GetIn(HDMI_PWR5V_1);
#endif          
#ifdef HDMI_PWR5V_2
	   case HDMI_SWITCH_2:
	      	return GPIO_GetIn(HDMI_PWR5V_2);
#endif
#ifdef HDMI_PWR5V_3	      	
          case HDMI_SWITCH_3:
	      	return GPIO_GetIn(HDMI_PWR5V_3);
#endif
#ifdef HDMI_PWR5V_4
          case HDMI_SWITCH_4:            
	      	return GPIO_GetIn(HDMI_PWR5V_4);
#endif
		  default: 
			     return 0;
	 }
