...
//#define FBM_TWO_FBP_SIZE (0x800000 + 0x1B00000 + 0x530000)
#define FBM_TWO_FBP_SIZE (0x800000 + 0x1780000 + FBM_H264_LEVEL50_SIZE)
#else
...
#define FBM_MEM_CFG_MT5368_3DTV               (0x4905000 +0x600000+ FBM_OD_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE+ FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_H264_LEVEL50_SIZE)
#define FBM_MEM_CFG_MT5368_128Mx1           (0x4705000 + FBM_OD_SIZE + FBM_VENC_SIZE + FBM_TWO_FBP_SIZE+ FBM_FD_SIZE + FBM_DIVX_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_H264_LEVEL50_SIZE)
...
typedef enum {
    ...
    // flash tcon
    eTconFlashTconPartition,
    eTconFlashTconSize,
    eTconFlashTconData,
    eTconFlashTconDataSize,
...
#define TOTAL_GPIO_NUMBER           (132)
#define TOTAL_MT8292_GPIO_NUMBER    (10)
#define TOTAL_MT8295_GPIO_NUMBER    (15)
#define TOTAL_OPCTRL_NUMBER         (37)

// ServoADC
#define MAX_SERVOADC_NUM            TOTAL_SERVOADC_NUMBER

// GPIO alias
#define GPIO_OPWM0              (54)
#define GPIO_OPWM1              (55)
#define GPIO_OPWM2              (56)
#define GPIO(x)                 (x)
