...
void CHIP_ClockSetting()
{
    ...
    // 0x1D=810mhz
    // 0x20=891mhz
    vIO32WriteFldAlign(REG_PLL_GROUP_CFG1, 0x1D, FLD_RG_MJCPLL_FBDIV);
    ...
    Clock source selection[3:0]
        ...
        1: cpupll_ck (756MHz)
        2: enetpll_ck (675MHZ)
        3: sawlesspll_ck (432MHz)
        4: sawlesspll_d2_ck (216MHz)
        5: sawlesspll_d4_ck (108MHz)
        6: sawlesspll_d6_ck (72MHz)
        7: usbpll_d2_ck (240MHz )
        8: usbpll_d2p5_ck (192MHz )
        9: usbpll_d4_ck (120MHz )
        10: usbpll_d1_ck (480MHz )
        11: dmpll_ck
        12: fractional divider
        13: MEM_CK
        14: slow_ck
        15: bist_ck        
    BUS_CK selection[10:8]
        0: bus_ck = xtal_ck
        1: bus_ck = syspll_d2p5_ck
        2: bus_ck = usbpll_d2p5_ck
        3: bus_ck = sawlesspll_d3_ck
        4: bus_ck = usbpll_d4_ck
        5: bus_ck = enetpll_d4_ck
    ...
    */
    ...
    11: usbpll_d3_ck
    */
    vIO32WriteFldAlign(CKGEN_ABIST_SRAM_CKCFG, 0x2, FLD_ABIST_SRAM_CK_SEL);
