...
void _DDR_SetDdr3BeforeAI(void)
{
    ...
    */
    ...
    if (TCMGET_DDR_CL() == 11)
    {
        ...
        u4Val = (!IS_DDR_BUSX8()) ? 0x04000400: 0x08000800;
        ...
        if (!IS_DDR_ASYNCON())
        {
            DRAM_WRITE32(0x04, 0x07433316);
        }
        else
        {
            DRAM_WRITE32(0x04, 0x09433316);
        }
    ...
    else if (TCMGET_DDR_CL() == 10)
    {
        ...
        if (!IS_DDR_ASYNCON())
        {
            DRAM_WRITE32(0x04, 0x07434414); 
        }
        else
        {
            DRAM_WRITE32(0x04, 0x09434414); 
        }
