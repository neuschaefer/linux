...
static INT32 _MPOD_WaitForWriteComplete()
{
    UINT32 i=0;
    while(1)
    {
...
static INT32 _MPOD_WaitForReadComplete()
{
    UINT32 i=0;
    while(1)
    {
...
static void _MPOD_PrintReadCmdStatus()
{
...
static INT32 _MPOD_CheckFifoSettingForMpod()
{
