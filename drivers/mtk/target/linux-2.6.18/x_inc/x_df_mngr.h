...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
extern INT32    x_dfm_open(
                    const CHAR*         ps_dfm_name,
                    HANDLE_T*           ph_dfm
                    );
extern INT32    x_dfm_close(
                    HANDLE_T            ph_dfm
                    );
extern INT32    x_dfm_load_logo(
                    HANDLE_T            h_dfm,
                    UINT16              ui2_on_id,
                    UINT16              ui2_svc_id,
                    UINT16              ui2_scan_idx,
...
extern INT32    x_dfm_get_cond(
                    HANDLE_T            h_dfm,
                    HANDLE_T            h_logo,
                    DFM_COND_T*         pe_cond
                    );
extern INT32    x_dfm_get_logo_type(
                    HANDLE_T            h_dfm,
                    HANDLE_T            h_logo,
                    UINT8*              pui1_logo_types,/* |= */
                    DFM_COND_T*         pe_cond
                    );
extern INT32    x_dfm_get_logo_data(
                    HANDLE_T            h_dfm,
                    HANDLE_T            h_logo,
...
extern INT32    x_dfm_free_logo(
                    HANDLE_T            h_dfm,
                    HANDLE_T            h_logo
                    );

extern INT32 x_dfm_change_svc(
                    HANDLE_T         h_dfm,
                    UINT16           ui2_onid,
