...
static INT32 _CmdJTagType(INT32 i4Argc, const CHAR ** szArgv)
{
    ...
    if(BSP_PinGet(PIN_HDMI_1_SCL) == 2)
    {
        fgHDMIJTag = TRUE;
    }
    ...
    {
        Printf("%s [jtag_type]\n", szArgv[0]);
        Printf("   jtag_type, 0:dedicate, 1:hdmi, 2:usb, 3:ptm\n");
    ...
    case 2: //usb
        ...
        break;
    case 3: //ptm
        i4Ret = BSP_PinSet(PIN_GPIO8, 2);
        i4Ret = BSP_PinSet(PIN_GPIO12, 2);
        i4Ret = BSP_PinSet(PIN_GPIO15, 2);
        i4Ret = BSP_PinSet(PIN_GPIO16, 2);
        i4Ret = BSP_PinSet(PIN_GPIO18, 2);
        i4Ret = BSP_PinSet(PIN_GPIO20, 2);
        i4Ret = BSP_PinSet(PIN_GPIO21, 2);
        i4Ret = BSP_PinSet(PIN_GPIO22, 2);
        i4Ret = BSP_PinSet(PIN_GPIO26, 2);
        IO_WRITE32(CKGEN_BASE, 0x2bc, 5);
        break;
    default:
        return -1;
    }
