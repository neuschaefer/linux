...
INT32 _i4EtherTxChkSumVerify(UINT32 u4Size, UINT32 u4Count, BOOL fgSingleSizeTest)
{
    ...
    pucSourAddr = (UINT32 *)VIRTUAL(x_alloc_dma_mem(u4TotalSize + (4 - (u4TotalSize & 0x03))));
    #elif CONFIG_SYS_MEM_PHASE3
    pucSourAddr = (UINT32 *)VIRTUAL(x_mem_alloc(u4TotalSize + (4 - (u4TotalSize & 0x03))));
    #else
    pucSourAddr = (UINT32 *)VIRTUAL(x_mem_alloc(u4TotalSize + (4 - (u4TotalSize & 0x03))));
    #endif
    #else
