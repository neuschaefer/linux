...
void vSet100MAmp(UINT32 chipId, UINT32 val)
{
  ...
  { 
    ...
    u4RegValue = ( u4ReadEthPhy(0x0e)&(0xfff0) )|(val & 0x0f);
...
UINT32 u1Get100MAmp(UINT32 chipId)
{
  ...
  { 
  	...
  	default:
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
    u4RegValue = ( u4ReadEthPhy(0x0e)&(0x000f) );
    vWriteEthPhy(0x1f, 0);//set to normal Phy 	
    break;
...
void vSet10MAmp(UINT32 chipId, UINT32 val)
{
  ...
  { 
    ...
    vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
    u4RegValue = ( u4ReadEthPhy(0x18)&(0xff3f) )|((val & 0x03)<< 6);//bit 6, bit7
...
UINT32 u1Get10MAmp(UINT32 chipId)
{
  ...
  { 
    ...
    vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
    u4RegValue = (u4ReadEthPhy(0x18) >> 6)& 0x03;//bit 6, bit7
    vWriteEthPhy(0x1f, 0);//set to normal Phy 	
    break;
  }	
...
void vSetSlewRate(UINT32 chipId, UINT32 val)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18)&(0x00ff) )|((val & 0x7f)<< 8);//bit 8~ bit14
    vWriteEthPhy(0x18, u4RegValue);
    vWriteEthPhy(0x1f, 0);//set to normal Phy 	
  	break;
...
UINT32 u1GetSlewRate(UINT32 chipId)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18)>> 8 )&0x7f;//bit 8~ bit14
...
void vSetInputBias(UINT32 chipId, UINT32 val)
{
  ...
  { 
    ...
    u4RegValue = ( u4ReadEthPhy(0x18)&(0xf9ff) )|((val & 0x03)<< 9);//bit 9~ bit10
    vWriteEthPhy(0x18, u4RegValue);
    vWriteEthPhy(0x1f, 0);//set to normal Phy 	
...
UINT32 u1GetInputBias(UINT32 chipId)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18)& 0x03 );//bit 0~ bit1
...
void vSetOutputBias(UINT32 chipId, UINT32 val)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18)&(0xfff3) )|((val & 0x03)<< 2);//bit 2~ bit3
    vWriteEthPhy(0x18, u4RegValue);
    
    u4RegValue = ( u4ReadEthPhy(0x18)&(0xffcf) )|((val & 0x03)<< 4);//bit 4~ bit5
    vWriteEthPhy(0x18, u4RegValue);
    vWriteEthPhy(0x1f, 0);//set to normal Phy 	
...
UINT32 u1GetOutputBias(UINT32 chipId)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18) >> 2)& 0x03 ;//bit 2~ bit3
...
void vSet50percentBW(UINT32 chipId, UINT32 val)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18)&(0xf7ff) )|((val & 0x01)<< 11);//bit 11
    vWriteEthPhy(0x18, u4RegValue);
  	vWriteEthPhy(0x1f, 0);//set to normal Phy 	
  	break;
...
void vSetFeedbackCap(UINT32 chipId, UINT32 val)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18)&(0x3fff) )|((val & 0x03)<< 14);//bit 14, Bit15
    vWriteEthPhy(0x18, u4RegValue);
  	vWriteEthPhy(0x1f, 0);//set to normal Phy 	
  	break;
...
UINT32 u1GetFeedbackCap(UINT32 chipId)
{
  ...
  { 
  	...
  	vWriteEthPhy(0x1f, 0x2a30); //set to Test Page	
  	u4RegValue = ( u4ReadEthPhy(0x18) >> 14) & 0x03;//bit 14, Bit15
  	vWriteEthPhy(0x1f, 0);//set to normal Phy 	
  	break;
  }		
