...
#if 1
#define HDMI_GPIO_HPD0 (221)
#define HDMI_GPIO_HPD1 (225)
#define HDMI_GPIO_HPD2 (229)
#define HDMI_GPIO_HPD3 (217)

#define HDMI_GPIO_PWR5V0 (222)
#define HDMI_GPIO_PWR5V1 (226)
#define HDMI_GPIO_PWR5V2 (230)
#define HDMI_GPIO_PWR5V3 (218)
...
#define HDMI_GPIO_PWR5V0 (218)
#define HDMI_GPIO_PWR5V1 (222)
#define HDMI_GPIO_PWR5V2 (226)
#define HDMI_GPIO_PWR5V3 (230)
#endif
...
void vHDMIHPDHigh(E_HDMI_SWITCH_NUM eSwitch)
{
	...
	switch(eSwitch)
	{
		...
		case HDMI_SWITCH_1:
			GPIO_Output(HDMI_GPIO_HPD0, &i4Val);
			break;
#endif
		...
		case HDMI_SWITCH_4:
			GPIO_Output(HDMI_GPIO_HPD3, &i4Val);
			break;
#endif			
		default: /* disable all */
			break;
...
UINT8 bHDMIPort5VStatus(E_HDMI_SWITCH_NUM ePort)
{
    ...
    switch(ePort)
    {
#ifdef HDMI_GPIO_PWR5V0
        case HDMI_SWITCH_1: 
	          input = GPIO_Input(HDMI_GPIO_PWR5V0);		          
	        break;
#endif
#ifdef HDMI_GPIO_PWR5V1
        case HDMI_SWITCH_2: 
	          input = GPIO_Input(HDMI_GPIO_PWR5V1);
	         break;
#endif
#ifdef HDMI_GPIO_PWR5V2
        case HDMI_SWITCH_3: 
	          input = GPIO_Input(HDMI_GPIO_PWR5V2);
	         break;
#endif
#ifdef HDMI_GPIO_PWR5V3
        case HDMI_SWITCH_4: 
	          input = GPIO_Input(HDMI_GPIO_PWR5V3);
	         break;
#endif
	  default:
	         break;
