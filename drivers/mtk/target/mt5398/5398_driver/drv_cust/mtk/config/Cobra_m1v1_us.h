...
// Audio Customization
//----------------------------------------------------------------------------
#define AUDIO_INCLUDE_FILE                  "mtk/Cobra_aud.h"
#define AUDIO_Mute_Gpio_Num                 (OPCTRL(11))    ///5396Z M1V1
#define AUDIO_Amp_Gpio_Num                  (OPCTRL(5))     ///5396Z_M1V1
#define AUDIO_MUTE_GPIO_POLARITY            AUD_MUTE_GPIO_LOW_ENALBE
#define AUDIO_AMP_GPIO_POLARITY             AUD_AMP_GPIO_LOW_ENALBE
#define AUDIO_INPUT_MUX_SEL_TABLE           (&_rCobraAudInputMuxTable)
...
#define TCON_CUST_FILE                      "mtk/Cobra_tcon_cust.c"
#endif
