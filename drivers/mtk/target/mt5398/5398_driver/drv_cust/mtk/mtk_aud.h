...
static const AUD_INTER_DAC_CFG_T _arMtkInterDacUsage =
{
    ...
    AUD_CHL_DOWNMIX,    // 5396Z M1V1, AL0/AR0 Headphone
    AUD_CHL_LS_RS,      // 5396Z M1V1, AL2/AR2 LineOut (Monitor)
    AUD_CHL_AUX,        // 5396Z M1V1, AL1/AR1 SCART1 (TV Bypass)          
    AUD_CHL_L_R,        // No Use, Corbra only ALR0~ALR2
#else
    AUD_CHL_L_R,            ///AR0, AL0
    AUD_CHL_L_R,            ///AR2, AL2
