...
#define MJC_SUPPORT_50TO120_3D (1<<0)
#define MJC_SUPPORT_50TO120_2D (1<<1)
#define MJC_SUPPORT_50TO120 (0 && (IS_LVDS_DISP_3D_SHUTTER))/*(MJC_SUPPORT_50TO120_2D|MJC_SUPPORT_50TO120_3D)*/
...
typedef struct
{
    ...
    UINT8   fgIsInterlace;
    UINT8   fgLineSyncMode;
	UINT8	fgFreeze;
    UINT8   fgSupport50To120;
    UINT8   u1DispRDly;
    UINT8   fgDispRSwp;
