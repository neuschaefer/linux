...
void _DDR_SetDdr2BeforeAI(void)
{
	...
	DRAM_DDRPHY_WRITE32(0x394, u4Val | 0x1);
    ...
    // Write ODT setting. Default 50 Ohm
    u4MRS |= 0x00440000; 
    ...
    {        
        ...
        DRAM_DDRPHY_WRITE32(0x380, 0x00040004);
        DRAM_DDRPHY_WRITE32(0x384, 0x00040004);
    ...
    else // u4CL == 6.
    {
        ...
        //set DQS gating window
        DRAM_WRITE32(0x388, DDR2_DQSIEN);
        DRAM_DDRPHY_WRITE32(0x380, 0x00010001);
        DRAM_DDRPHY_WRITE32(0x384, 0x00010001);
