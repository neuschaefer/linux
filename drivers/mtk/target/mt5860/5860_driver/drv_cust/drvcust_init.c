...
// For device want to use S/W approach to access
	...
	case eHDMIHPD0GPIONUM:
	 #if  defined(CC_MT5389) || defined(CC_MT5396) || defined(CC_MT5368) || defined(CC_MT5880) || defined(CC_MT5860)
 ...
 #if  defined(CC_MT5396)|| defined(CC_MT5368) || defined(CC_MT5880) || defined(CC_MT5860)
