    ...
    HANDLE_T *ph_nfy)
{
    ...
    i4_ret = dm_reg_nfy_fct(t_evt_cat, 
                              pf_nfy, 
                              pt_filtr, 
                              pv_tag, 
                              ph_nfy);
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_unreg_nfy_fct(
    HANDLE_T h_nfy)
{
    INT32 i4_ret;

    i4_ret = dm_unreg_nfy_fct(h_nfy);

    return i4_ret;
}

/*-----------------------------------------------------------------------------
 * Name: x_dm_get_device_info
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_get_device_info(
    HANDLE_T h_dev, 
    DM_DEV_INF_T *pt_inf)
{
    INT32 i4_ret;

    i4_ret = dm_get_device_info(h_dev, 
                                pt_inf);
    ...
    UINT32 *pui4_dev_ns)
{
    ...
    i4_ret = dm_get_devices(pt_filtr, 
                            pt_stat,
                            pui4_dev_ns);
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_get_device(
    DM_DEV_SPEC_T *pt_spec,
    HANDLE_T *ph_dev)
{
    INT32 i4_ret;

    i4_ret = dm_get_device(pt_spec, ph_dev); 

    return i4_ret;
}

INT32 x_dm_umount_remove(CHAR* ps_dev_name)
{
    return dm_umount_remove(ps_dev_name);
}


/*-----------------------------------------------------------------------------
 * Name: x_dm_query_automnt
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_spindle_control(
    HANDLE_T h_dev, 
    ...
    HANDLE_T *ph_ioc)
{
    return DMR_NOT_IMPLEMETED;
}

/*-----------------------------------------------------------------------------
 * Name: x_dm_hdd_spindle_control
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_hdd_spindle_control(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_read_dvd_struct(
    HANDLE_T h_dev,
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_com_get_feature(
    HANDLE_T h_dev, 
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_get_standby_timer
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_get_standby_timer(
    HANDLE_T h_dev, 
    UINT32 *pui4_time)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_hdd_get_standby_timer
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_hdd_get_standby_timer(
    HANDLE_T h_dev, 
    UINT32 *pui4_time)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_set_standby_timer
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_set_standby_timer(
    HANDLE_T h_dev, 
    UINT32 ui4_time)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_hdd_set_standby_timer
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_hdd_set_standby_timer(
    HANDLE_T h_dev, 
    UINT32 ui4_time)
{
    return DMR_NOT_IMPLEMETED;
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_disc_unfinalize(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_test_unit_ready(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_get_event_status
 *
 * Description:
 *
 * Input: -
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_get_event_status(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_mechanism_status
 *
 * Description:
 *
 * Input: -
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_mechanism_status(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_flashless_download
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_flashless_download(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_set_transfer_mode
 *
 * Description:
 *
 * Input: -
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_set_transfer_mode(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_read_buffer_capacity
 *
 * Description:
 *
 * Input: -
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_read_buffer_capacity(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_read_dvd_structure
 *
 * Description:
 *
 * Input: -
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_read_dvd_structure(
    HANDLE_T h_dev, 
    VOID *pv_parm)
{
    return DMR_NOT_IMPLEMETED;
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_get_med_toc_hdr(
    HANDLE_T h_dev, 
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_get_med_toc_ent(
    HANDLE_T h_dev,
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_get_last_sense_key
 *
 * Description:
 *
 * Input: -
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_get_last_sense_key(
    HANDLE_T h_dev, 
    UINT32 *pui4_key)
{
    return DMR_NOT_IMPLEMETED;
...
/*-----------------------------------------------------------------------------
 * Name: x_dm_odd_get_current_speed
 *
 ...
 *              OSAI error.
 ----------------------------------------------------------------------------*/
INT32 x_dm_odd_get_current_speed(
    HANDLE_T h_dev, 
    UINT32 *pui4_speed)
{
    return DMR_NOT_IMPLEMETED;
...
INT32 x_dm_get_usb_port_number(
    UINT8*                      pui1_usb_port_num)
{
    return dm_get_usb_port_number(pui1_usb_port_num);
}
