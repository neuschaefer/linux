...
#if 0
static INT32 cli_get_dbg_sel   (INT32  i4_argc, const CHAR**  pps_argv);
static INT32 cli_set_dbg_sel   (INT32  i4_argc, const CHAR**  pps_argv);
#endif
...
{
    {"cdb", NULL, NULL, &(at_cli_dbg_cmd[0]), "Core Database Command", CLI_SUPERVISOR},
    END_OF_CLI_CMD_TBL
};
 ...
 *
 * Description: This API gets the current setting of CDB module debug level.
 *
...
)
{
    ...
    {
#ifdef DEBUG            
        x_dbg_stmt("{CDB} dsm.gdl\n");
#endif          
        i4_rc = CLIR_INV_CMD_USAGE;
    }
    else
    {
        i4_rc = x_cli_show_dbg_level(cdb_get_dbg_level());
    }
 ...
 *
 * Description: This API sets the current setting of CDB module debug level.
 *
 * Inputs:  i4_argc         Contains the argument count.
 *          pps_argv        Contains the arguments.
 *
...
)
{
    ...
    {
        cdb_set_dbg_level(ui2_dbg);
        i4_rc = CLIR_OK;
    }    
    else
    {
#ifdef DEBUG            
        x_dbg_stmt("{CDB} cdb.sdl <n|e|a|i>\n");
        x_dbg_stmt("{CDB} where:  n=none, e=error, a=api, i=info. \n");
#endif        
        i4_rc=CLIR_INV_CMD_USAGE;
    }
 ...
 * Name: cdb_cli_init
 *
 * Description: This API initialize the CDB module's CLI interface.
 *
 * Inputs:
 *   VOID.
 *
 ...
 * Returns: CLIR_OK                 Routine successful.
 --------------------------------------------------------------------------*/
INT32 cdb_cli_init(VOID)
{
    /* Attach Core Database CLI command table to CLI */
