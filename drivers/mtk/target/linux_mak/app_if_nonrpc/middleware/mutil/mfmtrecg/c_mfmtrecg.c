                        ...
                        MEDIA_FORMAT_T*   pt_format)  
{
    ...
    return x_mfmtrecg_get_file_fmt(ps_name, pt_format);
}
/*-----------------------------------------------------------------------------
 * Name:  c_mfmtrecg_get_mem_fmt
 *
 ...
 * Returns: MFMTRECGR_OK    Success. The routine was successful and the operation has been completed.
 ----------------------------------------------------------------------------*/
INT32 c_mfmtrecg_get_mem_fmt ( 
                        const VOID*       pv_mem_data, 
                        SIZE_T            z_mem_leng,   
                        MEDIA_FORMAT_T*   pt_format)   
{
    return x_mfmtrecg_get_mem_fmt(pv_mem_data, z_mem_leng, pt_format);
}
