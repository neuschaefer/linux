...
)
{
    ...
    {
    case AEER_OK:
        i4_result = x_flm_create(ps_name, pv_tag, pf_flm_notify,
                           ph_fav_handle);
        if (i4_result == FLMR_OK)
        {
            handle_link_to_aux(h_aux, *ph_fav_handle);
        }
        else
        {
    ...
    case AEER_OUT_OF_RESOURCES:
        i4_result = FLMR_AEE_OUT_OF_RESOURCES;
        break;
    default:
        i4_result = FLMR_AEE_NO_RIGHTS;
        break;
    }
    return i4_result;
}
...
{
    return x_flm_delete(h_fav_handle);
}
...
{
    return x_flm_get_num_lists(pui2_numlists);
}
...
{
    return x_flm_get_name_len(ui2_listnum, pz_length);
}
...
{
    return x_flm_get_name(ui2_listnum, ps_name, pui4_master_version);
}
...
)
{
    ...
    {
    case AEER_OK:
        i4_result = x_flm_open(ps_name, pv_tag, pf_flm_notify,
                           ph_fav_handle);
        if (i4_result == FLMR_OK)
        {
            handle_link_to_aux(h_aux, *ph_fav_handle);
...
{
    return x_flm_close(h_fav_handle);
}
...
{
    return x_flm_get_num_recs(h_fav_handle, pui2_num_recs, pui4_fav_version);
}
...
{
    return x_flm_lock(h_fav_handle);
}
...
{
    return x_flm_unlock(h_fav_handle);
}
...
{
    return x_flm_get_position(h_fav_handle, pui2_position,
                 pt_service, ui2_record_index, pui4_version);
}
...
{
    return x_flm_add_rec(h_fav_handle, pt_rec, pui2_position);
}
...
{
    return x_flm_del_rec(h_fav_handle, ui2_position);
}
...
{
    return x_flm_get_rec(h_fav_handle, ui2_position, pt_rec, pui4_version);
}
...
{
    return x_flm_swap_rec(h_fav_handle, ui2_position1, ui2_position2);
}
...
{
    return x_flm_move_rec(h_fav_handle, ui2_from, pui2_to);
}
...
)
{
    ...
    {
    case AEER_OK:
        i4_result = x_flm_master_change_reg(pv_tag, pf_flm_notify,
                           ph_notify_handle);
        if (i4_result == FLMR_OK)
        {
            handle_link_to_aux(h_aux, *ph_notify_handle);
        }
        else
        {
            aee_release_handle_resource(1);
...
)
{
    ...
    {
    case AEER_OK:
        i4_result = x_flm_fs_load(h_dir, ps_pathname, 
                           ps_listname, pv_tag, pf_flm_notify,
                           ph_list);
        if (i4_result == FLMR_OK)
        {
            handle_link_to_aux(h_aux, *ph_list);
        }
        else
        {
            aee_release_handle_resource(1);
...
{
    return x_flm_fs_store(h_dir, ps_pathname, h_list);
}
...
{
    return x_flm_fs_del(h_dir, ps_pathname, ps_listname);
}
...
{
    return x_flm_fs_qry(h_dir, ps_pathname, ui2_index, ps_listname);
}
