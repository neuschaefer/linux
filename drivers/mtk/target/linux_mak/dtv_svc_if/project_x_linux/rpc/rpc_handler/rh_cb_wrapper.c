 ...
 *---------------------------------------------------------------------------*/
/*
 * Commonly used callback wrappers.
 */
...
INT32 
ri_x_stream_nfy_fct_wrapper(
    HANDLE_T                    h_stream,               /* in  */
    SM_COND_T                   e_nfy_cond,             /* in  */
    VOID*                       pv_nfy_tag,             /* in  */
    SM_EVN_TYPE_T               e_event,                /* in  */
    UINT32                      ui4_data                /* in  */)
{    
    RPC_DECL(5, INT32);
    ...
    RPC_DO_CB(pt_nfy_tag->t_id, "x_stream_nfy_fct", pt_nfy_tag->pv_cb_addr);
