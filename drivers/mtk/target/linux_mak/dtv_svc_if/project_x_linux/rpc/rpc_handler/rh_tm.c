    ...
    ARG_DESC_T*  pt_return)
{
    ...
    pt_return->u.i4_arg = x_tm_open_root(
                           pt_args[0].u.ps_str,
    ...
    ARG_DESC_T*  pt_return)
{
    ...
    pt_return->e_type   = ARG_TYPE_INT32;
    pt_return->u.i4_arg = x_tm_free(
                  (HANDLE_T )pt_args[0].u.ui4_arg);

    return RPCR_OK;
}

INT32 c_rpc_reg_tm_op_hndlrs()
{
    RPC_REG_OP_HNDLR(x_tm_free);
    RPC_REG_OP_HNDLR(x_tm_open_root);
