...
static VOID _dsm_dev_nfy_fct_wrapper(
                                HANDLE_T          h_dsm_dev,
                                ...
                                UINT32            ui4_data_2)
{
    ...
    RPC_DO_CB(pt_nfy_tag->t_id, "dsm_dev_nfy_fct", pt_nfy_tag->pv_cb_addr);

    /* Fix me here how to process error? */
    RPC_RETURN_VOID;          
}
INT32 _hndlr_x_dsm_open(
                                    RPC_ID_T     t_rpc_id,
                                    const CHAR*  ps_op,    
                                    UINT32       ui4_num_args,
                                    ARG_DESC_T*  pt_args,
                                    ...
                                    ARG_DESC_T*  pt_return)
{
    ...
    pt_return->u.i4_arg = x_dsm_dev_open(
    ...
    ARG_DESC_T*  pt_return)
{
    ...
    pt_return->e_type   = ARG_TYPE_INT32;
    pt_return->u.i4_arg = x_dsm_get(
        (HANDLE_T     )pt_args[0].u.ui4_arg,                           
            (DSM_GET_T)pt_args[1].u.ui4_arg,                         
                       pt_args[2].u.pv_arg,                        
    ...
    ARG_DESC_T*  pt_return)
{
    ...
    pt_return->e_type   = ARG_TYPE_INT32;
    pt_return->u.i4_arg = x_dsm_dev_get(
        (HANDLE_T     )pt_args[0].u.ui4_arg,                           
        (DSM_DEV_GET_T)pt_args[1].u.ui4_arg,                         
                       pt_args[2].u.pv_arg,                        
        (SIZE_T *     )pt_args[3].u.pz_arg,
                       pt_args[4].u.pv_desc);
    ...
    ARG_DESC_T*  pt_return)
{
    ...
    h_dsm = (HANDLE_T)pt_args[0].u.ui4_arg;
    t_set_type = (DSM_SET_T)pt_args[1].u.ui4_arg;
    
    pt_return->e_type   = ARG_TYPE_INT32;

    pt_return->u.i4_arg = x_dsm_set(h_dsm,                           
                                   t_set_type,  
                                   pt_args[2].u.pv_arg,                        
                                   pt_args[3].u.z_arg);
    return RPCR_OK;
    ...
    ARG_DESC_T*  pt_return)
{
    ...
    h_dsm = (HANDLE_T)pt_args[0].u.ui4_arg;
    t_set_type = (DSM_DEV_SET_T)pt_args[1].u.ui4_arg;
    
    pt_return->e_type   = ARG_TYPE_INT32;

    pt_return->u.i4_arg = x_dsm_dev_set(h_dsm,                           
                                   t_set_type,  
                                   pt_args[2].u.pv_arg,                        
                                   pt_args[3].u.z_arg);
    return RPCR_OK;
...
INT32 c_rpc_reg_dsm_op_hndlrs()
{

    RPC_REG_OP_HNDLR(x_dsm_open);
    RPC_REG_OP_HNDLR(x_dsm_dev_open);
    RPC_REG_OP_HNDLR(x_dsm_get);
    RPC_REG_OP_HNDLR(x_dsm_dev_get);
    RPC_REG_OP_HNDLR(x_dsm_get);
    RPC_REG_OP_HNDLR(x_dsm_dev_get);
    return RPCR_OK;
