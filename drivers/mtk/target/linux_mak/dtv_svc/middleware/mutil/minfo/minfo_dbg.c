...
/*-----------------------------------------------------------------------------
                    data declarations
 ----------------------------------------------------------------------------*/
static UINT16 ui2_minfo_dbg_level = DBG_LEVEL_NONE;
UINT16 minfo_get_dbg_level(VOID);
BOOL minfo_set_dbg_level(UINT16 ui2_level);
...
UINT16 minfo_get_dbg_level(VOID)
{
    return ui2_minfo_dbg_level;
}


/*-----------------------------------------------------------------------------
 * Name: minfo_set_dbg_level
 *
