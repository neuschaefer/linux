...
/*-----------------------------------------------------------------------------
 * Name: tsl_reset_rec_id
 *
 * Description: This function reset the TSL record ID library. 
 *
 * Inputs: 
 *    pt_tsl:   TSL structure containing the smallest and largest record id
 ...
 *
 ----------------------------------------------------------------------------*/
BOOL tsl_reset_rec_id(TSL_OBJ_T*    	pt_tsl)
{
    /*
    ...
    */
    ...
    /*
      Reset the TSL id values.
    */
    aui2_min_max[0]=TSL_SMALLEST_INIT_VAL;
    aui2_min_max[1]=TSL_NULL_REC_ID;

    /*
      Save the min and max record id value to the
      database object.
    */
    i4_rc=db_write_common(pt_tsl->h_cdb,aui2_min_max,
...
/*-----------------------------------------------------------------------------
 * Name: tsl_get_next_rec_id
 *
 * Description: This function get the next available TSL record ID.
 *
 * Inputs:  
 *    pt_tsl:   TSL structure containing the smallest and largest record id
 *              currently in used.
 ...
 *   TSLR_OUT_OF_RES  Can not add the new TSL ID/Name.
 ----------------------------------------------------------------------------*/
BOOL tsl_get_next_rec_id(const TSL_OBJ_T* pt_tsl, UINT16* pui2_next_id)
{
    UINT16  aui2_min_max[2];
    UINT16  ui2_i;
    ...
    */
    db_read_common(pt_tsl->h_cdb, aui2_min_max,
                   (UINT16) sizeof(aui2_min_max));
 ...
 *   FALSE     A Null record id is returned.
 ----------------------------------------------------------------------------*/
BOOL tsl_get_smallest_rec_id(const TSL_OBJ_T* pt_tsl, UINT16* pui2_next_id)
{
    UINT16  aui2_min_max[2];
    ...
    */
    ...
    if ( aui2_min_max[0] != TSL_SMALLEST_INIT_VAL )
    {
 ...
 *   FALSE     Invalid TSL ID/Name.
 ----------------------------------------------------------------------------*/
BOOL tsl_set_smallest_rec_id(TSL_OBJ_T* pt_tsl, UINT16  ui2_next_id)
{
    UINT16  aui2_min_max[2];
    ...
    */
    ...
    db_write_common(pt_tsl->h_cdb, aui2_min_max,
                    (UINT16) sizeof(aui2_min_max));
    return TRUE;
}

/*-----------------------------------------------------------------------------
 * Name: tsl_get_largest_rec_id
 *
 ...
 *
 ----------------------------------------------------------------------------*/
BOOL tsl_get_largest_rec_id(const TSL_OBJ_T* pt_tsl, UINT16* pui2_next_id)
{
    UINT16  aui2_min_max[2];
    ...
    */
    ...
    if ( aui2_min_max[1] != TSL_NULL_REC_ID )
    {
 ...
 *
 ----------------------------------------------------------------------------*/
BOOL tsl_set_largest_rec_id(TSL_OBJ_T* pt_tsl, UINT16  ui2_next_id)
{
    UINT16  aui2_min_max[2];
