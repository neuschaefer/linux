...
***********************************************************************/
/*-----------------------------------------------------------------------------
 * Name: svl_get_database_name
 *
 * Description: This function create the SVL object's database name to used
 ...
 *
 * Returns: 
 *   SVLR_OK           SVL object's CDB name is created.
 *
 ----------------------------------------------------------------------------*/
INT32 svl_get_database_name
(
...
{
    x_sprintf(ps_cdb_name,"SVL_%s_%d.db\0",ps_svl_name,ui2_svl_id);
    return SVLR_OK;
}

/*-----------------------------------------------------------------------------
 * Name: svl_cdb_to_svl_err_code
 *
 * Description: API to translate CDB error code to SVL error code.
 *             
 *
 ...
 *                           
 *
 * Returns: - tanslated SVLR error code.   
 *                        
 ----------------------------------------------------------------------------*/

INT32 svl_cdb_to_svl_err_code(INT32 i4_cdb_error)
{
    INT32 i4_rc;
...
/*-----------------------------------------------------------------------------
 * Name: svl_fm_to_svl_err_code
 *
 * Description: API to translate File Manager error code to SVL error code.
 *             
 *
 * Inputs:  - i4_cdb_error: CDB error code
 *
...
INT32 svl_fm_to_svl_err_code(INT32 i4_cdb_error)
{
    INT32 i4_rc;
...
/*-----------------------------------------------------------------------------
 * Name: svl_fsraw_to_svl_err_code
 *
 * Description: API to translate FS RAW error code to SVL error code.
 *             
 *
 * Inputs:  - i4_cdb_error: CDB error code
 *
...
INT32 svl_fsraw_to_svl_err_code(INT32 i4_error)
{
    INT32 i4_rc;
