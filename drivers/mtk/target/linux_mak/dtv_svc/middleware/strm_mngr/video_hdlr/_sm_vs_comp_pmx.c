 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: _sm_vs_comp_pmx.c,v $
 * $Revision: #3 $
 * $Date: 2012/11/03 $
 * $Author: xingju.wang $
 * $CCRevision: /main/DTV_X/DTV_X_HQ_int/13 $
 * $SWAuthor: Alec Lu $
 * $MD5HEX: 20c0caf14827ad322f3728224a298abf $
 *
 * Description: 
 *---------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
static SELECT_T _rm_comp_sel_fct_pmx( 
                    DRV_TYPE_T   e_type,
                    UINT16       ui2_id,
...
static VOID _rm_nfy_fct_pmx( HANDLE_T   h_obj,
                             UINT8      ui1_port,
                             ...
                             UINT32     ui4_data)
{
    ...
    {
        SM_VS_DBG_ERR((
            "[SM] VS, _rm_nfy_fct_pmx(), h_stream(0x%.8X) is invalid!\r\n", h_stream ));
        return;
    }
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 sm_vs_comp_pmx_open( HANDLE_T            h_stream,
                           HANDLE_T            h_source, 
