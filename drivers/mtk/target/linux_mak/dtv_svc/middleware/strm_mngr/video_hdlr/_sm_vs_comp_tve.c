...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
static SELECT_T _rm_comp_sel_fct_tve( 
                    DRV_TYPE_T   e_type,
                    UINT16       ui2_id,
...
static VOID _rm_nfy_fct_tve( HANDLE_T   h_obj,
                             UINT8      ui1_port,
                             ...
                             UINT32     ui4_data)
{
    ...
    {
        SM_VS_DBG_ERR((
            "[SM] VS, _rm_nfy_fct_tve(), h_stream(0x%.8X) is invalid!\r\n", h_stream ));
        return;
    }
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 sm_vs_comp_tve_open( HANDLE_T            h_stream,
                           HANDLE_T            h_source,
