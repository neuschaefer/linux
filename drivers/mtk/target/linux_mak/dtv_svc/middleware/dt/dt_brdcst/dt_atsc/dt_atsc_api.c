...
)
{
    ...
    */
    ...
    {
        DBG_INFO(("{DT} Processing Out-of-band STT.\n"));
...
INT32 x_dt_reg_atsc(VOID)
{
    ...
    */
    ...
    return dt_reg_atsc_functions(&t_table);
}
