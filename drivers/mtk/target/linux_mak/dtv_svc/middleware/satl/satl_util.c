...
***********************************************************************/
/*-----------------------------------------------------------------------------
 * Name: satl_get_database_name
 *
 * Description: This function create the SATL object's database name to used
 ...
 *
 * Returns: 
 *   SATLR_OK          SATL object's CDB name is created.
 *
 ----------------------------------------------------------------------------*/
INT32 satl_get_database_name
(
...
{
    x_sprintf(ps_cdb_name,"SATL_%s_%d.db\0",ps_satl_name,ui2_satl_id);
    return SATLR_OK;
}

/*-----------------------------------------------------------------------------
 * Name: satl_cdb_to_satl_err_code
 *
 * Description: API to translate CDB error code to SATL error code.
 *             
 *
 ...
 *                           
 *
 * Returns: - tanslated SATLR error code.   
 *                        
 ----------------------------------------------------------------------------*/

INT32 satl_cdb_to_satl_err_code(INT32 i4_cdb_error)
{
    INT32 i4_rc;
...
/*-----------------------------------------------------------------------------
 * Name: satl_fm_to_satl_err_code
 *
 * Description: API to translate File Manager error code to SATL error code.
 *             
 *
 * Inputs:  - i4_cdb_error: CDB error code
 *
...
INT32 satl_fm_to_satl_err_code(INT32 i4_cdb_error)
{
    INT32 i4_rc;
...
/*-----------------------------------------------------------------------------
 * Name: satl_fsraw_to_satl_err_code
 *
 * Description: API to translate FS RAW error code to SATL error code.
 *             
 *
 * Inputs:  - i4_cdb_error: CDB error code
 *
...
INT32 satl_fsraw_to_satl_err_code(INT32 i4_error)
{
    INT32 i4_rc;
