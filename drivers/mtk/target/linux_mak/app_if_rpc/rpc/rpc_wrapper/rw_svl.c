...
static INT32 _hndlr_x_svl_nfy_fct(
    RPC_ID_T     t_rpc_id,
...
{  
    ...
    ((x_svl_nfy_fct)pv_cb_addr)(
            (HANDLE_T)pt_args[0].u.ui4_arg,
          (SVL_COND_T)pt_args[1].u.ui4_arg,
                      pt_args[2].u.ui4_arg,
                      pt_args[3].u.pv_arg,
                      pt_args[4].u.ui4_arg);
...
{  
    ...
    pt_return->u.i4_arg = ((x_svl_sort_cmp)pv_cb_addr)(
    (const SVL_REC_T*)pt_args[0].u.pv_desc,
...
static INT32 _hndlr_x_svl_search_cmp(
    RPC_ID_T     t_rpc_id,
    const CHAR*  ps_cb_type,
    VOID *       pv_cb_addr,
    UINT32       ui4_num_args,
...
{  
    ...
    pt_return->u.i4_arg = ((x_svl_search_cmp)pv_cb_addr)(
       (const SVL_REC_T *)pt_args[0].u.pv_desc,
			       (VOID*)pt_args[1].u.ui4_arg,/* VOID * -> UINT32 */
            		      pt_args[2].u.pv_arg);
                      
    return RPCR_OK;
}

static INT32 _x_svl_create
(
...
)
{
    ...
    RPC_CHECK(RPC_ADD_REF_STR(RPC_DEFAULT_ID, ps_svl_name));
    
    RPC_ARG_INP(ARG_TYPE_REF_STR,    ps_svl_name);
    RPC_ARG_INP(ARG_TYPE_UINT16,      ui2_svl_id);
    ...
    RPC_ARG_OUT(ARG_TYPE_REF_UINT32,      ph_svl);

    RPC_DO_OP("x_svl_create");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_INV_ARG);
}

static INT32 _x_svl_open
(
    UINT16		    ui2_svl_id,
    VOID*		    pv_tag,
    x_svl_nfy_fct   pf_nfy,
...
)
{
    ...
    RPC_DO_OP("x_svl_open");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_INV_ARG);
}

static INT32 _x_svl_open_by_name
(
    const CHAR*     ps_svl_name,
    VOID*		    pv_tag,
    x_svl_nfy_fct	pf_nfy,
...
) 
{
    ...
    RPC_DO_OP("x_svl_open_by_name");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_INV_ARG);
}

static INT32 _x_svl_fs_load
(
    HANDLE_T        h_dir,
...
)
{
    ...
    RPC_CHECK(RPC_ADD_REF_STR(RPC_DEFAULT_ID, ps_svl_path));
    RPC_CHECK(RPC_ADD_REF_STR(RPC_DEFAULT_ID, ps_svl_name));
    
    RPC_ARG_INP(ARG_TYPE_UINT32,           h_dir);
    RPC_ARG_INP(ARG_TYPE_REF_STR,    ps_svl_path);
    RPC_ARG_INP(ARG_TYPE_UINT16,      ui2_svl_id);
    RPC_ARG_INP(ARG_TYPE_REF_STR,    ps_svl_name);
    RPC_ARG_INP(ARG_TYPE_REF_VOID,   pv_tag);
    RPC_ARG_INP(ARG_TYPE_REF_FUNC,   pf_nfy);
...
)
{
    ...
    i4_rc = _x_svl_create(ps_svl_name, ui2_svl_id, e_mem_policy,
...
)
{
    ...
    i4_rc = _x_svl_open(ui2_svl_id, pv_tag, pf_nfy, ph_svl);
    return i4_rc;
}
...
)
{
    ...
    i4_rc = _x_svl_open_by_name(ps_svl_name, pv_tag, pf_nfy, ph_svl);
    return i4_rc;
}
...
)
{
    ...
    i4_rc = _x_svl_fs_load(h_dir, ps_svl_path, ui2_svl_id,
...
)
{
    ...
    RPC_ARG_INP(ARG_TYPE_UINT32,           h_svl);
    RPC_ARG_INP(ARG_TYPE_UINT8, e_svl_qry_option);
    RPC_ARG_OUT(ARG_TYPE_REF_UINT16, pui2_rec_id);

    RPC_DO_OP("x_svl_qry_rec_id");
...
)
{
    ...
    RPC_ARG_OUT(ARG_TYPE_REF_UINT16, pui4_svl_id);
    RPC_ARG_OUT(ARG_TYPE_REF_STR,    ps_svl_name);

    RPC_DO_OP("x_svl_fs_qry");
...
)
{
    ...
    RPC_CHECK(RPC_ADD_REF_BUFF(RPC_DEFAULT_ID, ps_svl_name, MAX_SVL_NAME_LEN + 1));
    
    RPC_ARG_INP(ARG_TYPE_UINT32,           h_svl);
    RPC_ARG_OUT(ARG_TYPE_REF_UINT16, pui2_svl_id);
    /* For output name, we should use buffer */
    
    RPC_ARG_OUT(ARG_TYPE_REF_DESC,    ps_svl_name);

    RPC_DO_OP("x_svl_get_handle_info");
...
)
{
    ...
    RPC_ARG_INP(ARG_TYPE_UINT32,           h_svl);
    RPC_ARG_INP(ARG_TYPE_UINT32, ui4_channel_num);
    RPC_ARG_INP(ARG_TYPE_UINT32,     ui4_nw_mask);
    RPC_ARG_INP(ARG_TYPE_UINT16,         ui2_idx);
    RPC_ARG_OUT(ARG_TYPE_REF_DESC,    pt_svl_rec);
    RPC_ARG_IO(ARG_TYPE_REF_UINT32,  pui4_ver_id);

    RPC_DO_OP("x_svl_get_rec_by_channel");
...
)
{
    ...
    RPC_DO_OP("x_svl_get_rec_by_brdcst_type");
...
)
{
    ...
    RPC_ARG_INP(ARG_TYPE_UINT32,           h_svl);
    RPC_ARG_INP(ARG_TYPE_UINT16,      ui2_tsl_id);
    RPC_ARG_INP(ARG_TYPE_UINT16,  ui2_tsl_rec_id);
    RPC_ARG_INP(ARG_TYPE_UINT32,     ui4_nw_mask);
    RPC_ARG_INP(ARG_TYPE_UINT16,         ui2_idx);
    RPC_ARG_OUT(ARG_TYPE_REF_DESC,    pt_svl_rec);
    RPC_ARG_IO(ARG_TYPE_REF_UINT32,  pui4_ver_id);

    RPC_DO_OP("x_svl_get_rec_by_ts");
...
)
{
    ...
    RPC_DO_OP("x_svl_get_num_rec_by_channel");
...
)
{
    ...
    RPC_DO_OP("x_svl_get_num_rec_by_brdcst_type");
...
)
{
    ...
    RPC_DO_OP("x_svl_get_num_rec_by_ts");
...
{    
    ...
    RPC_ARG_INP(ARG_TYPE_UINT32,               h_svl);
    RPC_ARG_INP(ARG_TYPE_UINT32, ui4_current_channel);
    RPC_ARG_INP(ARG_TYPE_UINT32,         ui4_nw_mask);
    RPC_ARG_INP(ARG_TYPE_UINT8,           e_iter_dir);
    RPC_ARG_OUT(ARG_TYPE_REF_DESC,        pt_svl_rec);
    RPC_ARG_IO(ARG_TYPE_REF_UINT32,      pui4_ver_id);

    RPC_DO_OP("x_svl_iterate_rec");
 ...
 *   SVLR_INV_ARG    'pf_sort_cmp' or 'pf_search_cmp' is a NULL pointer.
 -----------------------------------------------------------------------*/
static INT32 _x_svl_reg_cmp_fcts
(
    HANDLE_T               h_svl,
    BOOL                   b_global,
    VOID*                  pv_tag,
...
)
{
    ...
    RPC_ARG_INP(ARG_TYPE_UINT32,           h_svl);
    RPC_ARG_INP(ARG_TYPE_BOOL,          b_global);
    RPC_ARG_INP(ARG_TYPE_REF_VOID,        pv_tag);
    RPC_ARG_INP(ARG_TYPE_REF_FUNC,   pf_sort_cmp);
    RPC_ARG_INP(ARG_TYPE_REF_FUNC, pf_search_cmp);

    RPC_DO_OP("x_svl_reg_cmp_fcts");
...
)
{
    ...
    i4_rc = _x_svl_reg_cmp_fcts(h_svl, b_global,
                                pv_tag, pf_sort_cmp, pf_search_cmp);
...
)
{
    ...
    RPC_DO_OP("x_svl_unreg_cmp_fcts");
...
)
{
    ...
    RPC_CHECK(RPC_ADD_REF_DESC(RPC_DEFAULT_ID, pt_client_data,  RPC_DESC_SVL_CLIENT_DATA_T, NULL));
    RPC_CHECK(RPC_ADD_REF_BUFF(RPC_DEFAULT_ID, pt_client_data->pui1_data_buf,  pt_client_data->ui1_buf_len));

    RPC_ARG_INP(ARG_TYPE_UINT32, h_svl);
    RPC_ARG_INP(ARG_TYPE_UINT16, ui2_svl_rec_id);
    RPC_ARG_OUT(ARG_TYPE_REF_DESC, pt_client_data);
    RPC_ARG_IO(ARG_TYPE_REF_UINT32, pui4_ver_id);

    RPC_DO_OP("x_svl_get_client_data");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}
...
)
{
    ...
    RPC_ARG_INP(ARG_TYPE_UINT32, h_svl);
    RPC_ARG_INP(ARG_TYPE_UINT16, ui2_svl_rec_id);
    RPC_ARG_INP(ARG_TYPE_REF_DESC, pt_client_data);

    RPC_DO_OP("x_svl_set_client_data");
...
)
{
    ...
    RPC_DO_OP("x_svl_iterate_rec_by_custom_ord");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_INV_ARG);
}

INT32 c_svl_init_mem_dump(SVL_MEM_DUMP_T * pt_mem_dump)
{
    RPC_DECL(1, INT32);

    RPC_CHECK(RPC_ADD_REF_DESC(RPC_DEFAULT_ID, pt_mem_dump,  RPC_DESC_SVL_MEM_DUMP_T, NULL));

    RPC_ARG_OUT(ARG_TYPE_REF_DESC, pt_mem_dump);

    RPC_DO_OP("x_svl_init_mem_dump");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_free_mem_dump(SVL_MEM_DUMP_T * pt_mem_dump)
{
    RPC_DECL(1, INT32);
    ...
    RPC_DO_OP("x_svl_free_mem_dump");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_dump_to_mem(HANDLE_T h_svl,
                        SVL_MEM_DUMP_T * pt_mem_dump)
{
    ...
    RPC_DO_OP("x_svl_dump_to_mem");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_load_from_mem(HANDLE_T h_svl,
                          SVL_MEM_DUMP_T * pt_mem_dump)
{
    RPC_DECL(2, INT32);
    ...
    RPC_DO_OP("x_svl_load_from_mem");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_get_rec_by_nw(HANDLE_T h_svl,
                          UINT16 ui2_nwl_id,
                          ...
                          UINT32 * pui4_ver_id)
{
    ...
    RPC_DO_OP("x_svl_get_rec_by_nw");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_get_rec_by_sat(HANDLE_T h_svl,
                           UINT16 ui2_satl_id,
                           ...
                           UINT32 * pui4_ver_id)
{
    ...
    RPC_DO_OP("x_svl_get_rec_by_sat");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_get_num_rec_by_nw(HANDLE_T h_svl,
                              UINT16 ui2_nwl_id,
                              UINT16 ui2_nwl_rec_id,
                              UINT32 ui4_nw_mask,
                              UINT16 * pui2_num_recs,
                              UINT32 * pui4_ver_id)
{
    ...
    RPC_DO_OP("x_svl_get_num_rec_by_nw");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_get_num_rec_by_sat(HANDLE_T h_svl,
                               UINT16 ui2_satl_id,
                               UINT16 ui2_satl_rec_id,
                               UINT32 ui4_nw_mask,
                               UINT16 * pui2_num_recs,
                               UINT32 * pui4_ver_id)
{
    ...
    RPC_DO_OP("x_svl_get_num_rec_by_sat");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_iterate_by_nw(HANDLE_T h_svl,
                          UINT32 ui4_current_channel,
                          UINT32 ui4_nw_mask,
                          UINT16 ui2_nwl_id,
                          UINT16 ui2_nwl_rec_id,
                          ...
                          UINT32 * pui4_ver_id)
{
    ...
    RPC_DO_OP("x_svl_iterate_by_nw");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_svl_iterate_by_sat(HANDLE_T h_svl,
                           UINT32 ui4_current_channel,
                           UINT32 ui4_nw_mask,
                           UINT16 ui2_satl_id,
                           UINT16 ui2_satl_rec_id,
                           ...
                           UINT32 * pui4_ver_id)
{
    ...
    RPC_DO_OP("x_svl_iterate_by_sat");

    RPC_RETURN(ARG_TYPE_INT32, SVLR_FAIL);
}

INT32 c_rpc_reg_svl_cb_hndlrs()
{
    RPC_REG_CB_HNDLR(x_svl_nfy_fct);    
    return RPCR_OK;
}

INT32 c_rpc_reg_svl_sort_cmp_hndlrs()
{
    RPC_REG_CB_HNDLR(x_svl_sort_cmp);    
    return RPCR_OK;
}

INT32 c_rpc_reg_svl_search_cmp_hndlrs()
{
    RPC_REG_CB_HNDLR(x_svl_search_cmp);    
    return RPCR_OK;
}
