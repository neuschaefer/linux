...
ifndef PRJ_ROOT
	...
	export PRJ_ROOT =$(DRV_SRC_ROOT)drivers/mtk/mt5368
endif
...
ifeq "$(findstring 5368_MT5112EE,$(BRDCST_IF))" "5368_MT5112EE"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
DEFINES += -DCC_FEDTD
endif
ifeq "$(findstring 5368_MT5135,$(BRDCST_IF))" "5368_MT5135"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
DEFINES += -DCC_FEDVBT
endif
ifeq "$(findstring 5368DUAL,$(BRDCST_IF))" "5368DUAL"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
endif
ifeq "$(findstring 5368DVBTC,$(BRDCST_IF))" "5368DVBTC"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
...
DEFINES += -D_CPU_LITTLE_ENDIAN_ -DCC_MT5368 -DCC_MT5368 -DCC_DRIVER_PROGRAM
