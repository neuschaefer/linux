...
#else
typedef   CHAR  AVL_char;		///< 8 bits signed char data type.
typedef UCHAR AVL_uchar;	///< 8 bits unsigned char data type.

typedef INT16 AVL_int16;	///< 16 bits signed char data type.
typedef UINT16  AVL_uint16;	///< 16 bits unsigned char data type.

typedef INT32  AVL_int32;		///< 32 bits signed char data type.
typedef UINT32  AVL_uint32;	///< 32 bits unsigned char data type.

typedef  CHAR * AVL_pchar;	///< pointer to a 8 bits signed char data type.
typedef  UCHAR * AVL_puchar; ///< pointer to a 8 bits unsigned char data type.

typedef  INT16 * AVL_pint16;	///< pointer to a 16 bits signed char data type.
typedef  UINT16 * AVL_puint16;	///< pointer to a 16 bits unsigned char data type.

typedef  INT32 * AVL_pint32;	///< pointer to a 32 bits signed char data type.
typedef  UINT32 * AVL_puint32; ///< pointer to a 32 bits unsigned char data type.

typedef UINT32 AVL_semaphore; 	///< the semaphore data type.
typedef UINT32 * AVL_psemaphore;		///< the pointer to a semaphore data type.
