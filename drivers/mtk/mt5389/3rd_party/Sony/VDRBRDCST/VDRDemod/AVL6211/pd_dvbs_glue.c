...
/////////////////end		
		...
		mcDBG_MSG_INFO(("Detect Channel CurTP_Num:%d............!\n",CurTP_Num));
		if(CurTP_Num>0)
		{
		...
		{
			mcDBG_MSG_INFO(("No Detect Channel.............!\n"));
...
static  INT32 DVBS_AutoScanCallback(UINT8 signal,UINT8 polar,UINT32 freq,UINT32 sym,UINT8 fec)
{
	...
	if(AVL6211_MD_Break())
	{
		mcDBG_MSG_INFO(("[DVBS_AutoScanCallback] MD has been broken....\n"));
		mcSEMA_UNLOCK_MTFE(pPdCtxDVBS->hHalLock);
		return 0;
	}
...
VOID  DVBS_TunerConnect()
{
    ...
    mcDBG_MSG_INFO(("[DVBS_TunerConnect] Enable TS Output!\n"));
	AV6211_EnableTSOutPut();
