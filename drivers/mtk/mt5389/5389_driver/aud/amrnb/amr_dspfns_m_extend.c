...
#else
  armdsp_flagdata_AMR.armdsp_bitfields.armdsp_q = 0;
#endif
}
...
#else
  ret = armdsp_flagdata_AMR.armdsp_bitfields.armdsp_q;
#endif
  return ret;
}
...
#else
  armdsp_flagdata_AMR.armdsp_bitfields.armdsp_q = flag;
#endif
