...
static UINT8 _TAS5717_RegRead(UINT8 u1Addr)
{
    ...
    if (u4ReadCount > 0)
    {
        Printf("5717 read 1 byte ok=0x%2x!\n", u1Data);
        return u1Data;
    }
    else
    {
...
static void _TAS5717_RegWriteN(UINT8 u1WordAddr, UINT8 *pu1Buf, UINT16 u2ByteCnt)
{
    UINT32 u4WriteCount = 0;
...
static void _TAS5717_Init(void)
{
    ...
    SIF_Init();
    _TAS5717_RegWrite(TAS5717_TRIM, 0x00);
    x_thread_delay(60);
    ...
    u1Array[6] = 0x77;
    u1Array[7] = 0xc0;
    _TAS5717_RegWriteN(TAS5717_DRC_ENERGY, u1Array, 8);
    ...
    u1Array[6] = 0x2f;
    u1Array[7] = 0xd2;
    _TAS5717_RegWriteN(TAS5717_DRC_ATTACK, u1Array, 8);
    ...
    u1Array[6] = 0xf9;
    u1Array[7] = 0x2b;
    _TAS5717_RegWriteN(TAS5717_DRC_DELAY, u1Array, 8);
    ...
    u1Array[2] = 0x39;
    u1Array[3] = 0x90;
    _TAS5717_RegWriteN(TAS5717_DRC_THRESHOLD, u1Array, 4);
    ...
    u1Array[2] = 0x47;
    u1Array[3] = 0xaf;
    _TAS5717_RegWriteN(TAS5717_DRC_COMPRESSION_RATIO, u1Array, 4);
    ...
    u1Array[2] = 0x42;
    u1Array[3] = 0x10;
    _TAS5717_RegWriteN(TAS5717_DRC_OFFSET, u1Array, 4);
    ...
    _TAS5717_RegWrite(TAS5717_IC_DELAY_CH1, 0xB8);  ///[Joel]0x4c);
    _TAS5717_RegWrite(TAS5717_IC_DELAY_CH2, 0x60);  ///[Joel]0x34);
    _TAS5717_RegWrite(TAS5717_IC_DELAY_CH3, 0xA0);  ///[Joel]0x1c);
    _TAS5717_RegWrite(TAS5717_IC_DELAY_CH4, 0x48);  ///[Joel]0x64);
}
