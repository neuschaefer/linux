...
#else
#define VDEC_THREAD_PRIORITY            60
#endif

#define VDEC_CMD_SIZE                    4
#define VDEC_CMD_Q_SIZE                5
...
#define VDEC_PDN_CON_SPEC 0xC8
#define VDEC_PDN_CON_MODULE 0xCC
...
EXTERN void _VDEC_MainLoop(void* pvArg);
#ifdef CC_REALD_3D_SUPPORT
EXTERN void _VDEC_TDTVModeChangeCB(void *pvArgv);
#endif
//-----------------------------------------------------------------------------
// Public functions
//-----------------------------------------------------------------------------
