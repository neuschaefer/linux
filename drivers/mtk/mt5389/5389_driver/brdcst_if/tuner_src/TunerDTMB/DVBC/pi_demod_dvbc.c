...
UINT8 DVBC_Connect(DEMOD_CTX_T *psDemodCtx, UINT8 Mode, UINT16 Rate)
{
  UINT8 fgRet = 0;  
    ...
    #if defined (CC_MT5135) || defined(CC_MT5135DVBC) ||defined(CC_MT5396)|| defined(CC_MT5368)||defined (CC_MT5175)//EC_code_dB330: For MT5396DVBTC demod
...
/* 
    ...
    mcSHOW_DBG_MSG(("disable DVBC UP!\n"));   
*/
...
BOOL DVBC_GetDvbcNotExist(DEMOD_CTX_T *psDemodCtx)
{
    ...
    mcSHOW_DBG_MSG((".DVBC ReAcq Cnt %d, QCN Fail Cnt %d, ASR Fail Cnt %d, QAM: %d, RS: %d!\n", 
        psDemodCtx->ucReAcqCnt, psDemodCtx->ucQCNFailState, psDemodCtx->ucASRFailState, psDemodCtx->ucQamMode, psDemodCtx->u2SymbolRate));
                 ...
                 UINT16 u2CurRomLen, UINT16 u2MaxI2cLen, BOOL fgClk50)
{
    ...
    #if defined(CC_MT5135) || defined (CC_MT5135DVBC)||defined (CC_MT5175)
...
#if defined(CC_MT5135) || defined(CC_MT5135DVBC) ||defined (CC_MT5175)//|| defined(CC_MT5396)
...
void DVBC_UpdateInfo(DEMOD_CTX_T *psDemodCtx)
{
    ...
    mcSHOW_DBG_MSG3(("psDemodCtx->ucASR_CFOflag = %d\n", psDemodCtx->ucASR_CFOflag));    //Iven, 20110303
    mcSHOW_DBG_MSG3(("ccOFST_DVBC_INFO5_ASR_CFO3 = %d\n", uc_data[3]));    //Iven, 20110303
    mcSHOW_DBG_MSG3(("ccOFST_DVBC_INFO5_ASR_CFO2 = %d\n", uc_data[2]));    //Iven, 20110303
    mcSHOW_DBG_MSG3(("ccOFST_DVBC_INFO5_ASR_CFO1 = %d\n", uc_data[1]));    //Iven, 20110303
    mcSHOW_DBG_MSG3(("ccOFST_DVBC_INFO5_ASR_CFO0 = %d\n", uc_data[0]));    //Iven, 20110303    
    }
