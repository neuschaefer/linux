 ...
 * $Author: dtvbm11 $
 * $Date: 2012/04/27 $
 * $RCSfile: pi_anana_tvsys_info.h,v $
 * $Revision: #1 $
 *
 *---------------------------------------------------------------------------*/

/** @file pi_anana_tvsys_info.h
 *  NA tv sys info export APIs
 */

#ifndef PI_ANANA_TVSYS_INFO_H
#define PI_ANANA_TVSYS_INFO_H
...
// Public functions
//-----------------------------------------------------------------------------
BOOL fgDrvTunerCheckTVDLock( UINT16 bTryLoopCnt );
#endif /* PI_ANANA_TVSYS_INFO_H */
