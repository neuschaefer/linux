...
/*                                                                                          */
/*  Module Name:            frequency_plans.h												*/
/*  Author (Nationality):   Luke Grove (British)	                                        */
/*  Description:            Specific frequency plans for optimised channel searching	    */
/*																						    */
...
#include "demod_MN88471.h"
    ...
    /*----------------------------------------------------------------------------*/
    /* frequency plan for testing                                                 */
    /*----------------------------------------------------------------------------*/

#define FREQ_PLAN_TOTAL_FREQUENCIES(x)   FreqPlanGetTotalChannels(x)
