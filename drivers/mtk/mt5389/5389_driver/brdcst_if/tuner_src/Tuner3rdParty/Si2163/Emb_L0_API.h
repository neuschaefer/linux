...
#ifdef TRACES
    #define TRACES_PRINTF                mcSHOW_USER_MSG
    /* <porting> replace this by your own error handling when it is not possible to allocate memory */
    #define ALLOCATION_ERROR_MESSAGE     mcSHOW_USER_MSG
    #define TREAT_ERROR_MESSAGE          mcSHOW_USER_MSG
    #define TRACES_ERR(EXP)   do { mcSHOW_USER_MSG (("\n -!!!!!- TRACES_ERROR:   %-30s , line %5d : " #EXP "\n\n", __FILE__, __LINE__)); } while (0)
    #define TRACES_TRACE(EXP) do { mcSHOW_USER_MSG ((" --- %-30s , line %5d : " #EXP "\n", __FILE__, __LINE__)); } while (0)
    #define TRACES_SHOW(EXP)  do { mcSHOW_USER_MSG ((" ... " #EXP "\n")); } while (0)
    #define TRACES_USE(EXP)   do { mcSHOW_USER_MSG (("" #EXP "\n")); } while (0)
#else
    /* <porting> replace this by your own error handling when it is not possible to allocate memory */
    #define ALLOCATION_ERROR_MESSAGE     //mcSHOW_USER_MSG
    /* <porting> replace these by your own error handling when you want to display errors */
    #define TREAT_ERROR_MESSAGE          //mcSHOW_USER_MSG
    #define TRACES_ERR(EXP)              //mcSHOW_USER_MSG
