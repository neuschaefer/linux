...
#define ccCMD_ID_FW_STUDY_EXAM2_SET_VALUE     0x9D
enum
{
    ccOFST_FW_STUDY_EXAM_INPUT_A,
    ccOFST_FW_STUDY_EXAM_INPUT_B,
    ccOFST_FW_STUDY_EXAM_INPUT_C,
    ccOFST_FW_STUDY_EXAM_INPUT_SIZE
};
#define ccCMD_ID_FW_STUDY_EXAM2_GET_VALUE      0x9E
enum
{
    ccOFST_FW_STUDY_EXAM_OUTPUT_AVERAGE,
    ccOFST_FW_STUDY_EXAM_OUTPUT_MIN,
    ccOFST_FW_STUDY_EXAM_OUTPUT_MAX,
    ccOFST_FW_STUDY_EXAM_OUTPUT_SIZE
};
