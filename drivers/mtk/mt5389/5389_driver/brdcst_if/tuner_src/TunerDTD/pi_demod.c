...
// DTD related clock
    ...
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_XTAL_CKCFG, 0x00000100);

    // addiv4_ck    (sawlesspll_d8) 54MHz
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_ADDIV4_CKCFG, 0x00000001);

    // tdad_ck      (sawlesspll_d2) 216MHz
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_ATDAD_CKCFG, 0x00000001);

    // clk54m_ck   (sawlesspll_d8) 54MHz
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_CLK54M_CKCFG, 0x00000002);

    // clk216m_ck (sawlesspll_d2) 216MHz
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_CLK216M_CKCFG, 0x00000002);

    // dvbtci_ck     (syspll_d12) 54MHz
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_DVBTCI_CKCFG, 0x00000003);
    
    // dvbtfe_ck     (=clk54m_ck) 54MHz
    mcSET_SHOW_REG(base, c5396_CKGEN_REG_DVBTFE_CKCFG, 0x00000104);    
...
//    BSP_PinSet(PIN_OSDA2, PINMUX_FUNCTION0);        
   ...
   mcSET_SHOW_REG(base, 0x61500, 0x00000102); 
   mcSET_SHOW_REG(base, 0x61500, 0x00000100); 
   mcSET_SHOW_REG(base, 0x61504, 0x0008A894);    
   mcSET_SHOW_REG(base, 0x61400, 0x00AAA882);    
...
VOID DTD_SetIF(DEMOD_CTX_T * psDemodCtx,UINT16 u2If_Freq)//SetIF
{
    ...
    mcSHOW_DBG_MSG(("Set IF Freq (SLD_FE)= %dKHz QAM Sample rate=%d M\n", u4IF_Freq,u4SampleRateQAM)); 
     ...
     i4IF_Set = (i4IF_B4DC*256)/125*256/27;     //IF_B4DC/54000*2*2^19
