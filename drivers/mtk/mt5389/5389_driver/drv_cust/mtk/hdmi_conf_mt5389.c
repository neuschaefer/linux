...
#define HDMI_GPIO_HPD1 (206)
#define HDMI_GPIO_HPD2 (209)
#define HDMI_GPIO_HPD3 (212)
...
{   
	...
	switch(eSwitch)
	{
		...
		case HDMI_SWITCH_1:
			#ifdef CC_MT5389_P1V1
				GPIO_Output(HDMI_GPIO_HPD1, &dHpdHigh);
			#else
		...
		case HDMI_SWITCH_2:
			#ifdef CC_MT5389_P1V1
				GPIO_Output(HDMI_GPIO_HPD2, &dHpdHigh);
			#else
		...
		case HDMI_SWITCH_3:
			#ifdef CC_MT5389_P1V1
				GPIO_Output(HDMI_GPIO_HPD3, &dHpdHigh);
			#else
...
#ifdef HDMI_GPIO_HPD1	
		case HDMI_SWITCH_1:
		        u1Ret = GPIO_GetIn(HDMI_GPIO_HPD1);
			break;
#endif
#ifdef HDMI_GPIO_HPD2
		case HDMI_SWITCH_2:
		        u1Ret = GPIO_GetIn(HDMI_GPIO_HPD2);
			break;
#endif			
#ifdef HDMI_GPIO_HPD3
		case HDMI_SWITCH_3:
		        u1Ret = GPIO_GetIn(HDMI_GPIO_HPD3);
			break;
#endif			
		default: /* disable all */
			break;
...
void vHDMISetSwitch(E_HDMI_SWITCH_NUM eSwitch)
{
	...
	{	
		...
		for ( i = HDMI_SWITCH_1 ; i <= HDMI_SWITCH_3 ; i++) 
		{
			if (i != eHdmiRx)
			{
				vHDMIHPDHigh(i);
