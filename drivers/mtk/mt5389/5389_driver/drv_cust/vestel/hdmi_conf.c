...
#define HDMI_PORT_LARGEST HDMI_SWITCH_2

#if MT5365
#define HDMI_GPIO_HPD1 OPCTRL(3) //PAD_HDMI_HPD1
#else
#define HDMI_GPIO_HPD1 5
#endif
#define HDMI_GPIO_HPD2 0xffffffff //PAD_HDMI_HPD2
...
void vHDMISetSwitch(UINT8 bSwitch)
{
	...
	{	
		...
		{
			case HDMI_SWITCH_1:				
				//vRegWriteFldAlign(ANA_INTF_2,0x2,RG_HDMI_SW_EN);	//HDMI port select
