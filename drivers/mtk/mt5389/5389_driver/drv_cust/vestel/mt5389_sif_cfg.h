...
static SIF_CONFIG_T _rSifConfig =
{
    4, // Total 6 buses
    {
        ...
        2, // PdwncI2C uses V2 engine (use VGA_SDA/SCL)
        0, // PdwncI2C1 
        0, // 8295BI2C0
        0  // 8295BI2C1
    }
...
static void SIF_MtkCfgPinSetFunc(UINT8 u1Channel)
{
	...
	rCrit = x_crit_start();    
#endif    
	if ((u1Channel == 0)||(u1Channel == 1)) //osda2/oscl2 for system bus and tuner, use V2 engine
	{
		u4Reg = CKGEN_READ32(0x404);
		//	[24:22] = !1; [15:14]  = 1; 
		if((u4Reg & 0x01c00000) == 0x00400000)
		{
			u4Reg &= ~(0x01c00000);
		}
		u4Reg &= ~(0x0000c000); 	   
		u4Reg |= 0x00004000;				
		CKGEN_WRITE32(0x404, u4Reg);
	}
	else if (u1Channel == 2)	//osda0/oscl0, use V1 engine
	{
		u4Reg = CKGEN_READ32(0x404);
		//	[24:22] = 2; [15:14]  = !2; 
		u4Reg &= ~(0x01c00000); 	   
		u4Reg |= 0x00800000;
		if((u4Reg & 0x0000c000) == 0x00008000)
		{
			u4Reg &= ~(0x0000c000);
		}		
		CKGEN_WRITE32(0x404, u4Reg);
	...
	else if(_SIF_ISR_IsPdwncMasterEnable() && u1Channel == 3)// PDWNC SIF0 use VGA_SDA/SCL
	{
		...
		u4Reg &= ~(0x00007000);
		u4Reg |= 0x00004000;
		if((u4Reg & 0x000000e0) == 0x000000a0)
		{
			u4Reg &= ~(0x000000e0);
		}
		if((u4Reg & 0x00000007) == 0x00000006)
		{
			u4Reg &= ~(0x00000007);
		}
	...
	#else	
	else if(_SIF_ISR_IsPdwncMasterEnable() && u1Channel == 3)// PDWNC SIF0 use OPCTRL2/0
	{
		u4Reg = IO_READ32(PDWNC_BASE, 0xB4);
		// [14:12] = !4; [7:5] = 5; [2:0] = 6;	
