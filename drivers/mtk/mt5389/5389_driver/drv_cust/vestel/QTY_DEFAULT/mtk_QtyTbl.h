...
tagDFT_QTY aDefaultQtyTbl[QUALITY_MAX] =
{
    ...
    {0x00, 0x00, 0x80, FROM_DFT, QUALITY_OSD_MAPPING_3D_SHARPNESS},//(SHARPNESS global gain)OSD_mapping for vestel ---pingan
    ...
    {0x00, 0x00, 0x01, FROM_DFT, QUALITY_AL_MINUS_EN}, 
    {0x00, 0x00, 0x80, FROM_DFT, QUALITY_AL_CBOOST_GAIN},     
    {0x00, 0x00, 0x02, FROM_DFT, QUALITY_AL_RANGE_SEL},    
    {0x00, 0x00, 0x98, FROM_DFT, QUALITY_AL_NEW_BOOST_LMT_U},     
    {0x00, 0x00, 0x80, FROM_DFT, QUALITY_AL_NEW_BOOST_LMT_L},    
...
{
    {
        #include "QTY_ITEM_PCF.h"
    },
    #if (FLASHPQ_NUM>=2)
    {
        #include "QTY_ITEM_PQF.h"
    },
    #endif
...
{
    {
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_RFTV_NTSC_358,      SOURCE_TYPE_TIMING_RFTV_PAL_60},        // [0]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_CVBS_NTSC_358,      SOURCE_TYPE_TIMING_SV_PAL_M_OS},        // [1]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_CVBS_PAL,           SOURCE_TYPE_TIMING_SV_PAL_60_OS},       // [2]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_SECAM_RFTV,         SOURCE_TYPE_TIMING_SECAM_RFTV},         // [3]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_SECAM_CVBS,         SOURCE_TYPE_TIMING_SECAM_SV},           // [4]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_SCART_RGB,          SOURCE_TYPE_TIMING_SCART_RGB},          // [5]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_SCART_AV_NTSC_358,  SOURCE_TYPE_TIMING_SCART_SV_SECAM},     // [6]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_YPBPR_SD_I_50,      SOURCE_TYPE_TIMING_YPBPR_SD_I_60_OS},   // [7]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_YPBPR_SD_P_50,      SOURCE_TYPE_TIMING_YPBPR_SD_P_60_OS},   // [8]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_YPBPR_720P_50,      SOURCE_TYPE_TIMING_YPBPR_720P_60},      // [9]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_YPBPR_1080I_50,     SOURCE_TYPE_TIMING_YPBPR_1080P_60},     // [10]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DIGI_SD_I_50,       SOURCE_TYPE_TIMING_DIGI_SD_I_60},       // [11]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DIGI_SD_P_50,       SOURCE_TYPE_TIMING_DIGI_SD_P_60},       // [12]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DIGI_720P_50,       SOURCE_TYPE_TIMING_DIGI_720P_60},       // [13]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DIGI_1080I_50,      SOURCE_TYPE_TIMING_DIGI_1080P_60},      // [14]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DTV_SD_I_50,        SOURCE_TYPE_TIMING_DTV_SD_I_60},        // [15]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DTV_SD_P_50,        SOURCE_TYPE_TIMING_DTV_SD_P_60},        // [16]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DTV_720P_50,        SOURCE_TYPE_TIMING_DTV_720P_60},        // [17]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_DTV_1080I_50,       SOURCE_TYPE_TIMING_DTV_1080P_60},       // [18]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_MM_SD_I,            SOURCE_TYPE_TIMING_MM_SD_P},            // [19]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_MM_720P_SD,         SOURCE_TYPE_TIMING_MM_720P_SD},         // [20]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_MM_720P_HD,         SOURCE_TYPE_TIMING_MM_720P_HD},         // [21]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_MM_1080IP_SD,       SOURCE_TYPE_TIMING_MM_1080IP_SD},       // [22]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_MM_1080IP_HD,       SOURCE_TYPE_TIMING_MM_1080IP_HD},       // [23]
        #include "QTY_TBL_DEFAULT_PCF.h"        // {SOURCE_TYPE_TIMING_PC_RGB,             SOURCE_TYPE_TIMING_PC_YCBCR},           // [24]
    },
    #if (FLASHPQ_NUM>=2)
    {
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_RFTV_NTSC_358,      SOURCE_TYPE_TIMING_RFTV_PAL_60},        // [0]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_CVBS_NTSC_358,      SOURCE_TYPE_TIMING_SV_PAL_M_OS},        // [1]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_CVBS_PAL,           SOURCE_TYPE_TIMING_SV_PAL_60_OS},       // [2]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_SECAM_RFTV,         SOURCE_TYPE_TIMING_SECAM_RFTV},         // [3]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_SECAM_CVBS,         SOURCE_TYPE_TIMING_SECAM_SV},           // [4]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_SCART_RGB,          SOURCE_TYPE_TIMING_SCART_RGB},          // [5]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_SCART_AV_NTSC_358,  SOURCE_TYPE_TIMING_SCART_SV_SECAM},     // [6]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_YPBPR_SD_I_50,      SOURCE_TYPE_TIMING_YPBPR_SD_I_60_OS},   // [7]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_YPBPR_SD_P_50,      SOURCE_TYPE_TIMING_YPBPR_SD_P_60_OS},   // [8]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_YPBPR_720P_50,      SOURCE_TYPE_TIMING_YPBPR_720P_60},      // [9]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_YPBPR_1080I_50,     SOURCE_TYPE_TIMING_YPBPR_1080P_60},     // [10]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DIGI_SD_I_50,       SOURCE_TYPE_TIMING_DIGI_SD_I_60},       // [11]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DIGI_SD_P_50,       SOURCE_TYPE_TIMING_DIGI_SD_P_60},       // [12]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DIGI_720P_50,       SOURCE_TYPE_TIMING_DIGI_720P_60},       // [13]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DIGI_1080I_50,      SOURCE_TYPE_TIMING_DIGI_1080P_60},      // [14]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DTV_SD_I_50,        SOURCE_TYPE_TIMING_DTV_SD_I_60},        // [15]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DTV_SD_P_50,        SOURCE_TYPE_TIMING_DTV_SD_P_60},        // [16]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DTV_720P_50,        SOURCE_TYPE_TIMING_DTV_720P_60},        // [17]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_DTV_1080I_50,       SOURCE_TYPE_TIMING_DTV_1080P_60},       // [18]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_MM_SD_I,            SOURCE_TYPE_TIMING_MM_SD_P},            // [19]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_MM_720P_SD,         SOURCE_TYPE_TIMING_MM_720P_SD},         // [20]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_MM_720P_HD,         SOURCE_TYPE_TIMING_MM_720P_HD},         // [21]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_MM_1080IP_SD,       SOURCE_TYPE_TIMING_MM_1080IP_SD},       // [22]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_MM_1080IP_HD,       SOURCE_TYPE_TIMING_MM_1080IP_HD},       // [23]
        #include "QTY_TBL_DEFAULT_PQF.h"        // {SOURCE_TYPE_TIMING_PC_RGB,             SOURCE_TYPE_TIMING_PC_YCBCR},           // [24]
    },
    #endif
