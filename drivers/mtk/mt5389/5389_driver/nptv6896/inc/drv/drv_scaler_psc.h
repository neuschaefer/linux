...
#define getPscDispPrm() pscInfo.dispPrm
#define getPscPicInfo() pscInfo.picInfo
#define getPscDispInfo() pscInfo.dispInfo

#define PSC_HSYNC_ADJ      0x32
#define PSC_ACTIVE_ADJ     0x32
#define PSC_READ_DELAY     0x0

#define PSC_WATER_THR_INIT 460
#define PSC_WATER_THR3     460
#define PSC_WATER_THR2     284     
#define PSC_WATER_THR1     216
