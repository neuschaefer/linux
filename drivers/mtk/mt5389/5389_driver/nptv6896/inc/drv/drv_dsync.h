...
// Macro declaration
#define fgDSHPol()  	(RegReadFldAlign(STA_SYNC1_03,HSYNC_P))
#define fgDSVPol()  	(RegReadFldAlign(STA_SYNC1_03,VSYNC_P))
#define fgDSHAct() 	 (RegReadFldAlign(STA_SYNC1_03,HSYNC_ACT))
#define fgDSCAct()  	(RegReadFldAlign(STA_SYNC1_03,CSYNC_ACT))
#define fgDSDEAct() 	(bReadVDOIN(STA2_12,BANK0)&0x80)
#define fgDSVAct()	 (RegReadFldAlign(STA_SYNC1_03,VSYNC_ACT))
#define fgDSFldType() (RegReadFldAlign(STA_SYNC1_03,FIELD))
...
#define vDSSetCLKMeasure() vRegWrite4BMsk(DSYNC_08, 0 ,Fld2Msk32(HLEN_STA_SELECT))
#define vDSSetPIXMeasure() vRegWrite4BMsk(DSYNC_08, Fld2Msk32(HLEN_STA_SELECT) ,Fld2Msk32(HLEN_STA_SELECT))
