...
#define FLASHPQ_TOTAL_TIMING 17
...
typedef enum
{
    PICTURE_MODE_DYNAMIC= 0, 
    PICTURE_MODE_NATURAL,
    PICTURE_MODE_CINEMA,
    PICTURE_MODE_GAME,
    PICTURE_MODE_PIXELLENCE,
    PICTURE_MODE_SPORT, 
    PICTURE_MODE_MAX
} VDP_PQ_SMART_PIC_MODE;

//Caihua Add 20110908
//The enum value should keep the same sequence as aUiVqMinMaxDftDefault[]
typedef enum
{
    UI_SMART_PIC_BRIGHTNESS=0,
    UI_SMART_PIC_CONTRAST,
    UI_SMART_PIC_HUE,
    UI_SMART_PIC_SATURATION,    
    UI_SMART_PIC_SHAPRNESS,
    UI_SMART_PIC_R_GAIN,
    UI_SMART_PIC_G_GAIN,
    UI_SMART_PIC_B_GAIN,
    UI_SMART_PIC_SKIN_TONE,
    UI_SMART_PIC_UI_DEF_MAX
}UI_SMART_PIC_CHANGE;
...
UINT8 bApiFlashPqUpdateQtyMinMaxAllSrc(UINT8 u1VidPath, UINT8 bIndex, UINT8 u1SrcTypTmg); //Add for vestel ---pingan 0606
...
#if 1//def SUPPORT_FLASH_PQ_2ND_PART
...
INT16 vApiFlashPqUpdateUi3DRange(UINT8 bQtyTiming, UINT8 bUiItem);  //Add for Vestel --- pingan 0606
void vApiSetUiDftRange(UINT8 u1PicMode);
void vApiUpdateUIDefaultRange(UINT8 u1PicMode, UINT8 u1SourceIndex);
...
//Backlight Mode and PowerSave Mode
void vApiUpdateBacklightMode(UINT8 bMode); //Caihua Add 20110902
void vApiUpdatePowerSaveMode(UINT8 bMode);
