...
#define PMX_OSD1 2 // VDP3, alpha-bit plane
...
/** get plane z-order
 *  @param  ucPlaneId plane id:{PMX_VDP_M, PMX_VDP_P, PMX_OSD_1, PMX_OSD_2}
 *  @param  ucPlaneOrder order:{PLA_MXR_Z_ORDER_1/2/3/4}
 ...
 *  @param  ucPlaneId video plane id:{PMX_VDP_M, PMX_VDP_P}
 *  @param  ucValue alpha value(0~255)
 *  @retval PMX_SET_OK success
 */
EXTERN UINT32 PMX_SetAlpha(UCHAR ucPlaneId, UCHAR ucValue);

/** _PMX_Set_ALPHA_MIX_GRP1_0
 *  @param  fgEnable   ALPHA_MIX_GRP1_0:MODE
 */
