...
#define PDWNC_PADCFG9 (IO_VIRT+IO_PDWNC_BASE+0x0E4)
	...
	#endif
#define PDWNC_SOGYCFG (IO_VIRT+IO_PDWNC_BASE+0x0FC)
...
#define PDWNC_PD_PWM1 (IO_VIRT+IO_PDWNC_BASE+0x158)
...
#define PDWNC_ADOUT8 (IO_VIRT+IO_PDWNC_BASE+0x394)
    #define FLD_ADOUT8 Fld(10,2,AC_MSKW10)//[9:2]
#define PDWNC_ADOUT9 (IO_VIRT+IO_PDWNC_BASE+0x398)
...
#define PDWNC_LDOCFG0 (IO_VIRT+IO_PDWNC_BASE+0x904)
    #define FLD_RG_LDO_TESTE Fld(1,31,AC_MSKB3)//[31:31]
#define PDWNC_SADCCFG0 (IO_VIRT+IO_PDWNC_BASE+0x908)
...
#define PDWNC_SADCCFG1 (IO_VIRT+IO_PDWNC_BASE+0x90C)
...
#define PDWNC_VGACFG0 (IO_VIRT+IO_PDWNC_BASE+0x910)
...
#define PDWNC_VGACFG1 (IO_VIRT+IO_PDWNC_BASE+0x914)
...
#define PDWNC_VGACFG2 (IO_VIRT+IO_PDWNC_BASE+0x918)
...
#define PDWNC_VGACFG3 (IO_VIRT+IO_PDWNC_BASE+0x91C)
...
#define PDWNC_VGACFG4 (IO_VIRT+IO_PDWNC_BASE+0x920)
...
#define PDWNC_VGACFG5 (IO_VIRT+IO_PDWNC_BASE+0x924)
...
#define PDWNC_VGACFG6 (IO_VIRT+IO_PDWNC_BASE+0x928)
