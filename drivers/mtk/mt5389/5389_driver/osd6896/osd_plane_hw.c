...
#if 0
INT32 _OSD_PLA_GetDataAddr(UINT32 u4Plane, UINT32 *pu4Value)
{
    OSD_VERIFY_PLANE(u4Plane);
   ...
   *pu4Value = ((OSD_READ32((u4Plane+1)*0x100+0x24)&0xFFFFFF)|(((OSD_READ32((u4Plane+1)*0x100+0x28)>>24)&0x3)<<24))<<4;
    return (INT32)OSD_RET_OK;
}
#endif
//-----------------------------------------------------------------------------
...
{ 
    ...
    ui4_bmp_addr = (_prHwOsdPlaneReg[u4Plane]->rField.u4RealBmpAddr << 4);
