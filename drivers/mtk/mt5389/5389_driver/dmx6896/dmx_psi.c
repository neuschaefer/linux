...
BOOL _DMX_PSI_AllocateBuffer(UINT8 u1Pidx, UINT32 u4Size)
{
    ...
    LOG(8, "Allocate PSI buffer: pidx %u, size: %u\n", u1Pidx, u4Size);
    ...
    UINT32 u4FrameAddr)
{
    ...
    LOG(8, "Unlock PSI buffer: pidx %u, frame: 0x%08x, size: %u\n", u1Pidx,
        u4FrameAddr, u4Size);
    ...
    UINT32 u4SkipSize, UINT32 u4CopySize, UCHAR* pu1Dest)
{
    ...
    LOG(7, "Get PSI buffer: pidx %u, frame: 0x%08x, skip: %u, copy: %u\n",
