...
BOOL _DMX_PES_AllocateBuffer(UINT8 u1Pidx, UINT32 u4Size)
{
    ...
    LOG(8, "Allocate PES buffer: pidx %u, size: %u\n", u1Pidx, u4Size);
    ...
    UINT32 u4FrameAddr)
{
    ...
    LOG(8, "Unlock PES buffer: pidx %u, frame: 0x%08x, size: %u\n", u1Pidx,
        u4FrameAddr, u4Size);
    ...
    UINT32 u4SkipSize, UINT32 u4CopySize, UCHAR* pu1Dest)
{
    ...
    LOG(8, "Get PES buffer: pidx %u, frame: 0x%08x, skip: %u, copy: %u\n",
