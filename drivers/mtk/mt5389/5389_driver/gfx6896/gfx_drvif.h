...
extern void _GFX_DFB_Flush(void);
...
extern void  _VGFX_GeneralAlphaComSet( UINT32 u4ImgCm, UINT32 u4WbCm, UINT32 u4Ar, UINT32 u4OpCode, BOOL fgAlcomNormal, 
...
#if defined(CC_MT5368)||defined(CC_MT5396)|| defined(CC_MT5389)||defined(CC_MT5398)||defined(CC_MT5880)||defined(CC_MT5880)
extern void _GFX_SetDstWrRgb24Bit(UINT32 u4Enable);
extern void _GFX_Idx2DirSrcPitchEn(UINT32 u4Enable);
extern void _GFX_SetReadArgbOrder(UINT32 u4Enable, UINT32 u4Aorder,UINT32 u4Rorder,UINT32 u4Gorder,UINT32 u4Border);
extern void _GFX_SetWriteArgbOrder( UINT32 u4Aorder,UINT32 u4Rorder,UINT32 u4Gorder,UINT32 u4Border);
...
#if defined(CC_MT5368)||defined(CC_MT5396)|| defined(CC_MT5389)||defined(CC_MT5398)||defined(CC_MT5880)
extern void _GfxSetBurstReadLength(BOOL fgEnBurstRead, UINT32 fgBurstReadMode);
extern BOOL _GfxGetBurstReadLength(void);
...
#if 1 // defined(CC_MT5368)||defined(CC_MT5396)|| defined(CC_MT5389)||defined(CC_MT5398)||defined(CC_MT5880)
extern void _GFX_MMU_Init(void);
extern void _GFX_MMU_ReInit(void);
extern void _GFX_MMU_Enable(UINT32  u4Enable );
extern UINT32 _GFX_MMU_Get_Enable(void);
extern void _GFX_MMU_Set_Enable(UINT32 u4_enable);
...
extern void _GFX_MMU_Set_Agent3(UINT32 u4Enable, UINT32  u4Mid);
...
extern void _GFX_MMU_Set_Cmprss(UINT32 u4_enable);
extern void _GFX_MMU_UPD_PGT(void);
extern void _GFX_MMU_Set_Cfg(GFX_MMU_T* pt_gfx_mmu);
extern void _GFX_MMU_Set_Dst_MMU(UINT32 u4_enable);
extern void _GFX_MMU_Clear_INT(void);
extern void _GFX_MMU_Reset_INT(void);
extern void _GFX_MMU_Set_Src_MMU(UINT32 u4_enable);
extern void _GFX_MMU_Set_Compress_Osd_Cfg(void);
extern void GFX_MMU_Check_Status(void);
extern void _GFX_MMU_ERROR_Action(void);
extern void _GFX_CHG_RISC_Flush(void);
...
extern void GFX_InvalidateDCacheMultipleLine(void);

#ifdef GFX_CC_YC
extern BOOL _GFX_ColorConvert_YC(GFX_COLOR_CONVERT_T* prGfxColorConvert);
#endif
extern void vSetGFXFlipMirror(BOOL fgMirrorEn, BOOL fgFlipEn);
...
extern void _GFX_Set_AlwaysRDSrc(UINT32 u4AlwaysRDSrc);
...
extern void _GFX_Set_FlashColCnvInfo(UINT8 *pu1SrcY, UINT32 u4SrcYPitch, UINT8 *pu1SrcCbCr, 
