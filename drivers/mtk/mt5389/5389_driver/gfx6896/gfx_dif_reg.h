...
#define GFX_FAST_BITBLIT_ENABLE     3
#define GFX_FAST_BITBLIT_DISABLE    0
#endif
...
typedef enum _E_GFX_REG_T
{
  ...
  #if defined(CC_MT5398)||defined(CC_MT5880)
    GREG_0x4120          = 0x48,  //0x4120
    GREG_0x4124          = 0x49,  //0x4124
    GREG_0x4128          = 0x4A,  //0x4128
    GREG_0x412c          = 0x4B,  //0x412c
    GREG_XOR_COLOR       = 0x4C,    //0x4130
    GREG_0x4134          = 0x4D,
    GREG_0x4138          = 0x4E,
    GREG_0x413c          = 0x4F,
    GREG_LAST            = 0x50, //0x4140
  #else
    GREG_LAST            = 0x48   // 0x4120
  #endif
#else
...
UINT32      :1;
   ...
   UINT32  fg_DSTWR_RGB_24BIT                :  1;   
    ...
    #if (defined(CC_MT5368)||defined(CC_MT5396)|| defined(CC_MT5389)|| defined(CC_MT5398))||defined(CC_MT5880)
    UINT32                      :  4;
    UINT32   fg_IDX2DIR_SRC_PITCH_EN    :  1;
    #else
    UINT32                      :  5;
    #endif
    ...
    UINT32 fg_SRCMIRROR         :  1;  //[27]
    #if defined(CC_MT5398)||defined(CC_MT5880)
    UINT32                      :  2;
    UINT32 fg_FAST_BITBLIT    :  2;
    #else
    UINT32                      :  4;
    #endif
    ...
    UINT32 fg_VFULL             :  1;
    UINT32 fg_RGB_24BIT_ORDER   :  3;
    UINT32 fg_WRITE_CBCR_ORDER  :  1;
    UINT32                      :  4;
    ...
    UINT32 fg_PREMULT_OVERFLOW_EN       : 1;  //[21]
    #if defined(CC_MT5398)||defined(CC_MT5880)
    UINT32   :1;
    UINT32 fg_ALCOM_MAXALPHA     :1;
    UINT32 fg_ALPHA0_RGB0        :1;
    ...
    #if defined(CC_MT5398)||defined(CC_MT5880)
    UINT32 fg_ROP_XOR_SRCALPHA_CHK    :  1;
    UINT32                      :  3;
    #else
    UINT32                      :  4;
    #endif
    ...
    //DWORD -  (4124h)
    UINT32  fg_Res4124  : 32;
    //DWORD -  (4128h)
    UINT32  fg_Res4128   : 32;
    //DWORD -  (412ch)
    UINT32  fg_Res412c    : 32;
    //DWORD -XOR COLOR  (4130h)
    UINT32 fg_XOR_COLOR         : 32;
    //DWORD -LAST    (4134h)
    UINT32  fg_Res4134    : 32;
    UINT32  fg_Res4138    : 32;
    UINT32  fg_Res413c    : 32;
    //DWORD -LAST    (4140h)
    UINT32 fg_LAST              : 32;
  #else
    // DWORD - LAST        (4120h)
