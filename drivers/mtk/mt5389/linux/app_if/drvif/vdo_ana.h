...
extern DRV_ERR_CODE_T _DRV_VDO_ANA_Init(void);

extern DRV_ERR_CODE_T _DRV_VDO_ANA_Start(UINT8 u1VideoIndex);

extern DRV_ERR_CODE_T _DRV_VDO_ANA_Stop(UINT8 u1VideoIndex);

extern DRV_ERR_CODE_T DRV_VDO_GetVbiTtx(UINT8 u1VideoIndex, 
	DRV_VDO_VBITTX_DATA_T* prVbiTtxData, INT32 i4Tag);

extern DRV_ERR_CODE_T _DRV_VDO_UnlockVbiTtx(UINT8 u1VideoIndex, 
	DRV_VDO_VBITTX_DATA_T* prVbiTtxData, INT32 i4Tag);
...
extern DRV_ERR_CODE_T _DRV_VDO_SetVga(UINT32 u4Mask, DRV_VDO_VGA_PARAM_T* prParam);

extern DRV_ERR_CODE_T _DRV_VDO_Auto(UINT8 u1VideoIndex);

extern DRV_ERR_CODE_T _DRV_VDO_Autocolor(UINT8 u1VideoIndex);
