...
extern int papi_ioctl_infra_gio(struct inode *inode, struct file *file,
    unsigned int cmd, unsigned long arg);

extern int papi_ioctl_infra_led(struct inode *inode, struct file *file,
    unsigned int cmd, unsigned long arg);

extern int papi_ioctl_infra_i2c(struct inode *inode, struct file *file,
    unsigned int cmd, unsigned long arg);

extern int papi_ioctl_infra_cecctrl(struct inode *inode, struct file *file,
    unsigned int cmd, unsigned long arg);
//-----------------------------------------------------------------------------
// Public functions
//-----------------------------------------------------------------------------

int papi_ioctl_infra(struct inode *inode, struct file *file,
    unsigned int cmd, unsigned long arg)
{
    int i4Ret = 0;
    ...
    case PAPI_IO_INFRA_I2CM_WRITEREAD:
        i4Ret = papi_ioctl_infra_i2c(inode, file, cmd, arg);
        break;
    ...
    case PAPI_IO_INFRA_CLK_GETUNIVERSALTIME: 
        i4Ret = papi_ioctl_infra_clk(inode, file, cmd, arg);
        break;        
    ...
    case PAPI_IO_INFRA_CECCTRL_SETNFY:
 	i4Ret = papi_ioctl_infra_cecctrl(inode, file, cmd, arg);
    	break; 	
    default:
