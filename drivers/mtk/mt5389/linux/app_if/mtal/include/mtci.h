...
EXTERN MT_RESULT_T  MTCI_GetCIS(UINT8 *puCisData);
 ...
 */
//-----------------------------------------------------------------------------
EXTERN MT_RESULT_T MTCI_ReadCor(UINT16 u2CorAddress,UINT8 *pu1Data);
...
//-----------------------------------------------------------------------------
/** MTCI_SetTsPath()
 *  @param fgExternalDemod TRUE for external demod, FALSE for internal demod
 *  @param fgThroughCard TRUE for TS through card, FALSE for bypass card.
 *  @retval MTR_OK successful,otherwise MTR_NOT_OK.
 */
//-----------------------------------------------------------------------------
