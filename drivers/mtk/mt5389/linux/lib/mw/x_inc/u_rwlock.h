...
#define _U_RWLOCK_H_
/*!
 * @defgroup    groupMW_RWLOCK Read Write LOCK API
 * @ingroup     groupMW
 * @brief    This header file declares Read Write LOCK exported constants, macros, and types.
 * 
 * @see groupMW
 *
 * @{
...
/*------------------------------------------------------------------*/
/*! @enum   RWL_OPTION_T
 *  @brief  Enumeration for read-write lock option.
 *  @code
 *  typedef    enum          
 *  {                       
 *      RWL_OPTION_WAIT = 1,
 ...
 *  } RWL_OPTION_T;
 *  @endcode
 *  @li@c  RWL_OPTION_WAIT      - Indicates that accessing to a read-write can 
 *                                be blocked
 *  @li@c  RWL_OPTION_NOWAIT    - Indicates that accessing to a read-write cannot 
 *                                be blocked
 */
/*------------------------------------------------------------------*/
typedef    enum
