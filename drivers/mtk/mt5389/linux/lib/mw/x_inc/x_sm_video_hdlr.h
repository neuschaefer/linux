...
/*----------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
/*! @defgroup groupMW_STRM_MNGR_VIDEO_HDLR Video Handler
 *
 *  @ingroup groupMW_STRM_MNGR
 *  @brief Provides video stream external function .
 *
 ...
 */
/*----------------------------------------------------------------------------*/
#ifndef _X_SM_VIDEO_HDLR_H_
#define _X_SM_VIDEO_HDLR_H_
...
typedef UINT32  VSH_VBI_PSR_ID_T;    /**<        */
 ...
 */
/*------------------------------------------------------------------*/
typedef BOOL (*x_sm_vsh_vbi_psr_open_fct)(
    HANDLE_T            h_vs,
 ...
 */
/*------------------------------------------------------------------*/
typedef BOOL (*x_sm_vsh_vbi_parse_fct)(
 ...
 */
/*------------------------------------------------------------------*/
typedef BOOL (*x_sm_vsh_vbi_get_fct)(
    VSH_VBI_PSR_ID_T    t_vbi_psr_id,
    VOID*               pv_vbi_data,
 ...
 */
/*------------------------------------------------------------------*/
typedef BOOL (*x_sm_vsh_vbi_psr_close_fct)(
    VSH_VBI_PSR_ID_T    t_vbi_psr_id );
 ...
 */
/*------------------------------------------------------------------*/
extern INT32 x_sm_video_hdlr_reg_vbi_psr(
 ...
 */
/*------------------------------------------------------------------*/
extern VOID x_sm_video_hdlr_nfy_vbi_data(
    HANDLE_T                    h_vs,
    VSH_VBI_PSR_ID_T            t_vbi_psr_id,
    VOID*                       pv_vbi_data,
    SIZE_T                      z_vbi_data_size );

#endif /* _X_SM_VIDEO_HDLR_H_ */
/*----------------------------------------------------------------------------*/
