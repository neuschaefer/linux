...
/* FLM handle type */
#define FLM_HANDLE (HT_GROUP_FLM + ((HANDLE_TYPE_T) 0))
/* handle for FLM master list change notifications */
#define FLM_MASTER_NOTIFY_HANDLE (HT_GROUP_FLM + ((HANDLE_TYPE_T) 1))
...
(
    HANDLE_T h_fav_handle,
    UINT16   ui2_from_position,
    UINT16*  pui2_to_position
);
