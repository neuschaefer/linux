 ...
 *---------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
/*! @file u_wgl_bdr_drop_shadow_left.h 
 *  $RCSfile: $
 *  $Revision: #1 $
 *  $Date: 2012/04/27 $
 *  $Author: dtvbm11 $
...
/*----------------------------------------------------------------------------*/
/*! @defgroup groupMW_WGL_BDR_DROP_SHADOW_LEFT   Bord Drop Shadow Left Widget
 *
 *  @ingroup groupMW_WGL
 *  @brief Provides definitions and exported function of the widget bord drop shadow left library.
 *
...
#ifndef _U_WGL_BDR_DROP_SHADOW_LEFT_H_
#define _U_WGL_BDR_DROP_SHADOW_LEFT_H_
...
*/
#define WGL_CMD_BDR_DPSDWLFT_GET_PREFERRED_INSET        WGL_MAKE_BORDER_CMD(WGL_BORDER_DROP_SHADOW_LEFT, 0)    
...
WGLR_OK	The function call is successful.
*/
#define WGL_CMD_BDR_DPSDWLFT_SET_HEIGHT                 WGL_MAKE_BORDER_CMD(WGL_BORDER_DROP_SHADOW_LEFT, 1)   
...
WGLR_INV_ARG	The argument pv_param1 is NULL.
*/
#define WGL_CMD_BDR_DPSDWLFT_GET_HEIGHT                 WGL_MAKE_BORDER_CMD(WGL_BORDER_DROP_SHADOW_LEFT, 2)   
...
alpha component" of the shadow color, 0 will make the shadow completely transparent. For more 
information about shadow alpha factor.

Input arguments

pv_param1	Specifies the shadow height of the border. This argument must be of type UINT8. 
...
WGLR_OK	The function call is successful.
*/
#define WGL_CMD_BDR_DPSDWLFT_SET_SHADOW_ALPHA_FACTOR    WGL_MAKE_BORDER_CMD(WGL_BORDER_DROP_SHADOW_LEFT, 3)   
...
WGLR_INV_ARG	The argument pv_param1 is NULL
*/
#define WGL_CMD_BDR_DPSDWLFT_GET_SHADOW_ALPHA_FACTOR    WGL_MAKE_BORDER_CMD(WGL_BORDER_DROP_SHADOW_LEFT, 4)   
...
#endif
/*----------------------------------------------------------------------------*/
/*! @} */   /* end of groupMW_WGL_BDR_DROP_SHADOW_LEFT*/
/*----------------------------------------------------------------------------*/
