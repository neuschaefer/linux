...
#if 0
#define SB_NTSC_VNET_ALL                ((UINT32) (0x00000001))
#define SB_NTSC_VNET_ACTIVE             MAKE_BIT_MASK_32 (1)
#define SB_NTSC_VNET_EPG                MAKE_BIT_MASK_32 (2)
#define SB_NTSC_VNET_VISIBLE            MAKE_BIT_MASK_32 (3)
#define SB_NTSC_VNET_FAVORITE1          MAKE_BIT_MASK_32 (4)
#define SB_NTSC_VNET_FAVORITE2          MAKE_BIT_MASK_32 (5)
#define SB_NTSC_VNET_FAVORITE3          MAKE_BIT_MASK_32 (6)
#define SB_NTSC_VNET_FAVORITE4          MAKE_BIT_MASK_32 (7)
#define SB_NTSC_VNET_BLOCKED            MAKE_BIT_MASK_32 (8)
#define SB_NTSC_VNET_FAKE               MAKE_BIT_MASK_32 (9)
#endif

#if 0
#define SB_NTSC_SCAN_START_IDX(value)   ((UINT16) ((value >> 16) & 0xFFFF))/**<  MACRO to get the start index of 32 bit value */
#define SB_NTSC_SCAN_STOP_IDX(value)    ((UINT16) (value & 0xFFFF))         /**<  MACRO to get the stop index of 32 bit value */
#endif
