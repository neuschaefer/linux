...
#include "x_wgl_cc_cnt_def.h"
#else

#ifndef _X_WGL_CC_CNT_DEF_H_
#define _X_WGL_CC_CNT_DEF_H_
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
/*------------------------------------------------------------------*/
/*! @brief  init the default content part of Closed Caption widget.
 *  @note 
 ...
 */
/*------------------------------------------------------------------*/
extern INT32 x_wgl_cc_cnt_def_init(VOID);
