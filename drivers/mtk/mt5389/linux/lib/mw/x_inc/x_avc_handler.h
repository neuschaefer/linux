...
#ifndef _X_AVC_HANDLER_H_
#define _X_AVC_HANDLER_H_
...
extern INT32 x_avc_reg_handler (const CHAR*                    ps_name,
                                const THREAD_DESCR_T*          pt_thread_descr,
                                const AVC_HANDLER_TIME_OUT_T*  pt_time_outs);

extern INT32 x_avc_unreg_handler (BOOL b_force);

#endif /* _X_AVC_HANDLER_H_ */
