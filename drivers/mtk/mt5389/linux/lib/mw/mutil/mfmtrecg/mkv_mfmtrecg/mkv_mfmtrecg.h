...
#ifndef _MKV_MFMTRECG_H_
#define _MKV_MFMTRECG_H_
...
#define MRECG_MKV_ELE_HEAD_LEN   12
#define MKV_ELE_EBML_HEAD_ID     0x1A45DFA3
#define MKV_ELE_EBML_DOC_TYPE_ID 0x00004282

/*-----------------------------------------------------------------------------
                    functions declarations
 ----------------------------------------------------------------------------*/
extern INT32 mkv_handler_mem_confirm_fct(
                        const VOID*       pv_mem_data, 
                        SIZE_T            z_mem_leng,   
                        MEDIA_FORMAT_T*   pt_format);
                        
extern INT32 mkv_handler_file_confirm_fct(
                        HANDLE_T          h_file,        
                        MEDIA_FORMAT_T*   pt_format);     
#ifdef __cplusplus
}
