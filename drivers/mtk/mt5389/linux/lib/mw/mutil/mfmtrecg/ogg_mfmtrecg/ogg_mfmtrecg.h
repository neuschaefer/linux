...
#ifndef _OGG_MFMTRECG_H_
#define _OGG_MFMTRECG_H_
...
/* This structure holds the ogg file boxes header. */
typedef struct _OGG_HEADER_T
{
    UINT32    ui4_ogg_type;
    UINT32    ui4_ogg_size;
} OGG_HEADER_T;
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
extern INT32 ogg_handler_file_confirm_fct(
                        HANDLE_T                    h_file,        
                        MEDIA_FORMAT_T*             pt_format);     
                        
extern INT32 ogg_handler_mem_confirm_fct(
