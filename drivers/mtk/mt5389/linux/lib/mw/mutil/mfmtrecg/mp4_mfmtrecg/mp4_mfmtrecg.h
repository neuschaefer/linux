...
#ifndef _MP4_MFMTRECG_H_
#define _MP4_MFMTRECG_H_
...
/* This structure holds the mp4 file boxes header. */
typedef struct _MP4_BOX_HEADER_T
{
    UINT32    ui4_mp4_box_size;
    UINT32    ui4_mp4_box_type;

    UINT64   ui8_mp4_box_longsize;
} MP4_BOX_HEADER_T;

/*-----------------------------------------------------------------------------
                    functions declarations
 ----------------------------------------------------------------------------*/
extern INT32 mp4_handler_file_confirm_fct(
                        HANDLE_T                    h_file,        
                        MEDIA_FORMAT_T*             pt_format);     
                        
extern INT32 mp4_handler_mem_confirm_fct(
