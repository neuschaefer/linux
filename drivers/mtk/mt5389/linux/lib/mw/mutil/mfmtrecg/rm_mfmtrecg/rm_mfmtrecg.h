...
#ifndef _RM_MFMTRECG_H_
#define _RM_MFMTRECG_H_
...
/* This structure holds the rm file boxes header. */
typedef struct _RM_BOX_HEADER_T
{
    UINT32    ui4_rm_box_type;
    UINT32    ui4_rm_box_size;
} RM_BOX_HEADER_T;

/*-----------------------------------------------------------------------------
                    functions declarations
 ----------------------------------------------------------------------------*/
extern INT32 rm_handler_file_confirm_fct(
                        HANDLE_T                    h_file,        
                        MEDIA_FORMAT_T*             pt_format);     
                        
extern INT32 rm_handler_mem_confirm_fct(
