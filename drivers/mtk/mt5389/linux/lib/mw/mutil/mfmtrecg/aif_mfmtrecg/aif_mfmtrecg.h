...
#ifndef _AIF_MFMTRECG_H_
#define _AIF_MFMTRECG_H_
...
/* This structure holds the aif file boxes header. */
typedef struct _AIF_BOX_HEADER_T
{
    UINT32    ui4_aif_box_type;
    UINT32    ui4_aif_box_size;
    UINT32    ui4_aif_box_id;
} AIF_BOX_HEADER_T;

/*-----------------------------------------------------------------------------
                    functions declarations
 ----------------------------------------------------------------------------*/
extern INT32 aif_handler_file_confirm_fct(
                        HANDLE_T                    h_file,        
                        MEDIA_FORMAT_T*             pt_format);     
                        
extern INT32 aif_handler_mem_confirm_fct(
