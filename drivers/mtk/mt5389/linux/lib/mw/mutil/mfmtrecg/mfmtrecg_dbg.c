...
/*-----------------------------------------------------------------------------
                    data declarations
 ----------------------------------------------------------------------------*/
static UINT16 ui2_mfmtrecg_dbg_level = DBG_LEVEL_NONE;

UINT16 mfmtrecg_get_dbg_level(VOID);
BOOL mfmtrecg_set_dbg_level(UINT16 ui2_level);
/*-----------------------------------------------------------------------------
                    function declarations
 ----------------------------------------------------------------------------*/

/*-----------------------------------------------------------------------------
 * Name: mfmtrecg_get_dbg_level
 *
...
UINT16 mfmtrecg_get_dbg_level(VOID)
{
    return ui2_mfmtrecg_dbg_level;
}


/*-----------------------------------------------------------------------------
 * Name: mfmtrecg_set_dbg_level
 *
...
BOOL mfmtrecg_set_dbg_level(UINT16 ui2_level)
{
    ...
    ui2_mfmtrecg_dbg_level = ui2_level;
    return TRUE;
