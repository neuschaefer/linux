...
#ifndef _ASF_MFMTRECG_H_
#define _ASF_MFMTRECG_H_
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
#define ASF_HEADER_TEST_LENGTH        16
...
typedef struct _MFMTRECG_SRC_INPUT_FCT_TBL_T
{
...
} MFMTRECG_SRC_INPUT_FCT_TBL_T;


/*-----------------------------------------------------------------------------
                    functions declarations
 ----------------------------------------------------------------------------*/
extern INT32 asf_handler_mem_confirm_fct( const VOID*       pv_mem_data, 
                                          SIZE_T            z_mem_leng,   
                                          MEDIA_FORMAT_T*   pt_format);
                        
extern INT32 asf_handler_file_confirm_fct( HANDLE_T         h_file,        
                                           MEDIA_FORMAT_T*  pt_format);  

extern BOOL _asf_mfmt_is_wma(MFMTRECG_SRC_INPUT_FCT_TBL_T* pt_input,
                             VOID*                         pv_obj);
extern INT32 asf_wma_handler_file_confirm_fct( HANDLE_T           h_file,        
                                               MEDIA_FORMAT_T*    pt_format);

extern INT32 asf_wma_handler_mem_confirm_fct( const VOID*      pv_mem_data, 
                                              SIZE_T           z_mem_leng,   
                                              MEDIA_FORMAT_T*  pt_format );
