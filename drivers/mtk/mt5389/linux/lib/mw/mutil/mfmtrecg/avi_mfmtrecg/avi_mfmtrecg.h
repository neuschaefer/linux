...
#ifndef _AVI_MFMTRECG_H_
#define _AVI_MFMTRECG_H_
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
extern INT32 avi_handler_mem_confirm_fct(
                        const VOID*       pv_mem_data, 
                        SIZE_T            z_mem_leng,   
                        MEDIA_FORMAT_T*   pt_format);
                        
extern INT32 avi_handler_file_confirm_fct(
                        HANDLE_T                    h_file,        
                        MEDIA_FORMAT_T*             pt_format);     
#ifdef __cplusplus
}
