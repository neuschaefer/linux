...
#ifndef _ASF_WMV8_INTRA_H_
#define _ASF_WMV8_INTRA_H_
...
/*Test wmv8 can be supported though it is a asf type*/
typedef struct 
{
    UINT8* u1Addr;
    UINT32 u4Len;
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
extern BOOL fgDecoderSupport(MINFO_INFO_VIDEO_ENC_T rDecoderType,SeqHeaderInfo* prHeaderInfo);

#endif /* _ASF_WMV8_INTRA_H_ */
