...
{
    MINFO_FLV_VIDEO_STM_ATRBT_T t_vid_strm_inf;
    MINFO_FLV_AUDIO_STM_ATRBT_T t_aud_strm_inf;
    UINT8 ui1_audio_strm_num;
    UINT8 ui1_video_strm_num;
}MINFO_FLV_STRM_INF_T;


typedef struct _MINFO_FLV_INF_T
{
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
extern INT32 i4_flv_minfo_tag_parse (MINFO_OBJ_T*    pt_minfo_obj);
