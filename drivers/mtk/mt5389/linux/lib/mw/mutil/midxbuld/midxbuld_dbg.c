...
/*-----------------------------------------------------------------------------
                    data declarations
 ----------------------------------------------------------------------------*/
static UINT16 ui2_midxbuld_dbg_level = DBG_LEVEL_NONE;

UINT16 midxbuld_get_dbg_level(VOID);
BOOL midxbuld_set_dbg_level(UINT16 ui2_level);
...
UINT16 midxbuld_get_dbg_level(VOID)
{
    return ui2_midxbuld_dbg_level;
}

/*-----------------------------------------------------------------------------
 * Name: midxbuld_set_dbg_level
 *
...
BOOL midxbuld_set_dbg_level(UINT16 ui2_level)
{
    ...
    ui2_midxbuld_dbg_level = ui2_level;
    return TRUE;
