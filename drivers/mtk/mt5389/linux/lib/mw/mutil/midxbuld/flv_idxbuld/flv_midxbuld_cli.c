...
#ifdef CLI_LVL_ALL
static INT32 midxbuld_cli_flv_fopen(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_mopen(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_close(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_start_idx(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_stop_idx(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_get_tbl(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_alloc_range(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_flv_free_range(INT32 i4_argc, const CHAR** pps_argv);
/* mfmtrecg command table */
static CLI_EXEC_T at_flv_midxbuld_cmd_tbl[] =
{
    {"fopen",       NULL,  midxbuld_cli_flv_fopen,        NULL,    "midxbuld_fopen",       CLI_SUPERVISOR},
    {"mopen",       NULL,  midxbuld_cli_flv_mopen,        NULL,    "midxbuld_mopen",       CLI_SUPERVISOR},
    {"close",       NULL,  midxbuld_cli_flv_close,        NULL,    "midxbuld_close",       CLI_SUPERVISOR},
    {"start",       NULL,  midxbuld_cli_flv_start_idx,    NULL,    "midxbuld_start_idx",   CLI_SUPERVISOR},
    {"stop",        NULL,  midxbuld_cli_flv_stop_idx,     NULL,    "midxbuld_stop_idx",    CLI_SUPERVISOR},
    {"get_tbl",     NULL,  midxbuld_cli_flv_get_tbl,      NULL,    "midxbuld_get_tbl",     CLI_SUPERVISOR},
    {"alloc_range", NULL,  midxbuld_cli_flv_alloc_range,  NULL,    "midxbuld_alloc_range", CLI_SUPERVISOR}, 
    {"free_range",  NULL,  midxbuld_cli_flv_free_range,   NULL,    "midxbuld_free_range",  CLI_SUPERVISOR}, 
    END_OF_CLI_CMD_TBL
};
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static VOID x_midxbuld_flv_nfy (
                        HANDLE_T                  h_midxbuld, 
...
static INT32 midxbuld_cli_flv_fopen(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    t_format.t_media_subtype.u.e_contnr_subtype  = MEDIA_CONTNR_SUBTYPE_FLV;

    if (*ps_file_path == 'c') /* CBR */
    {
        ps_file_path = "/mnt/usb/Mass-000/a05_divx311fast_640x304_870kbps_mp3_44khz_cbr128.flv";
    ...
    {
        ps_file_path = "/mnt/usb/Mass-000/a06_divx311fast_640x304_870kbps_mp3_44khz_vbr128.flv";
    ...
    i4_ret = x_midxbuld_fopen(ps_file_path, x_midxbuld_flv_nfy, (VOID*) -1, &t_format, &t_src_info, &t_key_info, &gh_midxbuld);
    if (i4_ret != MIDXBULDR_OK)
    {
        x_dbg_stmt("midxbuld_cli_flv_fopen ERROR!\r\n");
        return CLIR_CMD_EXEC_ERROR;
    }

    gui4_key_elmt_tbl_id = t_key_info.ui4_tbl_id;

    x_dbg_stmt("midxbuld_cli_flv_fopen OK!\r\n");
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_flv_start_idx
 *
 * Description: 
 *
 * Inputs:  i4_argc         Contains the argument count.
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_flv_stop_idx
 *
 * Description: 
 *
 * Inputs:  i4_argc         Contains the argument count.
...
static INT32 midxbuld_cli_flv_get_tbl(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    if (i4_ret != MIDXBULDR_OK)
    {
        x_dbg_stmt("midxbuld_cli_flv_get_key_tbl ERROR!\r\n");
        return CLIR_CMD_EXEC_ERROR;
    }
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_flv_alloc_range
 *
...
static INT32 midxbuld_cli_flv_alloc_range(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    if (i4_argc != 3)
    {
        x_dbg_stmt("Usage: alloc_tbl START_PTS END_PTS...\r\n");
        return CLIR_INV_ARG;
    }
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_flv_free_range
 *
 * Description: This API sets the info of idx builder.
 *
 * Inputs:  i4_argc         Contains the argument count.
...
static INT32 midxbuld_cli_flv_free_range(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    if (i4_argc != 2)
    {
        x_dbg_stmt("Usage: free_range RANGE_ID...\r\n");
        return CLIR_INV_ARG;
    }
    ...
    if (i4_ret != MIDXBULDR_OK)
    {
        x_dbg_stmt("midxbuld_cli_flv_free_range ERROR!\r\n");
        return CLIR_CMD_EXEC_ERROR;
    }

    x_dbg_stmt("midxbuld_cli_flv_free_range OK!\r\n");
 ...
 * Returns: 
 ----------------------------------------------------------------------------*/
INT32 flv_midxbuld_cli_init(CLI_EXEC_T **ppt_command_array)
{
#ifdef CLI_LVL_ALL

    *ppt_command_array = at_flv_midxbuld_cmd_tbl;
#endif
    return 0;
}
