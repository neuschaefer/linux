...
# $SWAuthor: Iolo Tsai $
# $MD5HEX: d8612697eeb84d37b0a9ac3c943aadc6 $
#
# Description:
...
THIS_COMPONENT = subtitle_engine

SRC =    sbtl_engine.c                      \
         sbtl_register.c                    \
         sbtl_state.c                       \
         sbtl_state_handler.c               \
         sbtl_utils.c                       \
         sbtl_dbg.c                         \
         sbtl_widget.c                      \
         sbtl_drv.c                         \
...
OPTIONAL_SUB_COMPONENTS = sbtl_divx sbtl_text sbtl_vobsub sbtl_lyric sbtl_mkv sbtl_vob sbtl_mp4

DEFINES +=

#DEFINES += -DMM_SBTL_SIMULATION
