...
#ifndef _SBTL_TEXT_PAGE_INST_MNGR_H_
#define _SBTL_TEXT_PAGE_INST_MNGR_H_
...
-----------------------------------------------------------------------------*/
#define SUBTITLE_IDX_NULL      0xffff
...
typedef VOID (*text_config)( SBTL_PAGE_INST_MNGR_T*     pt_mngr,
                             UINT32                     ui4_set_type);

typedef INT32 (*text_get_info)( SBTL_PAGE_INST_MNGR_T*        pt_mngr,
                                UINT32                        ui4_get_type,
                                VOID*                         pv_get_info,
                                SIZE_T                        z_get_info_len);


typedef struct _SBTL_TEXT_FNC_TBL_T
{
    ...
    text_config                 pf_config;
    text_get_info               pf_get_info;
}SBTL_TEXT_FNC_TBL_T;


typedef struct _SBTL_TEXT_PAGE_MNGR_PRIVATE_T
{
    BOOL                                b_page_exist;
    BOOL                                b_UTF16;
    MM_SBTL_LANG_T                      e_language;
    
    TEXT_PAGE_STATE_T                   e_state;
    ...
    VOID*                               pv_data;
}SBTL_TEXT_PAGE_MNGR_PRIVATE_T;

/*-----------------------------------------------------------------------------
                    functions declarations
-----------------------------------------------------------------------------*/
#endif /* _SBTL_TEXT_PAGE_INST_MNGR_H_ */
