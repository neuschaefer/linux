...
static int __devinit _mt53xx_STR_probe(struct platform_device *pdev)
{
	printk("_mt53xx_STR_probe\n");
	return 0;
}

static int __devexit _mt53xx_STR_remove(struct platform_device *pdev)
{
	printk("_mt53xx_STR_remove\n");
	return 0;	
}

static int _mt53xx_STR_suspend(struct platform_device *pdev, pm_message_t state)
{
...
static int _mt53xx_STR_resume(struct platform_device *pdev)
{
