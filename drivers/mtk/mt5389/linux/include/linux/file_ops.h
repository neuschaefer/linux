...
#ifndef __LINUX_FILE_OPS_H__
#define __LINUX_FILE_OPS_H__

#include <linux/fs.h>
#include "x_typedef.h"

struct file* FILE_Open(const char* path, int flags, int mode);
#define FILE_Close(a)   filp_close(a, NULL)
...
// Compatible translate function name.
#define file_open(p,f,m)     FILE_Open(p,f,m)
#define file_read(f,d,s,o)   FILE_Read(f,d,s,o)
#define file_write(f,d,s,o)  FILE_Write(f,d,s,o)
#define file_close(a)        filp_close(a, NULL)

#endif /* __LINUX_FILE_OPS_H__ */
