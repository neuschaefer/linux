...
#define DRV_CUSTOM_MODEL_SHIPPING_REGION_GA         (0 << 7)
#define DRV_CUSTOM_MODEL_SHIPPING_REGION_CHINA      (1 << 7)
...
// Shipping Region for Sony 2H PAA/China Models
#define DRV_CUSTOM_SHIPPING_REGION_OPTION_GA        0
#define DRV_CUSTOM_SHIPPING_REGION_OPTION_CHINA     1
...
extern INT32 d_sony_2k12_cust_spec_set (
...
extern INT32 d_sony_2k12_cust_spec_get (
    DRV_CUSTOM_CUST_SPEC_TYPE_T    e_cust_spec_type,
    VOID*                          pv_get_info,
    SIZE_T*                        pz_size
);
