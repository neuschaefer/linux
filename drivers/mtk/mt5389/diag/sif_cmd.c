...
/*  00    01    02   03     04    05    06    07   08     09    0A    0B    0C    0D    0E   0F */
	...
	0x30 ,0x00 ,0x40 ,0x00 ,0x50 ,0x00 ,0xFF ,0xFF ,0xFF ,0xFF ,0xFF ,0xFF ,0x40 ,0x30 ,0x20 ,0x10,
...
#if 0
/*  00    01    02   03     04    05    06    07   08     09    0A    0B    0C    0D    0E   0F */
	0x00,0xFF ,0xFF ,0xFF ,0xFF ,0xFF ,0xFF ,0x00 ,0x4D ,0xD9 ,0x01 ,0x9C ,0x01 ,0x01 ,0x01 ,0x01,
	0x01,0x13 ,0x01 ,0x03 ,0x80 ,0xA0 ,0x5A ,0x78 ,0x0A ,0x83 ,0xAD ,0xA2 ,0x56 ,0x49 ,0x9B ,0x25,
	...
	0x00,0x53 ,0x4F ,0x4E ,0x59 ,0x20 ,0x54 ,0x56 ,0x0A ,0x20 ,0x20 ,0x20 ,0x20 ,0x20 ,0x01 ,0x59,
	0x02,0x03 ,0x20 ,0x70 ,0x49 ,0x10 ,0x04 ,0x05 ,0x03 ,0x02 ,0x07 ,0x06 ,0x20 ,0x01 ,0x26 ,0x09,
	0x07,0x07 ,0x15 ,0x07 ,0x50 ,0x83 ,0x01 ,0x00 ,0x00 ,0x66 ,0x03 ,0x0C ,0x00 ,0x30 ,0x00 ,0x80,
	...
	0x26,0x7C ,0x43 ,0x00 ,0xB0 ,0x84 ,0x43 ,0x00 ,0x00 ,0x98 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x20
#endif
...
static INT32 _SifVGAEdidWriteSramCmd(INT32 i4Argc, const CHAR * *szArgv)
{
#if 1 //adam , wait for eeproom ready
    INT32 fgSet;
    INT32 i;
...
static INT32 _SifEDIDWriteCmd(INT32 i4Argc, const CHAR * *szArgv)
{   
#if ((defined (CC_MT5395) || defined(CC_MT5365) || defined(CC_MT5396) || defined(CC_MT5368) || defined (CC_MT5389)) && !defined(CC_HDMI_EDID_DISABLE))
    _InternalEdidWriteSram();
...
static INT32 _SifSCLStretchStressCmd(INT32 i4Argc, const CHAR * *szArgv)
{
    ...
    u4SrcPtr = (UINT32)x_mem_alloc(254);
    u4DstPtr = (UINT32)x_mem_alloc(254);
...
static INT32 _SifSCLStretchTestCmd(INT32 i4Argc, const CHAR **szArgv)
{
#ifndef REPLACE_EEPROM_WITH_FILE
    UINT32 i4Ret;
    ...
    Printf("%s successfully.\n", __FUNCTION__);
#endif /* !REPLACE_EEPROM_WITH_FILE */
    return 0;
}
...
//unsigned char XC5000_firmware_SEQUENCE[12370] = { 
