...
#if defined(CONFIG_SERIAL_MT5395_CONSOLE) && defined(CONFIG_MAGIC_SYSRQ)
...
#define SERIAL_MT5395_MAJOR     204
#define SERIAL_MT5395_MINOR     16

#define MT5395_ISR_PASS_LIMIT   256

/*
 * Port
 */
struct mt5395_uart_port
{
...
static struct mt5395_uart_port _mt5395_uart_ports[];
 ...
 * Locals
 */
static void _mt5395_uart_stop_tx(struct uart_port *port);

/*
 * HW functions of mt5395 uart
 */
...
static unsigned int _mt5395_u0_trans_mode_on(void)
{
    return UART_READ32(UART0_STATUS_OLD) & U0_TRANSPARENT;
}

static unsigned int _mt5395_u2_trans_mode_on(void)
{
    return UART_READ32(UART2_STATUS_OLD) & U2_TRANSPARENT;
}

static void _mt5395_uart_flush(int port)
{
    unsigned int u4Reg;
    unsigned long flags;
...
static void _mt5395_u0_set_trans_mode(unsigned int on)
{
    if (on > 0)
    {
...
static void _mt5395_u2_set_trans_mode(unsigned int on)
{
    if (on > 0)
    {
...
static void _mt5395_uart_hwinit(int port)
{
    unsigned int u4Tmp;
    unsigned long flags;
    ...
    if (port == 0)
    {
        ...
        {
            _mt5395_u0_set_trans_mode(0);
            UART_WRITE32(0, UART0_BUFFER_SIZE);
            _mt5395_u0_set_trans_mode(1);
        }
    }
    ...
    if (port == 2)
    {
        ...
        {
            _mt5395_u2_set_trans_mode(0);
            UART_WRITE32(0, UART2_BUFFER_SIZE);
            _mt5395_u2_set_trans_mode(1);
        }
...
void _mt5395_uart_set(unsigned int uCOMMCTRL, int baud, int datalen, int stop, int parity)
{
...
static void _mt5395_uart_get(unsigned int uCOMMCTRL, int *p_baud, int *p_datalen, int *p_stop, int *p_parity)
{
...
static unsigned int _mt5395_u0_read_allow(void)
{
...
static unsigned int _mt5395_u0_write_allow(void)
{
...
static void _mt5395_u0_int_enable(int enable)
{
    unsigned long flags;
...
static void _mt5395_u0_empty_int_enable(int enable)
{
    unsigned long flags;
...
static unsigned int _mt5395_u0_read_byte(void)
{
    unsigned int i4Ret;
...
static void _mt5395_u0_write_byte(unsigned int byte)
{
    
    UART_WRITE32(byte, UART0_DATA_BYTE);
}

static void _mt5395_u0_flush(void)
{
    _mt5395_uart_flush(UART_PORT_0);
    _UART_HwWaitTxBufClear(UART_PORT_0);
}

static void _mt5395_u0_get_top_err(int *p_parity, int *p_end, int *p_break)
{
...
static unsigned int _mt5395_u1_read_allow(void)
{
    return GET_RX_DATA_SIZE(UART_READ32(UART1_STATUS));
}

static unsigned int _mt5395_u1_write_allow(void)
{
    return GET_TX_EMPTY_SIZE(UART_READ32(UART1_STATUS));
}

static void _mt5395_u1_int_enable(int enable)
{
    unsigned long flags;
...
static void _mt5395_u1_empty_int_enable(int enable)
{
    unsigned long flags;
...
static unsigned int _mt5395_u1_read_byte(void)
{
    unsigned int i4Ret;
...
static void _mt5395_u1_write_byte(unsigned int byte)
{
    UART_WRITE32(byte, UART1_DATA_BYTE);
}

static void _mt5395_u1_flush(void)
{
    _mt5395_uart_flush(UART_PORT_1);
    _UART_HwWaitTxBufClear(UART_PORT_1);
}

static void _mt5395_u1_get_top_err(int *p_parity, int *p_end, int *p_break)
{
...
static unsigned int _mt5395_u2_read_allow(void)
{
    if (_mt5395_u2_trans_mode_on())
    {
...
static unsigned int _mt5395_u2_write_allow(void)
{
    if (_mt5395_u2_trans_mode_on())
    {
...
static void _mt5395_u2_int_enable(int enable)
{
    unsigned long flags;
...
static void _mt5395_u2_empty_int_enable(int enable)
{
    unsigned long flags;
...
static unsigned int _mt5395_u2_read_byte(void)
{
    unsigned int i4Ret;
...
static void _mt5395_u2_write_byte(unsigned int byte)
{
    UART_WRITE32(byte, UART2_DATA_BYTE);
}

static void _mt5395_u2_flush(void)
{
    _mt5395_uart_flush(UART_PORT_2);
    _UART_HwWaitTxBufClear(UART_PORT_2);
}

static void _mt5395_u2_get_top_err(int *p_parity, int *p_end, int *p_break)
{
 ...
 * interrupt handling
 */
static void _mt5395_uart_rx_chars(struct mt5395_uart_port *mport)
{
    ...
    if (((mport->nport == 0) && !(_mt5395_u0_trans_mode_on())) ||
        ((mport->nport == 2) && !(_mt5395_u2_trans_mode_on())))
    {
        max_count = 1;
    }
 ...
 */
#ifdef CONFIG_TTYMT7_SUPPORT
static void _mt5395_uart_rx_chars_2(struct mt5395_uart_port *mport, 
    struct mt5395_uart_port *mport_factory)
{
...
static void _mt5395_uart_tx_chars(struct mt5395_uart_port *mport)
{
    struct uart_port *port;
...
// Fake
#ifdef CONFIG_TTYMT7_SUPPORT
static void _mt5395_uart_tx_chars_2(struct mt5395_uart_port *mport)
{
    struct uart_port *port;
    struct circ_buf *xmit;
    int count;
...
static void _mt5395_uart_modem_state(struct mt5395_uart_port *mport)
{
    struct uart_port *port;
...
static unsigned int _mt5395_uart_tx_empty(struct uart_port *port)
{
    struct mt5395_uart_port *mport;
    unsigned int count;
    unsigned long flags;
    ...
    mport = (struct mt5395_uart_port *)port;
...
static void _mt5395_uart_set_mctrl(struct uart_port *port, unsigned int mctrl)
{
    struct mt5395_uart_port *mport;
    unsigned int regval;
    unsigned int uMS;
...
static unsigned int _mt5395_uart_get_mctrl(struct uart_port *port)
{
    struct mt5395_uart_port *mport;
...
static void _mt5395_uart_start_tx(struct uart_port *port)
{
...
static void _mt5395_uart_stop_rx(struct uart_port *port)
{
    struct mt5395_uart_port *mport;
    unsigned long flags;
...
static void _mt5395_uart_enable_ms(struct uart_port *port)
{
    struct mt5395_uart_port *mport;
...
static void _mt5395_uart_break_ctl(struct uart_port *port, int break_state)
{
    struct mt5395_uart_port *mport;
    unsigned int regval;
    unsigned long flags;
...
static irqreturn_t _mt5395_uart0_interrupt(int irq, void *dev_id);
static irqreturn_t _mt5395_uart1_interrupt(int irq, void *dev_id);
static irqreturn_t _mt5395_uart2_interrupt(int irq, void *dev_id);

static int _mt5395_uart_startup(struct uart_port *port)
{
    struct mt5395_uart_port *mport;
    unsigned long flags;
    int retval;
    ...
    /* FIXME: hw init? */
    _mt5395_uart_hwinit(mport->nport);
    ...
    if ((mport->nport == 0) && (u0irq == 1))
    {
        ...
        retval = request_irq(port->irq, _mt5395_uart0_interrupt, IRQF_SHARED,
                             "MT5395 Serial 0", port);
        if (retval)
        {
            _u0_irq_allocated --;
            return retval;
    ...
    {
        /* allocate irq, u0/u1 share the same interrupt number */
        retval = request_irq(port->irq, _mt5395_uart1_interrupt, IRQF_SHARED,
                             "MT5395 Serial 1", port);
        if (retval)
        {
            _u1_irq_allocated --;
            return retval;
    ...
    {
        /* allocate irq, u0/u1 share the same interrupt number */
        retval = request_irq(port->irq, _mt5395_uart2_interrupt, IRQF_SHARED,
                             "MT5395 Serial 2", port);
        if (retval)
        {
            _u2_irq_allocated --;
            return retval;
...
static void _mt5395_uart_shutdown(struct uart_port *port)
{
    struct mt5395_uart_port *mport;
    unsigned long flags;
    int u0irq, u1irq, u2irq;
...
static unsigned char _mt5395_uart_cal_rxd_timeout(unsigned int baud)
{
...
static void _mt5395_uart_set_termios(struct uart_port *port,
    struct ktermios *termios, struct ktermios *old)
{
    ...
    //_mt5395_uart_flush(mport->nport);
    if ((mport->baud != baud) ||
    ...
    _mt5395_uart_set(uCOMMCTRL, baud, datalen, stopbit, parity);
    ...
    case 0:
        ...
        UART_REG_BITSET(RX_TOUT_CYCLE(_mt5395_uart_cal_rxd_timeout(baud)) , UART0_BUFCTRL);
        break;
    case 1:
        UART_REG_BITCLR(RX_TOUT_CYCLE(0xFF) , UART1_BUFCTRL);
        UART_REG_BITSET(RX_TOUT_CYCLE(_mt5395_uart_cal_rxd_timeout(baud)) , UART1_BUFCTRL);
        break;
    case 2:
        UART_REG_BITCLR(RX_TOUT_CYCLE(0xFF) , UART2_BUFCTRL);
        UART_REG_BITSET(RX_TOUT_CYCLE(_mt5395_uart_cal_rxd_timeout(baud)) , UART2_BUFCTRL);
        break;
    default:
        break;
    }
...
static const char *_mt5395_uart_type(struct uart_port *port)
{
    return "MT5395 Serial";
}

static void _mt5395_uart_release_port(struct uart_port *port)
{
    release_mem_region(port->mapbase, MT5395_UART_SIZE);
}

static int _mt5395_uart_request_port(struct uart_port *port)
{
    void *pv_region;

    pv_region = request_mem_region(port->mapbase, MT5395_UART_SIZE,
                                   "MT5395 Uart IO Mem");
    return pv_region != NULL ? 0 : -EBUSY;
}

static void _mt5395_uart_config_port(struct uart_port *port, int flags)
{
    if (flags & UART_CONFIG_TYPE)
    {
        port->type = PORT_MT5395;
        _mt5395_uart_request_port(port);
    }
}

static int _mt5395_uart_verify_port(struct uart_port *port,
                                    struct serial_struct *ser)
{
	int ret = 0;
	if (ser->type != PORT_UNKNOWN && ser->type != PORT_MT5395)
	{
		ret = -EINVAL;
	}
	if (ser->irq != port->irq)
...
#ifdef CONFIG_TTYMT7_SUPPORT
static int _mt5395_uart_ioctl(struct uart_port *port, unsigned int cmd,
                  unsigned long arg)
{
    unsigned long flags;
    int ret = 0;  
...
static struct uart_ops _mt5395_uart_ops =
{
    .tx_empty       = _mt5395_uart_tx_empty,
    .set_mctrl      = _mt5395_uart_set_mctrl,
    .get_mctrl      = _mt5395_uart_get_mctrl,
    .stop_tx        = _mt5395_uart_stop_tx,
    .start_tx       = _mt5395_uart_start_tx,
    /* .send_xchar */
    .stop_rx        = _mt5395_uart_stop_rx,
    .enable_ms      = _mt5395_uart_enable_ms,
    .break_ctl      = _mt5395_uart_break_ctl,
    .startup        = _mt5395_uart_startup,
    .shutdown       = _mt5395_uart_shutdown,
    .set_termios    = _mt5395_uart_set_termios,
    /* .pm */
    /* .set_wake */
    .type           = _mt5395_uart_type,
    .release_port   = _mt5395_uart_release_port,
    .request_port   = _mt5395_uart_request_port,
    .config_port    = _mt5395_uart_config_port,
    .verify_port    = _mt5395_uart_verify_port,
#ifdef CONFIG_TTYMT7_SUPPORT
    .ioctl = _mt5395_uart_ioctl,
#endif
};
...
{
    {
        .port =
        {
            .membase        = (void*)MT5395_VA_UART,
            .mapbase        = MT5395_PA_UART,
            .iotype         = SERIAL_IO_MEM,
            .irq            = VECTOR_RS232_0,
            .uartclk        = 921600,
            .fifosize       = TX_BUF_SIZE,
            .ops            = &_mt5395_uart_ops,
        ...
        .rx_stop            = 0,
        .ms_enable          = 0,
        .fn_read_allow      = _mt5395_u0_read_allow,
        .fn_write_allow     = _mt5395_u0_write_allow,
        .fn_int_enable      = _mt5395_u0_int_enable,
        .fn_empty_int_enable    = _mt5395_u0_empty_int_enable,
        .fn_read_byte       = _mt5395_u0_read_byte,
        .fn_write_byte      = _mt5395_u0_write_byte,
        .fn_flush           = _mt5395_u0_flush,
        .fn_get_top_err     = _mt5395_u0_get_top_err,
    },
    {
        .port =
        {
        ...
        .rx_stop            = 0,
        .ms_enable          = 0,
        .fn_read_allow      = _mt5395_u1_read_allow,
        .fn_write_allow     = _mt5395_u1_write_allow,
        .fn_int_enable      = _mt5395_u1_int_enable,
        .fn_empty_int_enable    = _mt5395_u1_empty_int_enable,
        .fn_read_byte       = _mt5395_u1_read_byte,
        .fn_write_byte      = _mt5395_u1_write_byte,
        .fn_flush           = _mt5395_u1_flush,
        .fn_get_top_err     = _mt5395_u1_get_top_err,
    },
    {
        .port =
        {
            .membase        = (void*)MT5395_VA_UART2,
            .mapbase        = MT5395_PA_UART2,
            .iotype         = SERIAL_IO_MEM,
            .irq            = VECTOR_RS232_2,
            .uartclk        = 921600,
            .fifosize       = TX_BUF_SIZE,
        ...
        .rx_stop            = 0,
        .ms_enable          = 0,
        .fn_read_allow      = _mt5395_u2_read_allow,
        .fn_write_allow     = _mt5395_u2_write_allow,
        .fn_int_enable      = _mt5395_u2_int_enable,
        .fn_empty_int_enable= _mt5395_u2_empty_int_enable,
        .fn_read_byte       = _mt5395_u2_read_byte,
        .fn_write_byte      = _mt5395_u2_write_byte,
        .fn_flush           = _mt5395_u2_flush,
        .fn_get_top_err     = _mt5395_u2_get_top_err,
    },
#ifdef CONFIG_TTYMT7_SUPPORT
    {
        .port =
...
static irqreturn_t _mt5395_uart0_interrupt(int irq, void *dev_id)
{
    ...
    struct mt5395_uart_port *mport = (struct mt5395_uart_port *)dev_id;
#ifdef CONFIG_TTYMT7_SUPPORT
    struct mt5395_uart_port *mport_factory;
#endif
...
#ifdef CONFIG_TTYMT7_SUPPORT
    mport = &_mt5395_uart_ports[0];
    mport_factory = &_mt5395_uart_ports[3];   
#endif    
    ...
    if (mport != &_mt5395_uart_ports[0])
    {
        while (1)
            ;
    }
    //_mt5395_handle_uart_interrupt(mport, regs, uart_int_ident & U0_TBUF);

    /* rx mode */
    if (mport->fn_read_allow() || (uart_int_ident & (U0_RBUF | U0_RERR)))
    {
#ifdef CONFIG_TTYMT7_SUPPORT    
        _mt5395_uart_rx_chars_2(mport, mport_factory);
#else
        _mt5395_uart_rx_chars(mport);
#endif
        ret = IRQ_HANDLED;
    }
    ...
    else
    {
        ...
        {
            _mt5395_uart_tx_chars(mport_factory);
            ret = IRQ_HANDLED;
        }
    ...
    /* modem mode */
    _mt5395_uart_modem_state(mport);
...
static irqreturn_t _mt5395_uart1_interrupt(int irq, void *dev_id)
{
    ...
    /* ack u1 interrupt */
    UART_WRITE32(~uart_int_ident, UART_INT_ID);
    if (mport != &_mt5395_uart_ports[1])
    {
        while (1)
            ;
    }
    //_mt5395_handle_uart_interrupt(mport, regs, uart_int_ident & U1_TBUF);
...
static irqreturn_t _mt5395_uart2_interrupt(int irq, void *dev_id)
{
    ...
    if (mport != &_mt5395_uart_ports[2])
    {
        while (1)
            ;
    }
    //_mt5395_handle_uart_interrupt(mport, regs, uart_int_ident & U2_TBUF);
...
#ifdef CONFIG_SERIAL_MT5395_CONSOLE

static void _mt5395_uart_console_write(struct console *co, const char *s,
    unsigned int count)
{
...
#endif
    if (((co->index == 0) && (!_mt5395_u0_trans_mode_on())) ||
        ((co->index == 2) && (!_mt5395_u2_trans_mode_on())))
    {
        return;
    }
...
static void __init _mt5395_uart_console_get_options(struct uart_port *port,
...
//    case 3: // virtual UART 
    ...
    _mt5395_uart_get(uCOMMCTRL, &baud, &datalen, &stopbit, &parity);
...
static int __init _mt5395_uart_console_setup(struct console *co, char *options)
{
    struct uart_port *port;
    int baud    = 115200;
    int bits    = 8;
    ...
    printk(KERN_DEBUG "5395 console setup : co->index %d options:%s\n",
        co->index, options);
    ...
    port = (struct uart_port *)&_mt5395_uart_ports[co->index];
    ...
    {
        _mt5395_uart_console_get_options(port, &baud, &parity, &stopbit);
    }

    ret = uart_set_options(port, co, baud, parity, bits, flow);
    printk(KERN_DEBUG "5395 console setup : uart_set_option port(%d) "
...
static struct uart_driver _mt5395_uart_reg;
static struct console _mt5395_uart_console =
{
    .name       = "ttyMT",
    .write      = _mt5395_uart_console_write,
    .device     = uart_console_device,
    .setup      = _mt5395_uart_console_setup,
    .flags      = CON_PRINTBUFFER,
    .index      = -1,
    .data       = &_mt5395_uart_reg,
};

static int __init _mt5395_uart_console_init(void)
{
    // set to transparent if boot loader doesn't do this
    //_mt5395_u0_set_trans_mode_on();
    register_console(&_mt5395_uart_console);
    return 0;
}

console_initcall(_mt5395_uart_console_init);

static int __init _mt5395_late_console_init(void)
{
    if (!(_mt5395_uart_console.flags & CON_ENABLED))
    {
        register_console(&_mt5395_uart_console);
    }
    return 0;
...
late_initcall(_mt5395_late_console_init);

#define MT5395_CONSOLE &_mt5395_uart_console
#else

#define MT5395_CONSOLE NULL

#endif /* CONFIG_SERIAL_MT5395_CONSOLE */


static struct uart_driver _mt5395_uart_reg =
{
    .owner          = THIS_MODULE,
    .driver_name    = "MT5395 serial",
    .dev_name       = "ttyMT",
    .major          = SERIAL_MT5395_MAJOR,
    .minor          = SERIAL_MT5395_MINOR,
    .nr             = UART_NR,
    .cons           = MT5395_CONSOLE,
};
...
static int _mt5395_uart_probe(struct device *_dev)
{
    ...
    _mt5395_uart_ports[dev->id].port.dev = _dev;
    uart_add_one_port(&_mt5395_uart_reg, &_mt5395_uart_ports[dev->id].port);
    dev_set_drvdata(_dev, &_mt5395_uart_ports[dev->id]);
    return 0;
}

static int _mt5395_uart_remove(struct device *_dev)
{
    struct mt5395_uart_port *mport = dev_get_drvdata(_dev);

    dev_set_drvdata(_dev, NULL);

    if (mport)
    {
        uart_remove_one_port(&_mt5395_uart_reg, &mport->port);
    }
    return 0;
}

static int _mt5395_uart_suspend(struct device * _dev, pm_message_t state)
{
#if 0
    struct mt5395_uart_port *mport = dev_get_drvdata(_dev);
    ...
    {
        uart_suspend_port(&_mt5395_uart_reg, &mport->port);
    }
#endif
    return 0;
}

static int _mt5395_uart_resume(struct device *_dev)
{
#if 0
    struct mt5395_uart_port *mport = dev_get_drvdata(_dev);
    ...
    {
        uart_resume_port(&_mt5395_uart_reg, &mport->port);
    }
#endif
    return 0;
}

static struct device_driver _mt5395_uart_driver =
{
    .name           = "MT5395 uart",
    .bus            = &platform_bus_type,
    .probe          = _mt5395_uart_probe,
    .remove         = _mt5395_uart_remove,
    .suspend        = _mt5395_uart_suspend,
    .resume         = _mt5395_uart_resume,
};
...
static int __init _mt5395_uart_init(void)
{
    int ret;
    int i;
    ...
    for (i = 0; i < UART_NR; i++)
    {
        _mt5395_uart_hwinit(i);  /* all port 115200, no int */
    }
    
    printk(KERN_INFO "Serial: MT5395 driver $Revision: #1 $\n");
    ret = uart_register_driver(&_mt5395_uart_reg);
    ...
    for (i = 0; i < UART_NR; i++)
    {
        ...
        uart_add_one_port(&_mt5395_uart_reg, &_mt5395_uart_ports[i].port);
    }

    ret = driver_register(&_mt5395_uart_driver);
...
//unreg:
//    uart_unregister_driver(&_mt5395_uart_reg);

out:
    return ret;
}

static void __exit _mt5395_uart_exit(void)
{
    uart_unregister_driver(&_mt5395_uart_reg);
}
...
module_init(_mt5395_uart_init);
module_exit(_mt5395_uart_exit);

MODULE_AUTHOR("MediaTek Inc.");
MODULE_DESCRIPTION("MT5395 serial port driver $Revision: #1 $");
MODULE_LICENSE("MKL");
