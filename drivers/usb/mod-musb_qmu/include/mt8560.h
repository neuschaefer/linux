...
#define MUSB_DMABASE                                    (0x200)
#define MUSB_PHYBASE                                    (0x4B000)//(IO_VIRT + 0x49000)
...
#define MGC_PHY_Write32(_pBase, r, v) {\
	if((uint32_t)_pBase == (MUSB_BASE)){\
		*((volatile uint32_t *)((MUSB_PHYBASE)+ (MUSB_PORT0_PHYBASE) + (r))) = v;}\
		else if((uint32_t)_pBase == (MUSB_BASE2)){\
			*((volatile uint32_t *)((MUSB_PHYBASE)+ (MUSB_PORT1_PHYBASE) + (r))) = v;}\
			else if((uint32_t)_pBase == (MUSB_BASE3)){\
				*((volatile uint32_t *)((MUSB_PHYBASE)+ (MUSB_PORT2_PHYBASE) + (r))) = v;}\
				}
#else
...
//#ifdef FOR_MUSB_COMPILE
//#define MGC_MISC_Read32(_pBase, r) 0

//#define MGC_MISC_Write32(_pBase, r, v) do{}while(0)

//#define MGC_AnaPhy_Read32(_pBase, _offset) 0

//#define MGC_AnaPhy_Write32(_pBase, _offset, _data) do{}while(0)
//#endif
...
#define MGC_AnaPhy_Read32(_pBase, _offset) *((volatile uint32_t *)(((uint32_t)_pBase) + MUSB_ANAPHYBASE + _offset))

#define MGC_AnaPhy_Write32(_pBase, _offset, _data) \
(*((volatile uint32_t *)(((uint32_t)_pBase) + MUSB_ANAPHYBASE + _offset)) = _data)
