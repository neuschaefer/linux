...
void Mstar_U3phy_MS28_eFuse_2p(uintptr_t U3PHY_P0_A_base, uintptr_t U3PHY_P1_A_base)
{
	...
	if ((value & 0x80008000) == 0x80008000) {
		...
		setting = (u8)(value & 0x1F);
		writeb((readb((void*)(U3PHY_P0_A_base+0x8*2))&(~0x1F)) | setting,  (void*)(U3PHY_P0_A_base+0x8*2));
		setting = (u8)((value>>8) & 0x1F);
		writeb((readb((void*)(U3PHY_P0_A_base+0x10*2))&(~0x1F)) | setting,  (void*)(U3PHY_P0_A_base+0x10*2));

		setting = (u8)((value>>16) & 0x1F);
		writeb((readb((void*)(U3PHY_P1_A_base+0x8*2))&(~0x1F)) | setting,  (void*)(U3PHY_P1_A_base+0x8*2));
		setting = (u8)((value>>24) & 0x1F);
		writeb((readb((void*)(U3PHY_P1_A_base+0x10*2))&(~0x1F)) | setting,  (void*)(U3PHY_P1_A_base+0x10*2));
	}
}
#endif
