...
#define CFG_CUSTOM_NETLINK_SUPPORT                  1

#define CFG_SUPPORT_TX_BEACON_STA_MODE      1

/*Notice this feature need to first enable "CFG_CUSTOM_NETLINK_SUPPORT" */
#define CFG_SUPPORT_FRAMES_TO_CUSTOMER 1
#define FRAME_TYPES_TO_CUSTOMER_ENABLE_MASK 0xF
#define FRAME_TYPES_TO_CUSTOMER_OFFSET 4
