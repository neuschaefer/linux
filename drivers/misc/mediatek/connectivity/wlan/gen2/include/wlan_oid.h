...
typedef enum _ENUM_FRAME_TYPES_TO_CUSTOMER_T {
	/*Each bit indicate one type frame*/
	FRAME_TYPES_PROBE_REQ = 0,
	FRAME_TYPES_BEACON = 1,
	FRAME_TYPES_PROBE_RSP = 2,
	/*can add more types frame here if you want to send them to customer layer*/
	FRAME_TYPES_NUMS	
} ENUM_FRAME_TYPES_TO_CUSTOMER_T;
#endif
