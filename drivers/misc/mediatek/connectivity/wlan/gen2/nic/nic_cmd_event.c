...
VOID nicCmdEventDebugQuery(IN P_ADAPTER_T prAdapter, IN P_CMD_INFO_T prCmdInfo, IN PUINT_8 pucEventBuf)
{
	P_CMD_SW_DBG_CTRL_T prCmdSwCtrl;
	P_GLUE_INFO_T prGlueInfo;
	UINT_32 u4QueryInfoLen;
	...
	if (prCmdInfo->fgIsOid) {
		...
		kalMemCopy((P_CMD_SW_DBG_CTRL_T)prCmdInfo->pvInformationBuffer, prCmdSwCtrl, sizeof(CMD_SW_DBG_CTRL_T));
