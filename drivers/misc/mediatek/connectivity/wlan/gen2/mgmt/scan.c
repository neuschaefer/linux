...
*/
	...
	extern UINT_32 g_toCustomerFrameTypes;
#endif
...
WLAN_STATUS scanProcessBeaconAndProbeResp(IN P_ADAPTER_T prAdapter, IN P_SW_RFB_T prSwRfb)
{
	...
	{
		UINT_8 frameType;
		frameType = (*(PUINT_8) (prSwRfb->pvHeader)) & MASK_FRAME_TYPE;
		if(((frameType == MAC_FRAME_PROBE_RSP) && (g_toCustomerFrameTypes & BIT(FRAME_TYPES_PROBE_RSP)))
		|| ((frameType == MAC_FRAME_BEACON) && (g_toCustomerFrameTypes & BIT(FRAME_TYPES_BEACON))))
