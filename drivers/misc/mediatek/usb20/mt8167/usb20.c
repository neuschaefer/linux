...
{ .hw_ep_num =	1, .style = MUSB_FIFO_TX,	.maxpacket = 1024, .ep_mode = EP_ISO, .mode = MUSB_BUF_DOUBLE},
{ .hw_ep_num =	1, .style = MUSB_FIFO_RX,	.maxpacket = 1024, .ep_mode = EP_ISO, .mode = MUSB_BUF_DOUBLE},
{ .hw_ep_num =	2, .style = MUSB_FIFO_RX,	.maxpacket = 4, .ep_mode = EP_ISO, .mode = MUSB_BUF_DOUBLE},
#else
