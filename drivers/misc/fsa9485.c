...
static int fsa9485_write_reg(struct i2c_client *client,        u8 reg, u8 data)
{
	   ...
	   printk("[fsa9485] tsu8111_write_reg   reg[0x%2x] data[0x%2x]\n",buf[0],buf[1]);
...
static int fsa9485_read_reg(struct i2c_client *client, u8 reg, u8 *data)
{
	...
	printk("[fsa9485] tsu8111_read_reg reg[0x%2x] ", buf[0]);
...
static void fsa9485_detect_dev(struct fsa9485_usbsw *usbsw)
{
	...
	fsa9485_read_reg(client, 0x01, &val);
	printk("DEVID=0x%x\n",val);
	fsa9485_read_reg(client, 0x02, &val);
	printk("CTRL=0x%x\n",val);
	fsa9485_read_reg(client, 0x03, &val);
	printk("INT1=0x%x\n",val);
	fsa9485_read_reg(client, 0x04, &val);
	printk("INT2=0x%x\n",val);
	fsa9485_read_reg(client, 0x05, &val);
	printk("INT1_MASK=0x%x\n",val);
	fsa9485_read_reg(client, 0x06, &val);
	printk("INT2_MASK=0x%x\n",val);
	fsa9485_read_reg(client, 0x07, &val);
	printk("ADC=0x%x\n",val);
	fsa9485_read_reg(client, 0x08, &val);
	printk("TIMING1=0x%x\n",val);
	fsa9485_read_reg(client, 0x09, &val);
	printk("TIMING2=0x%x\n",val);
	fsa9485_read_reg(client, 0x0a, &val);
	printk("DEV_T1=0x%x\n",val);
	fsa9485_read_reg(client, 0x0b, &val);
	printk("DEV_T2=0x%x\n",val);
	fsa9485_read_reg(client, 0x0c, &val);
	printk("BTN1=0x%x\n",val);
	fsa9485_read_reg(client, 0x0d, &val);
	printk("BTN2=0x%x\n",val);
	fsa9485_read_reg(client, 0x0e, &val);
	printk("CK=0x%x\n",val);
	fsa9485_read_reg(client, 0x0f, &val);
	printk("CK_INT1=0x%x\n",val);
	fsa9485_read_reg(client, 0x10, &val);
	printk("CK_INT2=0x%x\n",val);
	fsa9485_read_reg(client, 0x11, &val);
	printk("CK_INTMASK1=0x%x\n",val);
	fsa9485_read_reg(client, 0x12, &val);
	printk("CK_INTMASK2=0x%x\n",val);
	fsa9485_read_reg(client, 0x13, &val);
	printk("MANSW1=0x%x\n",val);
	fsa9485_read_reg(client, 0x14, &val);
	printk("MANSW2=0x%x\n",val);
	fsa9485_read_reg(client, 0x1b, &val);
	printk("RESET=0x%x\n",val);
	fsa9485_read_reg(client, 0x1d, &val);
	printk("RESERVED_1D=0x%x\n",val);
...
static irqreturn_t fsa9485_irq_thread(int irq, void *data)
{
	...
	pr_info("fsa9485_irq_thread is called\b");
			 ...
			 const struct i2c_device_id *id)
{
	...
	schedule_delayed_work(&usbsw->init_work, msecs_to_jiffies(2500)); 
