...
#define RTL8168_VERSION "8.025.RC4" NAPI_SUFFIX
...
do{                                                                                            \
    volatile unsigned long u4TmpVar;                                                                  \
    u4TmpVar = (unsigned long) readl(((unsigned long)ioaddr) + ((reg) & 0xFFFC)); \
    u4TmpVar &= ~(((unsigned long)0xFF) << (8*((reg) & 0x03)));                                   \
    u4TmpVar |= (unsigned long)(((val8) & 0xFF) << (8*((reg) & 0x03)));                          \
    writel(u4TmpVar, (((unsigned long)ioaddr) + ((reg) & 0xFFFC))); \
}while(0)
...
do{                                                                                            \
    volatile unsigned long u4TmpVar;                                                                  \
    u4TmpVar = (unsigned long) readl(((unsigned long)ioaddr) + ((reg) & 0xFFFC)); \
    u4TmpVar &= ~(((unsigned long)0xFFFF) << (8*((reg) & 0x03)));                                 \
    u4TmpVar |= (val16) << (8*((reg) & 0x03));                                               \
    writel(u4TmpVar, (((unsigned long)ioaddr) + ((reg) & 0xFFFC))); \
}while(0)
...
#define RTL_R8(reg) \
    ((((unsigned long)readl(((unsigned long)ioaddr) + ((reg) & 0xFFFC))) >> (8*((reg) & 0x03))) & 0xFF)

//#define RTL_R16(reg)		readw (ioaddr + (reg))
#define RTL_R16(reg) \
    ((((unsigned long)readl(((unsigned long)ioaddr) + ((reg) & 0xFFFC))) >> (8*((reg) & 0x03))) & 0xFFFF)
