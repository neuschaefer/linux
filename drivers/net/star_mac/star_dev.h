...
{
	u32 base;               /* Base register of Star Ethernet */
	u32 pinmuxBase;         /* Base register of PinMux */
    u32 pdwncBase;          /* Base register of PDWNC */
    u32 ethPdwncBase;       /* Base register of Eternet PDWNC */
    u32 ethChksumBase;      /* Base register of Ethernet Checksum */
    u32 ethIPLL1Base;       /* Base register of Ethernet IPLL 1 */
    u32 ethIPLL2Base;       /* Base register of Ethernet IPLL 2 */
    u32 bspBase;            /* Base register of BSP */
...
#define StarDmaTxDisable(dev)			StarSetBit(STAR_TX_DMA_CTRL((dev)->base), RX_STOP)
#define StarDmaRxEnable(dev)			StarSetBit(STAR_RX_DMA_CTRL((dev)->base), TX_RESUME)
