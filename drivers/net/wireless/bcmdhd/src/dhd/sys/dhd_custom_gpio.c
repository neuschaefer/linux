...
#endif /* defined(CONFIG_ARCH_CAPRI) */
...
#endif /* CUSTOMER_HW */
#if defined(CUSTOMER_HW2) || defined(CUSTOMER_HW4) || defined(CONFIG_ARCH_CAPRI)
...
#if defined(CUSTOMER_HW3) || defined(CONFIG_ARCH_CAPRI)
#include <mach/gpio.h>
#endif
...
#elif defined(CUSTOMER_HW3) || defined(CONFIG_ARCH_CAPRI)
