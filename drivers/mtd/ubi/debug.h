...
static inline int ubi_self_check_all_ff(struct ubi_device *ubi,
                                        int pnum, int offset,
                                        int len)                     { return 0; }
static inline void ubi_dump_aeb(const struct ubi_ainf_peb *aeb,
                                int type)                            { return; }
static void ubi_dump_av(const struct ubi_ainf_volume *av)            { return; }
