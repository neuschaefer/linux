...
/* #define CONFIG_MHL_NEW_CBUS_MSC_CMD
 * defined in arch/arm/configs/m0_00_defconfig
 */
/*////////////////////////////////////////////////////////////////////////////*/
...
static int sii9234_cbus_init(struct sii9234_data *sii9234)
{
	...
	if (ret < 0)
		goto i2c_error_exit;
	ret = cbus_write_reg(sii9234, 0x80 + DEVCAP_VID_LINK_MODE, 0x02);
				/*YCbCr444 */
	if (ret < 0)
		goto i2c_error_exit;
...
static void mhl_mhl_end_worker(struct work_struct *p)
{
	mhl_onoff_ex(0);
	return;
}
					      ...
					      const struct i2c_device_id *id)
{
	...
	INIT_WORK(&sii9234->mhl_end_work, mhl_mhl_end_worker);
	...
	client->irq = gpio_to_irq(sii9234->pdata->gpio_mhl_int);
