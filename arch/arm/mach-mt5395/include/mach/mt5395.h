/*
 *  linux/include/asm-arm/arch-mt5395/mt5395.h
 *
 ...
 *
 */
#ifndef __ASM_ARCH_MT5395_H
#define __ASM_ARCH_MT5395_H
...
#define IO_SIZE             0x00066000    // Need to cover PCI-Express.

#define MT5395_SDRAM_PA     0x00000000
/* uart 0 and 1 */
#define MT5395_PA_UART      (IO_PHYS + 0x0c000)     //0x2000c000
#define MT5395_VA_UART      (IO_VIRT + 0x0c000)     //0xf000c000
#define MT5395_UART_SIZE    0x1000
/* uart 2*/
#define MT5395_PA_UART2     (IO_PHYS + 0x28800)
#define MT5395_VA_UART2     (IO_VIRT + 0x28800)
#define MT5395_UART2_SIZE   0x100
