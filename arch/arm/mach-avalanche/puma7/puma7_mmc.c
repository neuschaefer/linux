...
#include <puma7.h>
#include <puma7_hardware.h>



/***********************************************************************
 *       Puma7 SD Host Controller section (eMMC Controller)
 ***********************************************************************/
...
struct avalanche_mmc_platform_data puma7_mmc_platform_data = {
    .temp = 0, /* for future usage */
	};



static struct resource puma7_mmc_resources[] = {
        [0] = {
...
/* Flash eMMC Device */
static struct platform_device puma7_mmc_device = {
        .name           = "sdhci-puma7",         /* this name used to for driver matching */
        .id             = 0,                     /* the device instance number, or else "-1" to indicate there's only one. */
        .dev = {
               .platform_data = &puma7_mmc_platform_data,
        }, 
        .num_resources  = ARRAY_SIZE(puma7_mmc_resources),
        .resource       = puma7_mmc_resources,
};
...
static int puma7_mmc_init(void)
{
