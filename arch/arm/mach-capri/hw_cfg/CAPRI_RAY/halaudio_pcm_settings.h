...
/* PCM Configurations */
#define HALAUDIO_PCM_SETTINGS_CORE_ID_SELECT  6 /* Selected SSPI Core for PCM */
...
#else
#define HALAUDIO_PCM_SETTINGS_GPIO_BT_RST_B       98	/* BT_REG_ON */
#define HALAUDIO_PCM_SETTINGS_GPIO_BT_WAKE        97	/* BT_WAKE */
#endif
