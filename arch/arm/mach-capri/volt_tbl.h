...
#define ESUB_CCU_FREQ_VOLT_TBL		VLT_ID_ECO,VLT_ID_ECO,VLT_ID_NORMAL,VLT_ID_NORMAL,VLT_ID_NORMAL,\
						VLT_ID_TURBO,VLT_ID_TURBO,VLT_ID_TURBO
...
#define ALL_VAL_WAKEUP		0x06	/* 0.90V */
...
#define CSR_VAL_ECO1_SS_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TS_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TT_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TF_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_FF_1000M		0x08	/* 0.92V */

#define CSR_VAL_ECO2_SS_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TS_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TT_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TF_1000M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_FF_1000M		0x08	/* 0.92V */
...
#define CSR_VAL_NRML_FF_1000M		0x0D	/* 0.97V */
...
#define CSR_VAL_TURBO2_TS_1000M		0x30	/* 1.32V */
...
#define CSR_VAL_ECO1_SS_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TS_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TT_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TF_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_FF_1200M		0x08	/* 0.92V */

#define CSR_VAL_ECO2_SS_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TS_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TT_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TF_1200M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_FF_1200M		0x08	/* 1.12V */
...
#define CSR_VAL_NRML_SS_1200M		0x13	/* 1.03V */
#define CSR_VAL_NRML_TS_1200M		0x13	/* 1.03V */
#define CSR_VAL_NRML_TT_1200M		0x11	/* 1.01V */
#define CSR_VAL_NRML_TF_1200M		0x0F	/* 0.99V */
#define CSR_VAL_NRML_FF_1200M		0x0D	/* 0.97V */
...
#define CSR_VAL_TURBO1_SS_1200M		0x1D	/* 1.13V */
#define CSR_VAL_TURBO1_TS_1200M		0x1C	/* 1.12V */
#define CSR_VAL_TURBO1_TT_1200M		0x1A	/* 1.10V */
#define CSR_VAL_TURBO1_TF_1200M		0x19	/* 1.09V */
#define CSR_VAL_TURBO1_FF_1200M		0x17	/* 1.07V */
...
#define CSR_VAL_TURBO2_TS_1200M		0x33	/* 1.36V */
#define CSR_VAL_TURBO2_TT_1200M		0x30	/* 1.32V */
#define CSR_VAL_TURBO2_TF_1200M		0x2E	/* 1.30V */
#define CSR_VAL_TURBO2_FF_1200M		0x2B	/* 1.27V */



#define CSR_VAL_ECO1_SS_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TS_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TT_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_TF_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO1_FF_1500M		0x08	/* 0.92V */

#define CSR_VAL_ECO2_SS_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TS_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TT_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_TF_1500M		0x08	/* 0.92V */
#define CSR_VAL_ECO2_FF_1500M		0x08	/* 0.92V */
...
#define CSR_VAL_NRML_FF_1500M		0x0D	/* 0.97V */
...
#define CSR_VAL_TURBO1_TS_1500M		0x30	/* 1.32V */
