...
void chal_aci_auxmic_init(CHAL_HANDLE handle, uint32_t aci_base, uint32_t auxmic_base)
{
    ChalAudioCtrlBlk_t  *pCHALCb = (ChalAudioCtrlBlk_t*)handle;
...
void chal_audio_set_aci_auxmic_datab( CHAL_HANDLE handle, _Bool micOutEnable )
{
    uint32_t regVal;
    ChalAudioCtrlBlk_t  *pCHALCb = (ChalAudioCtrlBlk_t*)handle;
    ...
    CHAL_REG_WRITE32((pCHALCb->aci_base+ACI_ACI_CTRL_OFFSET), regVal);
}
/*
 * ============================================================================
 * 
