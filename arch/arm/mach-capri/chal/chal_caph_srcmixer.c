			...
			CAPH_SRCMixer_OUTPUT_e mixerOutput)
{
	...
	case CAPH_SRCM_PASSCH3_M: chnl = CAPH_SRCM_PASSCH1_L; break;
	case CAPH_SRCM_PASSCH4_M: chnl = CAPH_SRCM_PASSCH2_L; break;
	default: break;
	}
