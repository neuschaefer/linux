...
static struct ref_clk CLK_NAME(ref_208m) = {
 ...
 .ccu_clk = &CLK_NAME(root),
 .clk_gate_offset  = ROOT_CLK_MGR_REG_REF_208M_CLKGATE_OFFSET,
 .clk_en_mask = ROOT_CLK_MGR_REG_REF_208M_CLKGATE_REF_208M_CLK_EN_MASK,
 .gating_sel_mask = ROOT_CLK_MGR_REG_REF_208M_CLKGATE_REF_208M_HW_SW_GATING_SEL_MASK,
 .hyst_val_mask = ROOT_CLK_MGR_REG_REF_208M_CLKGATE_REF_208M_HYST_VAL_MASK,
 .hyst_en_mask = ROOT_CLK_MGR_REG_REF_208M_CLKGATE_REF_208M_HYST_EN_MASK,
 .stprsts_mask = ROOT_CLK_MGR_REG_REF_208M_CLKGATE_REF_208M_STPRSTS_MASK,
};
...
static struct ref_clk CLK_NAME(ref_26m) = {
 ...
 .ccu_clk = &CLK_NAME(root),
 .clk_gate_offset  = ROOT_CLK_MGR_REG_REF_26M_CLKGATE_OFFSET,
 .clk_en_mask = ROOT_CLK_MGR_REG_REF_26M_CLKGATE_REF_26M_CLK_EN_MASK,
 .gating_sel_mask = ROOT_CLK_MGR_REG_REF_26M_CLKGATE_REF_26M_HW_SW_GATING_SEL_MASK,
 .hyst_val_mask = ROOT_CLK_MGR_REG_REF_26M_CLKGATE_REF_26M_HYST_VAL_MASK,
 .hyst_en_mask = ROOT_CLK_MGR_REG_REF_26M_CLKGATE_REF_26M_HYST_EN_MASK,
 .stprsts_mask = ROOT_CLK_MGR_REG_REF_26M_CLKGATE_REF_26M_STPRSTS_MASK,
...
static struct ref_clk CLK_NAME(var_208m) = {
 ...
 .ccu_clk = &CLK_NAME(root),
 .clk_gate_offset  = ROOT_CLK_MGR_REG_VAR_208M_CLKGATE_OFFSET,
 .clk_en_mask = ROOT_CLK_MGR_REG_VAR_208M_CLKGATE_VAR_208M_CLK_EN_MASK,
 .gating_sel_mask = ROOT_CLK_MGR_REG_VAR_208M_CLKGATE_VAR_208M_HW_SW_GATING_SEL_MASK,
 .hyst_val_mask = ROOT_CLK_MGR_REG_VAR_208M_CLKGATE_VAR_208M_HYST_VAL_MASK,
 .hyst_en_mask = ROOT_CLK_MGR_REG_VAR_208M_CLKGATE_VAR_208M_HYST_EN_MASK,
 .stprsts_mask = ROOT_CLK_MGR_REG_VAR_208M_CLKGATE_VAR_208M_STPRSTS_MASK,
};
...
#endif
	.freq_volt = DEFINE_ARRAY_ARGS(PROC_VLT_ID_ECO, PROC_VLT_ID_ECO, PROC_VLT_ID_ECO, PROC_VLT_ID_ECO,\
...
static struct bus_clk CLK_NAME(ssp5_apb) = {
 ...
 .clk =	{
				.flags = SSP5_APB_BUS_CLK_FLAGS,
				.clk_type = CLK_TYPE_BUS,
				.id	= CLK_SSP5_APB_BUS_CLK_ID,
				.name = SSP5_APB_BUS_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(audioh_26m),NULL),
				.ops = &gen_bus_clk_ops,
		},
 .ccu_clk = &CLK_NAME(khub),
 .clk_gate_offset  = KHUB_CLK_MGR_REG_SSP5_CLKGATE_OFFSET,
 .clk_en_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_APB_CLK_EN_MASK,
 .gating_sel_mask =KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_APB_HW_SW_GATING_SEL_MASK,
 .hyst_val_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_APB_HYST_VAL_MASK,
 .hyst_en_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_APB_HYST_EN_MASK,
 .stprsts_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_APB_STPRSTS_MASK,
 .freq_tbl_index = -1,
 .src_clk = CLK_PTR(audioh_26m),
};
...
static struct bus_clk CLK_NAME(ssp6_apb) = {
 ...
 .clk =	{
				.flags = SSP6_APB_BUS_CLK_FLAGS,
				.clk_type = CLK_TYPE_BUS,
				.id	= CLK_SSP6_APB_BUS_CLK_ID,
				.name = SSP6_APB_BUS_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(audioh_26m),NULL),
				.ops = &gen_bus_clk_ops,
		},
 .ccu_clk = &CLK_NAME(khub),
 .clk_gate_offset  = KHUB_CLK_MGR_REG_SSP6_CLKGATE_OFFSET,
 .clk_en_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_APB_CLK_EN_MASK,
 .gating_sel_mask =KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_APB_HW_SW_GATING_SEL_MASK,
 .hyst_val_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_APB_HYST_VAL_MASK,
 .hyst_en_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_APB_HYST_EN_MASK,
 .stprsts_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_APB_STPRSTS_MASK,
 .freq_tbl_index = -1,
 .src_clk = CLK_PTR(audioh_26m),
};
...
*/
/*peri clk src list*/
static struct clk* ssp5_audio_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(ref_312m),CLK_PTR(ref_cx40));
static struct peri_clk CLK_NAME(ssp5_audio) = {

	.clk =	{
				.flags = SSP5_AUDIO_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_SSP5_AUDIO_PERI_CLK_ID,
				.name = SSP5_AUDIO_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(ssp5_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(khub),
	.mask_set = 2,
	.policy_bit_mask = KHUB_CLK_MGR_REG_POLICY0_MASK1_SSP5_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KHUB_CLK_MGR_REG_SSP5_CLKGATE_OFFSET,
	.clk_en_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_AUDIO_CLK_EN_MASK,
	.gating_sel_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_AUDIO_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_AUDIO_HYST_VAL_MASK,
	.hyst_en_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_AUDIO_HYST_EN_MASK,
	.stprsts_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_AUDIO_STPRSTS_MASK,
	.volt_lvl_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_OFFSET,
					.div_mask = KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_SSP5_AUDIO_DIV_MASK,
					.div_shift = KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_SSP5_AUDIO_DIV_SHIFT,
					.pre_div_offset = KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_OFFSET,
					.pre_div_mask= KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_SSP5_AUDIO_PRE_DIV_MASK,
					.pre_div_shift= KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_SSP5_AUDIO_PRE_DIV_SHIFT,
					.div_trig_offset= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_OFFSET,
//					.div_trig_mask= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_SSP5_AUDIO_TRIGGER_MASK, // not in Capri per Item 18
					.prediv_trig_offset= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_OFFSET,
					.prediv_trig_mask= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_SSP5_AUDIO_PRE_TRIGGER_MASK,
					.pll_select_offset= KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_OFFSET,
					.pll_select_mask= KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_SSP5_AUDIO_PRE_PLL_SELECT_MASK,
					.pll_select_shift= KHUB_CLK_MGR_REG_SSP5_AUDIO_DIV_SSP5_AUDIO_PRE_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 3,
					.src_inx = 0,
					.clk = ssp5_audio_peri_clk_src_list,
				},
};
...
*/
/*peri clk src list*/
static struct clk* ssp6_audio_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(ref_312m),CLK_PTR(ref_cx40));
static struct peri_clk CLK_NAME(ssp6_audio) = {

	.clk =	{
				.flags = SSP6_AUDIO_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_SSP6_AUDIO_PERI_CLK_ID,
				.name = SSP6_AUDIO_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(ssp6_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(khub),
	.mask_set = 2,
	.policy_bit_mask = KHUB_CLK_MGR_REG_POLICY0_MASK1_SSP6_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KHUB_CLK_MGR_REG_SSP6_CLKGATE_OFFSET,
	.clk_en_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_AUDIO_CLK_EN_MASK,
	.gating_sel_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_AUDIO_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_AUDIO_HYST_VAL_MASK,
	.hyst_en_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_AUDIO_HYST_EN_MASK,
	.stprsts_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_AUDIO_STPRSTS_MASK,
	.volt_lvl_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_OFFSET,
					.div_mask = KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_SSP6_AUDIO_DIV_MASK,
					.div_shift = KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_SSP6_AUDIO_DIV_SHIFT,
					.pre_div_offset = KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_OFFSET,
					.pre_div_mask= KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_SSP6_AUDIO_PRE_DIV_MASK,
					.pre_div_shift= KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_SSP6_AUDIO_PRE_DIV_SHIFT,
					.div_trig_offset= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_OFFSET,
//					.div_trig_mask= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_SSP6_AUDIO_TRIGGER_MASK, // not in Capri per Item 18
					.prediv_trig_offset= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_OFFSET,
					.prediv_trig_mask= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_SSP6_AUDIO_PRE_TRIGGER_MASK,
					.pll_select_offset= KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_OFFSET,
					.pll_select_mask= KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_SSP6_AUDIO_PRE_PLL_SELECT_MASK,
					.pll_select_shift= KHUB_CLK_MGR_REG_SSP6_AUDIO_DIV_SSP6_AUDIO_PRE_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 3,
					.src_inx = 2,
					.clk = ssp6_audio_peri_clk_src_list,
				},
};
...
*/
/*peri clk src list*/
static struct clk* ssp5_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(var_312m),CLK_PTR(ref_312m),CLK_PTR(ref_96m),CLK_PTR(var_96m));
static struct peri_clk CLK_NAME(ssp5) = {

	.clk =	{
				.flags = SSP5_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_SSP5_PERI_CLK_ID,
				.name = SSP5_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(ssp5_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(khub),
	...
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KHUB_CLK_MGR_REG_SSP5_CLKGATE_OFFSET,
	.clk_en_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_CLK_EN_MASK,
	.gating_sel_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_HYST_VAL_MASK,
	.hyst_en_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_HYST_EN_MASK,
	.stprsts_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_STPRSTS_MASK,
	.volt_lvl_mask = KHUB_CLK_MGR_REG_SSP5_CLKGATE_SSP5_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KHUB_CLK_MGR_REG_SSP5_DIV_OFFSET,
					.div_mask = KHUB_CLK_MGR_REG_SSP5_DIV_SSP5_DIV_MASK,
					.div_shift = KHUB_CLK_MGR_REG_SSP5_DIV_SSP5_DIV_SHIFT,
					.pre_div_offset = KHUB_CLK_MGR_REG_SSP5_DIV_OFFSET,
					.pre_div_mask= KHUB_CLK_MGR_REG_SSP5_DIV_SSP5_PRE_DIV_MASK,
					.pre_div_shift= KHUB_CLK_MGR_REG_SSP5_DIV_SSP5_PRE_DIV_SHIFT,
					.prediv_trig_offset= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_OFFSET,
					.prediv_trig_mask= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_SSP5_PRE_TRIGGER_MASK,
					.pll_select_offset= KHUB_CLK_MGR_REG_SSP5_DIV_OFFSET,
					.pll_select_mask= KHUB_CLK_MGR_REG_SSP5_DIV_SSP5_PRE_PLL_SELECT_MASK,
					.pll_select_shift= KHUB_CLK_MGR_REG_SSP5_DIV_SSP5_PRE_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 5,
					.src_inx = 0,
					.clk = ssp5_peri_clk_src_list,
				},
    .soft_reset_offset	= KHUB_RST_MGR_REG_SOFT_RSTN1_OFFSET,
    .clk_reset_mask		= KHUB_RST_MGR_REG_SOFT_RSTN1_SSP5_SOFT_RSTN_MASK,
};
...
*/
/*peri clk src list*/
static struct clk* ssp6_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(var_312m),CLK_PTR(ref_312m),CLK_PTR(ref_96m),CLK_PTR(var_96m));
static struct peri_clk CLK_NAME(ssp6) = {

	.clk =	{
				.flags = SSP6_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_SSP6_PERI_CLK_ID,
				.name = SSP6_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(ssp6_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(khub),
	...
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KHUB_CLK_MGR_REG_SSP6_CLKGATE_OFFSET,
	.clk_en_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_CLK_EN_MASK,
	.gating_sel_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_HYST_VAL_MASK,
	.hyst_en_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_HYST_EN_MASK,
	.stprsts_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_STPRSTS_MASK,
	.volt_lvl_mask = KHUB_CLK_MGR_REG_SSP6_CLKGATE_SSP6_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KHUB_CLK_MGR_REG_SSP6_DIV_OFFSET,
					.div_mask = KHUB_CLK_MGR_REG_SSP6_DIV_SSP6_DIV_MASK,
					.div_shift = KHUB_CLK_MGR_REG_SSP6_DIV_SSP6_DIV_SHIFT,
					.pre_div_offset = KHUB_CLK_MGR_REG_SSP6_DIV_OFFSET,
					.pre_div_mask= KHUB_CLK_MGR_REG_SSP6_DIV_SSP6_PRE_DIV_MASK,
					.pre_div_shift= KHUB_CLK_MGR_REG_SSP6_DIV_SSP6_PRE_DIV_SHIFT,
					.prediv_trig_offset= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_OFFSET,
					.prediv_trig_mask= KHUB_CLK_MGR_REG_PERIPH_SEG_TRG_SSP6_PRE_TRIGGER_MASK,
					.pll_select_offset= KHUB_CLK_MGR_REG_SSP6_DIV_OFFSET,
					.pll_select_mask= KHUB_CLK_MGR_REG_SSP6_DIV_SSP6_PRE_PLL_SELECT_MASK,
					.pll_select_shift= KHUB_CLK_MGR_REG_SSP6_DIV_SSP6_PRE_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 5,
					.src_inx = 0,
					.clk = ssp6_peri_clk_src_list,
				},
    .soft_reset_offset	= KHUB_RST_MGR_REG_SOFT_RSTN1_OFFSET,
    .clk_reset_mask		= KHUB_RST_MGR_REG_SOFT_RSTN1_SSP6_SOFT_RSTN_MASK,
};
...
*/
/*peri clk src list*/
static struct clk* pscs_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(var_312m));
static struct peri_clk CLK_NAME(pscs) = {

	.clk =	{
				.flags = PSCS_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_PSCS_PERI_CLK_ID,
				.name = PSCS_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(khubaon),
	...
	.policy_bit_mask = KHUBAON_CLK_MGR_REG_POLICY0_MASK1_SIM_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_OFFSET,
	.clk_en_mask = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_PSCS_CLK_EN_MASK,
	.gating_sel_mask = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_PSCS_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_PSCS_HYST_VAL_MASK,
	.hyst_en_mask = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_PSCS_HYST_EN_MASK,
	.stprsts_mask = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_PSCS_STPRSTS_MASK,
	.volt_lvl_mask = KHUBAON_CLK_MGR_REG_PSCS_CLKGATE_PSCS_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KHUBAON_CLK_MGR_REG_PSCS_DIV_OFFSET,
					.div_mask = KHUBAON_CLK_MGR_REG_PSCS_DIV_PSCS_DIV_MASK,
					.div_shift = KHUBAON_CLK_MGR_REG_PSCS_DIV_PSCS_DIV_SHIFT,
					.pll_select_offset= KHUBAON_CLK_MGR_REG_PSCS_DIV_OFFSET,
					.pll_select_mask= KHUBAON_CLK_MGR_REG_PSCS_DIV_PSCS_PLL_SELECT_MASK,
					.pll_select_shift= KHUBAON_CLK_MGR_REG_PSCS_DIV_PSCS_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 2,
					.src_inx = 1,
					.clk = pscs_peri_clk_src_list,
				},
	.soft_reset_offset	= KHUBAON_RST_MGR_REG_SOFT_RSTN0_OFFSET,
	.clk_reset_mask		= KHUBAON_RST_MGR_REG_SOFT_RSTN0_PSCS_SOFT_RSTN_MASK,
};
...
static struct bus_clk CLK_NAME(nand_ahb) = {
 ...
 .src_clk = NULL,
 .soft_reset_offset	= KPM_RST_MGR_REG_AHB_MST_SOFTRST_OFFSET,
 .clk_reset_mask	= KPM_RST_MGR_REG_AHB_MST_SOFTRST_NAND_SOFT_RSTN_MASK,
};
...
static struct bus_clk CLK_NAME(usbh_ahb) = {
    ...
    .ccu_clk = &CLK_NAME(kpm),
	.clk_gate_offset  = KPM_CLK_MGR_REG_USBH2_CLKGATE_OFFSET,
	.clk_en_mask = KPM_CLK_MGR_REG_USBH2_CLKGATE_USBH2_AHB_CLK_EN_MASK,
	.gating_sel_mask =
		KPM_CLK_MGR_REG_USBH2_CLKGATE_USBH2_AHB_HW_SW_GATING_SEL_MASK,
	.stprsts_mask = KPM_CLK_MGR_REG_USBH2_CLKGATE_USBH2_AHB_STPRSTS_MASK,
	.freq_tbl_index = -1,
	.src_clk = CLK_PTR(master_switch_ahb),
};
...
static struct bus_clk CLK_NAME(usbhsic_ahb) = {
	...
	.clk_type = CLK_TYPE_BUS,
	.id	= CLK_USBH_AHB_BUS_CLK_ID,
	.name = USBHSIC_AHB_BUS_CLK_NAME_STR,
	.dep_clks = DEFINE_ARRAY_ARGS(NULL),
	.ops = &gen_bus_clk_ops,
	},
	.ccu_clk = &CLK_NAME(kpm),
    .clk_gate_offset  = KPM_CLK_MGR_REG_HSIC2_CLKGATE_OFFSET,
    .clk_en_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_AHB_CLK_EN_MASK,
    .gating_sel_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_AHB_HW_SW_GATING_SEL_MASK,
    .stprsts_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_AHB_STPRSTS_MASK,
    .freq_tbl_index = -1,
    .src_clk = CLK_PTR(master_switch_ahb),
};
...
*/
/*peri clk src list*/
static struct clk* nand_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(var_312m),CLK_PTR(var_208m));
...
static struct peri_clk CLK_NAME(usbh_48m) = {
    ...
    .ccu_clk = &CLK_NAME(kpm),
    .mask_set = 0,
    .policy_bit_mask = KPM_CLK_MGR_REG_POLICY0_MASK_HSIC2_POLICY0_MASK_MASK,
    .policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
    .clk_gate_offset = KPM_CLK_MGR_REG_HSIC2_CLKGATE_OFFSET,
    .clk_en_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_48M_CLK_EN_MASK,
    .gating_sel_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_48M_HW_SW_GATING_SEL_MASK,
    .hyst_val_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_48M_HYST_VAL_MASK,
    .hyst_en_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_48M_HYST_EN_MASK,
    .stprsts_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_48M_STPRSTS_MASK,
    .volt_lvl_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_VOLTAGE_LEVEL_MASK,
    .clk_div = {
	.div_trig_offset= KPM_CLK_MGR_REG_DIV_TRIG_OFFSET,
	.div_trig_mask= KPM_CLK_MGR_REG_DIV_TRIG_HSIC2_48M_TRIGGER_MASK,
	.pll_select_offset= KPM_CLK_MGR_REG_HSIC2_DIV_OFFSET,
	.pll_select_mask= KPM_CLK_MGR_REG_HSIC2_DIV_HSIC2_48M_PLL_SELECT_MASK,
	.pll_select_shift= KPM_CLK_MGR_REG_HSIC2_DIV_HSIC2_48M_PLL_SELECT_SHIFT,
    },
    .src_clk = {
	.count = 3,
	.src_inx = 2,
    ...
    .soft_reset_offset	= KPM_RST_MGR_REG_AHB_MST_SOFTRST_OFFSET,
    .clk_reset_mask	= KPM_RST_MGR_REG_AHB_MST_SOFTRST_HSIC2_SOFT_RSTN_MASK,
};
...
static struct peri_clk CLK_NAME(usbh_12m) = {
    ...
    .policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
    .clk_gate_offset = KPM_CLK_MGR_REG_HSIC2_CLKGATE_OFFSET,
    .clk_en_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_12M_CLK_EN_MASK,
    .gating_sel_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_12M_HW_SW_GATING_SEL_MASK,
    .hyst_val_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_12M_HYST_VAL_MASK,
    .hyst_en_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_12M_HYST_EN_MASK,
    .stprsts_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_12M_STPRSTS_MASK,
    .volt_lvl_mask = KPM_CLK_MGR_REG_HSIC2_CLKGATE_HSIC2_VOLTAGE_LEVEL_MASK,
    .clk_div = {
	.div_trig_offset= KPM_CLK_MGR_REG_DIV_TRIG_OFFSET,
	.div_trig_mask= KPM_CLK_MGR_REG_DIV_TRIG_HSIC2_48M_TRIGGER_MASK,
...
//	.pi_id = -1,
	...
	.policy_mask2_offset = KPS_CLK_MGR_REG_POLICY0_MASK2_OFFSET,
...
static struct bus_clk CLK_NAME(uartb4_apb) = {
 ...
 .ccu_clk = &CLK_NAME(kps),
 .clk_gate_offset  = KPS_CLK_MGR_REG_UARTB4_CLKGATE_OFFSET,
 .clk_en_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_APB_CLK_EN_MASK,
 .gating_sel_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_APB_HW_SW_GATING_SEL_MASK,
 .stprsts_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_APB_STPRSTS_MASK,
 .freq_tbl_index = 1,
 .src_clk = NULL,
};
...
static struct bus_clk CLK_NAME(bsc3_apb) = {
 ...
 .gating_sel_mask = KPS_CLK_MGR_REG_BSC3_CLKGATE_BSC3_APB_HW_SW_GATING_SEL_MASK,
...
/*
Bus clock name CIR_APB
*/
static struct bus_clk CLK_NAME(cir_apb) = {

 .clk =	{
				.flags = CIR_APB_BUS_CLK_FLAGS,
				.clk_type = CLK_TYPE_BUS,
				.id	= CLK_CIR_APB_BUS_CLK_ID,
				.name = CIR_APB_BUS_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(NULL),
				.ops = &gen_bus_clk_ops,
		},
 .ccu_clk = &CLK_NAME(kps),
 .clk_gate_offset  = KPS_CLK_MGR_REG_CIR_CLKGATE_OFFSET,
 .clk_en_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_APB_CLK_EN_MASK,
 .gating_sel_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_APB_HW_SW_GATING_SEL_MASK,
 .stprsts_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_APB_STPRSTS_MASK,
 .freq_tbl_index = 2,
 .src_clk = NULL,
};
...
static struct bus_clk CLK_NAME(ssp2_apb) = {
 ...
 .clk =	{
				.flags = SSP2_APB_BUS_CLK_FLAGS,
				.clk_type = CLK_TYPE_BUS,
				.id	= CLK_SSP2_APB_BUS_CLK_ID,
				.name = SSP2_APB_BUS_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(NULL),
				.ops = &gen_bus_clk_ops,
		},
 .ccu_clk = &CLK_NAME(kps),
 .clk_gate_offset  = KPS_CLK_MGR_REG_SSP2_CLKGATE_OFFSET,
 .clk_en_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_APB_CLK_EN_MASK,
 .gating_sel_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_APB_HW_SW_GATING_SEL_MASK,
 .stprsts_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_APB_STPRSTS_MASK,
 .freq_tbl_index = 1,
 .src_clk = NULL,
};
...
static struct peri_clk CLK_NAME(uartb4) = {
	...
	.ccu_clk = &CLK_NAME(kps),
	.mask_set = 0,
	.policy_bit_mask = KPS_CLK_MGR_REG_POLICY0_MASK_UARTB4_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KPS_CLK_MGR_REG_UARTB4_CLKGATE_OFFSET,
	.clk_en_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_CLK_EN_MASK,
	.gating_sel_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_HW_SW_GATING_SEL_MASK,
	.stprsts_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_STPRSTS_MASK,
	.volt_lvl_mask = KPS_CLK_MGR_REG_UARTB4_CLKGATE_UARTB4_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KPS_CLK_MGR_REG_UARTB4_DIV_OFFSET,
					.div_mask = KPS_CLK_MGR_REG_UARTB4_DIV_UARTB4_DIV_MASK,
					.div_shift = KPS_CLK_MGR_REG_UARTB4_DIV_UARTB4_DIV_SHIFT,
					.div_trig_offset= KPS_CLK_MGR_REG_DIV_TRIG_OFFSET,
					.div_trig_mask= KPS_CLK_MGR_REG_DIV_TRIG_UARTB4_TRIGGER_MASK,
					.diether_bits= 8,
					.pll_select_offset= KPS_CLK_MGR_REG_UARTB4_DIV_OFFSET,
					.pll_select_mask= KPS_CLK_MGR_REG_UARTB4_DIV_UARTB4_PLL_SELECT_MASK,
					.pll_select_shift= KPS_CLK_MGR_REG_UARTB4_DIV_UARTB4_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 3,
					.src_inx = 1,
...
static struct peri_clk CLK_NAME(ssp0_audio) = {
	...
	.clk_div = {
					.div_offset = KPS_CLK_MGR_REG_SSP0_AUDIO_DIV_OFFSET,
					.div_mask = KPS_CLK_MGR_REG_SSP0_AUDIO_DIV_SSP0_AUDIO_DIV_MASK,
					.div_shift = KPS_CLK_MGR_REG_SSP0_AUDIO_DIV_SSP0_AUDIO_DIV_SHIFT,
					.div_trig_offset= KPS_CLK_MGR_REG_DIV_TRIG_OFFSET,
//					.div_trig_mask= KPS_CLK_MGR_REG_DIV_TRIG_SSP0_AUDIO_TRIGGER_MASK,   //not in Capri
					...
					.pll_select_offset= KPS_CLK_MGR_REG_SSP0_AUDIO_DIV_OFFSET,
					.pll_select_mask= KPS_CLK_MGR_REG_SSP0_AUDIO_DIV_SSP0_AUDIO_PRE_PLL_SELECT_MASK,
					.pll_select_shift= KPS_CLK_MGR_REG_SSP0_AUDIO_DIV_SSP0_AUDIO_PRE_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 3,
					.src_inx = 2,
...
*/
/*peri clk src list*/
static struct clk* ssp2_audio_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(ref_312m),CLK_PTR(ref_cx40));
static struct peri_clk CLK_NAME(ssp2_audio) = {

	.clk =	{
				.flags = SSP2_AUDIO_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_SSP2_AUDIO_PERI_CLK_ID,
				.name = SSP2_AUDIO_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(ssp2_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(kps),
	.mask_set = 0,
	.policy_bit_mask = KPS_CLK_MGR_REG_POLICY0_MASK_SSP2_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KPS_CLK_MGR_REG_SSP2_CLKGATE_OFFSET,
	.clk_en_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_AUDIO_CLK_EN_MASK,
	.gating_sel_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_AUDIO_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_AUDIO_HYST_VAL_MASK,
	.hyst_en_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_AUDIO_HYST_EN_MASK,
	.stprsts_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_AUDIO_STPRSTS_MASK,
	.volt_lvl_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KPS_CLK_MGR_REG_SSP2_DIV_OFFSET,
					.div_mask = KPS_CLK_MGR_REG_SSP2_DIV_SSP2_DIV_MASK,
					.div_shift = KPS_CLK_MGR_REG_SSP2_DIV_SSP2_DIV_SHIFT,
					.div_trig_offset= KPS_CLK_MGR_REG_DIV_TRIG_OFFSET,
//					.div_trig_mask= KPS_CLK_MGR_REG_DIV_TRIG_SSP2_AUDIO_TRIGGER_MASK,   //not in Capri
					.prediv_trig_offset= KPS_CLK_MGR_REG_DIV_TRIG_OFFSET,
					.prediv_trig_mask= KPS_CLK_MGR_REG_DIV_TRIG_SSP2_AUDIO_PRE_TRIGGER_MASK,
					.pll_select_offset= KPS_CLK_MGR_REG_SSP2_DIV_OFFSET,
					.pll_select_mask= KPS_CLK_MGR_REG_SSP2_DIV_SSP2_PLL_SELECT_MASK,
					.pll_select_shift= KPS_CLK_MGR_REG_SSP2_DIV_SSP2_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 3,
					.src_inx = 0,
					.clk = ssp2_audio_peri_clk_src_list,
				},
};
...
*/
/*peri clk src list*/
static struct clk* bsc3_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(var_104m),CLK_PTR(ref_104m),CLK_PTR(var_13m),CLK_PTR(ref_13m));
static struct peri_clk CLK_NAME(bsc3) = {
	...
	.ccu_clk = &CLK_NAME(kps),
	.mask_set = 2,
	.policy_bit_mask = KPS_CLK_MGR_REG_POLICY0_MASK2_BSC3_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KPS_CLK_MGR_REG_BSC3_CLKGATE_OFFSET,
	.clk_en_mask = KPS_CLK_MGR_REG_BSC3_CLKGATE_BSC3_CLK_EN_MASK,
	.gating_sel_mask = KPS_CLK_MGR_REG_BSC3_CLKGATE_BSC3_HW_SW_GATING_SEL_MASK,
	...
	.clk_div = {
					...
					.div_trig_offset= KPS_CLK_MGR_REG_DIV_TRIG2_OFFSET,
					.div_trig_mask= KPS_CLK_MGR_REG_DIV_TRIG2_BSC3_TRIGGER_MASK,
					.pll_select_offset= KPS_CLK_MGR_REG_BSC3_DIV_OFFSET,
					.pll_select_mask= KPS_CLK_MGR_REG_BSC3_DIV_BSC3_PLL_SELECT_MASK,
					.pll_select_shift= KPS_CLK_MGR_REG_BSC3_DIV_BSC3_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 5,
					.src_inx = 3,
...
/*
Peri clock name CIR
There is no peripheral clock for CIR. The peripheral uses the bus clock
for operations. The structure is made to look like there is a peripheral
clock. But it really enables the bus clock at the peripheral and bus
clock structures.
*/
/*peri clk src list*/
static struct peri_clk CLK_NAME(cir) = {

	.clk =	{
				.flags = CIR_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_CIR_PERI_CLK_ID,
				.name = CIR_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(cir_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(kps),
	.mask_set = 2,
	.policy_bit_mask = KPS_CLK_MGR_REG_POLICY0_MASK2_CIR_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KPS_CLK_MGR_REG_CIR_CLKGATE_OFFSET,
	.clk_en_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_APB_CLK_EN_MASK,
	.gating_sel_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_APB_HW_SW_GATING_SEL_MASK,
	.stprsts_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_APB_STPRSTS_MASK,
	.volt_lvl_mask = KPS_CLK_MGR_REG_CIR_CLKGATE_CIR_VOLTAGE_LEVEL_MASK,
	.soft_reset_offset	= KPS_RST_MGR_REG_APB1_SOFTRST_OFFSET,
	.clk_reset_mask		= KPS_RST_MGR_REG_APB1_SOFTRST_CIR_SOFT_RSTN_MASK,
};
...
static struct clk* ssp2_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(crystal),CLK_PTR(var_104m),CLK_PTR(ref_104m),CLK_PTR(var_96m),CLK_PTR(ref_96m));
static struct peri_clk CLK_NAME(ssp2) = {

	.clk =	{
				.flags = SSP2_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_SSP2_PERI_CLK_ID,
				.name = SSP2_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(CLK_PTR(ssp2_apb),NULL),
				.ops = &gen_peri_clk_ops,
		},
	.ccu_clk = &CLK_NAME(kps),
	...
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = KPS_CLK_MGR_REG_SSP2_CLKGATE_OFFSET,
	.clk_en_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_CLK_EN_MASK,
	.gating_sel_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_HW_SW_GATING_SEL_MASK,
	.stprsts_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_STPRSTS_MASK,
	.volt_lvl_mask = KPS_CLK_MGR_REG_SSP2_CLKGATE_SSP2_VOLTAGE_LEVEL_MASK,
	.clk_div = {
					.div_offset = KPS_CLK_MGR_REG_SSP2_DIV_OFFSET,
					.div_mask = KPS_CLK_MGR_REG_SSP2_DIV_SSP2_DIV_MASK,
					.div_shift = KPS_CLK_MGR_REG_SSP2_DIV_SSP2_DIV_SHIFT,
					.div_trig_offset= KPS_CLK_MGR_REG_DIV_TRIG_OFFSET,
					.div_trig_mask= KPS_CLK_MGR_REG_DIV_TRIG_SSP2_TRIGGER_MASK,
					.pll_select_offset= KPS_CLK_MGR_REG_SSP2_DIV_OFFSET,
					.pll_select_mask= KPS_CLK_MGR_REG_SSP2_DIV_SSP2_PLL_SELECT_MASK,
					.pll_select_shift= KPS_CLK_MGR_REG_SSP2_DIV_SSP2_PLL_SELECT_SHIFT,
				},
	.src_clk = {
					.count = 5,
					.src_inx = 0,
					.clk = ssp2_peri_clk_src_list,
				},
	.soft_reset_offset	= KPS_RST_MGR_REG_APB1_SOFTRST_OFFSET,
	.clk_reset_mask		= KPS_RST_MGR_REG_APB1_SOFTRST_SSP2_SOFT_RSTN_MASK,
};
/*
...
static struct peri_clk CLK_NAME(spum_open) = {
    ...
    .soft_reset_offset	= KPS_RST_MGR_REG_APB7_SOFTRST_OFFSET,
    .clk_reset_mask	= KPS_RST_MGR_REG_APB7_SOFTRST_SPUM_OPEN_SOFT_RSTN_MASK,
};
#ifdef CONFIG_KONA_PI_MGR
...
static struct peri_clk CLK_NAME(spum_sec) = {
    ...
    .soft_reset_offset	= KPS_RST_MGR_REG_APB7_SOFTRST_OFFSET,
    .clk_reset_mask	= KPS_RST_MGR_REG_APB7_SOFTRST_SPUM_SEC_SOFT_RSTN_MASK,
};
...
static struct ccu_clk CLK_NAME(esub) = {
	...
	.freq_tbl = DEFINE_ARRAY_ARGS(esub_clk_freq_list0,esub_clk_freq_list1,esub_clk_freq_list2,esub_clk_freq_list3,esub_clk_freq_list4,esub_clk_freq_list5,esub_clk_freq_list6,esub_clk_freq_list7),
	.ccu_reset_mgr_base = HW_IO_PHYS_TO_VIRT(ESUB_RST_BASE_ADDR),
...
static struct pll_clk CLK_NAME(esub_pll) = {
	...
	.pll_ctrl_offset = ESUB_CLK_MGR_REG_PLLE_PWRDN_OFFSET,
    .idle_pwrdwn_sw_ovrride_mask = 0,               // no such bit in Capri
    .soft_post_resetb_offset = ESUB_CLK_MGR_REG_PLLE_POST_RESETB_OFFSET, 
	.soft_post_resetb_mask = ESUB_CLK_MGR_REG_PLLE_POST_RESETB_I_POST_RESETB_PLLE_MASK,
    .soft_resetb_offset = ESUB_CLK_MGR_REG_PLLE_RESETB_OFFSET,
	.soft_resetb_mask = ESUB_CLK_MGR_REG_PLLE_RESETB_I_PLL_RESETB_PLLE_MASK,
    .pwrdwn_offset = ESUB_CLK_MGR_REG_PLLE_PWRDN_OFFSET,
	.pwrdwn_mask = ESUB_CLK_MGR_REG_PLLE_PWRDN_I_PLL_PWRDWN_PLLE_MASK,
    .ndiv_pdiv_offset = ESUB_CLK_MGR_REG_PLLE_NDIV_PDIV_OFFSET,
	.ndiv_int_mask = ESUB_CLK_MGR_REG_PLLE_NDIV_PDIV_I_NDIV_INT_PLLE_MASK,
	.ndiv_int_shift = ESUB_CLK_MGR_REG_PLLE_NDIV_PDIV_I_NDIV_INT_PLLE_SHIFT,
	.ndiv_int_max = 512,
	.pdiv_mask = ESUB_CLK_MGR_REG_PLLE_NDIV_PDIV_I_PDIV_PLLE_MASK,
	.pdiv_shift = ESUB_CLK_MGR_REG_PLLE_NDIV_PDIV_I_PDIV_PLLE_SHIFT,
	.pdiv_max = 8,
    .pll_lock_offset = ESUB_CLK_MGR_REG_PLL_LOCK_OFFSET,
	.pll_lock = ESUB_CLK_MGR_REG_PLL_LOCK_PLL_LOCK_PLLE_MASK,
	.ndiv_frac_offset = ESUB_CLK_MGR_REG_PLLE_NDIV_FRAC_OFFSET,
	.ndiv_frac_mask = ESUB_CLK_MGR_REG_PLLE_NDIV_FRAC_I_NDIV_FRAC_PLLE_SHIFT,
	.ndiv_frac_shift = ESUB_CLK_MGR_REG_PLLE_NDIV_FRAC_I_NDIV_FRAC_PLLE_MASK,
...
static struct pll_chnl_clk CLK_NAME(esw_sys_ch0) = {
		...
		.clk =	{
				.flags = ESW_SYS_CH0_CLK_FLAGS,
				.id	   = CLK_ESW_SYS_CH0_CLK_ID,
				.name = ESW_SYS_CH0_CLK_NAME_STR,
				.clk_type = CLK_TYPE_PLL_CHNL,
				.ops = &gen_pll_chnl_clk_ops,
		},
		...
		.cfg_reg_offset = ESUB_CLK_MGR_REG_PLLE_MDIV_ESW_SYS_CH0_OFFSET,
		.mdiv_mask = ESUB_CLK_MGR_REG_PLLE_MDIV_ESW_SYS_CH0_I_CH0_MDIV_PLLE_MASK,
		.mdiv_shift = ESUB_CLK_MGR_REG_PLLE_MDIV_ESW_SYS_CH0_I_CH0_MDIV_PLLE_SHIFT,
		.mdiv_max = 256,
		.pll_enableb_offset = ESUB_CLK_MGR_REG_PLLE_ENABLEB_OFFSET,
		.out_en_mask = 1<<(0+ESUB_CLK_MGR_REG_PLLE_ENABLEB_I_ENABLEB_PLLE_SHIFT),
		.pll_load_ch_en_offset = ESUB_CLK_MGR_REG_PLLE_LOAD_CH_EN_OFFSET,
		.load_en_mask = 1<<(0+ESUB_CLK_MGR_REG_PLLE_LOAD_CH_EN_I_LOAD_EN_CH_PLLE_SHIFT),
		.pll_hold_ch_offset =  ESUB_CLK_MGR_REG_PLLE_CTRL0_OFFSET,
		.hold_en_mask = 1<<(0+ESUB_CLK_MGR_REG_PLLE_CTRL0_I_HOLD_CH_PLLE_SHIFT),
};
...
static struct pll_chnl_clk CLK_NAME(esw_sys_125m_ch1) = {
		...
		.cfg_reg_offset = ESUB_CLK_MGR_REG_PLLE_MDIV_ESW_SYS_125M_CH1_OFFSET,
		.mdiv_mask = ESUB_CLK_MGR_REG_PLLE_MDIV_ESW_SYS_125M_CH1_I_CH1_MDIV_PLLE_MASK,
		.mdiv_shift = ESUB_CLK_MGR_REG_PLLE_MDIV_ESW_SYS_125M_CH1_I_CH1_MDIV_PLLE_SHIFT,
		.mdiv_max = 256,
		.pll_enableb_offset = ESUB_CLK_MGR_REG_PLLE_ENABLEB_OFFSET,
		.out_en_mask = 1<<(1+ESUB_CLK_MGR_REG_PLLE_ENABLEB_I_ENABLEB_PLLE_SHIFT),
		.pll_load_ch_en_offset = ESUB_CLK_MGR_REG_PLLE_LOAD_CH_EN_OFFSET,
		.load_en_mask = 1<<(1+ESUB_CLK_MGR_REG_PLLE_LOAD_CH_EN_I_LOAD_EN_CH_PLLE_SHIFT),
		.pll_hold_ch_offset =  ESUB_CLK_MGR_REG_PLLE_CTRL0_OFFSET,
		.hold_en_mask = 1<<(1+ESUB_CLK_MGR_REG_PLLE_CTRL0_I_HOLD_CH_PLLE_SHIFT),
};
...
*/
/*peri clk src list*/
static struct clk* esw_sys_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(esw_sys_ch0), CLK_PTR(var_208m),CLK_PTR(crystal));
static struct peri_clk CLK_NAME(esw_sys) = {
    ...
    .clk_div = {
        .div_offset = ESUB_CLK_MGR_REG_ESW_SYS_DIV_OFFSET,
        .div_mask = ESUB_CLK_MGR_REG_ESW_SYS_DIV_ESW_SYS_DIV_MASK,
        .div_shift = ESUB_CLK_MGR_REG_ESW_SYS_DIV_ESW_SYS_DIV_SHIFT,
        .div_trig_offset= ESUB_CLK_MGR_REG_ESW_SYS_DIV_OFFSET,
        .div_trig_mask= ESUB_CLK_MGR_REG_ESW_SYS_DIV_ESW_SYS_TRIGGER_MASK,
        .pll_select_offset= ESUB_CLK_MGR_REG_ESW_SYS_DIV_OFFSET,
        .pll_select_mask= ESUB_CLK_MGR_REG_ESW_SYS_DIV_ESW_SYS_PLL_SELECT_MASK,
        .pll_select_shift= ESUB_CLK_MGR_REG_ESW_SYS_DIV_ESW_SYS_PLL_SELECT_SHIFT,
    },
	.src_clk = {
		.count = 3,
		.src_inx = 0,
    ...
    .soft_reset_offset	= ESUB_RST_MGR_REG_ESW_SYS_SOFT_RSTN_OFFSET,
    .clk_reset_mask	= ESUB_RST_MGR_REG_ESW_SYS_SOFT_RSTN_ESW_SYS_SOFT_RSTN_MASK,
};
...
*/
/*peri clk src list*/
static struct clk* esw_125m_clk_peri_clk_src_list[] = DEFINE_ARRAY_ARGS(CLK_PTR(esw_gpio_125m),CLK_PTR(esw_sys_125m_ch1));
static struct peri_clk CLK_NAME(esw_125m) = {

	.clk =	{
				.flags = ESW_125M_PERI_CLK_FLAGS,
				.clk_type = CLK_TYPE_PERI,
				.id	= CLK_ESW_125M_PERI_CLK_ID,
				.name = ESW_125M_PERI_CLK_NAME_STR,
				.dep_clks = DEFINE_ARRAY_ARGS(NULL),
				.rate = 0,
				.ops = &gen_peri_clk_ops,
		},
	...
	.policy_bit_mask = ESUB_CLK_MGR_REG_POLICY0_MASK_ESW_POLICY0_MASK_MASK,
	.policy_mask_init = DEFINE_ARRAY_ARGS(1,1,1,1),
	.clk_gate_offset = ESUB_CLK_MGR_REG_ESW_SYS_125M_CLKGATE_OFFSET,
	.clk_en_mask = ESUB_CLK_MGR_REG_ESW_SYS_125M_CLKGATE_ESW_SYS_125M_CLK_EN_MASK,
	.gating_sel_mask = ESUB_CLK_MGR_REG_ESW_SYS_125M_CLKGATE_ESW_SYS_125M_HW_SW_GATING_SEL_MASK,
	.hyst_val_mask = ESUB_CLK_MGR_REG_ESW_SYS_125M_CLKGATE_ESW_SYS_125M_HYST_VAL_MASK,
	.hyst_en_mask = ESUB_CLK_MGR_REG_ESW_SYS_125M_CLKGATE_ESW_SYS_125M_HYST_EN_MASK,
	.stprsts_mask = ESUB_CLK_MGR_REG_ESW_SYS_125M_CLKGATE_ESW_SYS_125M_STPRSTS_MASK,
	.src_clk = {
		.count = 2,
		.src_inx = 0,
		.clk = esw_125m_clk_peri_clk_src_list,
	},
};
#endif
...
static inline void __proc_clk_set_pll0_div(u32 base, u32 div)
{
...
static int ccu_clk_set_voltage(struct ccu_clk *ccu_clk, u32 volt_id, u8 voltage)
{
	...
	reg_val = (reg_val & ~(CCU_VLT_MASK << shift)) | ((voltage & CCU_VLT_MASK) << shift);

	clk_dbg("%s:%s ccu , reg_val = 0x%x reg_addr = 0x%x\n", __func__,
			ccu_clk->clk.name, reg_val, reg_addr);
...
static int kproc_ccu_set_freq_policy(struct ccu_clk *ccu_clk,
	   int policy_id, int target_freq_id, int target_opp_inx)
{
	u32 reg_val = 0;
	u32 shift;
	u32 a9_voltage[] = DEFINE_ARRAY_ARGS(PROC_VLT_ID_ECO, PROC_VLT_ID_ECO, PROC_VLT_ID_ECO, PROC_VLT_ID_ECO,\
						PROC_VLT_ID_ECO1, PROC_VLT_ID_NORMAL, PROC_VLT_ID_TURBO1, PROC_VLT_ID_TURBO);
	int ret = 0;
	...
	__func__, ccu_clk->clk.name, target_freq_id, policy_id, target_opp_inx);
	...
	if (cur_freq_id < kproc_fid6) {
		...
		case kproc_fid6:
			...
			if (target_opp_inx == PI_PROC_OPP_TURBO1) {
				...
				ccu_clk_set_voltage(ccu_clk, kproc_fid6,
						a9_voltage[6]);
				__proc_clk_set_pll0_div(
					ccu_clk->ccu_clk_mgr_base, 3);
				ccu_policy_engine_resume(ccu_clk,
					ccu_clk->clk.flags & CCU_TARGET_LOAD ?
					   CCU_LOAD_TARGET : CCU_LOAD_ACTIVE);
			} else {
		...
		case kproc_fid4:
			...
			clk_dbg("%s: FID == 4 target_freq_id = %d. cur_id = %d\n",
		...
		case kproc_fid3:
			clk_dbg("%s: FID == 3 target_freq_id = %d. cur_id = %d\n",
					__func__, target_freq_id, cur_freq_id);
			reg_val = readl(CCU_POLICY_FREQ_REG(ccu_clk));
			reg_val &= ~(CCU_FREQ_POLICY_MASK << shift);
			reg_val |= target_freq_id << shift;
...
static struct __init clk_lookup capri_clk_tbl[] =
{
	...
	BRCM_REGISTER_CLK(CIR_APB_BUS_CLK_NAME_STR,NULL,cir_apb),
	...
	BRCM_REGISTER_CLK(CIR_PERI_CLK_NAME_STR,NULL,cir),
...
//	BRCM_REGISTER_CLK(SPUM_SEC_PERI_CLK_NAME_STR,NULL,spum_sec),
    ...
    BRCM_REGISTER_CLK(ESW_SYS_125M_CH1_CLK_NAME_STR,NULL,esw_sys_125m_ch1),
...
/*		remove_dep_clks();  */
    ...
    writel (0xA5A501, hub_base  + KHUB_CLK_MGR_REG_WR_ACCESS_OFFSET);
    writel (0x303, hub_base  + KHUB_CLK_MGR_REG_FUNNEL_CLKGATE_OFFSET);
    writel (0x303, hub_base  + KHUB_CLK_MGR_REG_TPIU_CLKGATE_OFFSET);
    writel (0x303, hub_base  + KHUB_CLK_MGR_REG_ETB_CLKGATE_OFFSET);
    writel (0x303, hub_base  + KHUB_CLK_MGR_REG_FINAL_FUNNEL_CLKGATE_OFFSET);
    writel (0x303, hub_base  + KHUB_CLK_MGR_REG_ATB_CLKGATE_OFFSET);
    writel (0x303, hub_base  + KHUB_CLK_MGR_REG_ETB2AXI_CLKGATE_OFFSET);
    
    writel (0xA5A500, hub_base  + KHUB_CLK_MGR_REG_WR_ACCESS_OFFSET);
    return 0;
}
...
static int misc_clk_status(struct clk *clk)
{
	...
	case CLK_TPIU_PERI_CLK_ID:
		...
		reg_offset = CHIPREG_ARM_PERI_CONTROL_OFFSET;
		reg_mask =
			CHIPREG_ARM_PERI_CONTROL_TPIU_CLK_IS_IDLE_MASK;
		reg_shift =
			CHIPREG_ARM_PERI_CONTROL_TPIU_CLK_IS_IDLE_SHIFT;
		break;
	case CLK_PTI_PERI_CLK_ID:
		reg_base = KONA_CHIPREG_VA;
		reg_offset = CHIPREG_ARM_PERI_CONTROL_OFFSET;
		reg_mask = CHIPREG_ARM_PERI_CONTROL_PTI_CLK_IS_IDLE_MASK;
		reg_shift =
			CHIPREG_ARM_PERI_CONTROL_PTI_CLK_IS_IDLE_SHIFT;
		break;
	default:
		return -EINVAL;
	}
...
int __init clock_late_init(void)
{
	...
	for (i=0; i<ARRAY_SIZE(capri_clk_tbl); i++){
		...
		clock_debug_add_ccu(capri_clk_tbl[i].clk);
		else if (capri_clk_tbl[i].clk->clk_type == CLK_TYPE_MISC)
			clock_debug_add_misc_clock(capri_clk_tbl[i].clk);
		else
		clock_debug_add_clock (capri_clk_tbl[i].clk);
	}
#endif
	return 0;
}
