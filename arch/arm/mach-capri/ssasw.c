...
#define SRCMIXER_MIXER2_MASK      ( CAPH_MIXER2_OUTFIFO | CAPH_MIXER2_OUTFIFO1 | CAPH_MIXER2_OUTFIFO2 )
...
#define DEVICE_SSASW_SRC_16000_AUDIOH_VINR      \
{ \
   .name = "SSASW 16000 Vin Right",             \
   .dev_sw_trig = CAPH_TAPSDOWN_CH1_NORM_INT,   \
   .sw_data_format = CAPH_MONO_16BIT,           \
   .src_sw_trig = CAPH_ADC_VOICE_FIFO_THR_MET,  \
   .src_in_fifo = CAPH_CH1_INFIFO,              \
   .src_out_fifo = CAPH_CH1_TAP_OUTFIFO,        \
   .src_in_data_format = CAPH_MONO_16BIT,       \
   .src_out_data_format = CAPH_MONO_16BIT,      \
   .mix_src_ch = CAPH_SRCM_CH_NONE,             \
   .mix_dst_ch = CAPH_M_NONE,                   \
   .mix_freq = CAPH_48KHz_16KHz,                \
}

#define DEVICE_SSASW_SRC_16000_AUDIOH_VINL      \
{ \
   .name = "SSASW 16000 Vin Left",              \
   .dev_sw_trig = CAPH_TAPSDOWN_CH2_NORM_INT,   \
   .sw_data_format = CAPH_MONO_16BIT,           \
   .src_sw_trig = CAPH_ADC_VOICE_L_FIFO_THR_MET,\
   .src_in_fifo = CAPH_CH2_INFIFO,              \
   .src_out_fifo = CAPH_CH2_TAP_OUTFIFO,        \
   .src_in_data_format = CAPH_MONO_16BIT,       \
   .src_out_data_format = CAPH_MONO_16BIT,      \
   .mix_src_ch = CAPH_SRCM_CH_NONE,             \
   .mix_dst_ch = CAPH_M_NONE,                   \
...
#define DEVICE_SSASW_SRC_16000_AUDIOH_NVINR     \
{ \
   .name = "SSASW 16000 NVin Right",            \
   .dev_sw_trig = CAPH_TAPSDOWN_CH3_NORM_INT,   \
   .sw_data_format = CAPH_MONO_16BIT,           \
   .src_sw_trig = CAPH_ADC_NOISE_FIFO_THR_MET,  \
   .src_in_fifo = CAPH_CH3_INFIFO,              \
   .src_out_fifo = CAPH_CH3_TAP_OUTFIFO,        \
   .src_in_data_format = CAPH_MONO_16BIT,       \
   .src_out_data_format = CAPH_MONO_16BIT,      \
   .mix_src_ch = CAPH_SRCM_CH_NONE,             \
   .mix_dst_ch = CAPH_M_NONE,                   \
...
#define DEVICE_SSASW_SRC_16000_AUDIOH_NVINL     \
{ \
   .name = "SSASW 16000 NVin Left",             \
   .dev_sw_trig = CAPH_TAPSDOWN_CH4_NORM_INT,   \
   .sw_data_format = CAPH_MONO_16BIT,           \
   .src_sw_trig = CAPH_ADC_NOISE_L_FIFO_THR_MET,\
   .src_in_fifo = CAPH_CH4_INFIFO,              \
   .src_out_fifo = CAPH_CH4_TAP_OUTFIFO,        \
   .src_in_data_format = CAPH_MONO_16BIT,       \
   .src_out_data_format = CAPH_MONO_16BIT,      \
   .mix_src_ch = CAPH_SRCM_CH_NONE,             \
   .mix_dst_ch = CAPH_M_NONE,                   \
...
#define DEVICE_SSASW_SSP3_PCM_EGR \
{ \
   .name = "SSASW SSP3 PCM Egress",       \
   .dev_sw_trig = CAPH_SSP3_TRIGGER_TX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}

#define DEVICE_SSASW_SSP3_PCM_IGR \
{ \
   .name = "SSASW SSP3 PCM Ingress",      \
   .dev_sw_trig = CAPH_SSP3_TRIGGER_RX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}

#define DEVICE_SSASW_SSP4_PCM_EGR \
{ \
   .name = "SSASW SSP4 PCM Egress",       \
   .dev_sw_trig = CAPH_SSP4_TRIGGER_TX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}

#define DEVICE_SSASW_SSP4_PCM_IGR \
{ \
   .name = "SSASW SSP4 PCM Ingress",      \
   .dev_sw_trig = CAPH_SSP4_TRIGGER_RX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}

#define DEVICE_SSASW_SSP5_PCM_EGR \
{ \
   .name = "SSASW SSP5 PCM Egress",       \
   .dev_sw_trig = CAPH_SSP5_TRIGGER_TX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}

#define DEVICE_SSASW_SSP5_PCM_IGR \
{ \
   .name = "SSASW SSP5 PCM Ingress",      \
   .dev_sw_trig = CAPH_SSP5_TRIGGER_RX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}
...
{ \
   ...
   .dev_sw_trig = CAPH_SSP6_TRIGGER_TX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}
...
{ \
   ...
   .dev_sw_trig = CAPH_SSP6_TRIGGER_RX0,  \
   .sw_data_format = CAPH_MONO_16BIT,     \
}
...
static CAPH_SRCMixer_FIFO_e      gChFifoUsed;
...
SSASW_DeviceAttribute_t SSASW_gDeviceAttribute[SSASW_NUM_DEVICE_ENTRIES] = {
   ...
   [SSASW_SRC_16000_AUDIOH_VINR]             = DEVICE_SSASW_SRC_16000_AUDIOH_VINR,
   [SSASW_SRC_16000_AUDIOH_VINL]             = DEVICE_SSASW_SRC_16000_AUDIOH_VINL,
   [SSASW_SRC_16000_AUDIOH_NVINR]            = DEVICE_SSASW_SRC_16000_AUDIOH_NVINR,
   [SSASW_SRC_16000_AUDIOH_NVINL]            = DEVICE_SSASW_SRC_16000_AUDIOH_NVINL,
	...
	[SSASW_SRC_44100_AUDIOH_HANDSFREE_STEREO] =
	    DEVICE_SSASW_SRC_44100_AUDIOH_HANDSFREE_STEREO,
	[SSASW_DEVICE_SSASW_SSP3_PCM_EGR] = DEVICE_SSASW_SSP3_PCM_EGR,
	[SSASW_DEVICE_SSASW_SSP3_PCM_IGR] = DEVICE_SSASW_SSP3_PCM_IGR,
	[SSASW_DEVICE_SSASW_SSP4_PCM_EGR] = DEVICE_SSASW_SSP4_PCM_EGR,
	[SSASW_DEVICE_SSASW_SSP4_PCM_IGR] = DEVICE_SSASW_SSP4_PCM_IGR,
	[SSASW_DEVICE_SSASW_SSP5_PCM_EGR] = DEVICE_SSASW_SSP5_PCM_EGR,
	[SSASW_DEVICE_SSASW_SSP5_PCM_IGR] = DEVICE_SSASW_SSP5_PCM_IGR,
...
static int ssasw_set_clock(SSASW_ChalHandle_t *chal_handle, int enable)
{
	...
	if (enable) {
		...
		chal_caph_switch_enable_clock_bypass(chal_handle->
						     chalSsaswHandle);
		chal_caph_switch_enable_clock(chal_handle->chalSsaswHandle);
	} else {
		chal_caph_switch_disable_clock_bypass(chal_handle->
						      chalSsaswHandle);
	...
	SSASW_Device_t dev, uint16_t src_addr, uint16_t dst_addr)
{
	...
	if (devAttr->src_in_fifo != CAPH_CH_INFIFO_NONE
		...
		if (channel_src_idx == SSASW_NUM_CHANNELS) {
			...
			chal_caph_switch_free_channel(gChalHandle.
						      chalSsaswHandle,
						      channel->caph_switch_ch);
		...
		channel_sec->caph_switch_ch =
		    chal_caph_switch_alloc_given_channel(chal_handle->
							 chalSsaswHandle,
							 CAPH_SWITCH_CH_VOID);
	...
	if (devAttr->src_in_fifo != CAPH_CH_INFIFO_NONE) {
		chal_caph_srcmixer_set_SRC(chal_handle->chalSrcMixerHandle,
					   devAttr->src_in_fifo,
					   devAttr->mix_freq);
		chal_caph_srcmixer_set_filter_type(chal_handle->
						   chalSrcMixerHandle,
						   devAttr->src_in_fifo,
						   CAPH_SRCM_LINEAR_PHASE);
		chal_caph_srcmixer_set_fifo_datafmt(chal_handle->
						    chalSrcMixerHandle,
						    devAttr->src_in_fifo,
						    devAttr->
						    src_in_data_format);
		chal_caph_srcmixer_set_fifo_thres(chal_handle->
						  chalSrcMixerHandle,
						  devAttr->src_in_fifo, 5, 2);
			...
			if (devAttr->mix_dst_ch ==
				...
				chal_caph_srcmixer_set_mixingainstep
				    (chal_handle->chalSrcMixerHandle,
				     ...
				     SRCMIXER_CH_DEF_GAIN_STEP);
				chal_caph_srcmixer_set_mixingain(
						chal_handle->chalSrcMixerHandle,
						devAttr->mix_src_ch,
						CAPH_M0_Left,
						devAttr->mix_dig_gain);
				chal_caph_srcmixer_set_mixingain(
						chal_handle->chalSrcMixerHandle,
						devAttr->mix_src_ch,
						CAPH_M0_Right,
...
int ssasw_mixer_enable(SSASW_Handle_t handle, int enable)
{
	...
	if (enable) {
		...
		if (devAttr->src_in_fifo != CAPH_CH_INFIFO_NONE) {
			chal_caph_srcmixer_enable_chnl(chal_handle->
						       chalSrcMixerHandle,
						       devAttr->src_in_fifo);
		}
	} else {
		if (devAttr->src_in_fifo != CAPH_CH_INFIFO_NONE) {
			chal_caph_srcmixer_disable_chnl(chal_handle->
							chalSrcMixerHandle,
							devAttr->src_in_fifo);
		}
