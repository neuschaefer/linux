...
{
    return reg32_read( (volatile uint32_t*)(chipregHw_BASE_ADDRESS + CHIPREG_PROJECT_ID_OFFSET ));
}
...
{
    return reg32_read( (volatile uint32_t*)(chipregHw_BASE_ADDRESS + CHIPREG_STRAP_OFFSET ));
}
