...
*  @return CHAL handle for the Audio
*****************************************************************************/
extern void chal_aci_auxmic_init(CHAL_HANDLE handle, uint32_t aci_base, uint32_t auxmic_base);
...
*  @return none
*****************************************************************************/
extern void chal_audio_set_aci_auxmic_datab( CHAL_HANDLE handle, _Bool micOutEnable );
