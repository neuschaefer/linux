...
#define DEVICE_PCM_SSP3_TO_CFIFO_TO_MEM \
{ \
   .flags = AADMA_DEVICE_FLAG_SECURE,           \
   .name = "pcm ssp3 to mem",                   \
   .aadma_trans_size = AADMA_DEF_BURST_SIZE,    \
   .cfifo_dir = CAPH_CFIFO_OUT,                 \
   .cfifo_size = AADMA_8KHZ_MONO_IGR_FIFO_SIZE, \
   .cfifo_thres1 = AADMA_DEF_IGR_THRES1,        \
   .cfifo_thres2 = AADMA_DEF_THRES2,            \
   .dev_fifo_addr = SSP3_BASE_ADDR + SSPIL_FIFO_ENTRY0RX_OFFSET, \
}

#define DEVICE_PCM_MEM_TO_CFIFO_TO_SSP3 \
{ \
   .flags = AADMA_DEVICE_FLAG_SECURE,           \
   .name = "pcm mem to ssp3",                   \
   .aadma_trans_size = AADMA_DEF_BURST_SIZE,    \
   .cfifo_dir = CAPH_CFIFO_IN,                  \
   .cfifo_size = AADMA_8KHZ_MONO_EGR_FIFO_SIZE, \
   .cfifo_thres1 = AADMA_DEF_EGR_THRES1,        \
   .cfifo_thres2 = AADMA_DEF_THRES2,            \
   .dev_fifo_addr = SSP3_BASE_ADDR + SSPIL_FIFO_ENTRY0TX_OFFSET, \
}

#define DEVICE_PCM_SSP4_TO_CFIFO_TO_MEM \
{ \
   .flags = AADMA_DEVICE_FLAG_SECURE,           \
   .name = "pcm ssp4 to mem",                   \
   .aadma_trans_size = AADMA_DEF_BURST_SIZE,    \
   .cfifo_dir = CAPH_CFIFO_OUT,                 \
   .cfifo_size = AADMA_8KHZ_MONO_IGR_FIFO_SIZE, \
   .cfifo_thres1 = AADMA_DEF_IGR_THRES1,        \
   .cfifo_thres2 = AADMA_DEF_THRES2,            \
   .dev_fifo_addr = SSP4_BASE_ADDR + SSPIL_FIFO_ENTRY0RX_OFFSET, \
}

#define DEVICE_PCM_MEM_TO_CFIFO_TO_SSP4 \
{ \
   .flags = AADMA_DEVICE_FLAG_SECURE,           \
   .name = "pcm mem to ssp4",                   \
   .aadma_trans_size = AADMA_DEF_BURST_SIZE,    \
   .cfifo_dir = CAPH_CFIFO_IN,                  \
   .cfifo_size = AADMA_8KHZ_MONO_EGR_FIFO_SIZE, \
   .cfifo_thres1 = AADMA_DEF_EGR_THRES1,        \
   .cfifo_thres2 = AADMA_DEF_THRES2,            \
   .dev_fifo_addr = SSP4_BASE_ADDR + SSPIL_FIFO_ENTRY0TX_OFFSET, \
}

#define DEVICE_PCM_SSP5_TO_CFIFO_TO_MEM \
{ \
   .flags = AADMA_DEVICE_FLAG_SECURE,           \
   .name = "pcm ssp5 to mem",                   \
   .aadma_trans_size = AADMA_DEF_BURST_SIZE,    \
   .cfifo_dir = CAPH_CFIFO_OUT,                 \
   .cfifo_size = AADMA_8KHZ_MONO_IGR_FIFO_SIZE, \
   .cfifo_thres1 = AADMA_DEF_IGR_THRES1,        \
   .cfifo_thres2 = AADMA_DEF_THRES2,            \
   .dev_fifo_addr = SSP5_BASE_ADDR + SSPIL_FIFO_ENTRY0RX_OFFSET, \
}

#define DEVICE_PCM_MEM_TO_CFIFO_TO_SSP5 \
{ \
   .flags = AADMA_DEVICE_FLAG_SECURE,           \
   .name = "pcm mem to ssp5",                   \
   .aadma_trans_size = AADMA_DEF_BURST_SIZE,    \
   .cfifo_dir = CAPH_CFIFO_IN,                  \
   .cfifo_size = AADMA_8KHZ_MONO_EGR_FIFO_SIZE, \
   .cfifo_thres1 = AADMA_DEF_EGR_THRES1,        \
   .cfifo_thres2 = AADMA_DEF_THRES2,            \
   .dev_fifo_addr = SSP5_BASE_ADDR + SSPIL_FIFO_ENTRY0TX_OFFSET, \
}
...
AADMA_DeviceAttribute_t AADMA_gDeviceAttribute[AADMA_NUM_DEVICE_ENTRIES] = {
	...
	[AADMA_DEVICE_PCM_SSP3_TO_CFIFO_TO_MEM] = 
	    DEVICE_PCM_SSP3_TO_CFIFO_TO_MEM,
	[AADMA_DEVICE_PCM_MEM_TO_CFIFO_TO_SSP3] = 
	    DEVICE_PCM_MEM_TO_CFIFO_TO_SSP3,
	[AADMA_DEVICE_PCM_SSP4_TO_CFIFO_TO_MEM] = 
	    DEVICE_PCM_SSP4_TO_CFIFO_TO_MEM,
	[AADMA_DEVICE_PCM_MEM_TO_CFIFO_TO_SSP4] = 
	    DEVICE_PCM_MEM_TO_CFIFO_TO_SSP4,
	[AADMA_DEVICE_PCM_SSP5_TO_CFIFO_TO_MEM] = 
	    DEVICE_PCM_SSP5_TO_CFIFO_TO_MEM,
	[AADMA_DEVICE_PCM_MEM_TO_CFIFO_TO_SSP5] = 
	    DEVICE_PCM_MEM_TO_CFIFO_TO_SSP5,
			...
			if (num_contiguous_slots >= num_slots) {
				...
				while (cfifo_buf_start_p <= cfifo_buf_end_p) {
					...
					for (j = 0; j < CFIFO_NUM_SEG_PER_SLOT;
					     j++) {
						cfifo_buf_start_p->seg[j].
						    seg_allocated = 1;
						cfifo_buf_start_p->seg[j].
						    seg_alloc_ch_id = fifo_ch;
						cfifo_buf_start_p->
						    num_seg_allocated++;
					}
					cfifo_buf_start_p++;
