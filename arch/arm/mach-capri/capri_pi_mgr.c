...
static u32 esub_dep_pi[] = { PI_MGR_PI_ID_ESUB_SUB };
static struct pi esub_pi = {
	...
	.qos_sw_event_id = SOFTWARE_0_EVENT,
	.dep_pi = esub_dep_pi,
	.num_dep_pi = ARRAY_SIZE(esub_dep_pi),
	.pi_info = {
				.policy_reg_offset = PWRMGR_LCDTE_VI_MM_POLICY_OFFSET,
				.ac_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_ESUB_PM_AC_SHIFT,
				.atl_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_ESUB_PM_ATL_SHIFT,
				.pm_policy_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_ESUB_PM_POLICY_SHIFT,

				.fixed_vol_map_mask = PWRMGR_FIXED_VOLTAGE_MAP_VI_ESUB_FIXED_VOLTAGE_MAP_SHIFT,
				.vi_to_vOx_map_mask = PWRMGR_VI_TO_VO0_MAP_VI_ESUB_TO_VO0_MAP_MASK,
				.wakeup_overide_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_ESUB_WAKEUP_OVERRIDE_MASK,
				.counter_reg_offset = PWRMGR_PI_ESUB_ON_COUNTER_OFFSET,
				.rtn_clmp_dis_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_ESUB_RETENTION_CLAMP_DISABLE_MASK,
			},
	.ops = &gen_pi_ops,
};
...
static struct pi esub_sub_pi = {
	...
	.pi_info = {
				.policy_reg_offset = PWRMGR_LCDTE_VI_MM_POLICY_OFFSET,
				.ac_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_ESUB_SUB_PM_AC_SHIFT,
				.atl_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_ESUB_SUB_PM_ATL_SHIFT,
				.pm_policy_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_ESUB_SUB_PM_POLICY_SHIFT,

				.fixed_vol_map_mask = PWRMGR_FIXED_VOLTAGE_MAP_VI_ESUB_FIXED_VOLTAGE_MAP_SHIFT,
				.vi_to_vOx_map_mask = PWRMGR_VI_TO_VO0_MAP_VI_ESUB_TO_VO0_MAP_MASK,
				.wakeup_overide_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_ESUB_SUB_WAKEUP_OVERRIDE_MASK,
				.counter_reg_offset = PWRMGR_PI_ESUB_SUB_ON_COUNTER_OFFSET,
				.rtn_clmp_dis_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_ESUB_SUB_RETENTION_CLAMP_DISABLE_MASK,
			},
	.ops = &gen_pi_ops,
};
#endif
...
static struct pi mm_pi = {
	...
	.pi_info =    {
				...
				.fixed_vol_map_mask = PWRMGR_FIXED_VOLTAGE_MAP_VI_MM_FIXED_VOLTAGE_MAP_SHIFT,
...
static struct pi mm_sub_pi = {
	...
	.pi_info =    {
				.policy_reg_offset = PWRMGR_LCDTE_VI_MM_POLICY_OFFSET,
				.ac_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_MM_SUB_PM_AC_SHIFT,
				.atl_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_MM_SUB_PM_ATL_SHIFT,
				.pm_policy_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_MM_SUB_PM_POLICY_SHIFT,

				.fixed_vol_map_mask = PWRMGR_FIXED_VOLTAGE_MAP_VI_MM_FIXED_VOLTAGE_MAP_SHIFT,
				.vi_to_vOx_map_mask = PWRMGR_VI_TO_VO0_MAP_VI_MM_TO_VO0_MAP_MASK,
				.wakeup_overide_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_MM_SUB_WAKEUP_OVERRIDE_MASK,
				.counter_reg_offset = PWRMGR_PI_MM_SUB_ON_COUNTER_OFFSET,
				.rtn_clmp_dis_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_MM_SUB_RETENTION_CLAMP_DISABLE_MASK,
			},
	.ops = NULL,
};
...
static struct pi mm_sub2_pi = {
	...
	.pi_info =    {
				.policy_reg_offset = PWRMGR_LCDTE_VI_MM_POLICY_OFFSET,
				.ac_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_MM_SUB2_PM_AC_SHIFT,
				.atl_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_MM_SUB2_PM_ATL_SHIFT,
				.pm_policy_shift = PWRMGR_LCDTE_VI_MM_POLICY_LCDTE_PI_MM_SUB2_PM_POLICY_SHIFT,

				.fixed_vol_map_mask = PWRMGR_FIXED_VOLTAGE_MAP_VI_MM_FIXED_VOLTAGE_MAP_SHIFT,
				.vi_to_vOx_map_mask = PWRMGR_VI_TO_VO0_MAP_VI_MM_TO_VO0_MAP_MASK,
				.wakeup_overide_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_MM_SUB2_WAKEUP_OVERRIDE_MASK,
				.counter_reg_offset = PWRMGR_PI_MM_SUB2_ON_COUNTER_OFFSET,
				.rtn_clmp_dis_mask = PWRMGR_PI_DEFAULT_POWER_STATE_PI_MM_SUB2_RETENTION_CLAMP_DISABLE_MASK,
			},
	.ops = NULL,
};
