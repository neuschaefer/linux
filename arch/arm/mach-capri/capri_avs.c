						...
						u32 silicon_type)
{
	...
	union si_type {
		struct si_type_struct silicon_types;
		u32 silicon_type;
	} silicon_types_union;
	...
	silicon_types_union.silicon_type = silicon_type;
	silicon_type_csr = silicon_types_union.silicon_types.silicon_type_csr;
	silicon_type_msr = silicon_types_union.silicon_types.silicon_type_msr;
	silicon_type_vsr = silicon_types_union.silicon_types.silicon_type_vsr;

	vlt_tbl_init = 1;

	BUG_ON(!vlt_tbl_init ||
		freq_inx > A9_FREQ_1500_MHZ);
