...
#if defined(CONFIG_HW_RANDOM_KONA) || defined(CONFIG_HW_RANDOM_KONA_MODULE)
...
#if defined(CONFIG_KONA_PWMC) || defined(CONFIG_KONA_PWMC_MODULE)
...
#if defined(CONFIG_W1_MASTER_DS1WM) || defined(CONFIG_W1_MASTER_DS1WM_MODULE)
...
#if defined(CONFIG_MPCORE_WATCHDOG) || defined(CONFIG_MPCORE_WATCHDOG_MODULE)
static struct resource wdt_device_resource[] = {
    [0] = {
        .start = PTIM_BASE_ADDR,
        .end   = PTIM_BASE_ADDR + 0x37,
        .flags = IORESOURCE_MEM,
    },
    [1] = {
...
static struct platform_device wdt_device =
{
   ...
   .dev = {
        .platform_data = ARM1_CORE_CLK_NAME_STR,
    },
};
#endif

#if defined(CONFIG_MTD_BCMNAND) || defined(CONFIG_MTD_BCMNAND_MODULE)
...
#if defined(CONFIG_RTC_DRV_ISLAND) || defined(CONFIG_RTC_DRV_ISLAND_MODULE)
...
#if defined(CONFIG_USB_ANDROID_RNDIS) || defined(CONFIG_USB_ANDROID_RNDIS_MODULE)
...
#if defined(CONFIG_KONA_CPU_FREQ_DRV) || defined(CONFIG_KONA_CPU_FREQ_DRV_MODULE)
...
#if defined(CONFIG_SENSORS_KONA) || defined(CONFIG_SENSORS_KONA_MODULE)
