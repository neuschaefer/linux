...
#define GPIO_SW(gpio_num, ev_code, act_low, descr, wake, debounce)	\
{								\
	.gpio		= gpio_num,				\
	.type		= EV_SW,				\
	.code		= ev_code,				\
...
//Terry add: Disable HOME KEY
static struct gpio_keys_button gpio_key_HOME_FL[] = {
	GPIO_BUTTON(GPIO_KB_COL1, 90, 1, "front_light", 1,1),			// Front light
#ifdef CONFIG_ANDROID//[
	GPIO_BUTTON(GPIO_KB_COL0, KEY_HOME, 1, "home", 1,50),	// home
	GPIO_SW(IMX_GPIO_NR(5,12), 0, 1, "hall_sensor",1,1),	// hall_sensor
#else //][!CONFIG_ANDROID
...
//	imx6q_add_imx_snvs_rtc();
	...
	{
		// if not E60QBX & E60QCX 
		// MSP430 .
		if(50==gptHWCFG->m_val.bPCB) {
			i2c_register_board_info(0,&i2c_sysmp_msp430_binfo,1);
		}
		else {
