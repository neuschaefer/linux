...
static irqreturn_t _AesIommuIrqHandler(UINT16 u2Vector)
{
    #if 0
...
static BOOL GCPU_EnableIOMMU(UINT32 u4Src1Start, UINT32 u4Src1End, UINT32 u4Src2Start, UINT32 u4Src2End)
{
    //IOMMU_GCPU_WRITE32(REG_IOMMU_CFG0, 0);
    // setup IOMMU
    IOMMU_GCPU_WRITE32(REG_IOMMU_CFG4, 0x0603000A);
...
BOOL NAND_AES_Encryption(UINT32 u4InBufStart, UINT32 u4OutBufStart, UINT32 u4BufSize)
{
    ...
    _GCPU_EnableIOMMU(rCmd.u4Param[8], rCmd.u4Param[9], 0, 0);
...
int SHA256_HW_INIT(struct shash_desc *desc)
{
	...
	{
		UINT32 u4Tmp;
	    u4Tmp = _u1Sha256DataBuf + GCPU_SHA_256_PACKET_SIZE;
	    u4Tmp = (u4Tmp >> 6);
	    u4Tmp = (u4Tmp << 6);
...
BOOL SHA256_HW_TRANSFORM(UINT32 *state, UINT32 u4InBufStart, UINT32 u4BufferSize, BOOL fgFirstPacket)
{
	...
	_GCPU_EnableIOMMU(rHwCmd.u4Param[12], rHwCmd.u4Param[13], 0, 0);
